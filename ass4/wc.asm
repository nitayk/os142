...
printint(int fd, int xx, int base, int sgn)
{
 ...
 582:	0f b6 80 5c 0c 00 00 	movzbl 0xc5c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6df:	75 09                	jne    6ea <printf+0x101>
          s = "(null)";
 6e1:	c7 45 f4 ee 09 00 00 	movl   $0x9ee,-0xc(%ebp)
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8e7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8ea:	a1 88 0c 00 00       	mov    0xc88,%eax
 8ef:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8f2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8f6:	75 23                	jne    91b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8f8:	c7 45 f0 80 0c 00 00 	movl   $0xc80,-0x10(%ebp)
 8ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
 902:	a3 88 0c 00 00       	mov    %eax,0xc88
 907:	a1 88 0c 00 00       	mov    0xc88,%eax
 90c:	a3 80 0c 00 00       	mov    %eax,0xc80
    base.s.size = 0;
 911:	c7 05 84 0c 00 00 00 	movl   $0x0,0xc84
 918:	00 00 00 
  }
 ...
 96e:	a3 88 0c 00 00       	mov    %eax,0xc88
      return (void*)(p + 1);
 ...
 979:	eb 38                	jmp    9b3 <malloc+0xde>
    ...
    if(p == freep)
 97b:	a1 88 0c 00 00       	mov    0xc88,%eax
