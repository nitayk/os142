...
main(int argc, char *argv[])
{
 ...
 113:	c7 44 24 04 34 0b 00 	movl   $0xb34,0x4(%esp)
 11a:	00 
 ...
 1a5:	c7 44 24 04 54 0b 00 	movl   $0xb54,0x4(%esp)
 1ac:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6fe:	0f b6 80 38 0e 00 00 	movzbl 0xe38(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 85b:	75 09                	jne    866 <printf+0x101>
          s = "(null)";
 85d:	c7 45 f4 6a 0b 00 00 	movl   $0xb6a,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 927:	a1 68 0e 00 00       	mov    0xe68,%eax
...
free(void *ap)
{
 ...
 9f2:	a3 68 0e 00 00       	mov    %eax,0xe68
}
 9f7:	c9                   	leave  
 9f8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a45:	e8 ce fe ff ff       	call   918 <free>
  return freep;
 a4a:	a1 68 0e 00 00       	mov    0xe68,%eax
}
 a4f:	c9                   	leave  
 a50:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a63:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a66:	a1 68 0e 00 00       	mov    0xe68,%eax
 a6b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a6e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a72:	75 23                	jne    a97 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a74:	c7 45 f0 60 0e 00 00 	movl   $0xe60,-0x10(%ebp)
 a7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a7e:	a3 68 0e 00 00       	mov    %eax,0xe68
 a83:	a1 68 0e 00 00       	mov    0xe68,%eax
 a88:	a3 60 0e 00 00       	mov    %eax,0xe60
    base.s.size = 0;
 a8d:	c7 05 64 0e 00 00 00 	movl   $0x0,0xe64
 a94:	00 00 00 
  }
 ...
 aea:	a3 68 0e 00 00       	mov    %eax,0xe68
      return (void*)(p + 1);
