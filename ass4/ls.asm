...
ls(char *path)
{
  ...
  df:	c7 44 24 04 37 0b 00 	movl   $0xb37,0x4(%esp)
  e6:	00 
 ...
 118:	c7 44 24 04 4b 0b 00 	movl   $0xb4b,0x4(%esp)
 11f:	00 
 ...
 183:	c7 44 24 04 5f 0b 00 	movl   $0xb5f,0x4(%esp)
 18a:	00 
 ...
 1b1:	c7 44 24 04 6c 0b 00 	movl   $0xb6c,0x4(%esp)
 1b8:	00 
 ...
 269:	c7 44 24 04 4b 0b 00 	movl   $0xb4b,0x4(%esp)
 270:	00 
 ...
 2b3:	c7 44 24 04 5f 0b 00 	movl   $0xb5f,0x4(%esp)
 2ba:	00 
...
main(int argc, char *argv[])
{
 ...
 311:	7f 11                	jg     324 <main+0x20>
    ls(".");
 313:	c7 04 24 7f 0b 00 00 	movl   $0xb7f,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 704:	0f b6 80 20 0e 00 00 	movzbl 0xe20(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 861:	75 09                	jne    86c <printf+0x101>
          s = "(null)";
 863:	c7 45 f4 81 0b 00 00 	movl   $0xb81,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 92d:	a1 4c 0e 00 00       	mov    0xe4c,%eax
...
free(void *ap)
{
 ...
 9f8:	a3 4c 0e 00 00       	mov    %eax,0xe4c
}
 9fd:	c9                   	leave  
 9fe:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a4b:	e8 ce fe ff ff       	call   91e <free>
  return freep;
 a50:	a1 4c 0e 00 00       	mov    0xe4c,%eax
}
 a55:	c9                   	leave  
 a56:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a69:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a6c:	a1 4c 0e 00 00       	mov    0xe4c,%eax
 a71:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a74:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a78:	75 23                	jne    a9d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a7a:	c7 45 f0 44 0e 00 00 	movl   $0xe44,-0x10(%ebp)
 a81:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a84:	a3 4c 0e 00 00       	mov    %eax,0xe4c
 a89:	a1 4c 0e 00 00       	mov    0xe4c,%eax
 a8e:	a3 44 0e 00 00       	mov    %eax,0xe44
    base.s.size = 0;
 a93:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 a9a:	00 00 00 
  }
 ...
 af0:	a3 4c 0e 00 00       	mov    %eax,0xe4c
      return (void*)(p + 1);
 ...
 afb:	eb 38                	jmp    b35 <malloc+0xde>
    ...
    if(p == freep)
 afd:	a1 4c 0e 00 00       	mov    0xe4c,%eax
