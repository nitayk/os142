...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 82 08 00 	movl   $0x882,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 438:	0f b6 80 ec 0a 00 00 	movzbl 0xaec(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 09                	jne    5a0 <printf+0x101>
          s = "(null)";
 597:	c7 45 f4 9e 08 00 00 	movl   $0x89e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 72c:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 731:	c9                   	leave  
 732:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 77f:	e8 ce fe ff ff       	call   652 <free>
  return freep;
 784:	a1 08 0b 00 00       	mov    0xb08,%eax
}
 789:	c9                   	leave  
 78a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a0:	a1 08 0b 00 00       	mov    0xb08,%eax
 7a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ac:	75 23                	jne    7d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7ae:	c7 45 f0 00 0b 00 00 	movl   $0xb00,-0x10(%ebp)
 7b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b8:	a3 08 0b 00 00       	mov    %eax,0xb08
 7bd:	a1 08 0b 00 00       	mov    0xb08,%eax
 7c2:	a3 00 0b 00 00       	mov    %eax,0xb00
    base.s.size = 0;
 7c7:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 7ce:	00 00 00 
  }
 ...
 824:	a3 08 0b 00 00       	mov    %eax,0xb08
      return (void*)(p + 1);
 ...
 82f:	eb 38                	jmp    869 <malloc+0xde>
    ...
    if(p == freep)
 831:	a1 08 0b 00 00       	mov    0xb08,%eax
