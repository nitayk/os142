     ...
     542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 50 1a 00 00 	movl   $0x1a50,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 50 1a 00 00 	movl   $0x1a50,(%esp)
     ...
     622:	c7 04 24 56 1a 00 00 	movl   $0x1a56,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 50 1a 00 00 	movl   $0x1a50,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 50 1a 00 00 	movl   $0x1a50,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    10a2:	0f b6 80 5e 1a 00 00 	movzbl 0x1a5e(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11ff:	75 09                	jne    120a <printf+0x101>
          s = "(null)";
    1201:	c7 45 f4 c8 15 00 00 	movl   $0x15c8,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12cb:	a1 ec 1a 00 00       	mov    0x1aec,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1396:	a3 ec 1a 00 00       	mov    %eax,0x1aec
}
    139b:	c9                   	leave  
    139c:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13ee:	a1 ec 1a 00 00       	mov    0x1aec,%eax
}
    13f3:	c9                   	leave  
    13f4:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    140a:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    140f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1412:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1416:	75 23                	jne    143b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1418:	c7 45 f0 e4 1a 00 00 	movl   $0x1ae4,-0x10(%ebp)
    141f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1422:	a3 ec 1a 00 00       	mov    %eax,0x1aec
    1427:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    142c:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
    base.s.size = 0;
    1431:	c7 05 e8 1a 00 00 00 	movl   $0x0,0x1ae8
    1438:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    148e:	a3 ec 1a 00 00       	mov    %eax,0x1aec
      return (void*)(p + 1);
    ...
    if(p == freep)
    149b:	a1 ec 1a 00 00       	mov    0x1aec,%eax
