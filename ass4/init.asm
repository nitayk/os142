...
main(void)
{
  ...
  69:	c7 44 24 04 f6 08 00 	movl   $0x8f6,0x4(%esp)
  70:	00 
  ...
  8d:	c7 44 24 04 09 09 00 	movl   $0x909,0x4(%esp)
  94:	00 
  ...
  ab:	75 2d                	jne    da <main+0xda>
      exec("sh", argv);
  ad:	c7 44 24 04 88 0b 00 	movl   $0xb88,0x4(%esp)
  b4:	00 
  b5:	c7 04 24 eb 08 00 00 	movl   $0x8eb,(%esp)
  bc:	e8 ee 02 00 00       	call   3af <exec>
      printf(1, "init: exec sh failed\n");
  c1:	c7 44 24 04 1c 09 00 	movl   $0x91c,0x4(%esp)
  c8:	00 
  ...
  da:	eb 14                	jmp    f0 <main+0xf0>
      printf(1, "zombie!\n");
  dc:	c7 44 24 04 32 09 00 	movl   $0x932,0x4(%esp)
  e3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b8:	0f b6 80 90 0b 00 00 	movzbl 0xb90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 615:	75 09                	jne    620 <printf+0x101>
          s = "(null)";
 617:	c7 45 f4 3b 09 00 00 	movl   $0x93b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 ac 0b 00 00       	mov    0xbac,%eax
...
free(void *ap)
{
 ...
 7ac:	a3 ac 0b 00 00       	mov    %eax,0xbac
}
 7b1:	c9                   	leave  
 7b2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ff:	e8 ce fe ff ff       	call   6d2 <free>
  return freep;
 804:	a1 ac 0b 00 00       	mov    0xbac,%eax
}
 809:	c9                   	leave  
 80a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 81d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 820:	a1 ac 0b 00 00       	mov    0xbac,%eax
 825:	89 45 f0             	mov    %eax,-0x10(%ebp)
 828:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 82c:	75 23                	jne    851 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 82e:	c7 45 f0 a4 0b 00 00 	movl   $0xba4,-0x10(%ebp)
 835:	8b 45 f0             	mov    -0x10(%ebp),%eax
 838:	a3 ac 0b 00 00       	mov    %eax,0xbac
 83d:	a1 ac 0b 00 00       	mov    0xbac,%eax
 842:	a3 a4 0b 00 00       	mov    %eax,0xba4
    base.s.size = 0;
 847:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 84e:	00 00 00 
  }
 ...
 8a4:	a3 ac 0b 00 00       	mov    %eax,0xbac
      return (void*)(p + 1);
 ...
 8af:	eb 38                	jmp    8e9 <malloc+0xde>
    ...
    if(p == freep)
 8b1:	a1 ac 0b 00 00       	mov    0xbac,%eax
