...
cat(int fd)
{
  ...
  4d:	c7 44 24 04 f9 08 00 	movl   $0x8f9,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  d5:	c7 44 24 04 0a 09 00 	movl   $0x90a,0x4(%esp)
  dc:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c6:	0f b6 80 8c 0b 00 00 	movzbl 0xb8c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 623:	75 09                	jne    62e <printf+0x101>
          s = "(null)";
 625:	c7 45 f4 1f 09 00 00 	movl   $0x91f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7ba:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 7bf:	c9                   	leave  
 7c0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 80d:	e8 ce fe ff ff       	call   6e0 <free>
  return freep;
 812:	a1 a8 0b 00 00       	mov    0xba8,%eax
}
 817:	c9                   	leave  
 818:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 83c:	c7 45 f0 a0 0b 00 00 	movl   $0xba0,-0x10(%ebp)
 843:	8b 45 f0             	mov    -0x10(%ebp),%eax
 846:	a3 a8 0b 00 00       	mov    %eax,0xba8
 84b:	a1 a8 0b 00 00       	mov    0xba8,%eax
 850:	a3 a0 0b 00 00       	mov    %eax,0xba0
    base.s.size = 0;
 855:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 85c:	00 00 00 
  }
 ...
 8b2:	a3 a8 0b 00 00       	mov    %eax,0xba8
      return (void*)(p + 1);
 ...
 8bd:	eb 38                	jmp    8f7 <malloc+0xde>
    ...
    if(p == freep)
 8bf:	a1 a8 0b 00 00       	mov    0xba8,%eax
