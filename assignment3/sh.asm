...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    101b:	8b 04 85 dc 24 00 00 	mov    0x24dc(,%eax,4),%eax
    1022:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
    1024:	c7 04 24 b0 24 00 00 	movl   $0x24b0,(%esp)
  ...
  case EXEC:
    ...
    1067:	c7 44 24 04 b7 24 00 	movl   $0x24b7,0x4(%esp)
    106e:	00 
    106f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1076:	e8 66 10 00 00       	call   20e1 <printf>
    break;
  ...
  case REDIR:
    ...
    10ba:	c7 44 24 04 c7 24 00 	movl   $0x24c7,0x4(%esp)
    10c1:	00 
    10c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    10c9:	e8 13 10 00 00       	call   20e1 <printf>
      exit();
  ...
  case PIPE:
    ...
    112e:	79 0c                	jns    113c <runcmd+0x13c>
      panic("pipe");
    1130:	c7 04 24 d7 24 00 00 	movl   $0x24d7,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
    1211:	c7 44 24 04 f4 24 00 	movl   $0x24f4,0x4(%esp)
    1218:	00 
    1219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1220:	e8 bc 0e 00 00       	call   20e1 <printf>
  memset(buf, 0, nbuf);
    ...
    1287:	eb 1f                	jmp    12a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1290:	00 
    1291:	c7 04 24 f7 24 00 00 	movl   $0x24f7,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    130b:	e8 d1 0d 00 00       	call   20e1 <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
    ...
    1364:	c7 44 24 04 0d 25 00 	movl   $0x250d,0x4(%esp)
    136b:	00 
    136c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1373:	e8 69 0d 00 00       	call   20e1 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
    1391:	c7 04 24 11 25 00 00 	movl   $0x2511,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    13af:	e8 19 10 00 00       	call   23cd <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    13ed:	e8 db 0f 00 00       	call   23cd <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1458:	e8 70 0f 00 00       	call   23cd <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    14a8:	e8 20 0f 00 00       	call   23cd <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    14f8:	e8 d0 0e 00 00       	call   23cd <malloc>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
    1721:	c7 44 24 08 16 25 00 	movl   $0x2516,0x8(%esp)
    1728:	00 
  ...
  if(s != es){
    ...
    174a:	c7 44 24 04 17 25 00 	movl   $0x2517,0x4(%esp)
    1751:	00 
    1752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1759:	e8 83 09 00 00       	call   20e1 <printf>
    panic("syntax");
    175e:	c7 04 24 26 25 00 00 	movl   $0x2526,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
    17cb:	c7 44 24 08 2d 25 00 	movl   $0x252d,0x8(%esp)
    17d2:	00 
  ...
  if(peek(ps, es, ";")){
    17e9:	c7 44 24 08 2f 25 00 	movl   $0x252f,0x8(%esp)
    17f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
    186d:	c7 44 24 08 31 25 00 	movl   $0x2531,0x8(%esp)
    1874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    192b:	c7 04 24 33 25 00 00 	movl   $0x2533,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    19d7:	c7 44 24 08 50 25 00 	movl   $0x2550,0x8(%esp)
    19de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    1a04:	c7 44 24 08 53 25 00 	movl   $0x2553,0x8(%esp)
    1a0b:	00 
    ...
    panic("parseblock");
    1a22:	c7 04 24 55 25 00 00 	movl   $0x2555,(%esp)
  ...
  if(!peek(ps, es, ")"))
    1a65:	c7 44 24 08 60 25 00 	movl   $0x2560,0x8(%esp)
    1a6c:	00 
    ...
    1a83:	c7 04 24 62 25 00 00 	movl   $0x2562,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    1ad8:	c7 44 24 08 53 25 00 	movl   $0x2553,0x8(%esp)
    1adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    1b75:	74 0c                	je     1b83 <parseexec+0xb1>
      panic("syntax");
    1b77:	c7 04 24 26 25 00 00 	movl   $0x2526,(%esp)
    ...
    1ba8:	7e 0c                	jle    1bb6 <parseexec+0xe4>
      panic("too many args");
    1baa:	c7 04 24 75 25 00 00 	movl   $0x2575,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
    1bd2:	c7 44 24 08 83 25 00 	movl   $0x2583,0x8(%esp)
    1bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1c3c:	8b 04 85 88 25 00 00 	mov    0x2588(,%eax,4),%eax
    1c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
{
    2001:	55                   	push   %ebp
    2002:	89 e5                	mov    %esp,%ebp
    2004:	83 ec 18             	sub    $0x18,%esp
    2007:	8b 45 0c             	mov    0xc(%ebp),%eax
    200a:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    200d:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2014:	00 
    2015:	8d 45 f4             	lea    -0xc(%ebp),%eax
    2018:	89 44 24 04          	mov    %eax,0x4(%esp)
    201c:	8b 45 08             	mov    0x8(%ebp),%eax
    201f:	89 04 24             	mov    %eax,(%esp)
    2022:	e8 5a ff ff ff       	call   1f81 <write>
}
    2027:	c9                   	leave  
    2028:	c3                   	ret    
...
{
    2029:	55                   	push   %ebp
    202a:	89 e5                	mov    %esp,%ebp
    202c:	56                   	push   %esi
    202d:	53                   	push   %ebx
    202e:	83 ec 30             	sub    $0x30,%esp
  ...
  neg = 0;
    2031:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    2038:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    203c:	74 17                	je     2055 <printint+0x2c>
    203e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    2042:	79 11                	jns    2055 <printint+0x2c>
    neg = 1;
    2044:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    204b:	8b 45 0c             	mov    0xc(%ebp),%eax
    204e:	f7 d8                	neg    %eax
    2050:	89 45 ec             	mov    %eax,-0x14(%ebp)
    2053:	eb 06                	jmp    205b <printint+0x32>
  } else {
    x = xx;
    2055:	8b 45 0c             	mov    0xc(%ebp),%eax
    2058:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    205b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    2062:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    2065:	8d 41 01             	lea    0x1(%ecx),%eax
    2068:	89 45 f4             	mov    %eax,-0xc(%ebp)
    206b:	8b 5d 10             	mov    0x10(%ebp),%ebx
    206e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    ...
    2088:	8b 45 ec             	mov    -0x14(%ebp),%eax
    208b:	ba 00 00 00 00       	mov    $0x0,%edx
    2090:	f7 f6                	div    %esi
    2092:	89 45 ec             	mov    %eax,-0x14(%ebp)
    2095:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    2099:	75 c7                	jne    2062 <printint+0x39>
  if(neg)
    209b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    209f:	74 10                	je     20b1 <printint+0x88>
    buf[i++] = '-';
    20a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20a4:	8d 50 01             	lea    0x1(%eax),%edx
    20a7:	89 55 f4             	mov    %edx,-0xc(%ebp)
    20aa:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    20af:	eb 1f                	jmp    20d0 <printint+0xa7>
    20b1:	eb 1d                	jmp    20d0 <printint+0xa7>
    putc(fd, buf[i]);
    20b3:	8d 55 dc             	lea    -0x24(%ebp),%edx
    20b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    20b9:	01 d0                	add    %edx,%eax
    20bb:	0f b6 00             	movzbl (%eax),%eax
    20be:	0f be c0             	movsbl %al,%eax
    20c1:	89 44 24 04          	mov    %eax,0x4(%esp)
    20c5:	8b 45 08             	mov    0x8(%ebp),%eax
    20c8:	89 04 24             	mov    %eax,(%esp)
    20cb:	e8 31 ff ff ff       	call   2001 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    20d0:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    20d4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    20d8:	79 d9                	jns    20b3 <printint+0x8a>
    putc(fd, buf[i]);
}
    20da:	83 c4 30             	add    $0x30,%esp
    20dd:	5b                   	pop    %ebx
    20de:	5e                   	pop    %esi
    20df:	5d                   	pop    %ebp
    20e0:	c3                   	ret    
...
{
    20e1:	55                   	push   %ebp
    20e2:	89 e5                	mov    %esp,%ebp
    20e4:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    20e7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    20ee:	8d 45 0c             	lea    0xc(%ebp),%eax
    20f1:	83 c0 04             	add    $0x4,%eax
    20f4:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    20f7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    20fe:	e9 7c 01 00 00       	jmp    227f <printf+0x19e>
    c = fmt[i] & 0xff;
    ...
    2116:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    2119:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    211d:	75 2c                	jne    214b <printf+0x6a>
      if(c == '%'){
    211f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    2123:	75 0c                	jne    2131 <printf+0x50>
        state = '%';
    2125:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    212c:	e9 4a 01 00 00       	jmp    227b <printf+0x19a>
      } else {
        putc(fd, c);
    2131:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2134:	0f be c0             	movsbl %al,%eax
    2137:	89 44 24 04          	mov    %eax,0x4(%esp)
    213b:	8b 45 08             	mov    0x8(%ebp),%eax
    213e:	89 04 24             	mov    %eax,(%esp)
    2141:	e8 bb fe ff ff       	call   2001 <putc>
    2146:	e9 30 01 00 00       	jmp    227b <printf+0x19a>
      }
    } else if(state == '%'){
    214b:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    214f:	0f 85 26 01 00 00    	jne    227b <printf+0x19a>
      if(c == 'd'){
    2155:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    2159:	75 2d                	jne    2188 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    215b:	8b 45 e8             	mov    -0x18(%ebp),%eax
    215e:	8b 00                	mov    (%eax),%eax
    2160:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    2167:	00 
    2168:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    216f:	00 
    2170:	89 44 24 04          	mov    %eax,0x4(%esp)
    2174:	8b 45 08             	mov    0x8(%ebp),%eax
    2177:	89 04 24             	mov    %eax,(%esp)
    217a:	e8 aa fe ff ff       	call   2029 <printint>
        ap++;
    217f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    2183:	e9 ec 00 00 00       	jmp    2274 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    2188:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    218c:	74 06                	je     2194 <printf+0xb3>
    218e:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    2192:	75 2d                	jne    21c1 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    2194:	8b 45 e8             	mov    -0x18(%ebp),%eax
    2197:	8b 00                	mov    (%eax),%eax
    2199:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    21a0:	00 
    21a1:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    21a8:	00 
    21a9:	89 44 24 04          	mov    %eax,0x4(%esp)
    21ad:	8b 45 08             	mov    0x8(%ebp),%eax
    21b0:	89 04 24             	mov    %eax,(%esp)
    21b3:	e8 71 fe ff ff       	call   2029 <printint>
        ap++;
    21b8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    21bc:	e9 b3 00 00 00       	jmp    2274 <printf+0x193>
      } else if(c == 's'){
    21c1:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    21c5:	75 45                	jne    220c <printf+0x12b>
        s = (char*)*ap;
    21c7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    21ca:	8b 00                	mov    (%eax),%eax
    21cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    21cf:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    21d3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    21d7:	75 09                	jne    21e2 <printf+0x101>
          s = "(null)";
    21d9:	c7 45 f4 a0 25 00 00 	movl   $0x25a0,-0xc(%ebp)
        while(*s != 0){
    21e0:	eb 1e                	jmp    2200 <printf+0x11f>
    21e2:	eb 1c                	jmp    2200 <printf+0x11f>
          putc(fd, *s);
    21e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    21e7:	0f b6 00             	movzbl (%eax),%eax
    21ea:	0f be c0             	movsbl %al,%eax
    21ed:	89 44 24 04          	mov    %eax,0x4(%esp)
    21f1:	8b 45 08             	mov    0x8(%ebp),%eax
    21f4:	89 04 24             	mov    %eax,(%esp)
    21f7:	e8 05 fe ff ff       	call   2001 <putc>
          s++;
    21fc:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    2203:	0f b6 00             	movzbl (%eax),%eax
    2206:	84 c0                	test   %al,%al
    2208:	75 da                	jne    21e4 <printf+0x103>
    220a:	eb 68                	jmp    2274 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    220c:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    2210:	75 1d                	jne    222f <printf+0x14e>
        putc(fd, *ap);
    2212:	8b 45 e8             	mov    -0x18(%ebp),%eax
    2215:	8b 00                	mov    (%eax),%eax
    2217:	0f be c0             	movsbl %al,%eax
    221a:	89 44 24 04          	mov    %eax,0x4(%esp)
    221e:	8b 45 08             	mov    0x8(%ebp),%eax
    2221:	89 04 24             	mov    %eax,(%esp)
    2224:	e8 d8 fd ff ff       	call   2001 <putc>
        ap++;
    2229:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    222d:	eb 45                	jmp    2274 <printf+0x193>
      } else if(c == '%'){
    222f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    2233:	75 17                	jne    224c <printf+0x16b>
        putc(fd, c);
    2235:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2238:	0f be c0             	movsbl %al,%eax
    223b:	89 44 24 04          	mov    %eax,0x4(%esp)
    223f:	8b 45 08             	mov    0x8(%ebp),%eax
    2242:	89 04 24             	mov    %eax,(%esp)
    2245:	e8 b7 fd ff ff       	call   2001 <putc>
    224a:	eb 28                	jmp    2274 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    224c:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    2253:	00 
    2254:	8b 45 08             	mov    0x8(%ebp),%eax
    2257:	89 04 24             	mov    %eax,(%esp)
    225a:	e8 a2 fd ff ff       	call   2001 <putc>
        putc(fd, c);
    225f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    2262:	0f be c0             	movsbl %al,%eax
    2265:	89 44 24 04          	mov    %eax,0x4(%esp)
    2269:	8b 45 08             	mov    0x8(%ebp),%eax
    226c:	89 04 24             	mov    %eax,(%esp)
    226f:	e8 8d fd ff ff       	call   2001 <putc>
      }
      state = 0;
    2274:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    227b:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    227f:	8b 55 0c             	mov    0xc(%ebp),%edx
    2282:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2285:	01 d0                	add    %edx,%eax
    2287:	0f b6 00             	movzbl (%eax),%eax
    228a:	84 c0                	test   %al,%al
    228c:	0f 85 71 fe ff ff    	jne    2103 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    22ad:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22b0:	8b 00                	mov    (%eax),%eax
    22b2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    22b5:	77 12                	ja     22c9 <free+0x35>
    22b7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22ba:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    22bd:	77 24                	ja     22e3 <free+0x4f>
    22bf:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22c2:	8b 00                	mov    (%eax),%eax
    22c4:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    22c7:	77 1a                	ja     22e3 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    22c9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22cc:	8b 00                	mov    (%eax),%eax
    22ce:	89 45 fc             	mov    %eax,-0x4(%ebp)
    22d1:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22d4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    22d7:	76 d4                	jbe    22ad <free+0x19>
    22d9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22dc:	8b 00                	mov    (%eax),%eax
    22de:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    22e1:	76 ca                	jbe    22ad <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    22e3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22e6:	8b 40 04             	mov    0x4(%eax),%eax
    22e9:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    22f0:	8b 45 f8             	mov    -0x8(%ebp),%eax
    22f3:	01 c2                	add    %eax,%edx
    22f5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    22f8:	8b 00                	mov    (%eax),%eax
    22fa:	39 c2                	cmp    %eax,%edx
    22fc:	75 24                	jne    2322 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    22fe:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2301:	8b 50 04             	mov    0x4(%eax),%edx
    2304:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2307:	8b 00                	mov    (%eax),%eax
    2309:	8b 40 04             	mov    0x4(%eax),%eax
    230c:	01 c2                	add    %eax,%edx
    230e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    2311:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    2314:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2317:	8b 00                	mov    (%eax),%eax
    2319:	8b 10                	mov    (%eax),%edx
    231b:	8b 45 f8             	mov    -0x8(%ebp),%eax
    231e:	89 10                	mov    %edx,(%eax)
    2320:	eb 0a                	jmp    232c <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    2322:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2325:	8b 10                	mov    (%eax),%edx
    2327:	8b 45 f8             	mov    -0x8(%ebp),%eax
    232a:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    232c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    232f:	8b 40 04             	mov    0x4(%eax),%eax
    2332:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    2339:	8b 45 fc             	mov    -0x4(%ebp),%eax
    233c:	01 d0                	add    %edx,%eax
    233e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    2341:	75 20                	jne    2363 <free+0xcf>
    p->s.size += bp->s.size;
    2343:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2346:	8b 50 04             	mov    0x4(%eax),%edx
    2349:	8b 45 f8             	mov    -0x8(%ebp),%eax
    234c:	8b 40 04             	mov    0x4(%eax),%eax
    234f:	01 c2                	add    %eax,%edx
    2351:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2354:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    2357:	8b 45 f8             	mov    -0x8(%ebp),%eax
    235a:	8b 10                	mov    (%eax),%edx
    235c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    235f:	89 10                	mov    %edx,(%eax)
    2361:	eb 08                	jmp    236b <free+0xd7>
  } else
    p->s.ptr = bp;
    2363:	8b 45 fc             	mov    -0x4(%ebp),%eax
    2366:	8b 55 f8             	mov    -0x8(%ebp),%edx
...
{
    2375:	55                   	push   %ebp
    2376:	89 e5                	mov    %esp,%ebp
    2378:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    237b:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    2382:	77 07                	ja     238b <morecore+0x16>
    nu = 4096;
    2384:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    238b:	8b 45 08             	mov    0x8(%ebp),%eax
    238e:	c1 e0 03             	shl    $0x3,%eax
    2391:	89 04 24             	mov    %eax,(%esp)
    2394:	e8 50 fc ff ff       	call   1fe9 <sbrk>
    2399:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    239c:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    23a0:	75 07                	jne    23a9 <morecore+0x34>
    return 0;
    23a2:	b8 00 00 00 00       	mov    $0x0,%eax
    23a7:	eb 22                	jmp    23cb <morecore+0x56>
  hp = (Header*)p;
    23a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    23ac:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    23af:	8b 45 f0             	mov    -0x10(%ebp),%eax
    23b2:	8b 55 08             	mov    0x8(%ebp),%edx
    23b5:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    23b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    23bb:	83 c0 08             	add    $0x8,%eax
...
malloc(uint nbytes)
{
    ...
    23d0:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    23d3:	8b 45 08             	mov    0x8(%ebp),%eax
    23d6:	83 c0 07             	add    $0x7,%eax
    23d9:	c1 e8 03             	shr    $0x3,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    2416:	8b 00                	mov    (%eax),%eax
    2418:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    241b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    241e:	8b 40 04             	mov    0x4(%eax),%eax
    2421:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    2424:	72 4d                	jb     2473 <malloc+0xa6>
      if(p->s.size == nunits)
    2426:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2429:	8b 40 04             	mov    0x4(%eax),%eax
    242c:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    242f:	75 0c                	jne    243d <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    2431:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2434:	8b 10                	mov    (%eax),%edx
    2436:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2439:	89 10                	mov    %edx,(%eax)
    243b:	eb 26                	jmp    2463 <malloc+0x96>
      else {
        p->s.size -= nunits;
    243d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2440:	8b 40 04             	mov    0x4(%eax),%eax
    2443:	2b 45 ec             	sub    -0x14(%ebp),%eax
    2446:	89 c2                	mov    %eax,%edx
    2448:	8b 45 f4             	mov    -0xc(%ebp),%eax
    244b:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    244e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2451:	8b 40 04             	mov    0x4(%eax),%eax
    2454:	c1 e0 03             	shl    $0x3,%eax
    2457:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    245a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    245d:	8b 55 ec             	mov    -0x14(%ebp),%edx
    2460:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    ...
    247d:	8b 45 ec             	mov    -0x14(%ebp),%eax
    2480:	89 04 24             	mov    %eax,(%esp)
    2483:	e8 ed fe ff ff       	call   2375 <morecore>
    2488:	89 45 f4             	mov    %eax,-0xc(%ebp)
    248b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    248f:	75 07                	jne    2498 <malloc+0xcb>
        return 0;
    2491:	b8 00 00 00 00       	mov    $0x0,%eax
    2496:	eb 13                	jmp    24ab <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    249b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    24a6:	e9 70 ff ff ff       	jmp    241b <malloc+0x4e>
}
    24ab:	c9                   	leave  
    24ac:	c3                   	ret    
