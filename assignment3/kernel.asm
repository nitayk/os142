...
8010003a:	c7 44 24 04 38 84 10 	movl   $0x80108438,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100049:	e8 9f 4d 00 00       	call   80104ded <initlock>
...
801000bd:	e8 4c 4d 00 00       	call   80104e0e <acquire>
...
80100104:	e8 67 4d 00 00       	call   80104e70 <release>
        return b;
...
8010011f:	e8 50 47 00 00       	call   80104874 <sleep>
      goto loop;
...
8010017c:	e8 ef 4c 00 00       	call   80104e70 <release>
      return b;
...
80100198:	c7 04 24 3f 84 10 80 	movl   $0x8010843f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 50 84 10 80 	movl   $0x80108450,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 57 84 10 80 	movl   $0x80108457,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 cd 4b 00 00       	call   80104e0e <acquire>
...
8010029d:	e8 ab 46 00 00       	call   8010494d <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 c2 4b 00 00       	call   80104e70 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 4e 4a 00 00       	call   80104e0e <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 5e 84 10 80 	movl   $0x8010845e,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 67 84 10 80 	movl   $0x80108467,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 38 49 00 00       	call   80104e70 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 6e 84 10 80 	movl   $0x8010846e,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 7d 84 10 80 	movl   $0x8010847d,(%esp)
...
8010058f:	e8 2b 49 00 00       	call   80104ebf <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 7f 84 10 80 	movl   $0x8010847f,(%esp)
...
801006e1:	e8 7c 49 00 00       	call   80105062 <memset>
  }
...
80100776:	e8 c0 62 00 00       	call   80106a3b <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 b4 62 00 00       	call   80106a3b <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 a8 62 00 00       	call   80106a3b <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 9b 62 00 00       	call   80106a3b <uartputc>
  cgaputc(c);
...
801007ba:	e8 4f 46 00 00       	call   80104e0e <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 01 42 00 00       	call   801049f0 <procdump>
      break;
...
801008f3:	e8 55 40 00 00       	call   8010494d <wakeup>
        }
      }
      break;
...
80100914:	e8 57 45 00 00       	call   80104e70 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 d0 44 00 00       	call   80104e0e <acquire>
  while(n > 0){
...
80100959:	e8 12 45 00 00       	call   80104e70 <release>
        ilock(ip);
...
80100982:	e8 ed 3e 00 00       	call   80104874 <sleep>
...
801009fe:	e8 6d 44 00 00       	call   80104e70 <release>
  ilock(ip);
...
80100a32:	e8 d7 43 00 00       	call   80104e0e <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 ff 43 00 00       	call   80104e70 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 83 84 10 	movl   $0x80108483,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 52 43 00 00       	call   80104ded <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 8b 84 10 	movl   $0x8010848b,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 a0 dd 10 80 	movl   $0x8010dda0,(%esp)
80100aaa:	e8 3e 43 00 00       	call   80104ded <initlock>
...
80100b71:	e8 16 70 00 00       	call   80107b8c <setupkvm>
...
80100c12:	e8 4c 73 00 00       	call   80107f63 <allocuvm>
...
80100c63:	e8 07 72 00 00       	call   80107e6f <loaduvm>
...
80100ccc:	e8 92 72 00 00       	call   80107f63 <allocuvm>
...
80100cf1:	e8 9d 74 00 00       	call   80108193 <clearpteu>
  sp = sz;
...
80100d27:	e8 a0 45 00 00       	call   801052cc <strlen>
...
80100d50:	e8 77 45 00 00       	call   801052cc <strlen>
...
80100d80:	e8 08 76 00 00       	call   8010838d <copyout>
...
80100e27:	e8 61 75 00 00       	call   8010838d <copyout>
...
80100e7f:	e8 fe 43 00 00       	call   80105282 <safestrcpy>
...
80100ed1:	e8 a7 6d 00 00       	call   80107c7d <switchuvm>
  freevm(oldpgdir);
80100ed6:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100ed9:	89 04 24             	mov    %eax,(%esp)
80100edc:	e8 18 72 00 00       	call   801080f9 <freevm>
  return 0;
...
80100ef4:	e8 00 72 00 00       	call   801080f9 <freevm>
  if(ip)
...
80100f1e:	c7 44 24 04 91 84 10 	movl   $0x80108491,0x4(%esp)
80100f25:	80 
80100f26:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f2d:	e8 bb 3e 00 00       	call   80104ded <initlock>
}
80100f32:	c9                   	leave  
80100f33:	c3                   	ret    
...
80100f37:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ftable.lock);
80100f3a:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f41:	e8 c8 3e 00 00       	call   80104e0e <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100f46:	c7 45 f4 94 de 10 80 	movl   $0x8010de94,-0xc(%ebp)
...
80100f5c:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
      release(&ftable.lock);
80100f63:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f6a:	e8 01 3f 00 00       	call   80104e70 <release>
      return f;
...
80100f78:	81 7d f4 f4 e7 10 80 	cmpl   $0x8010e7f4,-0xc(%ebp)
80100f7f:	72 ce                	jb     80100f4f <filealloc+0x1b>
  ...
  release(&ftable.lock);
80100f81:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f88:	e8 e3 3e 00 00       	call   80104e70 <release>
  return 0;
...
80100f97:	83 ec 18             	sub    $0x18,%esp
  acquire(&ftable.lock);
80100f9a:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100fa1:	e8 68 3e 00 00       	call   80104e0e <acquire>
  if(f->ref < 1)
...
80100fae:	7f 0c                	jg     80100fbc <filedup+0x28>
    panic("filedup");
80100fb0:	c7 04 24 98 84 10 80 	movl   $0x80108498,(%esp)
...
80100fc8:	89 50 04             	mov    %edx,0x4(%eax)
  release(&ftable.lock);
80100fcb:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100fd2:	e8 99 3e 00 00       	call   80104e70 <release>
  return f;
...
80100fdf:	83 ec 38             	sub    $0x38,%esp
  ...
  acquire(&ftable.lock);
80100fe2:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100fe9:	e8 20 3e 00 00       	call   80104e0e <acquire>
  if(f->ref < 1)
...
80100ff6:	7f 0c                	jg     80101004 <fileclose+0x28>
    panic("fileclose");
80100ff8:	c7 04 24 a0 84 10 80 	movl   $0x801084a0,(%esp)
...
8010101b:	7e 11                	jle    8010102e <fileclose+0x52>
    release(&ftable.lock);
8010101d:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80101024:	e8 47 3e 00 00       	call   80104e70 <release>
...
80101061:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  release(&ftable.lock);
80101067:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
8010106e:	e8 fd 3d 00 00       	call   80104e70 <release>
...
801011ad:	eb 0c                	jmp    801011bb <fileread+0xba>
  ...
  panic("fileread");
801011af:	c7 04 24 aa 84 10 80 	movl   $0x801084aa,(%esp)
...
801012bb:	c7 04 24 b3 84 10 80 	movl   $0x801084b3,(%esp)
...
801012eb:	eb 0c                	jmp    801012f9 <filewrite+0x13c>
  ...
  panic("filewrite");
801012ed:	c7 04 24 c3 84 10 80 	movl   $0x801084c3,(%esp)
...
80101333:	e8 f9 3d 00 00       	call   80105131 <memmove>
  brelse(bp);
...
80101379:	e8 e4 3c 00 00       	call   80105062 <memset>
  log_write(bp);
...
801014d6:	c7 04 24 cd 84 10 80 	movl   $0x801084cd,(%esp)
...
80101568:	c7 04 24 e3 84 10 80 	movl   $0x801084e3,(%esp)
...
801015b8:	c7 44 24 04 f6 84 10 	movl   $0x801084f6,0x4(%esp)
801015bf:	80 
801015c0:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801015c7:	e8 21 38 00 00       	call   80104ded <initlock>
}
801015cc:	c9                   	leave  
801015cd:	c3                   	ret    
...
80101649:	e8 14 3a 00 00       	call   80105062 <memset>
      dip->type = type;
...
8010169f:	c7 04 24 fd 84 10 80 	movl   $0x801084fd,(%esp)
...
80101748:	e8 e4 39 00 00       	call   80105131 <memmove>
  log_write(bp);
...
80101768:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&icache.lock);
8010176b:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101772:	e8 97 36 00 00       	call   80104e0e <acquire>

  // Is the inode already cached?
  empty = 0;
80101777:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010177e:	c7 45 f4 94 e8 10 80 	movl   $0x8010e894,-0xc(%ebp)
...
801017b2:	89 50 08             	mov    %edx,0x8(%eax)
      release(&icache.lock);
801017b5:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801017bc:	e8 af 36 00 00       	call   80104e70 <release>
      return ip;
...
801017e0:	81 7d f4 34 f8 10 80 	cmpl   $0x8010f834,-0xc(%ebp)
...
801017ef:	c7 04 24 0f 85 10 80 	movl   $0x8010850f,(%esp)
...
8010181f:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  release(&icache.lock);
80101826:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
8010182d:	e8 3e 36 00 00       	call   80104e70 <release>
...
80101844:	e8 c5 35 00 00       	call   80104e0e <acquire>
  ip->ref++;
...
80101855:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101858:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
8010185f:	e8 0c 36 00 00       	call   80104e70 <release>
  return ip;
...
801018c7:	89 50 0c             	mov    %edx,0xc(%eax)
  release(&icache.lock);
801018ca:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801018d1:	e8 9a 35 00 00       	call   80104e70 <release>
...
8010197c:	e8 b0 37 00 00       	call   80105131 <memmove>
    brelse(bp);
...
801019a7:	75 0c                	jne    801019b5 <ilock+0x14c>
      panic("ilock: no type");
801019a9:	c7 04 24 25 85 10 80 	movl   $0x80108525,(%esp)
...
801019d8:	7f 0c                	jg     801019e6 <iunlock+0x2f>
    panic("iunlock");
801019da:	c7 04 24 34 85 10 80 	movl   $0x80108534,(%esp)
801019e1:	e8 54 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019e6:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019ed:	e8 1c 34 00 00       	call   80104e0e <acquire>
  ip->flags &= ~I_BUSY;
...
80101a09:	e8 3f 2f 00 00       	call   8010494d <wakeup>
  release(&icache.lock);
80101a0e:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a15:	e8 56 34 00 00       	call   80104e70 <release>
}
80101a1a:	c9                   	leave  
80101a1b:	c3                   	ret    
...
80101a1f:	83 ec 18             	sub    $0x18,%esp
  acquire(&icache.lock);
80101a22:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a29:	e8 e0 33 00 00       	call   80104e0e <acquire>
...
80101a65:	74 0c                	je     80101a73 <iput+0x57>
      panic("iput busy");
80101a67:	c7 04 24 3c 85 10 80 	movl   $0x8010853c,(%esp)
...
80101a81:	89 50 0c             	mov    %edx,0xc(%eax)
    release(&icache.lock);
80101a84:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a8b:	e8 e0 33 00 00       	call   80104e70 <release>
    itrunc(ip);
...
80101ab6:	e8 53 33 00 00       	call   80104e0e <acquire>
    ip->flags = 0;
...
80101acb:	e8 7d 2e 00 00       	call   8010494d <wakeup>
  }
  ip->ref--;
...
80101ae6:	e8 85 33 00 00       	call   80104e70 <release>
}
80101aeb:	c9                   	leave  
80101aec:	c3                   	ret    
...
80101c06:	c7 04 24 46 85 10 80 	movl   $0x80108546,(%esp)
...
80101da9:	98                   	cwtl   
80101daa:	8b 04 c5 00 e8 10 80 	mov    -0x7fef1800(,%eax,8),%eax
...
80101ea7:	e8 85 32 00 00       	call   80105131 <memmove>
    brelse(bp);
...
80101f0d:	98                   	cwtl   
80101f0e:	8b 04 c5 04 e8 10 80 	mov    -0x7fef17fc(,%eax,8),%eax
...
80101f2a:	98                   	cwtl   
80101f2b:	8b 04 c5 04 e8 10 80 	mov    -0x7fef17fc(,%eax,8),%eax
...
80102006:	e8 26 31 00 00       	call   80105131 <memmove>
    log_write(bp);
...
80102084:	e8 4b 31 00 00       	call   801051d4 <strncmp>
}
80102089:	c9                   	leave  
8010208a:	c3                   	ret    
...
8010209e:	c7 04 24 59 85 10 80 	movl   $0x80108559,(%esp)
...
801020da:	74 0c                	je     801020e8 <dirlookup+0x5d>
      panic("dirlink read");
801020dc:	c7 04 24 6b 85 10 80 	movl   $0x8010856b,(%esp)
...
801021bf:	74 0c                	je     801021cd <dirlink+0x79>
      panic("dirlink read");
801021c1:	c7 04 24 6b 85 10 80 	movl   $0x8010856b,(%esp)
...
80102206:	e8 1f 30 00 00       	call   8010522a <strncpy>
  de.inum = inum;
...
80102236:	74 0c                	je     80102244 <dirlink+0xf0>
    panic("dirlink");
80102238:	c7 04 24 78 85 10 80 	movl   $0x80108578,(%esp)
...
801022bd:	e8 6f 2e 00 00       	call   80105131 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d8:	e8 54 2e 00 00       	call   80105131 <memmove>
    name[len] = 0;
...
80102527:	c7 44 24 04 80 85 10 	movl   $0x80108580,0x4(%esp)
8010252e:	80 
8010252f:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102536:	e8 b2 28 00 00       	call   80104ded <initlock>
  picenable(IRQ_IDE);
8010253b:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
80102542:	e8 39 15 00 00       	call   80103a80 <picenable>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102547:	a1 00 ff 10 80       	mov    0x8010ff00,%eax
...
80102596:	74 0c                	je     801025a4 <ideinit+0x83>
      havedisk1 = 1;
80102598:	c7 05 38 b6 10 80 01 	movl   $0x1,0x8010b638
8010259f:	00 00 00 
      break;
...
801025d1:	75 0c                	jne    801025df <idestart+0x18>
    panic("idestart");
801025d3:	c7 04 24 84 85 10 80 	movl   $0x80108584,(%esp)
...
801026ef:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&idelock);
801026f2:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
801026f9:	e8 10 27 00 00       	call   80104e0e <acquire>
  if((b = idequeue) == 0){
801026fe:	a1 34 b6 10 80       	mov    0x8010b634,%eax
80102703:	89 45 f4             	mov    %eax,-0xc(%ebp)
80102706:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010270a:	75 11                	jne    8010271d <ideintr+0x31>
    release(&idelock);
8010270c:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102713:	e8 58 27 00 00       	call   80104e70 <release>
...
80102723:	a3 34 b6 10 80       	mov    %eax,0x8010b634
...
80102786:	e8 c2 21 00 00       	call   8010494d <wakeup>
...
80102792:	74 0d                	je     801027a1 <ideintr+0xb5>
    idestart(idequeue);
80102794:	a1 34 b6 10 80       	mov    0x8010b634,%eax
...
801027a8:	e8 c3 26 00 00       	call   80104e70 <release>
}
801027ad:	c9                   	leave  
801027ae:	c3                   	ret    
...
801027c1:	c7 04 24 8d 85 10 80 	movl   $0x8010858d,(%esp)
...
801027da:	c7 04 24 a1 85 10 80 	movl   $0x801085a1,(%esp)
...
801027f0:	a1 38 b6 10 80       	mov    0x8010b638,%eax
801027f5:	85 c0                	test   %eax,%eax
801027f7:	75 0c                	jne    80102805 <iderw+0x56>
    panic("iderw: ide disk 1 not present");
801027f9:	c7 04 24 b6 85 10 80 	movl   $0x801085b6,(%esp)
80102800:	e8 35 dd ff ff       	call   8010053a <panic>

  acquire(&idelock);  //DOC: acquire-lock
80102805:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
8010280c:	e8 fd 25 00 00       	call   80104e0e <acquire>
...
8010281b:	c7 45 f4 34 b6 10 80 	movl   $0x8010b634,-0xc(%ebp)
...
80102857:	eb 13                	jmp    8010286c <iderw+0xbd>
    sleep(b, &idelock);
80102859:	c7 44 24 04 00 b6 10 	movl   $0x8010b600,0x4(%esp)
80102860:	80 
80102861:	8b 45 08             	mov    0x8(%ebp),%eax
80102864:	89 04 24             	mov    %eax,(%esp)
80102867:	e8 08 20 00 00       	call   80104874 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102877:	75 e0                	jne    80102859 <iderw+0xaa>
  ...
  release(&idelock);
80102879:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102880:	e8 eb 25 00 00       	call   80104e70 <release>
}
80102885:	c9                   	leave  
80102886:	c3                   	ret    
...
80102888:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
8010288a:	a1 34 f8 10 80       	mov    0x8010f834,%eax
8010288f:	8b 55 08             	mov    0x8(%ebp),%edx
80102892:	89 10                	mov    %edx,(%eax)
  return ioapic->data;
80102894:	a1 34 f8 10 80       	mov    0x8010f834,%eax
...
8010289f:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
801028a1:	a1 34 f8 10 80       	mov    0x8010f834,%eax
801028a6:	8b 55 08             	mov    0x8(%ebp),%edx
801028a9:	89 10                	mov    %edx,(%eax)
  ioapic->data = data;
801028ab:	a1 34 f8 10 80       	mov    0x8010f834,%eax
...
801028bb:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!ismp)
801028be:	a1 04 f9 10 80       	mov    0x8010f904,%eax
...
8010290e:	c7 04 24 d4 85 10 80 	movl   $0x801085d4,(%esp)
...
8010296e:	83 ec 08             	sub    $0x8,%esp
  if(!ismp)
80102971:	a1 04 f9 10 80       	mov    0x8010f904,%eax
...
801029c8:	c7 44 24 04 06 86 10 	movl   $0x80108606,0x4(%esp)
801029cf:	80 
801029d0:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
801029d7:	e8 11 24 00 00       	call   80104ded <initlock>
  kmem.use_lock = 0;
801029dc:	c7 05 74 f8 10 80 00 	movl   $0x0,0x8010f874
801029e3:	00 00 00 
...
80102a0d:	e8 0c 00 00 00       	call   80102a1e <freerange>
  kmem.use_lock = 1;
80102a12:	c7 05 74 f8 10 80 01 	movl   $0x1,0x8010f874
80102a19:	00 00 00 
}
80102a1c:	c9                   	leave  
80102a1d:	c3                   	ret    
...
80102a69:	81 7d 08 fc 26 11 80 	cmpl   $0x801126fc,0x8(%ebp)
...
80102a82:	76 0c                	jbe    80102a90 <kfree+0x39>
    panic("kfree");
80102a84:	c7 04 24 0b 86 10 80 	movl   $0x8010860b,(%esp)
...
80102aa6:	e8 b7 25 00 00       	call   80105062 <memset>

  if(kmem.use_lock)
80102aab:	a1 74 f8 10 80       	mov    0x8010f874,%eax
80102ab0:	85 c0                	test   %eax,%eax
80102ab2:	74 0c                	je     80102ac0 <kfree+0x69>
    acquire(&kmem.lock);
80102ab4:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
80102abb:	e8 4e 23 00 00       	call   80104e0e <acquire>
  r = (struct run*)v;
80102ac0:	8b 45 08             	mov    0x8(%ebp),%eax
80102ac3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  r->next = kmem.freelist;
80102ac6:	8b 15 78 f8 10 80    	mov    0x8010f878,%edx
80102acc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102acf:	89 10                	mov    %edx,(%eax)
  kmem.freelist = r;
80102ad1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102ad4:	a3 78 f8 10 80       	mov    %eax,0x8010f878
  if(kmem.use_lock)
80102ad9:	a1 74 f8 10 80       	mov    0x8010f874,%eax
80102ade:	85 c0                	test   %eax,%eax
80102ae0:	74 0c                	je     80102aee <kfree+0x97>
    release(&kmem.lock);
80102ae2:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
80102ae9:	e8 82 23 00 00       	call   80104e70 <release>
}
80102aee:	c9                   	leave  
80102aef:	c3                   	ret    
...
80102afd:	74 0c                	je     80102b0b <kalloc+0x1b>
    acquire(&kmem.lock);
80102aff:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
80102b06:	e8 03 23 00 00       	call   80104e0e <acquire>
  r = kmem.freelist;
80102b0b:	a1 78 f8 10 80       	mov    0x8010f878,%eax
...
80102b1e:	a3 78 f8 10 80       	mov    %eax,0x8010f878
  if(kmem.use_lock)
80102b23:	a1 74 f8 10 80       	mov    0x8010f874,%eax
80102b28:	85 c0                	test   %eax,%eax
80102b2a:	74 0c                	je     80102b38 <kalloc+0x48>
    release(&kmem.lock);
80102b2c:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
80102b33:	e8 38 23 00 00       	call   80104e70 <release>
  return (char*)r;
...
80102b9f:	75 17                	jne    80102bb8 <kbdgetc+0x5e>
    shift |= E0ESC;
80102ba1:	a1 3c b6 10 80       	mov    0x8010b63c,%eax
80102ba6:	83 c8 40             	or     $0x40,%eax
80102ba9:	a3 3c b6 10 80       	mov    %eax,0x8010b63c
    return 0;
...
80102bc4:	a1 3c b6 10 80       	mov    0x8010b63c,%eax
...
80102be1:	05 20 90 10 80       	add    $0x80109020,%eax
...
80102bf3:	a1 3c b6 10 80       	mov    0x8010b63c,%eax
80102bf8:	21 d0                	and    %edx,%eax
80102bfa:	a3 3c b6 10 80       	mov    %eax,0x8010b63c
    return 0;
...
80102c58:	a3 3c b6 10 80       	mov    %eax,0x8010b63c
  c = charcode[shift & (CTL | SHIFT)][data];
80102c5d:	a1 3c b6 10 80       	mov    0x8010b63c,%eax
80102c62:	83 e0 03             	and    $0x3,%eax
80102c65:	8b 14 85 20 95 10 80 	mov    -0x7fef6ae0(,%eax,4),%edx
...
80102cf0:	89 e5                	mov    %esp,%ebp
  lapic[index] = value;
80102cf2:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102d04:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102d13:	83 ec 08             	sub    $0x8,%esp
  if(!lapic) 
80102d16:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102d9c:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102e3d:	90                   	nop
80102e3e:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102e7b:	74 25                	je     80102ea2 <cpunum+0x39>
    static int n;
    if(n++ == 0)
80102e7d:	a1 40 b6 10 80       	mov    0x8010b640,%eax
80102e82:	8d 50 01             	lea    0x1(%eax),%edx
80102e85:	89 15 40 b6 10 80    	mov    %edx,0x8010b640
...
80102e96:	c7 04 24 14 86 10 80 	movl   $0x80108614,(%esp)
80102e9d:	e8 fe d4 ff ff       	call   801003a0 <cprintf>
        __builtin_return_address(0));
  }

  if(lapic)
80102ea2:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
80102ea7:	85 c0                	test   %eax,%eax
80102ea9:	74 0f                	je     80102eba <cpunum+0x51>
    return lapic[ID]>>24;
80102eab:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102ec4:	83 ec 08             	sub    $0x8,%esp
  if(lapic)
80102ec7:	a1 7c f8 10 80       	mov    0x8010f87c,%eax
...
80102feb:	c7 44 24 04 40 86 10 	movl   $0x80108640,0x4(%esp)
80102ff2:	80 
80102ff3:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80102ffa:	e8 ee 1d 00 00       	call   80104ded <initlock>
  readsb(ROOTDEV, &sb);
...
8010301c:	a3 b4 f8 10 80       	mov    %eax,0x8010f8b4
  log.size = sb.nlog;
80103021:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103024:	a3 b8 f8 10 80       	mov    %eax,0x8010f8b8
  log.dev = ROOTDEV;
80103029:	c7 05 c0 f8 10 80 01 	movl   $0x1,0x8010f8c0
80103030:	00 00 00 
  recover_from_log();
...
80103076:	8b 04 85 88 f8 10 80 	mov    -0x7fef0778(,%eax,4),%eax
8010307d:	89 c2                	mov    %eax,%edx
8010307f:	a1 c0 f8 10 80       	mov    0x8010f8c0,%eax
...
801030ae:	e8 7e 20 00 00       	call   80105131 <memmove>
...
801030d8:	a1 c4 f8 10 80       	mov    0x8010f8c4,%eax
...
801030ee:	a1 b4 f8 10 80       	mov    0x8010f8b4,%eax
801030f3:	89 c2                	mov    %eax,%edx
801030f5:	a1 c0 f8 10 80       	mov    0x8010f8c0,%eax
...
80103117:	a3 c4 f8 10 80       	mov    %eax,0x8010f8c4
...
80103135:	89 04 95 88 f8 10 80 	mov    %eax,-0x7fef0778(,%edx,4)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80103140:	a1 c4 f8 10 80       	mov    0x8010f8c4,%eax
...
8010315a:	83 ec 28             	sub    $0x28,%esp
  struct buf *buf = bread(log.dev, log.start);
8010315d:	a1 b4 f8 10 80       	mov    0x8010f8b4,%eax
80103162:	89 c2                	mov    %eax,%edx
80103164:	a1 c0 f8 10 80       	mov    0x8010f8c0,%eax
...
8010317e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int i;
  hb->n = log.lh.n;
80103181:	8b 15 c4 f8 10 80    	mov    0x8010f8c4,%edx
...
8010319b:	8b 0c 85 88 f8 10 80 	mov    -0x7fef0778(,%eax,4),%ecx
...
801031b0:	a1 c4 f8 10 80       	mov    0x8010f8c4,%eax
...
801031dd:	e8 58 fe ff ff       	call   8010303a <install_trans>
  log.lh.n = 0;
801031e2:	c7 05 c4 f8 10 80 00 	movl   $0x0,0x8010f8c4
801031e9:	00 00 00 
...
801031f6:	83 ec 18             	sub    $0x18,%esp
  acquire(&log.lock);
801031f9:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80103200:	e8 09 1c 00 00       	call   80104e0e <acquire>
  while (log.busy) {
80103205:	eb 14                	jmp    8010321b <begin_trans+0x28>
    sleep(&log, &log.lock);
80103207:	c7 44 24 04 80 f8 10 	movl   $0x8010f880,0x4(%esp)
8010320e:	80 
8010320f:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80103216:	e8 59 16 00 00       	call   80104874 <sleep>
...
begin_trans(void)
{
  acquire(&log.lock);
  while (log.busy) {
8010321b:	a1 bc f8 10 80       	mov    0x8010f8bc,%eax
80103220:	85 c0                	test   %eax,%eax
80103222:	75 e3                	jne    80103207 <begin_trans+0x14>
    sleep(&log, &log.lock);
  }
  log.busy = 1;
80103224:	c7 05 bc f8 10 80 01 	movl   $0x1,0x8010f8bc
8010322b:	00 00 00 
  release(&log.lock);
8010322e:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80103235:	e8 36 1c 00 00       	call   80104e70 <release>
}
8010323a:	c9                   	leave  
8010323b:	c3                   	ret    
...
8010323f:	83 ec 18             	sub    $0x18,%esp
  if (log.lh.n > 0) {
80103242:	a1 c4 f8 10 80       	mov    0x8010f8c4,%eax
...
80103250:	e8 e5 fd ff ff       	call   8010303a <install_trans>
    log.lh.n = 0; 
80103255:	c7 05 c4 f8 10 80 00 	movl   $0x0,0x8010f8c4
8010325c:	00 00 00 
...
8010326b:	e8 9e 1b 00 00       	call   80104e0e <acquire>
  log.busy = 0;
80103270:	c7 05 bc f8 10 80 00 	movl   $0x0,0x8010f8bc
80103277:	00 00 00 
  wakeup(&log);
8010327a:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80103281:	e8 c7 16 00 00       	call   8010494d <wakeup>
  release(&log.lock);
80103286:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
8010328d:	e8 de 1b 00 00       	call   80104e70 <release>
}
80103292:	c9                   	leave  
80103293:	c3                   	ret    
...
801032e6:	8b 04 85 88 f8 10 80 	mov    -0x7fef0778(,%eax,4),%eax
...
80103315:	89 04 95 88 f8 10 80 	mov    %eax,-0x7fef0778(,%edx,4)
  struct buf *lbuf = bread(b->dev, log.start+i+1);
8010331c:	8b 15 b4 f8 10 80    	mov    0x8010f8b4,%edx
...
8010335c:	e8 d0 1d 00 00       	call   80105131 <memmove>
  bwrite(lbuf);
...
80103372:	e8 a0 ce ff ff       	call   80100217 <brelse>
  if (i == log.lh.n)
80103377:	a1 c4 f8 10 80       	mov    0x8010f8c4,%eax
8010337c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010337f:	75 0d                	jne    8010338e <log_write+0xfa>
    log.lh.n++;
80103381:	a1 c4 f8 10 80       	mov    0x8010f8c4,%eax
80103386:	83 c0 01             	add    $0x1,%eax
80103389:	a3 c4 f8 10 80       	mov    %eax,0x8010f8c4
...
801033e3:	80 
801033e4:	c7 04 24 fc 26 11 80 	movl   $0x801126fc,(%esp)
801033eb:	e8 d2 f5 ff ff       	call   801029c2 <kinit1>
  kvmalloc();      // kernel page table
801033f0:	e8 54 48 00 00       	call   80107c49 <kvmalloc>
...
80103407:	e8 d0 41 00 00       	call   801075dc <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
8010341c:	c7 04 24 71 86 10 80 	movl   $0x80108671,(%esp)
...
80103437:	e8 ef 34 00 00       	call   8010692b <uartinit>
  pinit();         // process table
8010343c:	e8 77 0b 00 00       	call   80103fb8 <pinit>
  tvinit();        // trap vectors
80103441:	e8 97 30 00 00       	call   801064dd <tvinit>
  binit();         // buffer cache
...
80103455:	e8 c7 f0 ff ff       	call   80102521 <ideinit>
  if(!ismp)
8010345a:	a1 04 f9 10 80       	mov    0x8010f904,%eax
8010345f:	85 c0                	test   %eax,%eax
80103461:	75 05                	jne    80103468 <main+0x95>
    timerinit();   // uniprocessor timer
80103463:	e8 c0 2f 00 00       	call   80106428 <timerinit>
...
80103481:	e8 4d 0c 00 00       	call   801040d3 <userinit>
...
8010348e:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
80103491:	e8 ca 47 00 00       	call   80107c60 <switchkvm>
  seginit();
80103496:	e8 41 41 00 00       	call   801075dc <seginit>
  lapicinit(cpunum());
...
801034c3:	c7 04 24 88 86 10 80 	movl   $0x80108688,(%esp)
801034ca:	e8 d1 ce ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
801034cf:	e8 7d 31 00 00       	call   80106651 <idtinit>
...
801034ef:	e8 d8 11 00 00       	call   801046cc <scheduler>
...
80103513:	c7 44 24 04 0c b5 10 	movl   $0x8010b50c,0x4(%esp)
8010351a:	80 
8010351b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010351e:	89 04 24             	mov    %eax,(%esp)
80103521:	e8 0b 1c 00 00       	call   80105131 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80103526:	c7 45 f4 20 f9 10 80 	movl   $0x8010f920,-0xc(%ebp)
...
8010353d:	05 20 f9 10 80       	add    $0x8010f920,%eax
...
80103574:	c7 04 24 00 a0 10 80 	movl   $0x8010a000,(%esp)
...
801035b7:	a1 00 ff 10 80       	mov    0x8010ff00,%eax
801035bc:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801035c2:	05 20 f9 10 80       	add    $0x8010f920,%eax
...
8010361f:	89 e5                	mov    %esp,%ebp
  return bcpu-cpus;
80103621:	a1 44 b6 10 80       	mov    0x8010b644,%eax
80103626:	89 c2                	mov    %eax,%edx
80103628:	b8 20 f9 10 80       	mov    $0x8010f920,%eax
...
801036a2:	00 
801036a3:	c7 44 24 04 9c 86 10 	movl   $0x8010869c,0x4(%esp)
801036aa:	80 
801036ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ae:	89 04 24             	mov    %eax,(%esp)
801036b1:	e8 23 1a 00 00       	call   801050d9 <memcmp>
...
801037e3:	00 
801037e4:	c7 44 24 04 a1 86 10 	movl   $0x801086a1,0x4(%esp)
801037eb:	80 
801037ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037ef:	89 04 24             	mov    %eax,(%esp)
801037f2:	e8 e2 18 00 00       	call   801050d9 <memcmp>
...
80103874:	e9 9c 01 00 00       	jmp    80103a15 <mpinit+0x1c5>
  ismp = 1;
80103879:	c7 05 04 f9 10 80 01 	movl   $0x1,0x8010f904
80103880:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
80103883:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103886:	8b 40 24             	mov    0x24(%eax),%eax
80103889:	a3 7c f8 10 80       	mov    %eax,0x8010f87c
...
801038c0:	8b 04 85 e4 86 10 80 	mov    -0x7fef791c(,%eax,4),%eax
...
801038f9:	c7 04 24 a6 86 10 80 	movl   $0x801086a6,(%esp)
...
80103930:	a3 44 b6 10 80       	mov    %eax,0x8010b644
      cpus[ncpu].id = ncpu;
80103935:	8b 15 00 ff 10 80    	mov    0x8010ff00,%edx
8010393b:	a1 00 ff 10 80       	mov    0x8010ff00,%eax
80103940:	69 d2 bc 00 00 00    	imul   $0xbc,%edx,%edx
80103946:	81 c2 20 f9 10 80    	add    $0x8010f920,%edx
8010394c:	88 02                	mov    %al,(%edx)
      ncpu++;
8010394e:	a1 00 ff 10 80       	mov    0x8010ff00,%eax
80103953:	83 c0 01             	add    $0x1,%eax
80103956:	a3 00 ff 10 80       	mov    %eax,0x8010ff00
...
8010396e:	a2 00 f9 10 80       	mov    %al,0x8010f900
...
8010398c:	c7 04 24 c4 86 10 80 	movl   $0x801086c4,(%esp)
80103993:	e8 08 ca ff ff       	call   801003a0 <cprintf>
      ismp = 0;
80103998:	c7 05 04 f9 10 80 00 	movl   $0x0,0x8010f904
8010399f:	00 00 00 
  bcpu = &cpus[0];
  if((conf = mpconfig(&mp)) == 0)
    return;
...
801039a8:	0f 82 00 ff ff ff    	jb     801038ae <mpinit+0x5e>
  ...
  if(!ismp){
801039ae:	a1 04 f9 10 80       	mov    0x8010f904,%eax
801039b3:	85 c0                	test   %eax,%eax
801039b5:	75 1d                	jne    801039d4 <mpinit+0x184>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
801039b7:	c7 05 00 ff 10 80 01 	movl   $0x1,0x8010ff00
801039be:	00 00 00 
    lapic = 0;
801039c1:	c7 05 7c f8 10 80 00 	movl   $0x0,0x8010f87c
801039c8:	00 00 00 
    ioapicid = 0;
801039cb:	c6 05 00 f9 10 80 00 	movb   $0x0,0x8010f900
    return;
...
80103a46:	66 a3 00 b0 10 80    	mov    %ax,0x8010b000
  outb(IO_PIC1+1, mask);
...
80103a98:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
...
80103bc7:	e8 4b fe ff ff       	call   80103a17 <outb>
  ...
  if(irqmask != 0xFFFF)
80103bcc:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
...
80103c85:	c7 44 24 04 f8 86 10 	movl   $0x801086f8,0x4(%esp)
80103c8c:	80 
80103c8d:	89 04 24             	mov    %eax,(%esp)
80103c90:	e8 58 11 00 00       	call   80104ded <initlock>
  (*f0)->type = FD_PIPE;
...
80103d3c:	e8 cd 10 00 00       	call   80104e0e <acquire>
  if(writable){
...
80103d5f:	e8 e9 0b 00 00       	call   8010494d <wakeup>
...
80103d7e:	e8 ca 0b 00 00       	call   8010494d <wakeup>
  }
...
80103da3:	e8 c8 10 00 00       	call   80104e70 <release>
    kfree((char*)p);
...
80103dbb:	e8 b0 10 00 00       	call   80104e70 <release>
}
80103dc0:	c9                   	leave  
80103dc1:	c3                   	ret    
...
80103dce:	e8 3b 10 00 00       	call   80104e0e <acquire>
  for(i = 0; i < n; i++){
...
80103e01:	e8 6a 10 00 00       	call   80104e70 <release>
        return -1;
...
80103e1b:	e8 2d 0b 00 00       	call   8010494d <wakeup>
...
80103e33:	e8 3c 0a 00 00       	call   80104874 <sleep>
{
  int i;
...
80103e9c:	e8 ac 0a 00 00       	call   8010494d <wakeup>
  release(&p->lock);
80103ea1:	8b 45 08             	mov    0x8(%ebp),%eax
80103ea4:	89 04 24             	mov    %eax,(%esp)
80103ea7:	e8 c4 0f 00 00       	call   80104e70 <release>
  return n;
...
80103ebe:	e8 4b 0f 00 00       	call   80104e0e <acquire>
...
80103ed8:	e8 93 0f 00 00       	call   80104e70 <release>
      return -1;
...
80103efa:	e8 75 09 00 00       	call   80104874 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103f89:	e8 bf 09 00 00       	call   8010494d <wakeup>
  release(&p->lock);
80103f8e:	8b 45 08             	mov    0x8(%ebp),%eax
80103f91:	89 04 24             	mov    %eax,(%esp)
80103f94:	e8 d7 0e 00 00       	call   80104e70 <release>
  return i;
...
80103fa8:	9c                   	pushf  
80103fa9:	58                   	pop    %eax
80103faa:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
80103fad:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80103fb0:	c9                   	leave  
80103fb1:	c3                   	ret    
...
80103fbe:	c7 44 24 04 00 87 10 	movl   $0x80108700,0x4(%esp)
80103fc5:	80 
80103fc6:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80103fcd:	e8 1b 0e 00 00       	call   80104ded <initlock>
}
80103fd2:	c9                   	leave  
80103fd3:	c3                   	ret    
...
80103fd7:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  char *sp;

  acquire(&ptable.lock);
80103fda:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80103fe1:	e8 28 0e 00 00       	call   80104e0e <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fe6:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80103fed:	eb 50                	jmp    8010403f <allocproc+0x6b>
    if(p->state == UNUSED)
80103fef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103ff2:	8b 40 0c             	mov    0xc(%eax),%eax
80103ff5:	85 c0                	test   %eax,%eax
80103ff7:	75 42                	jne    8010403b <allocproc+0x67>
      goto found;
80103ff9:	90                   	nop
  release(&ptable.lock);
  return 0;
...
80103ffd:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
80104004:	a1 04 b0 10 80       	mov    0x8010b004,%eax
80104009:	8d 50 01             	lea    0x1(%eax),%edx
8010400c:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
80104012:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104015:	89 42 10             	mov    %eax,0x10(%edx)
  release(&ptable.lock);
80104018:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010401f:	e8 4c 0e 00 00       	call   80104e70 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104024:	e8 c7 ea ff ff       	call   80102af0 <kalloc>
80104029:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010402c:	89 42 08             	mov    %eax,0x8(%edx)
8010402f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104032:	8b 40 08             	mov    0x8(%eax),%eax
80104035:	85 c0                	test   %eax,%eax
80104037:	75 33                	jne    8010406c <allocproc+0x98>
80104039:	eb 20                	jmp    8010405b <allocproc+0x87>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010403b:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
8010403f:	81 7d f4 54 1e 11 80 	cmpl   $0x80111e54,-0xc(%ebp)
80104046:	72 a7                	jb     80103fef <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104048:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010404f:	e8 1c 0e 00 00       	call   80104e70 <release>
  return 0;
80104054:	b8 00 00 00 00       	mov    $0x0,%eax
80104059:	eb 76                	jmp    801040d1 <allocproc+0xfd>
  p->pid = nextpid++;
  release(&ptable.lock);
...
8010405e:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
80104065:	b8 00 00 00 00       	mov    $0x0,%eax
8010406a:	eb 65                	jmp    801040d1 <allocproc+0xfd>
  }
  sp = p->kstack + KSTACKSIZE;
8010406c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010406f:	8b 40 08             	mov    0x8(%eax),%eax
80104072:	05 00 10 00 00       	add    $0x1000,%eax
80104077:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
8010407a:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
8010407e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104081:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104084:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104087:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
8010408b:	ba 98 64 10 80       	mov    $0x80106498,%edx
80104090:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104093:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104095:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
80104099:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010409c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010409f:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
801040a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040a5:	8b 40 1c             	mov    0x1c(%eax),%eax
801040a8:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801040af:	00 
801040b0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801040b7:	00 
801040b8:	89 04 24             	mov    %eax,(%esp)
801040bb:	e8 a2 0f 00 00       	call   80105062 <memset>
  p->context->eip = (uint)forkret;
801040c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040c3:	8b 40 1c             	mov    0x1c(%eax),%eax
801040c6:	ba 48 48 10 80       	mov    $0x80104848,%edx
801040cb:	89 50 10             	mov    %edx,0x10(%eax)
...
801040d6:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
801040d9:	e8 f6 fe ff ff       	call   80103fd4 <allocproc>
801040de:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801040e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040e4:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm(kalloc)) == 0)
801040e9:	c7 04 24 f0 2a 10 80 	movl   $0x80102af0,(%esp)
801040f0:	e8 97 3a 00 00       	call   80107b8c <setupkvm>
801040f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801040f8:	89 42 04             	mov    %eax,0x4(%edx)
801040fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040fe:	8b 40 04             	mov    0x4(%eax),%eax
80104101:	85 c0                	test   %eax,%eax
80104103:	75 0c                	jne    80104111 <userinit+0x3e>
    panic("userinit: out of memory?");
80104105:	c7 04 24 07 87 10 80 	movl   $0x80108707,(%esp)
8010410c:	e8 29 c4 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80104111:	ba 2c 00 00 00       	mov    $0x2c,%edx
80104116:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104119:	8b 40 04             	mov    0x4(%eax),%eax
8010411c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104120:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
80104127:	80 
80104128:	89 04 24             	mov    %eax,(%esp)
8010412b:	e8 b4 3c 00 00       	call   80107de4 <inituvm>
  p->sz = PGSIZE;
80104130:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104133:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104139:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010413c:	8b 40 18             	mov    0x18(%eax),%eax
8010413f:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104146:	00 
80104147:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010414e:	00 
8010414f:	89 04 24             	mov    %eax,(%esp)
80104152:	e8 0b 0f 00 00       	call   80105062 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80104157:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010415a:	8b 40 18             	mov    0x18(%eax),%eax
8010415d:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104163:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104166:	8b 40 18             	mov    0x18(%eax),%eax
80104169:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
8010416f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104172:	8b 40 18             	mov    0x18(%eax),%eax
80104175:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104178:	8b 52 18             	mov    0x18(%edx),%edx
8010417b:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010417f:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80104183:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104186:	8b 40 18             	mov    0x18(%eax),%eax
80104189:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010418c:	8b 52 18             	mov    0x18(%edx),%edx
8010418f:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104193:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80104197:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010419a:	8b 40 18             	mov    0x18(%eax),%eax
8010419d:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801041a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041a7:	8b 40 18             	mov    0x18(%eax),%eax
801041aa:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801041b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041b4:	8b 40 18             	mov    0x18(%eax),%eax
801041b7:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
801041be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041c1:	83 c0 6c             	add    $0x6c,%eax
801041c4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801041cb:	00 
801041cc:	c7 44 24 04 20 87 10 	movl   $0x80108720,0x4(%esp)
801041d3:	80 
801041d4:	89 04 24             	mov    %eax,(%esp)
801041d7:	e8 a6 10 00 00       	call   80105282 <safestrcpy>
  p->cwd = namei("/");
801041dc:	c7 04 24 29 87 10 80 	movl   $0x80108729,(%esp)
801041e3:	e8 2c e2 ff ff       	call   80102414 <namei>
801041e8:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041eb:	89 42 68             	mov    %eax,0x68(%edx)

  p->state = RUNNABLE;
801041ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041f1:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
}
801041f8:	c9                   	leave  
801041f9:	c3                   	ret    
...
801041fd:	83 ec 28             	sub    $0x28,%esp
  uint sz;
  
  sz = proc->sz;
80104200:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104206:	8b 00                	mov    (%eax),%eax
80104208:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
8010420b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010420f:	7e 34                	jle    80104245 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80104211:	8b 55 08             	mov    0x8(%ebp),%edx
80104214:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104217:	01 c2                	add    %eax,%edx
80104219:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010421f:	8b 40 04             	mov    0x4(%eax),%eax
80104222:	89 54 24 08          	mov    %edx,0x8(%esp)
80104226:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104229:	89 54 24 04          	mov    %edx,0x4(%esp)
8010422d:	89 04 24             	mov    %eax,(%esp)
80104230:	e8 2e 3d 00 00       	call   80107f63 <allocuvm>
80104235:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104238:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010423c:	75 41                	jne    8010427f <growproc+0x85>
      return -1;
8010423e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104243:	eb 58                	jmp    8010429d <growproc+0xa3>
  } else if(n < 0){
80104245:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104249:	79 34                	jns    8010427f <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
8010424b:	8b 55 08             	mov    0x8(%ebp),%edx
8010424e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104251:	01 c2                	add    %eax,%edx
80104253:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104259:	8b 40 04             	mov    0x4(%eax),%eax
8010425c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104260:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104263:	89 54 24 04          	mov    %edx,0x4(%esp)
80104267:	89 04 24             	mov    %eax,(%esp)
8010426a:	e8 ce 3d 00 00       	call   8010803d <deallocuvm>
8010426f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104272:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104276:	75 07                	jne    8010427f <growproc+0x85>
      return -1;
80104278:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010427d:	eb 1e                	jmp    8010429d <growproc+0xa3>
  }
  proc->sz = sz;
8010427f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104285:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104288:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
8010428a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104290:	89 04 24             	mov    %eax,(%esp)
80104293:	e8 e5 39 00 00       	call   80107c7d <switchuvm>
  return 0;
80104298:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010429d:	c9                   	leave  
8010429e:	c3                   	ret    
...
801042a5:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
801042a8:	e8 27 fd ff ff       	call   80103fd4 <allocproc>
801042ad:	89 45 e0             	mov    %eax,-0x20(%ebp)
801042b0:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801042b4:	75 0a                	jne    801042c0 <fork+0x21>
    return -1;
801042b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042bb:	e9 3a 01 00 00       	jmp    801043fa <fork+0x15b>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
801042c0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042c6:	8b 10                	mov    (%eax),%edx
801042c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801042ce:	8b 40 04             	mov    0x4(%eax),%eax
801042d1:	89 54 24 04          	mov    %edx,0x4(%esp)
801042d5:	89 04 24             	mov    %eax,(%esp)
801042d8:	e8 fc 3e 00 00       	call   801081d9 <copyuvm>
801042dd:	8b 55 e0             	mov    -0x20(%ebp),%edx
801042e0:	89 42 04             	mov    %eax,0x4(%edx)
801042e3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042e6:	8b 40 04             	mov    0x4(%eax),%eax
801042e9:	85 c0                	test   %eax,%eax
801042eb:	75 2c                	jne    80104319 <fork+0x7a>
    kfree(np->kstack);
801042ed:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042f0:	8b 40 08             	mov    0x8(%eax),%eax
801042f3:	89 04 24             	mov    %eax,(%esp)
801042f6:	e8 5c e7 ff ff       	call   80102a57 <kfree>
    np->kstack = 0;
801042fb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801042fe:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
80104305:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104308:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
8010430f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104314:	e9 e1 00 00 00       	jmp    801043fa <fork+0x15b>
  }
  np->sz = proc->sz;
80104319:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010431f:	8b 10                	mov    (%eax),%edx
80104321:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104324:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104326:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010432d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104330:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
80104333:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104336:	8b 50 18             	mov    0x18(%eax),%edx
80104339:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010433f:	8b 40 18             	mov    0x18(%eax),%eax
80104342:	89 c3                	mov    %eax,%ebx
80104344:	b8 13 00 00 00       	mov    $0x13,%eax
80104349:	89 d7                	mov    %edx,%edi
8010434b:	89 de                	mov    %ebx,%esi
8010434d:	89 c1                	mov    %eax,%ecx
8010434f:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80104351:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104354:	8b 40 18             	mov    0x18(%eax),%eax
80104357:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
8010435e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104365:	eb 3d                	jmp    801043a4 <fork+0x105>
    if(proc->ofile[i])
80104367:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010436d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104370:	83 c2 08             	add    $0x8,%edx
80104373:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104377:	85 c0                	test   %eax,%eax
80104379:	74 25                	je     801043a0 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
8010437b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104381:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104384:	83 c2 08             	add    $0x8,%edx
80104387:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010438b:	89 04 24             	mov    %eax,(%esp)
8010438e:	e8 01 cc ff ff       	call   80100f94 <filedup>
80104393:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104396:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104399:	83 c1 08             	add    $0x8,%ecx
8010439c:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
801043a0:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801043a4:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801043a8:	7e bd                	jle    80104367 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
801043aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043b0:	8b 40 68             	mov    0x68(%eax),%eax
801043b3:	89 04 24             	mov    %eax,(%esp)
801043b6:	e8 7c d4 ff ff       	call   80101837 <idup>
801043bb:	8b 55 e0             	mov    -0x20(%ebp),%edx
801043be:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
801043c1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043c4:	8b 40 10             	mov    0x10(%eax),%eax
801043c7:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
801043ca:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043cd:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
801043d4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043da:	8d 50 6c             	lea    0x6c(%eax),%edx
801043dd:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043e0:	83 c0 6c             	add    $0x6c,%eax
801043e3:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801043ea:	00 
801043eb:	89 54 24 04          	mov    %edx,0x4(%esp)
801043ef:	89 04 24             	mov    %eax,(%esp)
801043f2:	e8 8b 0e 00 00       	call   80105282 <safestrcpy>
  return pid;
801043f7:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801043fa:	83 c4 2c             	add    $0x2c,%esp
801043fd:	5b                   	pop    %ebx
801043fe:	5e                   	pop    %esi
801043ff:	5f                   	pop    %edi
80104400:	5d                   	pop    %ebp
...
80104405:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
80104408:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010440f:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104414:	39 c2                	cmp    %eax,%edx
80104416:	75 0c                	jne    80104424 <exit+0x22>
    panic("init exiting");
80104418:	c7 04 24 2b 87 10 80 	movl   $0x8010872b,(%esp)
8010441f:	e8 16 c1 ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104424:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010442b:	eb 44                	jmp    80104471 <exit+0x6f>
    if(proc->ofile[fd]){
...
8010446c:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010446d:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104471:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104475:	7e b6                	jle    8010442d <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
8010447d:	8b 40 68             	mov    0x68(%eax),%eax
80104480:	89 04 24             	mov    %eax,(%esp)
80104483:	e8 94 d5 ff ff       	call   80101a1c <iput>
  proc->cwd = 0;
80104488:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010448e:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104495:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010449c:	e8 6d 09 00 00       	call   80104e0e <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
801044a1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044a7:	8b 40 14             	mov    0x14(%eax),%eax
801044aa:	89 04 24             	mov    %eax,(%esp)
801044ad:	e8 5d 04 00 00       	call   8010490f <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044b2:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
801044b9:	eb 38                	jmp    801044f3 <exit+0xf1>
    if(p->parent == proc){
801044bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044be:	8b 50 14             	mov    0x14(%eax),%edx
801044c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044c7:	39 c2                	cmp    %eax,%edx
801044c9:	75 24                	jne    801044ef <exit+0xed>
      p->parent = initproc;
801044cb:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
801044d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044d4:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
801044d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044da:	8b 40 0c             	mov    0xc(%eax),%eax
801044dd:	83 f8 05             	cmp    $0x5,%eax
801044e0:	75 0d                	jne    801044ef <exit+0xed>
        wakeup1(initproc);
801044e2:	a1 48 b6 10 80       	mov    0x8010b648,%eax
801044e7:	89 04 24             	mov    %eax,(%esp)
801044ea:	e8 20 04 00 00       	call   8010490f <wakeup1>
...
801044f3:	81 7d f4 54 1e 11 80 	cmpl   $0x80111e54,-0xc(%ebp)
801044fa:	72 bf                	jb     801044bb <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
80104502:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104509:	e8 56 02 00 00       	call   80104764 <sched>
  panic("zombie exit");
8010450e:	c7 04 24 38 87 10 80 	movl   $0x80108738,(%esp)
80104515:	e8 20 c0 ff ff       	call   8010053a <panic>
...
8010451d:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80104520:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104527:	e8 e2 08 00 00       	call   80104e0e <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010452c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104533:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
8010453a:	e9 9a 00 00 00       	jmp    801045d9 <wait+0xbf>
      if(p->parent != proc)
8010453f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104542:	8b 50 14             	mov    0x14(%eax),%edx
80104545:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010454b:	39 c2                	cmp    %eax,%edx
8010454d:	74 05                	je     80104554 <wait+0x3a>
        continue;
8010454f:	e9 81 00 00 00       	jmp    801045d5 <wait+0xbb>
      havekids = 1;
80104554:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
8010455b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010455e:	8b 40 0c             	mov    0xc(%eax),%eax
80104561:	83 f8 05             	cmp    $0x5,%eax
80104564:	75 6f                	jne    801045d5 <wait+0xbb>
        // Found one.
        pid = p->pid;
80104566:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104569:	8b 40 10             	mov    0x10(%eax),%eax
8010456c:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
8010456f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104572:	8b 40 08             	mov    0x8(%eax),%eax
80104575:	89 04 24             	mov    %eax,(%esp)
80104578:	e8 da e4 ff ff       	call   80102a57 <kfree>
        p->kstack = 0;
...
80104590:	e8 64 3b 00 00       	call   801080f9 <freevm>
        p->state = UNUSED;
80104595:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104598:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
8010459f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045a2:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801045a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045ac:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801045b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045b6:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
801045ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045bd:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
801045c4:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801045cb:	e8 a0 08 00 00       	call   80104e70 <release>
        return pid;
801045d0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801045d3:	eb 52                	jmp    80104627 <wait+0x10d>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045d5:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
801045d9:	81 7d f4 54 1e 11 80 	cmpl   $0x80111e54,-0xc(%ebp)
801045e0:	0f 82 59 ff ff ff    	jb     8010453f <wait+0x25>
        return pid;
      }
    }
...
801045e6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801045ea:	74 0d                	je     801045f9 <wait+0xdf>
801045ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045f2:	8b 40 24             	mov    0x24(%eax),%eax
801045f5:	85 c0                	test   %eax,%eax
801045f7:	74 13                	je     8010460c <wait+0xf2>
      release(&ptable.lock);
801045f9:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104600:	e8 6b 08 00 00       	call   80104e70 <release>
      return -1;
80104605:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010460a:	eb 1b                	jmp    80104627 <wait+0x10d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010460c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104612:	c7 44 24 04 20 ff 10 	movl   $0x8010ff20,0x4(%esp)
80104619:	80 
8010461a:	89 04 24             	mov    %eax,(%esp)
8010461d:	e8 52 02 00 00       	call   80104874 <sleep>
  }
80104622:	e9 05 ff ff ff       	jmp    8010452c <wait+0x12>
}
80104627:	c9                   	leave  
80104628:	c3                   	ret    

80104629 <register_handler>:
...
80104638:	8b 40 44             	mov    0x44(%eax),%eax
8010463b:	89 c2                	mov    %eax,%edx
8010463d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104643:	8b 40 04             	mov    0x4(%eax),%eax
80104646:	89 54 24 04          	mov    %edx,0x4(%esp)
8010464a:	89 04 24             	mov    %eax,(%esp)
8010464d:	e8 de 3c 00 00       	call   80108330 <uva2ka>
80104652:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if ((proc->tf->esp & 0xFFF) == 0)
80104655:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010465b:	8b 40 18             	mov    0x18(%eax),%eax
8010465e:	8b 40 44             	mov    0x44(%eax),%eax
80104661:	25 ff 0f 00 00       	and    $0xfff,%eax
80104666:	85 c0                	test   %eax,%eax
80104668:	75 0c                	jne    80104676 <register_handler+0x4d>
    panic("esp_offset == 0");
8010466a:	c7 04 24 44 87 10 80 	movl   $0x80108744,(%esp)
80104671:	e8 c4 be ff ff       	call   8010053a <panic>

    /* open a new frame */
  *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF))
80104676:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010467c:	8b 40 18             	mov    0x18(%eax),%eax
8010467f:	8b 40 44             	mov    0x44(%eax),%eax
80104682:	83 e8 04             	sub    $0x4,%eax
80104685:	25 ff 0f 00 00       	and    $0xfff,%eax
...
8010469a:	8b 40 38             	mov    0x38(%eax),%eax
8010469d:	89 02                	mov    %eax,(%edx)
  proc->tf->esp -= 4;
8010469f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046a5:	8b 40 18             	mov    0x18(%eax),%eax
801046a8:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801046af:	8b 52 18             	mov    0x18(%edx),%edx
801046b2:	8b 52 44             	mov    0x44(%edx),%edx
801046b5:	83 ea 04             	sub    $0x4,%edx
801046b8:	89 50 44             	mov    %edx,0x44(%eax)
...
801046c7:	89 50 38             	mov    %edx,0x38(%eax)
}
801046ca:	c9                   	leave  
801046cb:	c3                   	ret    
...
801046cf:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(;;){
    // Enable interrupts on this processor.
    sti();
801046d2:	e8 db f8 ff ff       	call   80103fb2 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
801046d7:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801046de:	e8 2b 07 00 00       	call   80104e0e <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046e3:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
801046ea:	eb 5e                	jmp    8010474a <scheduler+0x7e>
      if(p->state != RUNNABLE)
801046ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ef:	8b 40 0c             	mov    0xc(%eax),%eax
801046f2:	83 f8 03             	cmp    $0x3,%eax
801046f5:	74 02                	je     801046f9 <scheduler+0x2d>
        continue;
801046f7:	eb 4d                	jmp    80104746 <scheduler+0x7a>
...
801046fc:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104702:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104705:	89 04 24             	mov    %eax,(%esp)
80104708:	e8 70 35 00 00       	call   80107c7d <switchuvm>
      p->state = RUNNING;
8010470d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104710:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104717:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010471d:	8b 40 1c             	mov    0x1c(%eax),%eax
80104720:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104727:	83 c2 04             	add    $0x4,%edx
8010472a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010472e:	89 14 24             	mov    %edx,(%esp)
80104731:	e8 bd 0b 00 00       	call   801052f3 <swtch>
      switchkvm();
80104736:	e8 25 35 00 00       	call   80107c60 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
8010473b:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104742:	00 00 00 00 
    // Enable interrupts on this processor.
    sti();
...
80104751:	72 99                	jb     801046ec <scheduler+0x20>
    ...
    release(&ptable.lock);
80104753:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010475a:	e8 11 07 00 00       	call   80104e70 <release>

  }
8010475f:	e9 6e ff ff ff       	jmp    801046d2 <scheduler+0x6>
...
80104767:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
8010476a:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104771:	e8 c2 07 00 00       	call   80104f38 <holding>
80104776:	85 c0                	test   %eax,%eax
80104778:	75 0c                	jne    80104786 <sched+0x22>
    panic("sched ptable.lock");
8010477a:	c7 04 24 54 87 10 80 	movl   $0x80108754,(%esp)
80104781:	e8 b4 bd ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
80104786:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010478c:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104792:	83 f8 01             	cmp    $0x1,%eax
80104795:	74 0c                	je     801047a3 <sched+0x3f>
    panic("sched locks");
80104797:	c7 04 24 66 87 10 80 	movl   $0x80108766,(%esp)
8010479e:	e8 97 bd ff ff       	call   8010053a <panic>
  if(proc->state == RUNNING)
801047a3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047a9:	8b 40 0c             	mov    0xc(%eax),%eax
801047ac:	83 f8 04             	cmp    $0x4,%eax
801047af:	75 0c                	jne    801047bd <sched+0x59>
    panic("sched running");
801047b1:	c7 04 24 72 87 10 80 	movl   $0x80108772,(%esp)
801047b8:	e8 7d bd ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
801047bd:	e8 e0 f7 ff ff       	call   80103fa2 <readeflags>
801047c2:	25 00 02 00 00       	and    $0x200,%eax
801047c7:	85 c0                	test   %eax,%eax
801047c9:	74 0c                	je     801047d7 <sched+0x73>
    panic("sched interruptible");
801047cb:	c7 04 24 80 87 10 80 	movl   $0x80108780,(%esp)
801047d2:	e8 63 bd ff ff       	call   8010053a <panic>
  intena = cpu->intena;
801047d7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801047dd:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
...
801047f6:	83 c2 1c             	add    $0x1c,%edx
801047f9:	89 44 24 04          	mov    %eax,0x4(%esp)
801047fd:	89 14 24             	mov    %edx,(%esp)
80104800:	e8 ee 0a 00 00       	call   801052f3 <swtch>
  cpu->intena = intena;
80104805:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010480b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010480e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104814:	c9                   	leave  
80104815:	c3                   	ret    
...
8010481c:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104823:	e8 e6 05 00 00       	call   80104e0e <acquire>
  proc->state = RUNNABLE;
80104828:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010482e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104835:	e8 2a ff ff ff       	call   80104764 <sched>
  release(&ptable.lock);
8010483a:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104841:	e8 2a 06 00 00       	call   80104e70 <release>
}
80104846:	c9                   	leave  
80104847:	c3                   	ret    
...
80104855:	e8 16 06 00 00       	call   80104e70 <release>

  if (first) {
8010485a:	a1 08 b0 10 80       	mov    0x8010b008,%eax
8010485f:	85 c0                	test   %eax,%eax
80104861:	74 0f                	je     80104872 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104863:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
8010486a:	00 00 00 
    initlog();
8010486d:	e8 73 e7 ff ff       	call   80102fe5 <initlog>
  }
...
80104882:	75 0c                	jne    80104890 <sleep+0x1c>
    panic("sleep");
80104884:	c7 04 24 94 87 10 80 	movl   $0x80108794,(%esp)
8010488b:	e8 aa bc ff ff       	call   8010053a <panic>

  if(lk == 0)
80104890:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104894:	75 0c                	jne    801048a2 <sleep+0x2e>
    panic("sleep without lk");
80104896:	c7 04 24 9a 87 10 80 	movl   $0x8010879a,(%esp)
8010489d:	e8 98 bc ff ff       	call   8010053a <panic>
...
801048a2:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
801048a9:	74 17                	je     801048c2 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
801048ab:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801048b2:	e8 57 05 00 00       	call   80104e0e <acquire>
    release(lk);
801048b7:	8b 45 0c             	mov    0xc(%ebp),%eax
801048ba:	89 04 24             	mov    %eax,(%esp)
801048bd:	e8 ae 05 00 00       	call   80104e70 <release>
  }
...
801048cb:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
801048ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048d4:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
801048db:	e8 84 fe ff ff       	call   80104764 <sched>

  // Tidy up.
  proc->chan = 0;
801048e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048e6:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
801048ed:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
801048f4:	74 17                	je     8010490d <sleep+0x99>
    release(&ptable.lock);
801048f6:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801048fd:	e8 6e 05 00 00       	call   80104e70 <release>
    acquire(lk);
80104902:	8b 45 0c             	mov    0xc(%ebp),%eax
80104905:	89 04 24             	mov    %eax,(%esp)
80104908:	e8 01 05 00 00       	call   80104e0e <acquire>
  }
}
8010490d:	c9                   	leave  
8010490e:	c3                   	ret    
...
80104912:	83 ec 10             	sub    $0x10,%esp
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104915:	c7 45 fc 54 ff 10 80 	movl   $0x8010ff54,-0x4(%ebp)
8010491c:	eb 24                	jmp    80104942 <wakeup1+0x33>
    if(p->state == SLEEPING && p->chan == chan)
8010491e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104921:	8b 40 0c             	mov    0xc(%eax),%eax
80104924:	83 f8 02             	cmp    $0x2,%eax
80104927:	75 15                	jne    8010493e <wakeup1+0x2f>
80104929:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010492c:	8b 40 20             	mov    0x20(%eax),%eax
8010492f:	3b 45 08             	cmp    0x8(%ebp),%eax
80104932:	75 0a                	jne    8010493e <wakeup1+0x2f>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010493e:	83 45 fc 7c          	addl   $0x7c,-0x4(%ebp)
80104942:	81 7d fc 54 1e 11 80 	cmpl   $0x80111e54,-0x4(%ebp)
80104949:	72 d3                	jb     8010491e <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
8010494b:	c9                   	leave  
...
80104950:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104953:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010495a:	e8 af 04 00 00       	call   80104e0e <acquire>
  wakeup1(chan);
8010495f:	8b 45 08             	mov    0x8(%ebp),%eax
80104962:	89 04 24             	mov    %eax,(%esp)
80104965:	e8 a5 ff ff ff       	call   8010490f <wakeup1>
  release(&ptable.lock);
8010496a:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104971:	e8 fa 04 00 00       	call   80104e70 <release>
}
80104976:	c9                   	leave  
80104977:	c3                   	ret    
...
8010497b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010497e:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104985:	e8 84 04 00 00       	call   80104e0e <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010498a:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104991:	eb 41                	jmp    801049d4 <kill+0x5c>
    if(p->pid == pid){
80104993:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104996:	8b 40 10             	mov    0x10(%eax),%eax
80104999:	3b 45 08             	cmp    0x8(%ebp),%eax
8010499c:	75 32                	jne    801049d0 <kill+0x58>
      p->killed = 1;
8010499e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049a1:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801049a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049ab:	8b 40 0c             	mov    0xc(%eax),%eax
801049ae:	83 f8 02             	cmp    $0x2,%eax
801049b1:	75 0a                	jne    801049bd <kill+0x45>
        p->state = RUNNABLE;
801049b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b6:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
801049bd:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801049c4:	e8 a7 04 00 00       	call   80104e70 <release>
      return 0;
801049c9:	b8 00 00 00 00       	mov    $0x0,%eax
801049ce:	eb 1e                	jmp    801049ee <kill+0x76>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049d0:	83 45 f4 7c          	addl   $0x7c,-0xc(%ebp)
801049d4:	81 7d f4 54 1e 11 80 	cmpl   $0x80111e54,-0xc(%ebp)
801049db:	72 b6                	jb     80104993 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
801049dd:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801049e4:	e8 87 04 00 00       	call   80104e70 <release>
  return -1;
...
801049f3:	83 ec 68             	sub    $0x68,%esp
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049f6:	c7 45 ec 54 ff 10 80 	movl   $0x8010ff54,-0x14(%ebp)
801049fd:	e9 a6 03 00 00       	jmp    80104da8 <procdump+0x3b8>
    if(p->state == UNUSED)
80104a02:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a05:	8b 40 0c             	mov    0xc(%eax),%eax
80104a08:	85 c0                	test   %eax,%eax
80104a0a:	75 05                	jne    80104a11 <procdump+0x21>
      continue;
80104a0c:	e9 93 03 00 00       	jmp    80104da4 <procdump+0x3b4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104a11:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a14:	8b 40 0c             	mov    0xc(%eax),%eax
80104a17:	83 f8 05             	cmp    $0x5,%eax
80104a1a:	77 23                	ja     80104a3f <procdump+0x4f>
80104a1c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a1f:	8b 40 0c             	mov    0xc(%eax),%eax
80104a22:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104a29:	85 c0                	test   %eax,%eax
80104a2b:	74 12                	je     80104a3f <procdump+0x4f>
      state = states[p->state];
80104a2d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a30:	8b 40 0c             	mov    0xc(%eax),%eax
80104a33:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104a3a:	89 45 e8             	mov    %eax,-0x18(%ebp)
80104a3d:	eb 07                	jmp    80104a46 <procdump+0x56>
    else
      state = "???";
80104a3f:	c7 45 e8 ab 87 10 80 	movl   $0x801087ab,-0x18(%ebp)
    cprintf("%d %s %s\n", p->pid, state, p->name);
80104a46:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a49:	8d 50 6c             	lea    0x6c(%eax),%edx
80104a4c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a4f:	8b 40 10             	mov    0x10(%eax),%eax
80104a52:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104a56:	8b 55 e8             	mov    -0x18(%ebp),%edx
80104a59:	89 54 24 08          	mov    %edx,0x8(%esp)
80104a5d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a61:	c7 04 24 af 87 10 80 	movl   $0x801087af,(%esp)
80104a68:	e8 33 b9 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104a6d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a70:	8b 40 0c             	mov    0xc(%eax),%eax
80104a73:	83 f8 02             	cmp    $0x2,%eax
80104a76:	75 50                	jne    80104ac8 <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104a78:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104a7b:	8b 40 1c             	mov    0x1c(%eax),%eax
80104a7e:	8b 40 0c             	mov    0xc(%eax),%eax
80104a81:	83 c0 08             	add    $0x8,%eax
80104a84:	8d 55 b4             	lea    -0x4c(%ebp),%edx
80104a87:	89 54 24 04          	mov    %edx,0x4(%esp)
80104a8b:	89 04 24             	mov    %eax,(%esp)
80104a8e:	e8 2c 04 00 00       	call   80104ebf <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104a93:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104a9a:	eb 1b                	jmp    80104ab7 <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104a9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a9f:	8b 44 85 b4          	mov    -0x4c(%ebp,%eax,4),%eax
80104aa3:	89 44 24 04          	mov    %eax,0x4(%esp)
80104aa7:	c7 04 24 b9 87 10 80 	movl   $0x801087b9,(%esp)
80104aae:	e8 ed b8 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s\n", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104ab3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104ab7:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104abb:	7f 0b                	jg     80104ac8 <procdump+0xd8>
80104abd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ac0:	8b 44 85 b4          	mov    -0x4c(%ebp,%eax,4),%eax
80104ac4:	85 c0                	test   %eax,%eax
80104ac6:	75 d4                	jne    80104a9c <procdump+0xac>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104ac8:	c7 04 24 bd 87 10 80 	movl   $0x801087bd,(%esp)
80104acf:	e8 cc b8 ff ff       	call   801003a0 <cprintf>

    pde_t * pgdir = p -> pgdir;
80104ad4:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104ad7:	8b 40 04             	mov    0x4(%eax),%eax
80104ada:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    cprintf("Page Tables:\n");
80104add:	c7 04 24 bf 87 10 80 	movl   $0x801087bf,(%esp)
...
80104af0:	c7 04 24 d0 87 10 80 	movl   $0x801087d0,(%esp)
80104af7:	e8 a4 b8 ff ff       	call   801003a0 <cprintf>

    for (i=0 ; i < NPDENTRIES ; i++) {
80104afc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104b03:	e9 61 01 00 00       	jmp    80104c69 <procdump+0x279>
    	if ((pgdir[i] & PTE_P) && (pgdir[i] & PTE_U) && (pgdir[i] & PTE_A) ) {	// check if USER PAGE and PRESENT
80104b08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b0b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104b12:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104b15:	01 d0                	add    %edx,%eax
80104b17:	8b 00                	mov    (%eax),%eax
80104b19:	83 e0 01             	and    $0x1,%eax
80104b1c:	85 c0                	test   %eax,%eax
80104b1e:	0f 84 41 01 00 00    	je     80104c65 <procdump+0x275>
80104b24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b27:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104b2e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104b31:	01 d0                	add    %edx,%eax
80104b33:	8b 00                	mov    (%eax),%eax
80104b35:	83 e0 04             	and    $0x4,%eax
80104b38:	85 c0                	test   %eax,%eax
80104b3a:	0f 84 25 01 00 00    	je     80104c65 <procdump+0x275>
80104b40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b43:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104b4a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104b4d:	01 d0                	add    %edx,%eax
80104b4f:	8b 00                	mov    (%eax),%eax
80104b51:	83 e0 20             	and    $0x20,%eax
80104b54:	85 c0                	test   %eax,%eax
80104b56:	0f 84 09 01 00 00    	je     80104c65 <procdump+0x275>
    		cprintf("  pdir PTE %d,%d:\n",i,pgdir[i]>>12);
80104b5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b5f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104b66:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104b69:	01 d0                	add    %edx,%eax
80104b6b:	8b 00                	mov    (%eax),%eax
80104b6d:	c1 e8 0c             	shr    $0xc,%eax
80104b70:	89 44 24 08          	mov    %eax,0x8(%esp)
80104b74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b77:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b7b:	c7 04 24 fa 87 10 80 	movl   $0x801087fa,(%esp)
80104b82:	e8 19 b8 ff ff       	call   801003a0 <cprintf>
    		pde_t * pgtbl = P2V(pgdir[i]>>12);
80104b87:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b8a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104b91:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104b94:	01 d0                	add    %edx,%eax
80104b96:	8b 00                	mov    (%eax),%eax
80104b98:	c1 e8 0c             	shr    $0xc,%eax
80104b9b:	05 00 00 00 80       	add    $0x80000000,%eax
80104ba0:	89 45 e0             	mov    %eax,-0x20(%ebp)
    		cprintf("    memory location of page table = %p\n",pgtbl);
80104ba3:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104ba6:	89 44 24 04          	mov    %eax,0x4(%esp)
80104baa:	c7 04 24 10 88 10 80 	movl   $0x80108810,(%esp)
80104bb1:	e8 ea b7 ff ff       	call   801003a0 <cprintf>
    	    for (j=0 ; j < NPTENTRIES; j++) {
80104bb6:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104bbd:	e9 96 00 00 00       	jmp    80104c58 <procdump+0x268>
    	    	if ((pgtbl[j] & PTE_P) && (pgtbl[j] & PTE_U) && (pgtbl[j] & PTE_A))
80104bc2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bc5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104bcc:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104bcf:	01 d0                	add    %edx,%eax
80104bd1:	8b 00                	mov    (%eax),%eax
80104bd3:	83 e0 01             	and    $0x1,%eax
80104bd6:	85 c0                	test   %eax,%eax
80104bd8:	74 7a                	je     80104c54 <procdump+0x264>
80104bda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bdd:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104be4:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104be7:	01 d0                	add    %edx,%eax
80104be9:	8b 00                	mov    (%eax),%eax
80104beb:	83 e0 04             	and    $0x4,%eax
80104bee:	85 c0                	test   %eax,%eax
80104bf0:	74 62                	je     80104c54 <procdump+0x264>
80104bf2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bf5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104bfc:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104bff:	01 d0                	add    %edx,%eax
80104c01:	8b 00                	mov    (%eax),%eax
80104c03:	83 e0 20             	and    $0x20,%eax
80104c06:	85 c0                	test   %eax,%eax
80104c08:	74 4a                	je     80104c54 <procdump+0x264>
    	    		cprintf("    ptbl PTE %d,%d,%p\n",j,pgtbl[j]>>12,P2V(PTE_ADDR(pgtbl[j])));
80104c0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c0d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104c14:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104c17:	01 d0                	add    %edx,%eax
80104c19:	8b 00                	mov    (%eax),%eax
80104c1b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80104c20:	05 00 00 00 80       	add    $0x80000000,%eax
80104c25:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c28:	8d 0c 95 00 00 00 00 	lea    0x0(,%edx,4),%ecx
80104c2f:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104c32:	01 ca                	add    %ecx,%edx
80104c34:	8b 12                	mov    (%edx),%edx
80104c36:	c1 ea 0c             	shr    $0xc,%edx
80104c39:	89 44 24 0c          	mov    %eax,0xc(%esp)
80104c3d:	89 54 24 08          	mov    %edx,0x8(%esp)
80104c41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c44:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c48:	c7 04 24 38 88 10 80 	movl   $0x80108838,(%esp)
80104c4f:	e8 4c b7 ff ff       	call   801003a0 <cprintf>
    for (i=0 ; i < NPDENTRIES ; i++) {
    	if ((pgdir[i] & PTE_P) && (pgdir[i] & PTE_U) && (pgdir[i] & PTE_A) ) {	// check if USER PAGE and PRESENT
    		cprintf("  pdir PTE %d,%d:\n",i,pgdir[i]>>12);
    		pde_t * pgtbl = P2V(pgdir[i]>>12);
    		cprintf("    memory location of page table = %p\n",pgtbl);
    	    for (j=0 ; j < NPTENTRIES; j++) {
80104c54:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104c58:	81 7d f0 ff 03 00 00 	cmpl   $0x3ff,-0x10(%ebp)
80104c5f:	0f 8e 5d ff ff ff    	jle    80104bc2 <procdump+0x1d2>
    pde_t * pgdir = p -> pgdir;
    cprintf("Page Tables:\n");
...
80104c69:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80104c70:	0f 8e 92 fe ff ff    	jle    80104b08 <procdump+0x118>
    	    		cprintf("    ptbl PTE %d,%d,%p\n",j,pgtbl[j]>>12,P2V(PTE_ADDR(pgtbl[j])));
...
80104c76:	c7 04 24 4f 88 10 80 	movl   $0x8010884f,(%esp)
80104c7d:	e8 1e b7 ff ff       	call   801003a0 <cprintf>
	for (i=0 ; i < NPDENTRIES ; i++) {
80104c82:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104c89:	e9 09 01 00 00       	jmp    80104d97 <procdump+0x3a7>
		if ((pgdir[i] & PTE_P) && (pgdir[i] & PTE_U) && (pgdir[i] & PTE_A)) {	// check if USER PAGE and PRESENT
80104c8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c91:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104c98:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104c9b:	01 d0                	add    %edx,%eax
80104c9d:	8b 00                	mov    (%eax),%eax
80104c9f:	83 e0 01             	and    $0x1,%eax
80104ca2:	85 c0                	test   %eax,%eax
80104ca4:	0f 84 e9 00 00 00    	je     80104d93 <procdump+0x3a3>
80104caa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cad:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104cb4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104cb7:	01 d0                	add    %edx,%eax
80104cb9:	8b 00                	mov    (%eax),%eax
80104cbb:	83 e0 04             	and    $0x4,%eax
80104cbe:	85 c0                	test   %eax,%eax
80104cc0:	0f 84 cd 00 00 00    	je     80104d93 <procdump+0x3a3>
80104cc6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cc9:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104cd0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104cd3:	01 d0                	add    %edx,%eax
80104cd5:	8b 00                	mov    (%eax),%eax
80104cd7:	83 e0 20             	and    $0x20,%eax
80104cda:	85 c0                	test   %eax,%eax
80104cdc:	0f 84 b1 00 00 00    	je     80104d93 <procdump+0x3a3>
			pde_t * pgtbl = P2V(pgdir[i]>>12);
80104ce2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ce5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104cec:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104cef:	01 d0                	add    %edx,%eax
80104cf1:	8b 00                	mov    (%eax),%eax
80104cf3:	c1 e8 0c             	shr    $0xc,%eax
80104cf6:	05 00 00 00 80       	add    $0x80000000,%eax
80104cfb:	89 45 dc             	mov    %eax,-0x24(%ebp)
			for (j=0 ; j < NPTENTRIES; j++) {
80104cfe:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104d05:	eb 7f                	jmp    80104d86 <procdump+0x396>
				if ((pgtbl[j] & PTE_P) && (pgtbl[j] & PTE_U) && (pgtbl[j] & PTE_A))
80104d07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d0a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104d11:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104d14:	01 d0                	add    %edx,%eax
80104d16:	8b 00                	mov    (%eax),%eax
80104d18:	83 e0 01             	and    $0x1,%eax
80104d1b:	85 c0                	test   %eax,%eax
80104d1d:	74 63                	je     80104d82 <procdump+0x392>
80104d1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d22:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104d29:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104d2c:	01 d0                	add    %edx,%eax
80104d2e:	8b 00                	mov    (%eax),%eax
80104d30:	83 e0 04             	and    $0x4,%eax
80104d33:	85 c0                	test   %eax,%eax
80104d35:	74 4b                	je     80104d82 <procdump+0x392>
80104d37:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d3a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104d41:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104d44:	01 d0                	add    %edx,%eax
80104d46:	8b 00                	mov    (%eax),%eax
80104d48:	83 e0 20             	and    $0x20,%eax
80104d4b:	85 c0                	test   %eax,%eax
80104d4d:	74 33                	je     80104d82 <procdump+0x392>
					cprintf("%d -> %d\n",(i<<10)|j,pgtbl[j]>>12);
80104d4f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d52:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104d59:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104d5c:	01 d0                	add    %edx,%eax
80104d5e:	8b 00                	mov    (%eax),%eax
80104d60:	c1 e8 0c             	shr    $0xc,%eax
80104d63:	89 c2                	mov    %eax,%edx
80104d65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d68:	c1 e0 0a             	shl    $0xa,%eax
80104d6b:	0b 45 f0             	or     -0x10(%ebp),%eax
80104d6e:	89 54 24 08          	mov    %edx,0x8(%esp)
80104d72:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d76:	c7 04 24 5f 88 10 80 	movl   $0x8010885f,(%esp)
80104d7d:	e8 1e b6 ff ff       	call   801003a0 <cprintf>
    }
	cprintf("Port Mappings:\n");
	for (i=0 ; i < NPDENTRIES ; i++) {
		if ((pgdir[i] & PTE_P) && (pgdir[i] & PTE_U) && (pgdir[i] & PTE_A)) {	// check if USER PAGE and PRESENT
			pde_t * pgtbl = P2V(pgdir[i]>>12);
			for (j=0 ; j < NPTENTRIES; j++) {
80104d82:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104d86:	81 7d f0 ff 03 00 00 	cmpl   $0x3ff,-0x10(%ebp)
80104d8d:	0f 8e 74 ff ff ff    	jle    80104d07 <procdump+0x317>
	...
	cprintf("Port Mappings:\n");
	for (i=0 ; i < NPDENTRIES ; i++) {
80104d93:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104d97:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80104d9e:	0f 8e ea fe ff ff    	jle    80104c8e <procdump+0x29e>
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104da4:	83 45 ec 7c          	addl   $0x7c,-0x14(%ebp)
80104da8:	81 7d ec 54 1e 11 80 	cmpl   $0x80111e54,-0x14(%ebp)
80104daf:	0f 82 4d fc ff ff    	jb     80104a02 <procdump+0x12>
...
80104dbd:	9c                   	pushf  
80104dbe:	58                   	pop    %eax
80104dbf:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
...
80104de2:	f0 87 02             	lock xchg %eax,(%edx)
80104de5:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
80104e05:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104e0c:	5d                   	pop    %ebp
80104e0d:	c3                   	ret    
...
80104e14:	e8 49 01 00 00       	call   80104f62 <pushcli>
  if(holding(lk))
80104e19:	8b 45 08             	mov    0x8(%ebp),%eax
80104e1c:	89 04 24             	mov    %eax,(%esp)
80104e1f:	e8 14 01 00 00       	call   80104f38 <holding>
80104e24:	85 c0                	test   %eax,%eax
80104e26:	74 0c                	je     80104e34 <acquire+0x26>
    panic("acquire");
80104e28:	c7 04 24 93 88 10 80 	movl   $0x80108893,(%esp)
80104e2f:	e8 06 b7 ff ff       	call   8010053a <panic>
...
80104e38:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104e3f:	00 
80104e40:	89 04 24             	mov    %eax,(%esp)
80104e43:	e8 8b ff ff ff       	call   80104dd3 <xchg>
80104e48:	85 c0                	test   %eax,%eax
80104e4a:	75 e9                	jne    80104e35 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104e4c:	8b 45 08             	mov    0x8(%ebp),%eax
80104e4f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104e56:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104e59:	8b 45 08             	mov    0x8(%ebp),%eax
80104e5c:	83 c0 0c             	add    $0xc,%eax
80104e5f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e63:	8d 45 08             	lea    0x8(%ebp),%eax
80104e66:	89 04 24             	mov    %eax,(%esp)
80104e69:	e8 51 00 00 00       	call   80104ebf <getcallerpcs>
}
80104e6e:	c9                   	leave  
80104e6f:	c3                   	ret    
...
80104e7c:	e8 b7 00 00 00       	call   80104f38 <holding>
80104e81:	85 c0                	test   %eax,%eax
80104e83:	75 0c                	jne    80104e91 <release+0x21>
    panic("release");
80104e85:	c7 04 24 9b 88 10 80 	movl   $0x8010889b,(%esp)
80104e8c:	e8 a9 b6 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104e91:	8b 45 08             	mov    0x8(%ebp),%eax
80104e94:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104e9b:	8b 45 08             	mov    0x8(%ebp),%eax
80104e9e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104ea8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104eaf:	00 
80104eb0:	89 04 24             	mov    %eax,(%esp)
80104eb3:	e8 1b ff ff ff       	call   80104dd3 <xchg>

  popcli();
80104eb8:	e8 e9 00 00 00       	call   80104fa6 <popcli>
}
80104ebd:	c9                   	leave  
80104ebe:	c3                   	ret    

80104ebf <getcallerpcs>:
...
80104ec8:	83 e8 08             	sub    $0x8,%eax
80104ecb:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104ece:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104ed5:	eb 38                	jmp    80104f0f <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104ed7:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104edb:	74 38                	je     80104f15 <getcallerpcs+0x56>
80104edd:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104ee4:	76 2f                	jbe    80104f15 <getcallerpcs+0x56>
80104ee6:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104eea:	74 29                	je     80104f15 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104eec:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104eef:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104ef6:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ef9:	01 c2                	add    %eax,%edx
80104efb:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104efe:	8b 40 04             	mov    0x4(%eax),%eax
80104f01:	89 02                	mov    %eax,(%edx)
...
80104f13:	7e c2                	jle    80104ed7 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80104f34:	7e e1                	jle    80104f17 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80104f36:	c9                   	leave  
80104f37:	c3                   	ret    
...
80104f42:	74 17                	je     80104f5b <holding+0x23>
80104f44:	8b 45 08             	mov    0x8(%ebp),%eax
80104f47:	8b 50 08             	mov    0x8(%eax),%edx
80104f4a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f50:	39 c2                	cmp    %eax,%edx
80104f52:	75 07                	jne    80104f5b <holding+0x23>
80104f54:	b8 01 00 00 00       	mov    $0x1,%eax
80104f59:	eb 05                	jmp    80104f60 <holding+0x28>
...
80104f65:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104f68:	e8 4a fe ff ff       	call   80104db7 <readeflags>
80104f6d:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104f70:	e8 52 fe ff ff       	call   80104dc7 <cli>
  if(cpu->ncli++ == 0)
80104f75:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104f7c:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80104f82:	8d 48 01             	lea    0x1(%eax),%ecx
80104f85:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
80104f8b:	85 c0                	test   %eax,%eax
80104f8d:	75 15                	jne    80104fa4 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80104f8f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f95:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f98:	81 e2 00 02 00 00    	and    $0x200,%edx
80104f9e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104fa4:	c9                   	leave  
80104fa5:	c3                   	ret    
...
80104fa9:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104fac:	e8 06 fe ff ff       	call   80104db7 <readeflags>
80104fb1:	25 00 02 00 00       	and    $0x200,%eax
80104fb6:	85 c0                	test   %eax,%eax
80104fb8:	74 0c                	je     80104fc6 <popcli+0x20>
    panic("popcli - interruptible");
80104fba:	c7 04 24 a3 88 10 80 	movl   $0x801088a3,(%esp)
...
80104fd2:	83 ea 01             	sub    $0x1,%edx
80104fd5:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104fdb:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104fe1:	85 c0                	test   %eax,%eax
80104fe3:	79 0c                	jns    80104ff1 <popcli+0x4b>
    panic("popcli");
80104fe5:	c7 04 24 ba 88 10 80 	movl   $0x801088ba,(%esp)
80104fec:	e8 49 b5 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104ff1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ff7:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104ffd:	85 c0                	test   %eax,%eax
80104fff:	75 15                	jne    80105016 <popcli+0x70>
80105001:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105007:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010500d:	85 c0                	test   %eax,%eax
8010500f:	74 05                	je     80105016 <popcli+0x70>
    sti();
80105011:	e8 b7 fd ff ff       	call   80104dcd <sti>
}
80105016:	c9                   	leave  
80105017:	c3                   	ret    
...
8010501d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105020:	8b 55 10             	mov    0x10(%ebp),%edx
80105023:	8b 45 0c             	mov    0xc(%ebp),%eax
80105026:	89 cb                	mov    %ecx,%ebx
80105028:	89 df                	mov    %ebx,%edi
8010502a:	89 d1                	mov    %edx,%ecx
8010502c:	fc                   	cld    
8010502d:	f3 aa                	rep stos %al,%es:(%edi)
8010502f:	89 ca                	mov    %ecx,%edx
80105031:	89 fb                	mov    %edi,%ebx
80105033:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105040:	57                   	push   %edi
80105041:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
80105042:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105045:	8b 55 10             	mov    0x10(%ebp),%edx
80105048:	8b 45 0c             	mov    0xc(%ebp),%eax
8010504b:	89 cb                	mov    %ecx,%ebx
8010504d:	89 df                	mov    %ebx,%edi
8010504f:	89 d1                	mov    %edx,%ecx
80105051:	fc                   	cld    
80105052:	f3 ab                	rep stos %eax,%es:(%edi)
80105054:	89 ca                	mov    %ecx,%edx
80105056:	89 fb                	mov    %edi,%ebx
80105058:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010505b:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80105070:	75 49                	jne    801050bb <memset+0x59>
80105072:	8b 45 10             	mov    0x10(%ebp),%eax
80105075:	83 e0 03             	and    $0x3,%eax
80105078:	85 c0                	test   %eax,%eax
8010507a:	75 3f                	jne    801050bb <memset+0x59>
    c &= 0xFF;
8010507c:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105083:	8b 45 10             	mov    0x10(%ebp),%eax
80105086:	c1 e8 02             	shr    $0x2,%eax
80105089:	89 c2                	mov    %eax,%edx
8010508b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010508e:	c1 e0 18             	shl    $0x18,%eax
80105091:	89 c1                	mov    %eax,%ecx
80105093:	8b 45 0c             	mov    0xc(%ebp),%eax
80105096:	c1 e0 10             	shl    $0x10,%eax
80105099:	09 c1                	or     %eax,%ecx
8010509b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010509e:	c1 e0 08             	shl    $0x8,%eax
801050a1:	09 c8                	or     %ecx,%eax
801050a3:	0b 45 0c             	or     0xc(%ebp),%eax
801050a6:	89 54 24 08          	mov    %edx,0x8(%esp)
801050aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801050ae:	8b 45 08             	mov    0x8(%ebp),%eax
801050b1:	89 04 24             	mov    %eax,(%esp)
801050b4:	e8 84 ff ff ff       	call   8010503d <stosl>
801050b9:	eb 19                	jmp    801050d4 <memset+0x72>
  } else
    stosb(dst, c, n);
801050bb:	8b 45 10             	mov    0x10(%ebp),%eax
801050be:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801050cf:	e8 44 ff ff ff       	call   80105018 <stosb>
  return dst;
...
801050e8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801050eb:	eb 30                	jmp    8010511d <memcmp+0x44>
    if(*s1 != *s2)
801050ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050f0:	0f b6 10             	movzbl (%eax),%edx
801050f3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050f6:	0f b6 00             	movzbl (%eax),%eax
801050f9:	38 c2                	cmp    %al,%dl
801050fb:	74 18                	je     80105115 <memcmp+0x3c>
      return *s1 - *s2;
801050fd:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105100:	0f b6 00             	movzbl (%eax),%eax
80105103:	0f b6 d0             	movzbl %al,%edx
80105106:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105109:	0f b6 00             	movzbl (%eax),%eax
8010510c:	0f b6 c0             	movzbl %al,%eax
8010510f:	29 c2                	sub    %eax,%edx
80105111:	89 d0                	mov    %edx,%eax
80105113:	eb 1a                	jmp    8010512f <memcmp+0x56>
    s1++, s2++;
80105115:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
80105120:	8d 50 ff             	lea    -0x1(%eax),%edx
80105123:	89 55 10             	mov    %edx,0x10(%ebp)
80105126:	85 c0                	test   %eax,%eax
80105128:	75 c3                	jne    801050ed <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105149:	73 3d                	jae    80105188 <memmove+0x57>
...
80105156:	76 30                	jbe    80105188 <memmove+0x57>
    s += n;
...
8010517c:	8d 50 ff             	lea    -0x1(%eax),%edx
8010517f:	89 55 10             	mov    %edx,0x10(%ebp)
80105182:	85 c0                	test   %eax,%eax
80105184:	75 e0                	jne    80105166 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105186:	eb 26                	jmp    801051ae <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105188:	eb 17                	jmp    801051a1 <memmove+0x70>
      *d++ = *s++;
8010518a:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010518d:	8d 50 01             	lea    0x1(%eax),%edx
80105190:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105193:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105196:	8d 4a 01             	lea    0x1(%edx),%ecx
80105199:	89 4d fc             	mov    %ecx,-0x4(%ebp)
8010519c:	0f b6 12             	movzbl (%edx),%edx
8010519f:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801051a1:	8b 45 10             	mov    0x10(%ebp),%eax
801051a4:	8d 50 ff             	lea    -0x1(%eax),%edx
801051a7:	89 55 10             	mov    %edx,0x10(%ebp)
801051aa:	85 c0                	test   %eax,%eax
801051ac:	75 dc                	jne    8010518a <memmove+0x59>
      *d++ = *s++;
...
801051cd:	e8 5f ff ff ff       	call   80105131 <memmove>
}
801051d2:	c9                   	leave  
801051d3:	c3                   	ret    
...
801051d5:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801051d7:	eb 0c                	jmp    801051e5 <strncmp+0x11>
    n--, p++, q++;
801051d9:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801051dd:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801051e1:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801051e9:	74 1a                	je     80105205 <strncmp+0x31>
801051eb:	8b 45 08             	mov    0x8(%ebp),%eax
801051ee:	0f b6 00             	movzbl (%eax),%eax
801051f1:	84 c0                	test   %al,%al
801051f3:	74 10                	je     80105205 <strncmp+0x31>
801051f5:	8b 45 08             	mov    0x8(%ebp),%eax
801051f8:	0f b6 10             	movzbl (%eax),%edx
801051fb:	8b 45 0c             	mov    0xc(%ebp),%eax
801051fe:	0f b6 00             	movzbl (%eax),%eax
80105201:	38 c2                	cmp    %al,%dl
80105203:	74 d4                	je     801051d9 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105205:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105209:	75 07                	jne    80105212 <strncmp+0x3e>
    return 0;
8010520b:	b8 00 00 00 00       	mov    $0x0,%eax
80105210:	eb 16                	jmp    80105228 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
80105212:	8b 45 08             	mov    0x8(%ebp),%eax
80105215:	0f b6 00             	movzbl (%eax),%eax
80105218:	0f b6 d0             	movzbl %al,%edx
8010521b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010521e:	0f b6 00             	movzbl (%eax),%eax
80105221:	0f b6 c0             	movzbl %al,%eax
80105224:	29 c2                	sub    %eax,%edx
...
80105242:	7e 1e                	jle    80105262 <strncpy+0x38>
80105244:	8b 45 08             	mov    0x8(%ebp),%eax
80105247:	8d 50 01             	lea    0x1(%eax),%edx
8010524a:	89 55 08             	mov    %edx,0x8(%ebp)
8010524d:	8b 55 0c             	mov    0xc(%ebp),%edx
80105250:	8d 4a 01             	lea    0x1(%edx),%ecx
80105253:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105256:	0f b6 12             	movzbl (%edx),%edx
80105259:	88 10                	mov    %dl,(%eax)
8010525b:	0f b6 00             	movzbl (%eax),%eax
8010525e:	84 c0                	test   %al,%al
80105260:	75 d5                	jne    80105237 <strncpy+0xd>
    ;
  while(n-- > 0)
80105262:	eb 0c                	jmp    80105270 <strncpy+0x46>
    *s++ = 0;
80105264:	8b 45 08             	mov    0x8(%ebp),%eax
80105267:	8d 50 01             	lea    0x1(%eax),%edx
8010526a:	89 55 08             	mov    %edx,0x8(%ebp)
8010526d:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
8010527b:	7f e7                	jg     80105264 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
8010528b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
8010528e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105292:	7f 05                	jg     80105299 <safestrcpy+0x17>
    return os;
80105294:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105297:	eb 31                	jmp    801052ca <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105299:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010529d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052a1:	7e 1e                	jle    801052c1 <safestrcpy+0x3f>
...
801052af:	8d 4a 01             	lea    0x1(%edx),%ecx
801052b2:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801052b5:	0f b6 12             	movzbl (%edx),%edx
801052b8:	88 10                	mov    %dl,(%eax)
801052ba:	0f b6 00             	movzbl (%eax),%eax
801052bd:	84 c0                	test   %al,%al
801052bf:	75 d8                	jne    80105299 <safestrcpy+0x17>
    ;
  *s = 0;
801052c1:	8b 45 08             	mov    0x8(%ebp),%eax
801052c4:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
801052cf:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
801052d2:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801052d9:	eb 04                	jmp    801052df <strlen+0x13>
801052db:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801052ec:	75 ed                	jne    801052db <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801052f3:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801052f7:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801052fe:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801052ff:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105301:	89 d4                	mov    %edx,%esp
...
8010538c:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010538f:	72 dc                	jb     8010536d <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801053a4:	8b 40 18             	mov    0x18(%eax),%eax
801053a7:	8b 50 44             	mov    0x44(%eax),%edx
801053aa:	8b 45 08             	mov    0x8(%ebp),%eax
801053ad:	c1 e0 02             	shl    $0x2,%eax
801053b0:	01 d0                	add    %edx,%eax
801053b2:	8d 48 04             	lea    0x4(%eax),%ecx
801053b5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053bb:	8b 55 0c             	mov    0xc(%ebp),%edx
801053be:	89 54 24 08          	mov    %edx,0x8(%esp)
801053c2:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801053c6:	89 04 24             	mov    %eax,(%esp)
801053c9:	e8 3a ff ff ff       	call   80105308 <fetchint>
}
801053ce:	c9                   	leave  
801053cf:	c3                   	ret    
...
80105435:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105438:	8d 45 fc             	lea    -0x4(%ebp),%eax
8010543b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010543f:	8b 45 08             	mov    0x8(%ebp),%eax
80105442:	89 04 24             	mov    %eax,(%esp)
80105445:	e8 4e ff ff ff       	call   80105398 <argint>
8010544a:	85 c0                	test   %eax,%eax
8010544c:	79 07                	jns    80105455 <argstr+0x23>
    return -1;
8010544e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105453:	eb 1e                	jmp    80105473 <argstr+0x41>
...
80105463:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105467:	89 54 24 04          	mov    %edx,0x4(%esp)
8010546b:	89 04 24             	mov    %eax,(%esp)
8010546e:	e8 c9 fe ff ff       	call   8010533c <fetchstr>
}
80105473:	c9                   	leave  
80105474:	c3                   	ret    
...
80105482:	8b 40 18             	mov    0x18(%eax),%eax
80105485:	8b 40 1c             	mov    0x1c(%eax),%eax
80105488:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
8010548b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010548f:	78 2e                	js     801054bf <syscall+0x4a>
80105491:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105495:	7f 28                	jg     801054bf <syscall+0x4a>
80105497:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010549a:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054a1:	85 c0                	test   %eax,%eax
801054a3:	74 1a                	je     801054bf <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
801054a5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054ab:	8b 58 18             	mov    0x18(%eax),%ebx
801054ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054b1:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054b8:	ff d0                	call   *%eax
801054ba:	89 43 1c             	mov    %eax,0x1c(%ebx)
801054bd:	eb 73                	jmp    80105532 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
801054bf:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
801054c3:	7e 30                	jle    801054f5 <syscall+0x80>
801054c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054c8:	83 f8 15             	cmp    $0x15,%eax
801054cb:	77 28                	ja     801054f5 <syscall+0x80>
801054cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054d0:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054d7:	85 c0                	test   %eax,%eax
801054d9:	74 1a                	je     801054f5 <syscall+0x80>
    proc->tf->eax = syscalls[num]();
801054db:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054e1:	8b 58 18             	mov    0x18(%eax),%ebx
801054e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054e7:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054ee:	ff d0                	call   *%eax
801054f0:	89 43 1c             	mov    %eax,0x1c(%ebx)
801054f3:	eb 3d                	jmp    80105532 <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801054f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054fb:	8d 48 6c             	lea    0x6c(%eax),%ecx
801054fe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105504:	8b 40 10             	mov    0x10(%eax),%eax
80105507:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010550a:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010550e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105512:	89 44 24 04          	mov    %eax,0x4(%esp)
80105516:	c7 04 24 c1 88 10 80 	movl   $0x801088c1,(%esp)
8010551d:	e8 7e ae ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
...
80105532:	83 c4 24             	add    $0x24,%esp
80105535:	5b                   	pop    %ebx
80105536:	5d                   	pop    %ebp
80105537:	c3                   	ret    
...
8010554b:	e8 48 fe ff ff       	call   80105398 <argint>
...
801055fc:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
801055ff:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105602:	89 44 24 08          	mov    %eax,0x8(%esp)
80105606:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010560d:	00 
8010560e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105615:	e8 1e ff ff ff       	call   80105538 <argfd>
8010561a:	85 c0                	test   %eax,%eax
8010561c:	79 07                	jns    80105625 <sys_dup+0x2c>
    return -1;
8010561e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105623:	eb 29                	jmp    8010564e <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105625:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105628:	89 04 24             	mov    %eax,(%esp)
8010562b:	e8 7d ff ff ff       	call   801055ad <fdalloc>
80105630:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105633:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105637:	79 07                	jns    80105640 <sys_dup+0x47>
    return -1;
80105639:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010563e:	eb 0e                	jmp    8010564e <sys_dup+0x55>
  filedup(f);
80105640:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105643:	89 04 24             	mov    %eax,(%esp)
80105646:	e8 49 b9 ff ff       	call   80100f94 <filedup>
  return fd;
...
8010566c:	e8 c7 fe ff ff       	call   80105538 <argfd>
80105671:	85 c0                	test   %eax,%eax
80105673:	78 35                	js     801056aa <sys_read+0x5a>
80105675:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105678:	89 44 24 04          	mov    %eax,0x4(%esp)
8010567c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105683:	e8 10 fd ff ff       	call   80105398 <argint>
80105688:	85 c0                	test   %eax,%eax
8010568a:	78 1e                	js     801056aa <sys_read+0x5a>
...
801056a1:	e8 2a fd ff ff       	call   801053d0 <argptr>
801056a6:	85 c0                	test   %eax,%eax
801056a8:	79 07                	jns    801056b1 <sys_read+0x61>
    return -1;
801056aa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056af:	eb 19                	jmp    801056ca <sys_read+0x7a>
...
801056c5:	e8 37 ba ff ff       	call   80101101 <fileread>
}
801056ca:	c9                   	leave  
801056cb:	c3                   	ret    
...
801056e8:	e8 4b fe ff ff       	call   80105538 <argfd>
801056ed:	85 c0                	test   %eax,%eax
801056ef:	78 35                	js     80105726 <sys_write+0x5a>
801056f1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801056f8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801056ff:	e8 94 fc ff ff       	call   80105398 <argint>
80105704:	85 c0                	test   %eax,%eax
80105706:	78 1e                	js     80105726 <sys_write+0x5a>
...
8010571d:	e8 ae fc ff ff       	call   801053d0 <argptr>
80105722:	85 c0                	test   %eax,%eax
80105724:	79 07                	jns    8010572d <sys_write+0x61>
    return -1;
80105726:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010572b:	eb 19                	jmp    80105746 <sys_write+0x7a>
...
80105741:	e8 77 ba ff ff       	call   801011bd <filewrite>
}
80105746:	c9                   	leave  
80105747:	c3                   	ret    
...
8010575c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105763:	e8 d0 fd ff ff       	call   80105538 <argfd>
80105768:	85 c0                	test   %eax,%eax
8010576a:	79 07                	jns    80105773 <sys_close+0x2b>
    return -1;
8010576c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105771:	eb 24                	jmp    80105797 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105773:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105779:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010577c:	83 c2 08             	add    $0x8,%edx
8010577f:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105786:	00 
  fileclose(f);
80105787:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010578a:	89 04 24             	mov    %eax,(%esp)
8010578d:	e8 4a b8 ff ff       	call   80100fdc <fileclose>
  return 0;
...
801057b5:	e8 7e fd ff ff       	call   80105538 <argfd>
801057ba:	85 c0                	test   %eax,%eax
801057bc:	78 1f                	js     801057dd <sys_fstat+0x44>
801057be:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801057c5:	00 
801057c6:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057c9:	89 44 24 04          	mov    %eax,0x4(%esp)
801057cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057d4:	e8 f7 fb ff ff       	call   801053d0 <argptr>
801057d9:	85 c0                	test   %eax,%eax
801057db:	79 07                	jns    801057e4 <sys_fstat+0x4b>
    return -1;
801057dd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057e2:	eb 12                	jmp    801057f6 <sys_fstat+0x5d>
...
801057f1:	e8 bc b8 ff ff       	call   801010b2 <filestat>
}
801057f6:	c9                   	leave  
801057f7:	c3                   	ret    
...
801057fb:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801057fe:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105801:	89 44 24 04          	mov    %eax,0x4(%esp)
80105805:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010580c:	e8 21 fc ff ff       	call   80105432 <argstr>
80105811:	85 c0                	test   %eax,%eax
80105813:	78 17                	js     8010582c <sys_link+0x34>
80105815:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105818:	89 44 24 04          	mov    %eax,0x4(%esp)
8010581c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105823:	e8 0a fc ff ff       	call   80105432 <argstr>
80105828:	85 c0                	test   %eax,%eax
8010582a:	79 0a                	jns    80105836 <sys_link+0x3e>
    return -1;
8010582c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105831:	e9 3d 01 00 00       	jmp    80105973 <sys_link+0x17b>
  if((ip = namei(old)) == 0)
80105836:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105839:	89 04 24             	mov    %eax,(%esp)
8010583c:	e8 d3 cb ff ff       	call   80102414 <namei>
80105841:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105844:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105848:	75 0a                	jne    80105854 <sys_link+0x5c>
    return -1;
8010584a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010584f:	e9 1f 01 00 00       	jmp    80105973 <sys_link+0x17b>

  begin_trans();
80105854:	e8 9a d9 ff ff       	call   801031f3 <begin_trans>

  ilock(ip);
80105859:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010585c:	89 04 24             	mov    %eax,(%esp)
8010585f:	e8 05 c0 ff ff       	call   80101869 <ilock>
  if(ip->type == T_DIR){
80105864:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105867:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010586b:	66 83 f8 01          	cmp    $0x1,%ax
8010586f:	75 1a                	jne    8010588b <sys_link+0x93>
    iunlockput(ip);
80105871:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105874:	89 04 24             	mov    %eax,(%esp)
80105877:	e8 71 c2 ff ff       	call   80101aed <iunlockput>
    commit_trans();
8010587c:	e8 bb d9 ff ff       	call   8010323c <commit_trans>
    return -1;
80105881:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105886:	e9 e8 00 00 00       	jmp    80105973 <sys_link+0x17b>
  }

  ip->nlink++;
8010588b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010588e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105892:	8d 50 01             	lea    0x1(%eax),%edx
80105895:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105898:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010589c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010589f:	89 04 24             	mov    %eax,(%esp)
801058a2:	e8 06 be ff ff       	call   801016ad <iupdate>
  iunlock(ip);
801058a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058aa:	89 04 24             	mov    %eax,(%esp)
801058ad:	e8 05 c1 ff ff       	call   801019b7 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
801058b2:	8b 45 dc             	mov    -0x24(%ebp),%eax
801058b5:	8d 55 e2             	lea    -0x1e(%ebp),%edx
801058b8:	89 54 24 04          	mov    %edx,0x4(%esp)
801058bc:	89 04 24             	mov    %eax,(%esp)
801058bf:	e8 72 cb ff ff       	call   80102436 <nameiparent>
801058c4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801058c7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801058cb:	75 02                	jne    801058cf <sys_link+0xd7>
    goto bad;
801058cd:	eb 68                	jmp    80105937 <sys_link+0x13f>
  ilock(dp);
801058cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058d2:	89 04 24             	mov    %eax,(%esp)
801058d5:	e8 8f bf ff ff       	call   80101869 <ilock>
...
801058e6:	75 20                	jne    80105908 <sys_link+0x110>
801058e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058eb:	8b 40 04             	mov    0x4(%eax),%eax
801058ee:	89 44 24 08          	mov    %eax,0x8(%esp)
801058f2:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801058f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801058f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058fc:	89 04 24             	mov    %eax,(%esp)
801058ff:	e8 50 c8 ff ff       	call   80102154 <dirlink>
80105904:	85 c0                	test   %eax,%eax
80105906:	79 0d                	jns    80105915 <sys_link+0x11d>
    iunlockput(dp);
80105908:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010590b:	89 04 24             	mov    %eax,(%esp)
8010590e:	e8 da c1 ff ff       	call   80101aed <iunlockput>
    goto bad;
80105913:	eb 22                	jmp    80105937 <sys_link+0x13f>
  }
  iunlockput(dp);
80105915:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105918:	89 04 24             	mov    %eax,(%esp)
8010591b:	e8 cd c1 ff ff       	call   80101aed <iunlockput>
  iput(ip);
80105920:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105923:	89 04 24             	mov    %eax,(%esp)
80105926:	e8 f1 c0 ff ff       	call   80101a1c <iput>

  commit_trans();
8010592b:	e8 0c d9 ff ff       	call   8010323c <commit_trans>

  return 0;
80105930:	b8 00 00 00 00       	mov    $0x0,%eax
80105935:	eb 3c                	jmp    80105973 <sys_link+0x17b>

bad:
  ilock(ip);
80105937:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010593a:	89 04 24             	mov    %eax,(%esp)
8010593d:	e8 27 bf ff ff       	call   80101869 <ilock>
  ip->nlink--;
...
80105959:	e8 4f bd ff ff       	call   801016ad <iupdate>
  iunlockput(ip);
8010595e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105961:	89 04 24             	mov    %eax,(%esp)
80105964:	e8 84 c1 ff ff       	call   80101aed <iunlockput>
  commit_trans();
80105969:	e8 ce d8 ff ff       	call   8010323c <commit_trans>
  return -1;
...
80105978:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010597b:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105982:	eb 4b                	jmp    801059cf <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105984:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105987:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010598e:	00 
...
801059a0:	e8 d1 c3 ff ff       	call   80101d76 <readi>
801059a5:	83 f8 10             	cmp    $0x10,%eax
801059a8:	74 0c                	je     801059b6 <isdirempty+0x41>
      panic("isdirempty: readi");
801059aa:	c7 04 24 dd 88 10 80 	movl   $0x801088dd,(%esp)
801059b1:	e8 84 ab ff ff       	call   8010053a <panic>
    if(de.inum != 0)
801059b6:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801059ba:	66 85 c0             	test   %ax,%ax
801059bd:	74 07                	je     801059c6 <isdirempty+0x51>
      return 0;
801059bf:	b8 00 00 00 00       	mov    $0x0,%eax
801059c4:	eb 1b                	jmp    801059e1 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801059c9:	83 c0 10             	add    $0x10,%eax
801059cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059cf:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059d2:	8b 45 08             	mov    0x8(%ebp),%eax
801059d5:	8b 40 18             	mov    0x18(%eax),%eax
801059d8:	39 c2                	cmp    %eax,%edx
801059da:	72 a8                	jb     80105984 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
801059dc:	b8 01 00 00 00       	mov    $0x1,%eax
}
801059e1:	c9                   	leave  
801059e2:	c3                   	ret    
...
801059e6:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801059e9:	8d 45 cc             	lea    -0x34(%ebp),%eax
801059ec:	89 44 24 04          	mov    %eax,0x4(%esp)
801059f0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059f7:	e8 36 fa ff ff       	call   80105432 <argstr>
801059fc:	85 c0                	test   %eax,%eax
801059fe:	79 0a                	jns    80105a0a <sys_unlink+0x27>
    return -1;
80105a00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a05:	e9 aa 01 00 00       	jmp    80105bb4 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105a0a:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105a0d:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105a10:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a14:	89 04 24             	mov    %eax,(%esp)
80105a17:	e8 1a ca ff ff       	call   80102436 <nameiparent>
80105a1c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a1f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a23:	75 0a                	jne    80105a2f <sys_unlink+0x4c>
    return -1;
80105a25:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a2a:	e9 85 01 00 00       	jmp    80105bb4 <sys_unlink+0x1d1>

  begin_trans();
80105a2f:	e8 bf d7 ff ff       	call   801031f3 <begin_trans>

  ilock(dp);
80105a34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a37:	89 04 24             	mov    %eax,(%esp)
80105a3a:	e8 2a be ff ff       	call   80101869 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a3f:	c7 44 24 04 ef 88 10 	movl   $0x801088ef,0x4(%esp)
80105a46:	80 
80105a47:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a4a:	89 04 24             	mov    %eax,(%esp)
80105a4d:	e8 17 c6 ff ff       	call   80102069 <namecmp>
80105a52:	85 c0                	test   %eax,%eax
80105a54:	0f 84 45 01 00 00    	je     80105b9f <sys_unlink+0x1bc>
80105a5a:	c7 44 24 04 f1 88 10 	movl   $0x801088f1,0x4(%esp)
80105a61:	80 
80105a62:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a65:	89 04 24             	mov    %eax,(%esp)
80105a68:	e8 fc c5 ff ff       	call   80102069 <namecmp>
80105a6d:	85 c0                	test   %eax,%eax
80105a6f:	0f 84 2a 01 00 00    	je     80105b9f <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105a75:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105a78:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a7c:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a86:	89 04 24             	mov    %eax,(%esp)
80105a89:	e8 fd c5 ff ff       	call   8010208b <dirlookup>
80105a8e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105a91:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105a95:	75 05                	jne    80105a9c <sys_unlink+0xb9>
    goto bad;
80105a97:	e9 03 01 00 00       	jmp    80105b9f <sys_unlink+0x1bc>
  ilock(ip);
80105a9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a9f:	89 04 24             	mov    %eax,(%esp)
80105aa2:	e8 c2 bd ff ff       	call   80101869 <ilock>

  if(ip->nlink < 1)
80105aa7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aaa:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105aae:	66 85 c0             	test   %ax,%ax
80105ab1:	7f 0c                	jg     80105abf <sys_unlink+0xdc>
    panic("unlink: nlink < 1");
80105ab3:	c7 04 24 f4 88 10 80 	movl   $0x801088f4,(%esp)
80105aba:	e8 7b aa ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105abf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ac2:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ac6:	66 83 f8 01          	cmp    $0x1,%ax
80105aca:	75 1f                	jne    80105aeb <sys_unlink+0x108>
80105acc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105acf:	89 04 24             	mov    %eax,(%esp)
80105ad2:	e8 9e fe ff ff       	call   80105975 <isdirempty>
80105ad7:	85 c0                	test   %eax,%eax
80105ad9:	75 10                	jne    80105aeb <sys_unlink+0x108>
    iunlockput(ip);
80105adb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ade:	89 04 24             	mov    %eax,(%esp)
80105ae1:	e8 07 c0 ff ff       	call   80101aed <iunlockput>
    goto bad;
80105ae6:	e9 b4 00 00 00       	jmp    80105b9f <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105aeb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105af2:	00 
80105af3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105afa:	00 
80105afb:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105afe:	89 04 24             	mov    %eax,(%esp)
80105b01:	e8 5c f5 ff ff       	call   80105062 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b06:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105b09:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105b10:	00 
...
80105b22:	e8 b3 c3 ff ff       	call   80101eda <writei>
80105b27:	83 f8 10             	cmp    $0x10,%eax
80105b2a:	74 0c                	je     80105b38 <sys_unlink+0x155>
    panic("unlink: writei");
80105b2c:	c7 04 24 06 89 10 80 	movl   $0x80108906,(%esp)
80105b33:	e8 02 aa ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105b38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b3f:	66 83 f8 01          	cmp    $0x1,%ax
80105b43:	75 1c                	jne    80105b61 <sys_unlink+0x17e>
    dp->nlink--;
80105b45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b48:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b4c:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105b5c:	e8 4c bb ff ff       	call   801016ad <iupdate>
  }
  iunlockput(dp);
80105b61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b64:	89 04 24             	mov    %eax,(%esp)
80105b67:	e8 81 bf ff ff       	call   80101aed <iunlockput>

  ip->nlink--;
80105b6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b6f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b73:	8d 50 ff             	lea    -0x1(%eax),%edx
80105b76:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b79:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105b7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b80:	89 04 24             	mov    %eax,(%esp)
80105b83:	e8 25 bb ff ff       	call   801016ad <iupdate>
  iunlockput(ip);
80105b88:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8b:	89 04 24             	mov    %eax,(%esp)
80105b8e:	e8 5a bf ff ff       	call   80101aed <iunlockput>

  commit_trans();
80105b93:	e8 a4 d6 ff ff       	call   8010323c <commit_trans>

  return 0;
80105b98:	b8 00 00 00 00       	mov    $0x0,%eax
80105b9d:	eb 15                	jmp    80105bb4 <sys_unlink+0x1d1>

bad:
  iunlockput(dp);
80105b9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ba2:	89 04 24             	mov    %eax,(%esp)
80105ba5:	e8 43 bf ff ff       	call   80101aed <iunlockput>
  commit_trans();
80105baa:	e8 8d d6 ff ff       	call   8010323c <commit_trans>
  return -1;
...
80105bb9:	83 ec 48             	sub    $0x48,%esp
80105bbc:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105bbf:	8b 55 10             	mov    0x10(%ebp),%edx
80105bc2:	8b 45 14             	mov    0x14(%ebp),%eax
80105bc5:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105bc9:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105bcd:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105bd1:	8d 45 de             	lea    -0x22(%ebp),%eax
80105bd4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bd8:	8b 45 08             	mov    0x8(%ebp),%eax
80105bdb:	89 04 24             	mov    %eax,(%esp)
80105bde:	e8 53 c8 ff ff       	call   80102436 <nameiparent>
80105be3:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105be6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bea:	75 0a                	jne    80105bf6 <create+0x40>
    return 0;
80105bec:	b8 00 00 00 00       	mov    $0x0,%eax
80105bf1:	e9 7e 01 00 00       	jmp    80105d74 <create+0x1be>
  ilock(dp);
80105bf6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bf9:	89 04 24             	mov    %eax,(%esp)
80105bfc:	e8 68 bc ff ff       	call   80101869 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105c01:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105c04:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c08:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c0b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c12:	89 04 24             	mov    %eax,(%esp)
80105c15:	e8 71 c4 ff ff       	call   8010208b <dirlookup>
80105c1a:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c1d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c21:	74 47                	je     80105c6a <create+0xb4>
    iunlockput(dp);
80105c23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c26:	89 04 24             	mov    %eax,(%esp)
80105c29:	e8 bf be ff ff       	call   80101aed <iunlockput>
    ilock(ip);
80105c2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c31:	89 04 24             	mov    %eax,(%esp)
80105c34:	e8 30 bc ff ff       	call   80101869 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c39:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c3e:	75 15                	jne    80105c55 <create+0x9f>
80105c40:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c43:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c47:	66 83 f8 02          	cmp    $0x2,%ax
80105c4b:	75 08                	jne    80105c55 <create+0x9f>
      return ip;
80105c4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c50:	e9 1f 01 00 00       	jmp    80105d74 <create+0x1be>
    iunlockput(ip);
80105c55:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c58:	89 04 24             	mov    %eax,(%esp)
80105c5b:	e8 8d be ff ff       	call   80101aed <iunlockput>
    return 0;
80105c60:	b8 00 00 00 00       	mov    $0x0,%eax
80105c65:	e9 0a 01 00 00       	jmp    80105d74 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105c6a:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105c6e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c71:	8b 00                	mov    (%eax),%eax
80105c73:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c77:	89 04 24             	mov    %eax,(%esp)
80105c7a:	e8 4f b9 ff ff       	call   801015ce <ialloc>
80105c7f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c82:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c86:	75 0c                	jne    80105c94 <create+0xde>
    panic("create: ialloc");
80105c88:	c7 04 24 15 89 10 80 	movl   $0x80108915,(%esp)
80105c8f:	e8 a6 a8 ff ff       	call   8010053a <panic>

  ilock(ip);
80105c94:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c97:	89 04 24             	mov    %eax,(%esp)
80105c9a:	e8 ca bb ff ff       	call   80101869 <ilock>
  ip->major = major;
80105c9f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca2:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105ca6:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105caa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cad:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105cb1:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105cb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cb8:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105cbe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cc1:	89 04 24             	mov    %eax,(%esp)
80105cc4:	e8 e4 b9 ff ff       	call   801016ad <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105cc9:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105cce:	75 6a                	jne    80105d3a <create+0x184>
    dp->nlink++;  // for ".."
80105cd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd3:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105cd7:	8d 50 01             	lea    0x1(%eax),%edx
...
80105ce7:	e8 c1 b9 ff ff       	call   801016ad <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105cec:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cef:	8b 40 04             	mov    0x4(%eax),%eax
80105cf2:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cf6:	c7 44 24 04 ef 88 10 	movl   $0x801088ef,0x4(%esp)
80105cfd:	80 
80105cfe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d01:	89 04 24             	mov    %eax,(%esp)
80105d04:	e8 4b c4 ff ff       	call   80102154 <dirlink>
80105d09:	85 c0                	test   %eax,%eax
80105d0b:	78 21                	js     80105d2e <create+0x178>
80105d0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d10:	8b 40 04             	mov    0x4(%eax),%eax
80105d13:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d17:	c7 44 24 04 f1 88 10 	movl   $0x801088f1,0x4(%esp)
80105d1e:	80 
80105d1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d22:	89 04 24             	mov    %eax,(%esp)
80105d25:	e8 2a c4 ff ff       	call   80102154 <dirlink>
80105d2a:	85 c0                	test   %eax,%eax
80105d2c:	79 0c                	jns    80105d3a <create+0x184>
      panic("create dots");
80105d2e:	c7 04 24 24 89 10 80 	movl   $0x80108924,(%esp)
80105d35:	e8 00 a8 ff ff       	call   8010053a <panic>
  }
...
80105d51:	e8 fe c3 ff ff       	call   80102154 <dirlink>
80105d56:	85 c0                	test   %eax,%eax
80105d58:	79 0c                	jns    80105d66 <create+0x1b0>
    panic("create: dirlink");
80105d5a:	c7 04 24 30 89 10 80 	movl   $0x80108930,(%esp)
80105d61:	e8 d4 a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105d66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d69:	89 04 24             	mov    %eax,(%esp)
80105d6c:	e8 7c bd ff ff       	call   80101aed <iunlockput>
...
80105d8a:	e8 a3 f6 ff ff       	call   80105432 <argstr>
...
80105da1:	e8 f2 f5 ff ff       	call   80105398 <argint>
80105da6:	85 c0                	test   %eax,%eax
80105da8:	79 0a                	jns    80105db4 <sys_open+0x3e>
    return -1;
80105daa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105daf:	e9 48 01 00 00       	jmp    80105efc <sys_open+0x186>
  if(omode & O_CREATE){
80105db4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105db7:	25 00 02 00 00       	and    $0x200,%eax
80105dbc:	85 c0                	test   %eax,%eax
80105dbe:	74 40                	je     80105e00 <sys_open+0x8a>
    begin_trans();
80105dc0:	e8 2e d4 ff ff       	call   801031f3 <begin_trans>
...
80105de3:	e8 ce fd ff ff       	call   80105bb6 <create>
80105de8:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105deb:	e8 4c d4 ff ff       	call   8010323c <commit_trans>
    if(ip == 0)
80105df0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105df4:	75 5c                	jne    80105e52 <sys_open+0xdc>
      return -1;
80105df6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dfb:	e9 fc 00 00 00       	jmp    80105efc <sys_open+0x186>
  } else {
    if((ip = namei(path)) == 0)
80105e00:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e03:	89 04 24             	mov    %eax,(%esp)
80105e06:	e8 09 c6 ff ff       	call   80102414 <namei>
80105e0b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e0e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e12:	75 0a                	jne    80105e1e <sys_open+0xa8>
      return -1;
80105e14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e19:	e9 de 00 00 00       	jmp    80105efc <sys_open+0x186>
    ilock(ip);
80105e1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e21:	89 04 24             	mov    %eax,(%esp)
80105e24:	e8 40 ba ff ff       	call   80101869 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e2c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e30:	66 83 f8 01          	cmp    $0x1,%ax
80105e34:	75 1c                	jne    80105e52 <sys_open+0xdc>
80105e36:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e39:	85 c0                	test   %eax,%eax
80105e3b:	74 15                	je     80105e52 <sys_open+0xdc>
      iunlockput(ip);
80105e3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e40:	89 04 24             	mov    %eax,(%esp)
80105e43:	e8 a5 bc ff ff       	call   80101aed <iunlockput>
      return -1;
80105e48:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e4d:	e9 aa 00 00 00       	jmp    80105efc <sys_open+0x186>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105e52:	e8 dd b0 ff ff       	call   80100f34 <filealloc>
80105e57:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e5a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e5e:	74 14                	je     80105e74 <sys_open+0xfe>
80105e60:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e63:	89 04 24             	mov    %eax,(%esp)
80105e66:	e8 42 f7 ff ff       	call   801055ad <fdalloc>
80105e6b:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105e6e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105e72:	79 23                	jns    80105e97 <sys_open+0x121>
    if(f)
80105e74:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e78:	74 0b                	je     80105e85 <sys_open+0x10f>
      fileclose(f);
80105e7a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e7d:	89 04 24             	mov    %eax,(%esp)
80105e80:	e8 57 b1 ff ff       	call   80100fdc <fileclose>
    iunlockput(ip);
80105e85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e88:	89 04 24             	mov    %eax,(%esp)
80105e8b:	e8 5d bc ff ff       	call   80101aed <iunlockput>
    return -1;
80105e90:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e95:	eb 65                	jmp    80105efc <sys_open+0x186>
  }
  iunlock(ip);
80105e97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e9a:	89 04 24             	mov    %eax,(%esp)
80105e9d:	e8 15 bb ff ff       	call   801019b7 <iunlock>

  f->type = FD_INODE;
80105ea2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ea5:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105eab:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eae:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105eb1:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105eb4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eb7:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105ebe:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ec1:	83 e0 01             	and    $0x1,%eax
80105ec4:	85 c0                	test   %eax,%eax
80105ec6:	0f 94 c0             	sete   %al
80105ec9:	89 c2                	mov    %eax,%edx
80105ecb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ece:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105ed1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ed4:	83 e0 01             	and    $0x1,%eax
80105ed7:	85 c0                	test   %eax,%eax
80105ed9:	75 0a                	jne    80105ee5 <sys_open+0x16f>
80105edb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ede:	83 e0 02             	and    $0x2,%eax
80105ee1:	85 c0                	test   %eax,%eax
80105ee3:	74 07                	je     80105eec <sys_open+0x176>
80105ee5:	b8 01 00 00 00       	mov    $0x1,%eax
80105eea:	eb 05                	jmp    80105ef1 <sys_open+0x17b>
80105eec:	b8 00 00 00 00       	mov    $0x0,%eax
80105ef1:	89 c2                	mov    %eax,%edx
80105ef3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ef6:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105ef9:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105efc:	c9                   	leave  
80105efd:	c3                   	ret    
...
80105f01:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105f04:	e8 ea d2 ff ff       	call   801031f3 <begin_trans>
...
80105f17:	e8 16 f5 ff ff       	call   80105432 <argstr>
80105f1c:	85 c0                	test   %eax,%eax
80105f1e:	78 2c                	js     80105f4c <sys_mkdir+0x4e>
80105f20:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f23:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105f2a:	00 
80105f2b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105f32:	00 
80105f33:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105f3a:	00 
80105f3b:	89 04 24             	mov    %eax,(%esp)
80105f3e:	e8 73 fc ff ff       	call   80105bb6 <create>
80105f43:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f46:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f4a:	75 0c                	jne    80105f58 <sys_mkdir+0x5a>
    commit_trans();
80105f4c:	e8 eb d2 ff ff       	call   8010323c <commit_trans>
    return -1;
80105f51:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f56:	eb 15                	jmp    80105f6d <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105f58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f5b:	89 04 24             	mov    %eax,(%esp)
80105f5e:	e8 8a bb ff ff       	call   80101aed <iunlockput>
  commit_trans();
80105f63:	e8 d4 d2 ff ff       	call   8010323c <commit_trans>
  return 0;
...
80105f72:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
80105f75:	e8 79 d2 ff ff       	call   801031f3 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80105f7a:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105f7d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f81:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f88:	e8 a5 f4 ff ff       	call   80105432 <argstr>
80105f8d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f90:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f94:	78 5e                	js     80105ff4 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80105f96:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105f99:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fa4:	e8 ef f3 ff ff       	call   80105398 <argint>
  char *path;
  int len;
  int major, minor;
...
80105fc2:	78 30                	js     80105ff4 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105fc4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fc7:	0f bf c8             	movswl %ax,%ecx
80105fca:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105fcd:	0f bf d0             	movswl %ax,%edx
80105fd0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105fd3:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105fd7:	89 54 24 08          	mov    %edx,0x8(%esp)
80105fdb:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105fe2:	00 
80105fe3:	89 04 24             	mov    %eax,(%esp)
80105fe6:	e8 cb fb ff ff       	call   80105bb6 <create>
80105feb:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ff2:	75 0c                	jne    80106000 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80105ff4:	e8 43 d2 ff ff       	call   8010323c <commit_trans>
    return -1;
80105ff9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ffe:	eb 15                	jmp    80106015 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106000:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106003:	89 04 24             	mov    %eax,(%esp)
80106006:	e8 e2 ba ff ff       	call   80101aed <iunlockput>
  commit_trans();
8010600b:	e8 2c d2 ff ff       	call   8010323c <commit_trans>
  return 0;
...
801060ab:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
801060bf:	e8 6e f3 ff ff       	call   80105432 <argstr>
801060c4:	85 c0                	test   %eax,%eax
801060c6:	78 1a                	js     801060e2 <sys_exec+0x3a>
801060c8:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801060ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801060d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060d9:	e8 ba f2 ff ff       	call   80105398 <argint>
801060de:	85 c0                	test   %eax,%eax
801060e0:	79 0a                	jns    801060ec <sys_exec+0x44>
    return -1;
801060e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060e7:	e9 de 00 00 00       	jmp    801061ca <sys_exec+0x122>
  }
  memset(argv, 0, sizeof(argv));
801060ec:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801060f3:	00 
801060f4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801060fb:	00 
801060fc:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106102:	89 04 24             	mov    %eax,(%esp)
80106105:	e8 58 ef ff ff       	call   80105062 <memset>
  for(i=0;; i++){
8010610a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106111:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106114:	83 f8 1f             	cmp    $0x1f,%eax
80106117:	76 0a                	jbe    80106123 <sys_exec+0x7b>
      return -1;
80106119:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010611e:	e9 a7 00 00 00       	jmp    801061ca <sys_exec+0x122>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
80106123:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106126:	c1 e0 02             	shl    $0x2,%eax
80106129:	89 c2                	mov    %eax,%edx
8010612b:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106131:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80106134:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010613a:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
80106140:	89 54 24 08          	mov    %edx,0x8(%esp)
80106144:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106148:	89 04 24             	mov    %eax,(%esp)
8010614b:	e8 b8 f1 ff ff       	call   80105308 <fetchint>
80106150:	85 c0                	test   %eax,%eax
80106152:	79 07                	jns    8010615b <sys_exec+0xb3>
      return -1;
80106154:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106159:	eb 6f                	jmp    801061ca <sys_exec+0x122>
    if(uarg == 0){
8010615b:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106161:	85 c0                	test   %eax,%eax
80106163:	75 26                	jne    8010618b <sys_exec+0xe3>
      argv[i] = 0;
80106165:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106168:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010616f:	00 00 00 00 
      break;
80106173:	90                   	nop
    }
...
80106177:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010617d:	89 54 24 04          	mov    %edx,0x4(%esp)
80106181:	89 04 24             	mov    %eax,(%esp)
80106184:	e8 66 a9 ff ff       	call   80100aef <exec>
80106189:	eb 3f                	jmp    801061ca <sys_exec+0x122>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(proc, uarg, &argv[i]) < 0)
8010618b:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106191:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106194:	c1 e2 02             	shl    $0x2,%edx
80106197:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
8010619a:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
801061a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801061a6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801061aa:	89 54 24 04          	mov    %edx,0x4(%esp)
801061ae:	89 04 24             	mov    %eax,(%esp)
801061b1:	e8 86 f1 ff ff       	call   8010533c <fetchstr>
801061b6:	85 c0                	test   %eax,%eax
801061b8:	79 07                	jns    801061c1 <sys_exec+0x119>
      return -1;
801061ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061bf:	eb 09                	jmp    801061ca <sys_exec+0x122>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801061c1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
801061c5:	e9 47 ff ff ff       	jmp    80106111 <sys_exec+0x69>
  return exec(path, argv);
}
801061ca:	c9                   	leave  
801061cb:	c3                   	ret    
...
801061cf:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801061d2:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801061d9:	00 
801061da:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061dd:	89 44 24 04          	mov    %eax,0x4(%esp)
801061e1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061e8:	e8 e3 f1 ff ff       	call   801053d0 <argptr>
801061ed:	85 c0                	test   %eax,%eax
801061ef:	79 0a                	jns    801061fb <sys_pipe+0x2f>
    return -1;
801061f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061f6:	e9 9b 00 00 00       	jmp    80106296 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801061fb:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801061fe:	89 44 24 04          	mov    %eax,0x4(%esp)
80106202:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106205:	89 04 24             	mov    %eax,(%esp)
80106208:	e8 e0 d9 ff ff       	call   80103bed <pipealloc>
8010620d:	85 c0                	test   %eax,%eax
8010620f:	79 07                	jns    80106218 <sys_pipe+0x4c>
    return -1;
80106211:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106216:	eb 7e                	jmp    80106296 <sys_pipe+0xca>
  fd0 = -1;
80106218:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010621f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106222:	89 04 24             	mov    %eax,(%esp)
80106225:	e8 83 f3 ff ff       	call   801055ad <fdalloc>
8010622a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010622d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106231:	78 14                	js     80106247 <sys_pipe+0x7b>
80106233:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106236:	89 04 24             	mov    %eax,(%esp)
80106239:	e8 6f f3 ff ff       	call   801055ad <fdalloc>
8010623e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106241:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106245:	79 37                	jns    8010627e <sys_pipe+0xb2>
    if(fd0 >= 0)
80106247:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010624b:	78 14                	js     80106261 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010624d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106253:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106256:	83 c2 08             	add    $0x8,%edx
80106259:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106260:	00 
    fileclose(rf);
80106261:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106264:	89 04 24             	mov    %eax,(%esp)
80106267:	e8 70 ad ff ff       	call   80100fdc <fileclose>
    fileclose(wf);
8010626c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010626f:	89 04 24             	mov    %eax,(%esp)
80106272:	e8 65 ad ff ff       	call   80100fdc <fileclose>
    return -1;
80106277:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010627c:	eb 18                	jmp    80106296 <sys_pipe+0xca>
  }
  fd[0] = fd0;
...
8010629b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010629e:	e8 fc df ff ff       	call   8010429f <fork>
}
801062a3:	c9                   	leave  
801062a4:	c3                   	ret    
...
801062a8:	83 ec 08             	sub    $0x8,%esp
  exit();
801062ab:	e8 52 e1 ff ff       	call   80104402 <exit>
...
801062ba:	83 ec 08             	sub    $0x8,%esp
  return wait();
801062bd:	e8 58 e2 ff ff       	call   8010451a <wait>
}
801062c2:	c9                   	leave  
801062c3:	c3                   	ret    
...
801062d8:	e8 bb f0 ff ff       	call   80105398 <argint>
801062dd:	85 c0                	test   %eax,%eax
801062df:	79 07                	jns    801062e8 <sys_kill+0x24>
    return -1;
801062e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e6:	eb 0b                	jmp    801062f3 <sys_kill+0x2f>
  return kill(pid);
801062e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062eb:	89 04 24             	mov    %eax,(%esp)
801062ee:	e8 85 e6 ff ff       	call   80104978 <kill>
}
801062f3:	c9                   	leave  
801062f4:	c3                   	ret    
...
80106317:	e8 7c f0 ff ff       	call   80105398 <argint>
8010631c:	85 c0                	test   %eax,%eax
8010631e:	79 07                	jns    80106327 <sys_sbrk+0x24>
    return -1;
80106320:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106325:	eb 24                	jmp    8010634b <sys_sbrk+0x48>
  addr = proc->sz;
...
80106338:	e8 bd de ff ff       	call   801041fa <growproc>
8010633d:	85 c0                	test   %eax,%eax
8010633f:	79 07                	jns    80106348 <sys_sbrk+0x45>
    return -1;
80106341:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106346:	eb 03                	jmp    8010634b <sys_sbrk+0x48>
  return addr;
...
80106361:	e8 32 f0 ff ff       	call   80105398 <argint>
80106366:	85 c0                	test   %eax,%eax
80106368:	79 07                	jns    80106371 <sys_sleep+0x24>
    return -1;
8010636a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010636f:	eb 6c                	jmp    801063dd <sys_sleep+0x90>
  acquire(&tickslock);
80106371:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106378:	e8 91 ea ff ff       	call   80104e0e <acquire>
  ticks0 = ticks;
8010637d:	a1 a0 26 11 80       	mov    0x801126a0,%eax
80106382:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106385:	eb 34                	jmp    801063bb <sys_sleep+0x6e>
    if(proc->killed){
80106387:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010638d:	8b 40 24             	mov    0x24(%eax),%eax
80106390:	85 c0                	test   %eax,%eax
80106392:	74 13                	je     801063a7 <sys_sleep+0x5a>
      release(&tickslock);
80106394:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
8010639b:	e8 d0 ea ff ff       	call   80104e70 <release>
      return -1;
801063a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063a5:	eb 36                	jmp    801063dd <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801063a7:	c7 44 24 04 60 1e 11 	movl   $0x80111e60,0x4(%esp)
801063ae:	80 
801063af:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
801063b6:	e8 b9 e4 ff ff       	call   80104874 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801063bb:	a1 a0 26 11 80       	mov    0x801126a0,%eax
801063c0:	2b 45 f4             	sub    -0xc(%ebp),%eax
801063c3:	89 c2                	mov    %eax,%edx
801063c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063c8:	39 c2                	cmp    %eax,%edx
801063ca:	72 bb                	jb     80106387 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801063cc:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
801063d3:	e8 98 ea ff ff       	call   80104e70 <release>
  return 0;
...
801063e2:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
801063e5:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
801063ec:	e8 1d ea ff ff       	call   80104e0e <acquire>
  xticks = ticks;
801063f1:	a1 a0 26 11 80       	mov    0x801126a0,%eax
801063f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063f9:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106400:	e8 6b ea ff ff       	call   80104e70 <release>
  return xticks;
...
80106410:	8b 55 08             	mov    0x8(%ebp),%edx
80106413:	8b 45 0c             	mov    0xc(%ebp),%eax
80106416:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010641a:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010641d:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106421:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106425:	ee                   	out    %al,(%dx)
}
80106426:	c9                   	leave  
80106427:	c3                   	ret    
...
8010642e:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106435:	00 
80106436:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010643d:	e8 c8 ff ff ff       	call   8010640a <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106442:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106449:	00 
8010644a:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106451:	e8 b4 ff ff ff       	call   8010640a <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106456:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
8010645d:	00 
8010645e:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106465:	e8 a0 ff ff ff       	call   8010640a <outb>
  picenable(IRQ_TIMER);
8010646a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106471:	e8 0a d6 ff ff       	call   80103a80 <picenable>
}
80106476:	c9                   	leave  
80106477:	c3                   	ret    
...
80106479:	06                   	push   %es
  pushl %fs
8010647a:	0f a0                	push   %fs
  pushl %gs
8010647c:	0f a8                	push   %gs
  pushal
8010647e:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
8010647f:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106483:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106485:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106487:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
8010648b:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
8010648d:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
8010648f:	54                   	push   %esp
  call trap
80106490:	e8 d8 01 00 00       	call   8010666d <trap>
  addl $4, %esp
80106495:	83 c4 04             	add    $0x4,%esp
...
80106498:	61                   	popa   
  popl %gs
80106499:	0f a9                	pop    %gs
  popl %fs
8010649b:	0f a1                	pop    %fs
  popl %es
8010649d:	07                   	pop    %es
  popl %ds
8010649e:	1f                   	pop    %ds
...
801064a6:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801064a9:	8b 45 0c             	mov    0xc(%ebp),%eax
801064ac:	83 e8 01             	sub    $0x1,%eax
801064af:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801064b3:	8b 45 08             	mov    0x8(%ebp),%eax
801064b6:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801064ba:	8b 45 08             	mov    0x8(%ebp),%eax
801064bd:	c1 e8 10             	shr    $0x10,%eax
801064c0:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
801064c4:	8d 45 fa             	lea    -0x6(%ebp),%eax
801064c7:	0f 01 18             	lidtl  (%eax)
}
801064ca:	c9                   	leave  
801064cb:	c3                   	ret    
...
801064cf:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
801064d2:	0f 20 d0             	mov    %cr2,%eax
801064d5:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
801064d8:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801064db:	c9                   	leave  
801064dc:	c3                   	ret    
...
801064e0:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
801064e3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801064ea:	e9 c3 00 00 00       	jmp    801065b2 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801064ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f2:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
801064f9:	89 c2                	mov    %eax,%edx
801064fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064fe:	66 89 14 c5 a0 1e 11 	mov    %dx,-0x7feee160(,%eax,8)
80106505:	80 
80106506:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106509:	66 c7 04 c5 a2 1e 11 	movw   $0x8,-0x7feee15e(,%eax,8)
80106510:	80 08 00 
80106513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106516:	0f b6 14 c5 a4 1e 11 	movzbl -0x7feee15c(,%eax,8),%edx
8010651d:	80 
8010651e:	83 e2 e0             	and    $0xffffffe0,%edx
80106521:	88 14 c5 a4 1e 11 80 	mov    %dl,-0x7feee15c(,%eax,8)
80106528:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010652b:	0f b6 14 c5 a4 1e 11 	movzbl -0x7feee15c(,%eax,8),%edx
80106532:	80 
80106533:	83 e2 1f             	and    $0x1f,%edx
80106536:	88 14 c5 a4 1e 11 80 	mov    %dl,-0x7feee15c(,%eax,8)
8010653d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106540:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
80106547:	80 
80106548:	83 e2 f0             	and    $0xfffffff0,%edx
8010654b:	83 ca 0e             	or     $0xe,%edx
8010654e:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
80106555:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106558:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
8010655f:	80 
80106560:	83 e2 ef             	and    $0xffffffef,%edx
80106563:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
8010656a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010656d:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
80106574:	80 
80106575:	83 e2 9f             	and    $0xffffff9f,%edx
80106578:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
8010657f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106582:	0f b6 14 c5 a5 1e 11 	movzbl -0x7feee15b(,%eax,8),%edx
80106589:	80 
8010658a:	83 ca 80             	or     $0xffffff80,%edx
8010658d:	88 14 c5 a5 1e 11 80 	mov    %dl,-0x7feee15b(,%eax,8)
80106594:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106597:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
8010659e:	c1 e8 10             	shr    $0x10,%eax
801065a1:	89 c2                	mov    %eax,%edx
801065a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065a6:	66 89 14 c5 a6 1e 11 	mov    %dx,-0x7feee15a(,%eax,8)
801065ad:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801065ae:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801065b2:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
801065b9:	0f 8e 30 ff ff ff    	jle    801064ef <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801065bf:	a1 98 b1 10 80       	mov    0x8010b198,%eax
801065c4:	66 a3 a0 20 11 80    	mov    %ax,0x801120a0
801065ca:	66 c7 05 a2 20 11 80 	movw   $0x8,0x801120a2
801065d1:	08 00 
801065d3:	0f b6 05 a4 20 11 80 	movzbl 0x801120a4,%eax
801065da:	83 e0 e0             	and    $0xffffffe0,%eax
801065dd:	a2 a4 20 11 80       	mov    %al,0x801120a4
801065e2:	0f b6 05 a4 20 11 80 	movzbl 0x801120a4,%eax
801065e9:	83 e0 1f             	and    $0x1f,%eax
801065ec:	a2 a4 20 11 80       	mov    %al,0x801120a4
801065f1:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
801065f8:	83 c8 0f             	or     $0xf,%eax
801065fb:	a2 a5 20 11 80       	mov    %al,0x801120a5
80106600:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
80106607:	83 e0 ef             	and    $0xffffffef,%eax
8010660a:	a2 a5 20 11 80       	mov    %al,0x801120a5
8010660f:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
80106616:	83 c8 60             	or     $0x60,%eax
80106619:	a2 a5 20 11 80       	mov    %al,0x801120a5
8010661e:	0f b6 05 a5 20 11 80 	movzbl 0x801120a5,%eax
80106625:	83 c8 80             	or     $0xffffff80,%eax
80106628:	a2 a5 20 11 80       	mov    %al,0x801120a5
8010662d:	a1 98 b1 10 80       	mov    0x8010b198,%eax
80106632:	c1 e8 10             	shr    $0x10,%eax
80106635:	66 a3 a6 20 11 80    	mov    %ax,0x801120a6
  
  initlock(&tickslock, "time");
8010663b:	c7 44 24 04 40 89 10 	movl   $0x80108940,0x4(%esp)
80106642:	80 
80106643:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
8010664a:	e8 9e e7 ff ff       	call   80104ded <initlock>
}
8010664f:	c9                   	leave  
80106650:	c3                   	ret    
...
80106654:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106657:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
8010665e:	00 
8010665f:	c7 04 24 a0 1e 11 80 	movl   $0x80111ea0,(%esp)
80106666:	e8 38 fe ff ff       	call   801064a3 <lidt>
}
8010666b:	c9                   	leave  
8010666c:	c3                   	ret    
...
80106673:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106676:	8b 45 08             	mov    0x8(%ebp),%eax
80106679:	8b 40 30             	mov    0x30(%eax),%eax
8010667c:	83 f8 40             	cmp    $0x40,%eax
8010667f:	75 3f                	jne    801066c0 <trap+0x53>
    if(proc->killed)
80106681:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106687:	8b 40 24             	mov    0x24(%eax),%eax
8010668a:	85 c0                	test   %eax,%eax
8010668c:	74 05                	je     80106693 <trap+0x26>
      exit();
8010668e:	e8 6f dd ff ff       	call   80104402 <exit>
    proc->tf = tf;
80106693:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106699:	8b 55 08             	mov    0x8(%ebp),%edx
8010669c:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010669f:	e8 d1 ed ff ff       	call   80105475 <syscall>
    if(proc->killed)
801066a4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066aa:	8b 40 24             	mov    0x24(%eax),%eax
801066ad:	85 c0                	test   %eax,%eax
801066af:	74 0a                	je     801066bb <trap+0x4e>
      exit();
801066b1:	e8 4c dd ff ff       	call   80104402 <exit>
    return;
801066b6:	e9 2d 02 00 00       	jmp    801068e8 <trap+0x27b>
801066bb:	e9 28 02 00 00       	jmp    801068e8 <trap+0x27b>
  }

  switch(tf->trapno){
801066c0:	8b 45 08             	mov    0x8(%ebp),%eax
801066c3:	8b 40 30             	mov    0x30(%eax),%eax
801066c6:	83 e8 20             	sub    $0x20,%eax
801066c9:	83 f8 1f             	cmp    $0x1f,%eax
801066cc:	0f 87 bc 00 00 00    	ja     8010678e <trap+0x121>
801066d2:	8b 04 85 e8 89 10 80 	mov    -0x7fef7618(,%eax,4),%eax
801066d9:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
801066db:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801066e1:	0f b6 00             	movzbl (%eax),%eax
801066e4:	84 c0                	test   %al,%al
801066e6:	75 31                	jne    80106719 <trap+0xac>
      acquire(&tickslock);
801066e8:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
801066ef:	e8 1a e7 ff ff       	call   80104e0e <acquire>
      ticks++;
801066f4:	a1 a0 26 11 80       	mov    0x801126a0,%eax
801066f9:	83 c0 01             	add    $0x1,%eax
801066fc:	a3 a0 26 11 80       	mov    %eax,0x801126a0
      wakeup(&ticks);
80106701:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80106708:	e8 40 e2 ff ff       	call   8010494d <wakeup>
      release(&tickslock);
8010670d:	c7 04 24 60 1e 11 80 	movl   $0x80111e60,(%esp)
80106714:	e8 57 e7 ff ff       	call   80104e70 <release>
    }
    lapiceoi();
80106719:	e8 a3 c7 ff ff       	call   80102ec1 <lapiceoi>
    break;
8010671e:	e9 41 01 00 00       	jmp    80106864 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106723:	e8 c4 bf ff ff       	call   801026ec <ideintr>
    lapiceoi();
80106728:	e8 94 c7 ff ff       	call   80102ec1 <lapiceoi>
    break;
8010672d:	e9 32 01 00 00       	jmp    80106864 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106732:	e8 76 c5 ff ff       	call   80102cad <kbdintr>
    lapiceoi();
80106737:	e8 85 c7 ff ff       	call   80102ec1 <lapiceoi>
    break;
8010673c:	e9 23 01 00 00       	jmp    80106864 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106741:	e8 97 03 00 00       	call   80106add <uartintr>
    lapiceoi();
80106746:	e8 76 c7 ff ff       	call   80102ec1 <lapiceoi>
    break;
8010674b:	e9 14 01 00 00       	jmp    80106864 <trap+0x1f7>
  case T_IRQ0 + 7:
...
8010676c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106770:	89 54 24 08          	mov    %edx,0x8(%esp)
80106774:	89 44 24 04          	mov    %eax,0x4(%esp)
80106778:	c7 04 24 48 89 10 80 	movl   $0x80108948,(%esp)
8010677f:	e8 1c 9c ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106784:	e8 38 c7 ff ff       	call   80102ec1 <lapiceoi>
    break;
80106789:	e9 d6 00 00 00       	jmp    80106864 <trap+0x1f7>
...
80106796:	74 11                	je     801067a9 <trap+0x13c>
80106798:	8b 45 08             	mov    0x8(%ebp),%eax
8010679b:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010679f:	0f b7 c0             	movzwl %ax,%eax
801067a2:	83 e0 03             	and    $0x3,%eax
801067a5:	85 c0                	test   %eax,%eax
801067a7:	75 46                	jne    801067ef <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801067a9:	e8 1e fd ff ff       	call   801064cc <rcr2>
801067ae:	8b 55 08             	mov    0x8(%ebp),%edx
801067b1:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
801067b4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801067bb:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801067be:	0f b6 ca             	movzbl %dl,%ecx
801067c1:	8b 55 08             	mov    0x8(%ebp),%edx
801067c4:	8b 52 30             	mov    0x30(%edx),%edx
801067c7:	89 44 24 10          	mov    %eax,0x10(%esp)
801067cb:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801067cf:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801067d3:	89 54 24 04          	mov    %edx,0x4(%esp)
801067d7:	c7 04 24 6c 89 10 80 	movl   $0x8010896c,(%esp)
801067de:	e8 bd 9b ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801067e3:	c7 04 24 9e 89 10 80 	movl   $0x8010899e,(%esp)
801067ea:	e8 4b 9d ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067ef:	e8 d8 fc ff ff       	call   801064cc <rcr2>
801067f4:	89 c2                	mov    %eax,%edx
801067f6:	8b 45 08             	mov    0x8(%ebp),%eax
801067f9:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801067fc:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106802:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106805:	0f b6 f0             	movzbl %al,%esi
80106808:	8b 45 08             	mov    0x8(%ebp),%eax
8010680b:	8b 58 34             	mov    0x34(%eax),%ebx
8010680e:	8b 45 08             	mov    0x8(%ebp),%eax
80106811:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106814:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010681a:	83 c0 6c             	add    $0x6c,%eax
8010681d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106820:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106826:	8b 40 10             	mov    0x10(%eax),%eax
80106829:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010682d:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106831:	89 74 24 14          	mov    %esi,0x14(%esp)
80106835:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106839:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010683d:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106840:	89 74 24 08          	mov    %esi,0x8(%esp)
80106844:	89 44 24 04          	mov    %eax,0x4(%esp)
80106848:	c7 04 24 a4 89 10 80 	movl   $0x801089a4,(%esp)
8010684f:	e8 4c 9b ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106854:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010685a:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106861:	eb 01                	jmp    80106864 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
8010686c:	74 24                	je     80106892 <trap+0x225>
8010686e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106874:	8b 40 24             	mov    0x24(%eax),%eax
80106877:	85 c0                	test   %eax,%eax
80106879:	74 17                	je     80106892 <trap+0x225>
8010687b:	8b 45 08             	mov    0x8(%ebp),%eax
8010687e:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106882:	0f b7 c0             	movzwl %ax,%eax
80106885:	83 e0 03             	and    $0x3,%eax
80106888:	83 f8 03             	cmp    $0x3,%eax
8010688b:	75 05                	jne    80106892 <trap+0x225>
    exit();
8010688d:	e8 70 db ff ff       	call   80104402 <exit>
...
8010689a:	74 1e                	je     801068ba <trap+0x24d>
8010689c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068a2:	8b 40 0c             	mov    0xc(%eax),%eax
801068a5:	83 f8 04             	cmp    $0x4,%eax
801068a8:	75 10                	jne    801068ba <trap+0x24d>
801068aa:	8b 45 08             	mov    0x8(%ebp),%eax
801068ad:	8b 40 30             	mov    0x30(%eax),%eax
801068b0:	83 f8 20             	cmp    $0x20,%eax
801068b3:	75 05                	jne    801068ba <trap+0x24d>
    yield();
801068b5:	e8 5c df ff ff       	call   80104816 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801068ba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068c0:	85 c0                	test   %eax,%eax
801068c2:	74 24                	je     801068e8 <trap+0x27b>
801068c4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068ca:	8b 40 24             	mov    0x24(%eax),%eax
801068cd:	85 c0                	test   %eax,%eax
801068cf:	74 17                	je     801068e8 <trap+0x27b>
801068d1:	8b 45 08             	mov    0x8(%ebp),%eax
801068d4:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801068d8:	0f b7 c0             	movzwl %ax,%eax
801068db:	83 e0 03             	and    $0x3,%eax
801068de:	83 f8 03             	cmp    $0x3,%eax
801068e1:	75 05                	jne    801068e8 <trap+0x27b>
    exit();
801068e3:	e8 1a db ff ff       	call   80104402 <exit>
}
801068e8:	83 c4 3c             	add    $0x3c,%esp
801068eb:	5b                   	pop    %ebx
801068ec:	5e                   	pop    %esi
801068ed:	5f                   	pop    %edi
801068ee:	5d                   	pop    %ebp
...
801068f3:	83 ec 14             	sub    $0x14,%esp
801068f6:	8b 45 08             	mov    0x8(%ebp),%eax
801068f9:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801068fd:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106901:	89 c2                	mov    %eax,%edx
80106903:	ec                   	in     (%dx),%al
80106904:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106907:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
8010690b:	c9                   	leave  
8010690c:	c3                   	ret    
...
80106913:	8b 55 08             	mov    0x8(%ebp),%edx
80106916:	8b 45 0c             	mov    0xc(%ebp),%eax
80106919:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010691d:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106920:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106924:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
8010692e:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106931:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106938:	00 
80106939:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106940:	e8 c8 ff ff ff       	call   8010690d <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106945:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
8010694c:	00 
8010694d:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106954:	e8 b4 ff ff ff       	call   8010690d <outb>
  outb(COM1+0, 115200/9600);
80106959:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106960:	00 
80106961:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106968:	e8 a0 ff ff ff       	call   8010690d <outb>
  outb(COM1+1, 0);
8010696d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106974:	00 
80106975:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010697c:	e8 8c ff ff ff       	call   8010690d <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106981:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106988:	00 
80106989:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106990:	e8 78 ff ff ff       	call   8010690d <outb>
  outb(COM1+4, 0);
80106995:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010699c:	00 
8010699d:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
801069a4:	e8 64 ff ff ff       	call   8010690d <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
801069a9:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801069b0:	00 
801069b1:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801069b8:	e8 50 ff ff ff       	call   8010690d <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801069bd:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069c4:	e8 27 ff ff ff       	call   801068f0 <inb>
801069c9:	3c ff                	cmp    $0xff,%al
801069cb:	75 02                	jne    801069cf <uartinit+0xa4>
    return;
801069cd:	eb 6a                	jmp    80106a39 <uartinit+0x10e>
  uart = 1;
801069cf:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
801069d6:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
801069d9:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801069e0:	e8 0b ff ff ff       	call   801068f0 <inb>
  inb(COM1+0);
801069e5:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069ec:	e8 ff fe ff ff       	call   801068f0 <inb>
  picenable(IRQ_COM1);
801069f1:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801069f8:	e8 83 d0 ff ff       	call   80103a80 <picenable>
  ioapicenable(IRQ_COM1, 0);
801069fd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106a04:	00 
80106a05:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106a0c:	e8 5a bf ff ff       	call   8010296b <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a11:	c7 45 f4 68 8a 10 80 	movl   $0x80108a68,-0xc(%ebp)
80106a18:	eb 15                	jmp    80106a2f <uartinit+0x104>
    uartputc(*p);
80106a1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a1d:	0f b6 00             	movzbl (%eax),%eax
80106a20:	0f be c0             	movsbl %al,%eax
80106a23:	89 04 24             	mov    %eax,(%esp)
80106a26:	e8 10 00 00 00       	call   80106a3b <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106a2b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106a2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a32:	0f b6 00             	movzbl (%eax),%eax
80106a35:	84 c0                	test   %al,%al
80106a37:	75 e1                	jne    80106a1a <uartinit+0xef>
    uartputc(*p);
}
80106a39:	c9                   	leave  
80106a3a:	c3                   	ret    
...
80106a3e:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106a41:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106a46:	85 c0                	test   %eax,%eax
80106a48:	75 02                	jne    80106a4c <uartputc+0x11>
    return;
80106a4a:	eb 4b                	jmp    80106a97 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106a4c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106a53:	eb 10                	jmp    80106a65 <uartputc+0x2a>
    microdelay(10);
80106a55:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106a5c:	e8 85 c4 ff ff       	call   80102ee6 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106a61:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106a65:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106a69:	7f 16                	jg     80106a81 <uartputc+0x46>
80106a6b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a72:	e8 79 fe ff ff       	call   801068f0 <inb>
80106a77:	0f b6 c0             	movzbl %al,%eax
80106a7a:	83 e0 20             	and    $0x20,%eax
80106a7d:	85 c0                	test   %eax,%eax
80106a7f:	74 d4                	je     80106a55 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106a81:	8b 45 08             	mov    0x8(%ebp),%eax
80106a84:	0f b6 c0             	movzbl %al,%eax
80106a87:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a8b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a92:	e8 76 fe ff ff       	call   8010690d <outb>
}
80106a97:	c9                   	leave  
80106a98:	c3                   	ret    
...
80106a9c:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106a9f:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106aa4:	85 c0                	test   %eax,%eax
80106aa6:	75 07                	jne    80106aaf <uartgetc+0x16>
    return -1;
80106aa8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106aad:	eb 2c                	jmp    80106adb <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106aaf:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106ab6:	e8 35 fe ff ff       	call   801068f0 <inb>
80106abb:	0f b6 c0             	movzbl %al,%eax
80106abe:	83 e0 01             	and    $0x1,%eax
80106ac1:	85 c0                	test   %eax,%eax
80106ac3:	75 07                	jne    80106acc <uartgetc+0x33>
    return -1;
80106ac5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106aca:	eb 0f                	jmp    80106adb <uartgetc+0x42>
  return inb(COM1+0);
80106acc:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106ad3:	e8 18 fe ff ff       	call   801068f0 <inb>
80106ad8:	0f b6 c0             	movzbl %al,%eax
}
80106adb:	c9                   	leave  
80106adc:	c3                   	ret    
...
80106ae3:	c7 04 24 99 6a 10 80 	movl   $0x80106a99,(%esp)
80106aea:	e8 be 9c ff ff       	call   801007ad <consoleintr>
}
80106aef:	c9                   	leave  
80106af0:	c3                   	ret    
...
80106af3:	6a 00                	push   $0x0
  jmp alltraps
80106af5:	e9 7e f9 ff ff       	jmp    80106478 <alltraps>
...
80106afa:	6a 00                	push   $0x0
  pushl $1
80106afc:	6a 01                	push   $0x1
  jmp alltraps
80106afe:	e9 75 f9 ff ff       	jmp    80106478 <alltraps>
...
80106b03:	6a 00                	push   $0x0
  pushl $2
80106b05:	6a 02                	push   $0x2
  jmp alltraps
80106b07:	e9 6c f9 ff ff       	jmp    80106478 <alltraps>
...
80106b0c:	6a 00                	push   $0x0
  pushl $3
80106b0e:	6a 03                	push   $0x3
  jmp alltraps
80106b10:	e9 63 f9 ff ff       	jmp    80106478 <alltraps>
...
80106b15:	6a 00                	push   $0x0
  pushl $4
80106b17:	6a 04                	push   $0x4
  jmp alltraps
80106b19:	e9 5a f9 ff ff       	jmp    80106478 <alltraps>
...
80106b1e:	6a 00                	push   $0x0
  pushl $5
80106b20:	6a 05                	push   $0x5
  jmp alltraps
80106b22:	e9 51 f9 ff ff       	jmp    80106478 <alltraps>
...
80106b29:	6a 06                	push   $0x6
  jmp alltraps
80106b2b:	e9 48 f9 ff ff       	jmp    80106478 <alltraps>
...
80106b30:	6a 00                	push   $0x0
  pushl $7
80106b32:	6a 07                	push   $0x7
  jmp alltraps
80106b34:	e9 3f f9 ff ff       	jmp    80106478 <alltraps>

80106b39 <vector8>:
.globl vector8
vector8:
  pushl $8
80106b39:	6a 08                	push   $0x8
  jmp alltraps
80106b3b:	e9 38 f9 ff ff       	jmp    80106478 <alltraps>
...
80106b40:	6a 00                	push   $0x0
  pushl $9
80106b42:	6a 09                	push   $0x9
  jmp alltraps
80106b44:	e9 2f f9 ff ff       	jmp    80106478 <alltraps>

80106b49 <vector10>:
.globl vector10
vector10:
  pushl $10
80106b49:	6a 0a                	push   $0xa
  jmp alltraps
80106b4b:	e9 28 f9 ff ff       	jmp    80106478 <alltraps>

80106b50 <vector11>:
.globl vector11
vector11:
  pushl $11
80106b50:	6a 0b                	push   $0xb
  jmp alltraps
80106b52:	e9 21 f9 ff ff       	jmp    80106478 <alltraps>

80106b57 <vector12>:
.globl vector12
vector12:
  pushl $12
80106b57:	6a 0c                	push   $0xc
  jmp alltraps
80106b59:	e9 1a f9 ff ff       	jmp    80106478 <alltraps>

80106b5e <vector13>:
.globl vector13
vector13:
  pushl $13
80106b5e:	6a 0d                	push   $0xd
  jmp alltraps
80106b60:	e9 13 f9 ff ff       	jmp    80106478 <alltraps>

80106b65 <vector14>:
.globl vector14
vector14:
  pushl $14
80106b65:	6a 0e                	push   $0xe
  jmp alltraps
80106b67:	e9 0c f9 ff ff       	jmp    80106478 <alltraps>
...
80106b6c:	6a 00                	push   $0x0
  pushl $15
80106b6e:	6a 0f                	push   $0xf
  jmp alltraps
80106b70:	e9 03 f9 ff ff       	jmp    80106478 <alltraps>
...
80106b77:	6a 10                	push   $0x10
  jmp alltraps
80106b79:	e9 fa f8 ff ff       	jmp    80106478 <alltraps>

80106b7e <vector17>:
.globl vector17
vector17:
  pushl $17
80106b7e:	6a 11                	push   $0x11
  jmp alltraps
80106b80:	e9 f3 f8 ff ff       	jmp    80106478 <alltraps>
...
80106b85:	6a 00                	push   $0x0
  pushl $18
80106b87:	6a 12                	push   $0x12
  jmp alltraps
80106b89:	e9 ea f8 ff ff       	jmp    80106478 <alltraps>
...
80106b8e:	6a 00                	push   $0x0
  pushl $19
80106b90:	6a 13                	push   $0x13
  jmp alltraps
80106b92:	e9 e1 f8 ff ff       	jmp    80106478 <alltraps>
...
80106b97:	6a 00                	push   $0x0
  pushl $20
80106b99:	6a 14                	push   $0x14
  jmp alltraps
80106b9b:	e9 d8 f8 ff ff       	jmp    80106478 <alltraps>
...
80106ba0:	6a 00                	push   $0x0
  pushl $21
80106ba2:	6a 15                	push   $0x15
  jmp alltraps
80106ba4:	e9 cf f8 ff ff       	jmp    80106478 <alltraps>
...
80106ba9:	6a 00                	push   $0x0
  pushl $22
80106bab:	6a 16                	push   $0x16
  jmp alltraps
80106bad:	e9 c6 f8 ff ff       	jmp    80106478 <alltraps>
...
80106bb2:	6a 00                	push   $0x0
  pushl $23
80106bb4:	6a 17                	push   $0x17
  jmp alltraps
80106bb6:	e9 bd f8 ff ff       	jmp    80106478 <alltraps>
...
80106bbb:	6a 00                	push   $0x0
  pushl $24
80106bbd:	6a 18                	push   $0x18
  jmp alltraps
80106bbf:	e9 b4 f8 ff ff       	jmp    80106478 <alltraps>
...
80106bc4:	6a 00                	push   $0x0
  pushl $25
80106bc6:	6a 19                	push   $0x19
  jmp alltraps
80106bc8:	e9 ab f8 ff ff       	jmp    80106478 <alltraps>
...
80106bcd:	6a 00                	push   $0x0
  pushl $26
80106bcf:	6a 1a                	push   $0x1a
  jmp alltraps
80106bd1:	e9 a2 f8 ff ff       	jmp    80106478 <alltraps>
...
80106bd6:	6a 00                	push   $0x0
  pushl $27
80106bd8:	6a 1b                	push   $0x1b
  jmp alltraps
80106bda:	e9 99 f8 ff ff       	jmp    80106478 <alltraps>
...
80106bdf:	6a 00                	push   $0x0
  pushl $28
80106be1:	6a 1c                	push   $0x1c
  jmp alltraps
80106be3:	e9 90 f8 ff ff       	jmp    80106478 <alltraps>
...
80106be8:	6a 00                	push   $0x0
  pushl $29
80106bea:	6a 1d                	push   $0x1d
  jmp alltraps
80106bec:	e9 87 f8 ff ff       	jmp    80106478 <alltraps>
...
80106bf1:	6a 00                	push   $0x0
  pushl $30
80106bf3:	6a 1e                	push   $0x1e
  jmp alltraps
80106bf5:	e9 7e f8 ff ff       	jmp    80106478 <alltraps>
...
80106bfa:	6a 00                	push   $0x0
  pushl $31
80106bfc:	6a 1f                	push   $0x1f
  jmp alltraps
80106bfe:	e9 75 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c03:	6a 00                	push   $0x0
  pushl $32
80106c05:	6a 20                	push   $0x20
  jmp alltraps
80106c07:	e9 6c f8 ff ff       	jmp    80106478 <alltraps>
...
80106c0c:	6a 00                	push   $0x0
  pushl $33
80106c0e:	6a 21                	push   $0x21
  jmp alltraps
80106c10:	e9 63 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c15:	6a 00                	push   $0x0
  pushl $34
80106c17:	6a 22                	push   $0x22
  jmp alltraps
80106c19:	e9 5a f8 ff ff       	jmp    80106478 <alltraps>
...
80106c1e:	6a 00                	push   $0x0
  pushl $35
80106c20:	6a 23                	push   $0x23
  jmp alltraps
80106c22:	e9 51 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c27:	6a 00                	push   $0x0
  pushl $36
80106c29:	6a 24                	push   $0x24
  jmp alltraps
80106c2b:	e9 48 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c30:	6a 00                	push   $0x0
  pushl $37
80106c32:	6a 25                	push   $0x25
  jmp alltraps
80106c34:	e9 3f f8 ff ff       	jmp    80106478 <alltraps>
...
80106c39:	6a 00                	push   $0x0
  pushl $38
80106c3b:	6a 26                	push   $0x26
  jmp alltraps
80106c3d:	e9 36 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c42:	6a 00                	push   $0x0
  pushl $39
80106c44:	6a 27                	push   $0x27
  jmp alltraps
80106c46:	e9 2d f8 ff ff       	jmp    80106478 <alltraps>
...
80106c4b:	6a 00                	push   $0x0
  pushl $40
80106c4d:	6a 28                	push   $0x28
  jmp alltraps
80106c4f:	e9 24 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c54:	6a 00                	push   $0x0
  pushl $41
80106c56:	6a 29                	push   $0x29
  jmp alltraps
80106c58:	e9 1b f8 ff ff       	jmp    80106478 <alltraps>
...
80106c5d:	6a 00                	push   $0x0
  pushl $42
80106c5f:	6a 2a                	push   $0x2a
  jmp alltraps
80106c61:	e9 12 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c66:	6a 00                	push   $0x0
  pushl $43
80106c68:	6a 2b                	push   $0x2b
  jmp alltraps
80106c6a:	e9 09 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c6f:	6a 00                	push   $0x0
  pushl $44
80106c71:	6a 2c                	push   $0x2c
  jmp alltraps
80106c73:	e9 00 f8 ff ff       	jmp    80106478 <alltraps>
...
80106c78:	6a 00                	push   $0x0
  pushl $45
80106c7a:	6a 2d                	push   $0x2d
  jmp alltraps
80106c7c:	e9 f7 f7 ff ff       	jmp    80106478 <alltraps>
...
80106c81:	6a 00                	push   $0x0
  pushl $46
80106c83:	6a 2e                	push   $0x2e
  jmp alltraps
80106c85:	e9 ee f7 ff ff       	jmp    80106478 <alltraps>
...
80106c8a:	6a 00                	push   $0x0
  pushl $47
80106c8c:	6a 2f                	push   $0x2f
  jmp alltraps
80106c8e:	e9 e5 f7 ff ff       	jmp    80106478 <alltraps>
...
80106c93:	6a 00                	push   $0x0
  pushl $48
80106c95:	6a 30                	push   $0x30
  jmp alltraps
80106c97:	e9 dc f7 ff ff       	jmp    80106478 <alltraps>
...
80106c9c:	6a 00                	push   $0x0
  pushl $49
80106c9e:	6a 31                	push   $0x31
  jmp alltraps
80106ca0:	e9 d3 f7 ff ff       	jmp    80106478 <alltraps>
...
80106ca5:	6a 00                	push   $0x0
  pushl $50
80106ca7:	6a 32                	push   $0x32
  jmp alltraps
80106ca9:	e9 ca f7 ff ff       	jmp    80106478 <alltraps>
...
80106cae:	6a 00                	push   $0x0
  pushl $51
80106cb0:	6a 33                	push   $0x33
  jmp alltraps
80106cb2:	e9 c1 f7 ff ff       	jmp    80106478 <alltraps>
...
80106cb7:	6a 00                	push   $0x0
  pushl $52
80106cb9:	6a 34                	push   $0x34
  jmp alltraps
80106cbb:	e9 b8 f7 ff ff       	jmp    80106478 <alltraps>
...
80106cc0:	6a 00                	push   $0x0
  pushl $53
80106cc2:	6a 35                	push   $0x35
  jmp alltraps
80106cc4:	e9 af f7 ff ff       	jmp    80106478 <alltraps>
...
80106cc9:	6a 00                	push   $0x0
  pushl $54
80106ccb:	6a 36                	push   $0x36
  jmp alltraps
80106ccd:	e9 a6 f7 ff ff       	jmp    80106478 <alltraps>
...
80106cd2:	6a 00                	push   $0x0
  pushl $55
80106cd4:	6a 37                	push   $0x37
  jmp alltraps
80106cd6:	e9 9d f7 ff ff       	jmp    80106478 <alltraps>
...
80106cdb:	6a 00                	push   $0x0
  pushl $56
80106cdd:	6a 38                	push   $0x38
  jmp alltraps
80106cdf:	e9 94 f7 ff ff       	jmp    80106478 <alltraps>
...
80106ce4:	6a 00                	push   $0x0
  pushl $57
80106ce6:	6a 39                	push   $0x39
  jmp alltraps
80106ce8:	e9 8b f7 ff ff       	jmp    80106478 <alltraps>
...
80106ced:	6a 00                	push   $0x0
  pushl $58
80106cef:	6a 3a                	push   $0x3a
  jmp alltraps
80106cf1:	e9 82 f7 ff ff       	jmp    80106478 <alltraps>
...
80106cf6:	6a 00                	push   $0x0
  pushl $59
80106cf8:	6a 3b                	push   $0x3b
  jmp alltraps
80106cfa:	e9 79 f7 ff ff       	jmp    80106478 <alltraps>
...
80106cff:	6a 00                	push   $0x0
  pushl $60
80106d01:	6a 3c                	push   $0x3c
  jmp alltraps
80106d03:	e9 70 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d08:	6a 00                	push   $0x0
  pushl $61
80106d0a:	6a 3d                	push   $0x3d
  jmp alltraps
80106d0c:	e9 67 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d11:	6a 00                	push   $0x0
  pushl $62
80106d13:	6a 3e                	push   $0x3e
  jmp alltraps
80106d15:	e9 5e f7 ff ff       	jmp    80106478 <alltraps>
...
80106d1a:	6a 00                	push   $0x0
  pushl $63
80106d1c:	6a 3f                	push   $0x3f
  jmp alltraps
80106d1e:	e9 55 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d23:	6a 00                	push   $0x0
  pushl $64
80106d25:	6a 40                	push   $0x40
  jmp alltraps
80106d27:	e9 4c f7 ff ff       	jmp    80106478 <alltraps>
...
80106d2c:	6a 00                	push   $0x0
  pushl $65
80106d2e:	6a 41                	push   $0x41
  jmp alltraps
80106d30:	e9 43 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d35:	6a 00                	push   $0x0
  pushl $66
80106d37:	6a 42                	push   $0x42
  jmp alltraps
80106d39:	e9 3a f7 ff ff       	jmp    80106478 <alltraps>
...
80106d3e:	6a 00                	push   $0x0
  pushl $67
80106d40:	6a 43                	push   $0x43
  jmp alltraps
80106d42:	e9 31 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d47:	6a 00                	push   $0x0
  pushl $68
80106d49:	6a 44                	push   $0x44
  jmp alltraps
80106d4b:	e9 28 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d50:	6a 00                	push   $0x0
  pushl $69
80106d52:	6a 45                	push   $0x45
  jmp alltraps
80106d54:	e9 1f f7 ff ff       	jmp    80106478 <alltraps>
...
80106d59:	6a 00                	push   $0x0
  pushl $70
80106d5b:	6a 46                	push   $0x46
  jmp alltraps
80106d5d:	e9 16 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d62:	6a 00                	push   $0x0
  pushl $71
80106d64:	6a 47                	push   $0x47
  jmp alltraps
80106d66:	e9 0d f7 ff ff       	jmp    80106478 <alltraps>
...
80106d6b:	6a 00                	push   $0x0
  pushl $72
80106d6d:	6a 48                	push   $0x48
  jmp alltraps
80106d6f:	e9 04 f7 ff ff       	jmp    80106478 <alltraps>
...
80106d74:	6a 00                	push   $0x0
  pushl $73
80106d76:	6a 49                	push   $0x49
  jmp alltraps
80106d78:	e9 fb f6 ff ff       	jmp    80106478 <alltraps>
...
80106d7d:	6a 00                	push   $0x0
  pushl $74
80106d7f:	6a 4a                	push   $0x4a
  jmp alltraps
80106d81:	e9 f2 f6 ff ff       	jmp    80106478 <alltraps>
...
80106d86:	6a 00                	push   $0x0
  pushl $75
80106d88:	6a 4b                	push   $0x4b
  jmp alltraps
80106d8a:	e9 e9 f6 ff ff       	jmp    80106478 <alltraps>
...
80106d8f:	6a 00                	push   $0x0
  pushl $76
80106d91:	6a 4c                	push   $0x4c
  jmp alltraps
80106d93:	e9 e0 f6 ff ff       	jmp    80106478 <alltraps>
...
80106d98:	6a 00                	push   $0x0
  pushl $77
80106d9a:	6a 4d                	push   $0x4d
  jmp alltraps
80106d9c:	e9 d7 f6 ff ff       	jmp    80106478 <alltraps>
...
80106da1:	6a 00                	push   $0x0
  pushl $78
80106da3:	6a 4e                	push   $0x4e
  jmp alltraps
80106da5:	e9 ce f6 ff ff       	jmp    80106478 <alltraps>
...
80106daa:	6a 00                	push   $0x0
  pushl $79
80106dac:	6a 4f                	push   $0x4f
  jmp alltraps
80106dae:	e9 c5 f6 ff ff       	jmp    80106478 <alltraps>
...
80106db3:	6a 00                	push   $0x0
  pushl $80
80106db5:	6a 50                	push   $0x50
  jmp alltraps
80106db7:	e9 bc f6 ff ff       	jmp    80106478 <alltraps>
...
80106dbc:	6a 00                	push   $0x0
  pushl $81
80106dbe:	6a 51                	push   $0x51
  jmp alltraps
80106dc0:	e9 b3 f6 ff ff       	jmp    80106478 <alltraps>
...
80106dc5:	6a 00                	push   $0x0
  pushl $82
80106dc7:	6a 52                	push   $0x52
  jmp alltraps
80106dc9:	e9 aa f6 ff ff       	jmp    80106478 <alltraps>
...
80106dce:	6a 00                	push   $0x0
  pushl $83
80106dd0:	6a 53                	push   $0x53
  jmp alltraps
80106dd2:	e9 a1 f6 ff ff       	jmp    80106478 <alltraps>
...
80106dd7:	6a 00                	push   $0x0
  pushl $84
80106dd9:	6a 54                	push   $0x54
  jmp alltraps
80106ddb:	e9 98 f6 ff ff       	jmp    80106478 <alltraps>
...
80106de0:	6a 00                	push   $0x0
  pushl $85
80106de2:	6a 55                	push   $0x55
  jmp alltraps
80106de4:	e9 8f f6 ff ff       	jmp    80106478 <alltraps>
...
80106de9:	6a 00                	push   $0x0
  pushl $86
80106deb:	6a 56                	push   $0x56
  jmp alltraps
80106ded:	e9 86 f6 ff ff       	jmp    80106478 <alltraps>
...
80106df2:	6a 00                	push   $0x0
  pushl $87
80106df4:	6a 57                	push   $0x57
  jmp alltraps
80106df6:	e9 7d f6 ff ff       	jmp    80106478 <alltraps>
...
80106dfb:	6a 00                	push   $0x0
  pushl $88
80106dfd:	6a 58                	push   $0x58
  jmp alltraps
80106dff:	e9 74 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e04:	6a 00                	push   $0x0
  pushl $89
80106e06:	6a 59                	push   $0x59
  jmp alltraps
80106e08:	e9 6b f6 ff ff       	jmp    80106478 <alltraps>
...
80106e0d:	6a 00                	push   $0x0
  pushl $90
80106e0f:	6a 5a                	push   $0x5a
  jmp alltraps
80106e11:	e9 62 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e16:	6a 00                	push   $0x0
  pushl $91
80106e18:	6a 5b                	push   $0x5b
  jmp alltraps
80106e1a:	e9 59 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e1f:	6a 00                	push   $0x0
  pushl $92
80106e21:	6a 5c                	push   $0x5c
  jmp alltraps
80106e23:	e9 50 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e28:	6a 00                	push   $0x0
  pushl $93
80106e2a:	6a 5d                	push   $0x5d
  jmp alltraps
80106e2c:	e9 47 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e31:	6a 00                	push   $0x0
  pushl $94
80106e33:	6a 5e                	push   $0x5e
  jmp alltraps
80106e35:	e9 3e f6 ff ff       	jmp    80106478 <alltraps>
...
80106e3a:	6a 00                	push   $0x0
  pushl $95
80106e3c:	6a 5f                	push   $0x5f
  jmp alltraps
80106e3e:	e9 35 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e43:	6a 00                	push   $0x0
  pushl $96
80106e45:	6a 60                	push   $0x60
  jmp alltraps
80106e47:	e9 2c f6 ff ff       	jmp    80106478 <alltraps>
...
80106e4c:	6a 00                	push   $0x0
  pushl $97
80106e4e:	6a 61                	push   $0x61
  jmp alltraps
80106e50:	e9 23 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e55:	6a 00                	push   $0x0
  pushl $98
80106e57:	6a 62                	push   $0x62
  jmp alltraps
80106e59:	e9 1a f6 ff ff       	jmp    80106478 <alltraps>
...
80106e5e:	6a 00                	push   $0x0
  pushl $99
80106e60:	6a 63                	push   $0x63
  jmp alltraps
80106e62:	e9 11 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e67:	6a 00                	push   $0x0
  pushl $100
80106e69:	6a 64                	push   $0x64
  jmp alltraps
80106e6b:	e9 08 f6 ff ff       	jmp    80106478 <alltraps>
...
80106e70:	6a 00                	push   $0x0
  pushl $101
80106e72:	6a 65                	push   $0x65
  jmp alltraps
80106e74:	e9 ff f5 ff ff       	jmp    80106478 <alltraps>
...
80106e79:	6a 00                	push   $0x0
  pushl $102
80106e7b:	6a 66                	push   $0x66
  jmp alltraps
80106e7d:	e9 f6 f5 ff ff       	jmp    80106478 <alltraps>
...
80106e82:	6a 00                	push   $0x0
  pushl $103
80106e84:	6a 67                	push   $0x67
  jmp alltraps
80106e86:	e9 ed f5 ff ff       	jmp    80106478 <alltraps>
...
80106e8b:	6a 00                	push   $0x0
  pushl $104
80106e8d:	6a 68                	push   $0x68
  jmp alltraps
80106e8f:	e9 e4 f5 ff ff       	jmp    80106478 <alltraps>
...
80106e94:	6a 00                	push   $0x0
  pushl $105
80106e96:	6a 69                	push   $0x69
  jmp alltraps
80106e98:	e9 db f5 ff ff       	jmp    80106478 <alltraps>
...
80106e9d:	6a 00                	push   $0x0
  pushl $106
80106e9f:	6a 6a                	push   $0x6a
  jmp alltraps
80106ea1:	e9 d2 f5 ff ff       	jmp    80106478 <alltraps>
...
80106ea6:	6a 00                	push   $0x0
  pushl $107
80106ea8:	6a 6b                	push   $0x6b
  jmp alltraps
80106eaa:	e9 c9 f5 ff ff       	jmp    80106478 <alltraps>
...
80106eaf:	6a 00                	push   $0x0
  pushl $108
80106eb1:	6a 6c                	push   $0x6c
  jmp alltraps
80106eb3:	e9 c0 f5 ff ff       	jmp    80106478 <alltraps>
...
80106eb8:	6a 00                	push   $0x0
  pushl $109
80106eba:	6a 6d                	push   $0x6d
  jmp alltraps
80106ebc:	e9 b7 f5 ff ff       	jmp    80106478 <alltraps>
...
80106ec1:	6a 00                	push   $0x0
  pushl $110
80106ec3:	6a 6e                	push   $0x6e
  jmp alltraps
80106ec5:	e9 ae f5 ff ff       	jmp    80106478 <alltraps>
...
80106eca:	6a 00                	push   $0x0
  pushl $111
80106ecc:	6a 6f                	push   $0x6f
  jmp alltraps
80106ece:	e9 a5 f5 ff ff       	jmp    80106478 <alltraps>
...
80106ed3:	6a 00                	push   $0x0
  pushl $112
80106ed5:	6a 70                	push   $0x70
  jmp alltraps
80106ed7:	e9 9c f5 ff ff       	jmp    80106478 <alltraps>
...
80106edc:	6a 00                	push   $0x0
  pushl $113
80106ede:	6a 71                	push   $0x71
  jmp alltraps
80106ee0:	e9 93 f5 ff ff       	jmp    80106478 <alltraps>
...
80106ee5:	6a 00                	push   $0x0
  pushl $114
80106ee7:	6a 72                	push   $0x72
  jmp alltraps
80106ee9:	e9 8a f5 ff ff       	jmp    80106478 <alltraps>
...
80106eee:	6a 00                	push   $0x0
  pushl $115
80106ef0:	6a 73                	push   $0x73
  jmp alltraps
80106ef2:	e9 81 f5 ff ff       	jmp    80106478 <alltraps>
...
80106ef7:	6a 00                	push   $0x0
  pushl $116
80106ef9:	6a 74                	push   $0x74
  jmp alltraps
80106efb:	e9 78 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f00:	6a 00                	push   $0x0
  pushl $117
80106f02:	6a 75                	push   $0x75
  jmp alltraps
80106f04:	e9 6f f5 ff ff       	jmp    80106478 <alltraps>
...
80106f09:	6a 00                	push   $0x0
  pushl $118
80106f0b:	6a 76                	push   $0x76
  jmp alltraps
80106f0d:	e9 66 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f12:	6a 00                	push   $0x0
  pushl $119
80106f14:	6a 77                	push   $0x77
  jmp alltraps
80106f16:	e9 5d f5 ff ff       	jmp    80106478 <alltraps>
...
80106f1b:	6a 00                	push   $0x0
  pushl $120
80106f1d:	6a 78                	push   $0x78
  jmp alltraps
80106f1f:	e9 54 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f24:	6a 00                	push   $0x0
  pushl $121
80106f26:	6a 79                	push   $0x79
  jmp alltraps
80106f28:	e9 4b f5 ff ff       	jmp    80106478 <alltraps>
...
80106f2d:	6a 00                	push   $0x0
  pushl $122
80106f2f:	6a 7a                	push   $0x7a
  jmp alltraps
80106f31:	e9 42 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f36:	6a 00                	push   $0x0
  pushl $123
80106f38:	6a 7b                	push   $0x7b
  jmp alltraps
80106f3a:	e9 39 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f3f:	6a 00                	push   $0x0
  pushl $124
80106f41:	6a 7c                	push   $0x7c
  jmp alltraps
80106f43:	e9 30 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f48:	6a 00                	push   $0x0
  pushl $125
80106f4a:	6a 7d                	push   $0x7d
  jmp alltraps
80106f4c:	e9 27 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f51:	6a 00                	push   $0x0
  pushl $126
80106f53:	6a 7e                	push   $0x7e
  jmp alltraps
80106f55:	e9 1e f5 ff ff       	jmp    80106478 <alltraps>
...
80106f5a:	6a 00                	push   $0x0
  pushl $127
80106f5c:	6a 7f                	push   $0x7f
  jmp alltraps
80106f5e:	e9 15 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f63:	6a 00                	push   $0x0
  pushl $128
80106f65:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106f6a:	e9 09 f5 ff ff       	jmp    80106478 <alltraps>
...
80106f6f:	6a 00                	push   $0x0
  pushl $129
80106f71:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106f76:	e9 fd f4 ff ff       	jmp    80106478 <alltraps>
...
80106f7b:	6a 00                	push   $0x0
  pushl $130
80106f7d:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106f82:	e9 f1 f4 ff ff       	jmp    80106478 <alltraps>
...
80106f87:	6a 00                	push   $0x0
  pushl $131
80106f89:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106f8e:	e9 e5 f4 ff ff       	jmp    80106478 <alltraps>
...
80106f93:	6a 00                	push   $0x0
  pushl $132
80106f95:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106f9a:	e9 d9 f4 ff ff       	jmp    80106478 <alltraps>
...
80106f9f:	6a 00                	push   $0x0
  pushl $133
80106fa1:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106fa6:	e9 cd f4 ff ff       	jmp    80106478 <alltraps>
...
80106fab:	6a 00                	push   $0x0
  pushl $134
80106fad:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106fb2:	e9 c1 f4 ff ff       	jmp    80106478 <alltraps>
...
80106fb7:	6a 00                	push   $0x0
  pushl $135
80106fb9:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106fbe:	e9 b5 f4 ff ff       	jmp    80106478 <alltraps>
...
80106fc3:	6a 00                	push   $0x0
  pushl $136
80106fc5:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106fca:	e9 a9 f4 ff ff       	jmp    80106478 <alltraps>
...
80106fcf:	6a 00                	push   $0x0
  pushl $137
80106fd1:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106fd6:	e9 9d f4 ff ff       	jmp    80106478 <alltraps>
...
80106fdb:	6a 00                	push   $0x0
  pushl $138
80106fdd:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106fe2:	e9 91 f4 ff ff       	jmp    80106478 <alltraps>
...
80106fe7:	6a 00                	push   $0x0
  pushl $139
80106fe9:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106fee:	e9 85 f4 ff ff       	jmp    80106478 <alltraps>
...
80106ff3:	6a 00                	push   $0x0
  pushl $140
80106ff5:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106ffa:	e9 79 f4 ff ff       	jmp    80106478 <alltraps>
...
80106fff:	6a 00                	push   $0x0
  pushl $141
80107001:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107006:	e9 6d f4 ff ff       	jmp    80106478 <alltraps>
...
8010700b:	6a 00                	push   $0x0
  pushl $142
8010700d:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107012:	e9 61 f4 ff ff       	jmp    80106478 <alltraps>
...
80107017:	6a 00                	push   $0x0
  pushl $143
80107019:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010701e:	e9 55 f4 ff ff       	jmp    80106478 <alltraps>
...
80107023:	6a 00                	push   $0x0
  pushl $144
80107025:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010702a:	e9 49 f4 ff ff       	jmp    80106478 <alltraps>
...
8010702f:	6a 00                	push   $0x0
  pushl $145
80107031:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107036:	e9 3d f4 ff ff       	jmp    80106478 <alltraps>
...
8010703b:	6a 00                	push   $0x0
  pushl $146
8010703d:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107042:	e9 31 f4 ff ff       	jmp    80106478 <alltraps>
...
80107047:	6a 00                	push   $0x0
  pushl $147
80107049:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010704e:	e9 25 f4 ff ff       	jmp    80106478 <alltraps>
...
80107053:	6a 00                	push   $0x0
  pushl $148
80107055:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010705a:	e9 19 f4 ff ff       	jmp    80106478 <alltraps>
...
8010705f:	6a 00                	push   $0x0
  pushl $149
80107061:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107066:	e9 0d f4 ff ff       	jmp    80106478 <alltraps>
...
8010706b:	6a 00                	push   $0x0
  pushl $150
8010706d:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107072:	e9 01 f4 ff ff       	jmp    80106478 <alltraps>
...
80107077:	6a 00                	push   $0x0
  pushl $151
80107079:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010707e:	e9 f5 f3 ff ff       	jmp    80106478 <alltraps>
...
80107083:	6a 00                	push   $0x0
  pushl $152
80107085:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010708a:	e9 e9 f3 ff ff       	jmp    80106478 <alltraps>
...
8010708f:	6a 00                	push   $0x0
  pushl $153
80107091:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107096:	e9 dd f3 ff ff       	jmp    80106478 <alltraps>
...
8010709b:	6a 00                	push   $0x0
  pushl $154
8010709d:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801070a2:	e9 d1 f3 ff ff       	jmp    80106478 <alltraps>
...
801070a7:	6a 00                	push   $0x0
  pushl $155
801070a9:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801070ae:	e9 c5 f3 ff ff       	jmp    80106478 <alltraps>
...
801070b3:	6a 00                	push   $0x0
  pushl $156
801070b5:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801070ba:	e9 b9 f3 ff ff       	jmp    80106478 <alltraps>
...
801070bf:	6a 00                	push   $0x0
  pushl $157
801070c1:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801070c6:	e9 ad f3 ff ff       	jmp    80106478 <alltraps>
...
801070cb:	6a 00                	push   $0x0
  pushl $158
801070cd:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801070d2:	e9 a1 f3 ff ff       	jmp    80106478 <alltraps>
...
801070d7:	6a 00                	push   $0x0
  pushl $159
801070d9:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801070de:	e9 95 f3 ff ff       	jmp    80106478 <alltraps>
...
801070e3:	6a 00                	push   $0x0
  pushl $160
801070e5:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801070ea:	e9 89 f3 ff ff       	jmp    80106478 <alltraps>
...
801070ef:	6a 00                	push   $0x0
  pushl $161
801070f1:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801070f6:	e9 7d f3 ff ff       	jmp    80106478 <alltraps>
...
801070fb:	6a 00                	push   $0x0
  pushl $162
801070fd:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107102:	e9 71 f3 ff ff       	jmp    80106478 <alltraps>
...
80107107:	6a 00                	push   $0x0
  pushl $163
80107109:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010710e:	e9 65 f3 ff ff       	jmp    80106478 <alltraps>
...
80107113:	6a 00                	push   $0x0
  pushl $164
80107115:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010711a:	e9 59 f3 ff ff       	jmp    80106478 <alltraps>
...
8010711f:	6a 00                	push   $0x0
  pushl $165
80107121:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107126:	e9 4d f3 ff ff       	jmp    80106478 <alltraps>
...
8010712b:	6a 00                	push   $0x0
  pushl $166
8010712d:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107132:	e9 41 f3 ff ff       	jmp    80106478 <alltraps>
...
80107137:	6a 00                	push   $0x0
  pushl $167
80107139:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010713e:	e9 35 f3 ff ff       	jmp    80106478 <alltraps>
...
80107143:	6a 00                	push   $0x0
  pushl $168
80107145:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010714a:	e9 29 f3 ff ff       	jmp    80106478 <alltraps>
...
8010714f:	6a 00                	push   $0x0
  pushl $169
80107151:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107156:	e9 1d f3 ff ff       	jmp    80106478 <alltraps>
...
8010715b:	6a 00                	push   $0x0
  pushl $170
8010715d:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107162:	e9 11 f3 ff ff       	jmp    80106478 <alltraps>
...
80107167:	6a 00                	push   $0x0
  pushl $171
80107169:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010716e:	e9 05 f3 ff ff       	jmp    80106478 <alltraps>
...
80107173:	6a 00                	push   $0x0
  pushl $172
80107175:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010717a:	e9 f9 f2 ff ff       	jmp    80106478 <alltraps>
...
8010717f:	6a 00                	push   $0x0
  pushl $173
80107181:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107186:	e9 ed f2 ff ff       	jmp    80106478 <alltraps>
...
8010718b:	6a 00                	push   $0x0
  pushl $174
8010718d:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107192:	e9 e1 f2 ff ff       	jmp    80106478 <alltraps>
...
80107197:	6a 00                	push   $0x0
  pushl $175
80107199:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010719e:	e9 d5 f2 ff ff       	jmp    80106478 <alltraps>
...
801071a3:	6a 00                	push   $0x0
  pushl $176
801071a5:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801071aa:	e9 c9 f2 ff ff       	jmp    80106478 <alltraps>
...
801071af:	6a 00                	push   $0x0
  pushl $177
801071b1:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801071b6:	e9 bd f2 ff ff       	jmp    80106478 <alltraps>
...
801071bb:	6a 00                	push   $0x0
  pushl $178
801071bd:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801071c2:	e9 b1 f2 ff ff       	jmp    80106478 <alltraps>
...
801071c7:	6a 00                	push   $0x0
  pushl $179
801071c9:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801071ce:	e9 a5 f2 ff ff       	jmp    80106478 <alltraps>
...
801071d3:	6a 00                	push   $0x0
  pushl $180
801071d5:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801071da:	e9 99 f2 ff ff       	jmp    80106478 <alltraps>
...
801071df:	6a 00                	push   $0x0
  pushl $181
801071e1:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801071e6:	e9 8d f2 ff ff       	jmp    80106478 <alltraps>
...
801071eb:	6a 00                	push   $0x0
  pushl $182
801071ed:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801071f2:	e9 81 f2 ff ff       	jmp    80106478 <alltraps>
...
801071f7:	6a 00                	push   $0x0
  pushl $183
801071f9:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801071fe:	e9 75 f2 ff ff       	jmp    80106478 <alltraps>
...
80107203:	6a 00                	push   $0x0
  pushl $184
80107205:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010720a:	e9 69 f2 ff ff       	jmp    80106478 <alltraps>
...
8010720f:	6a 00                	push   $0x0
  pushl $185
80107211:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107216:	e9 5d f2 ff ff       	jmp    80106478 <alltraps>
...
8010721b:	6a 00                	push   $0x0
  pushl $186
8010721d:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107222:	e9 51 f2 ff ff       	jmp    80106478 <alltraps>
...
80107227:	6a 00                	push   $0x0
  pushl $187
80107229:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010722e:	e9 45 f2 ff ff       	jmp    80106478 <alltraps>
...
80107233:	6a 00                	push   $0x0
  pushl $188
80107235:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010723a:	e9 39 f2 ff ff       	jmp    80106478 <alltraps>
...
8010723f:	6a 00                	push   $0x0
  pushl $189
80107241:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107246:	e9 2d f2 ff ff       	jmp    80106478 <alltraps>
...
8010724b:	6a 00                	push   $0x0
  pushl $190
8010724d:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107252:	e9 21 f2 ff ff       	jmp    80106478 <alltraps>
...
80107257:	6a 00                	push   $0x0
  pushl $191
80107259:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010725e:	e9 15 f2 ff ff       	jmp    80106478 <alltraps>
...
80107263:	6a 00                	push   $0x0
  pushl $192
80107265:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010726a:	e9 09 f2 ff ff       	jmp    80106478 <alltraps>
...
8010726f:	6a 00                	push   $0x0
  pushl $193
80107271:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107276:	e9 fd f1 ff ff       	jmp    80106478 <alltraps>
...
8010727b:	6a 00                	push   $0x0
  pushl $194
8010727d:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107282:	e9 f1 f1 ff ff       	jmp    80106478 <alltraps>
...
80107287:	6a 00                	push   $0x0
  pushl $195
80107289:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010728e:	e9 e5 f1 ff ff       	jmp    80106478 <alltraps>
...
80107293:	6a 00                	push   $0x0
  pushl $196
80107295:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010729a:	e9 d9 f1 ff ff       	jmp    80106478 <alltraps>
...
8010729f:	6a 00                	push   $0x0
  pushl $197
801072a1:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801072a6:	e9 cd f1 ff ff       	jmp    80106478 <alltraps>
...
801072ab:	6a 00                	push   $0x0
  pushl $198
801072ad:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801072b2:	e9 c1 f1 ff ff       	jmp    80106478 <alltraps>
...
801072b7:	6a 00                	push   $0x0
  pushl $199
801072b9:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801072be:	e9 b5 f1 ff ff       	jmp    80106478 <alltraps>
...
801072c3:	6a 00                	push   $0x0
  pushl $200
801072c5:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801072ca:	e9 a9 f1 ff ff       	jmp    80106478 <alltraps>
...
801072cf:	6a 00                	push   $0x0
  pushl $201
801072d1:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801072d6:	e9 9d f1 ff ff       	jmp    80106478 <alltraps>
...
801072db:	6a 00                	push   $0x0
  pushl $202
801072dd:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801072e2:	e9 91 f1 ff ff       	jmp    80106478 <alltraps>
...
801072e7:	6a 00                	push   $0x0
  pushl $203
801072e9:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801072ee:	e9 85 f1 ff ff       	jmp    80106478 <alltraps>
...
801072f3:	6a 00                	push   $0x0
  pushl $204
801072f5:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801072fa:	e9 79 f1 ff ff       	jmp    80106478 <alltraps>
...
801072ff:	6a 00                	push   $0x0
  pushl $205
80107301:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107306:	e9 6d f1 ff ff       	jmp    80106478 <alltraps>
...
8010730b:	6a 00                	push   $0x0
  pushl $206
8010730d:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107312:	e9 61 f1 ff ff       	jmp    80106478 <alltraps>
...
80107317:	6a 00                	push   $0x0
  pushl $207
80107319:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010731e:	e9 55 f1 ff ff       	jmp    80106478 <alltraps>
...
80107323:	6a 00                	push   $0x0
  pushl $208
80107325:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010732a:	e9 49 f1 ff ff       	jmp    80106478 <alltraps>
...
8010732f:	6a 00                	push   $0x0
  pushl $209
80107331:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107336:	e9 3d f1 ff ff       	jmp    80106478 <alltraps>
...
8010733b:	6a 00                	push   $0x0
  pushl $210
8010733d:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107342:	e9 31 f1 ff ff       	jmp    80106478 <alltraps>
...
80107347:	6a 00                	push   $0x0
  pushl $211
80107349:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
8010734e:	e9 25 f1 ff ff       	jmp    80106478 <alltraps>
...
80107353:	6a 00                	push   $0x0
  pushl $212
80107355:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010735a:	e9 19 f1 ff ff       	jmp    80106478 <alltraps>
...
8010735f:	6a 00                	push   $0x0
  pushl $213
80107361:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107366:	e9 0d f1 ff ff       	jmp    80106478 <alltraps>
...
8010736b:	6a 00                	push   $0x0
  pushl $214
8010736d:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107372:	e9 01 f1 ff ff       	jmp    80106478 <alltraps>
...
80107377:	6a 00                	push   $0x0
  pushl $215
80107379:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010737e:	e9 f5 f0 ff ff       	jmp    80106478 <alltraps>
...
80107383:	6a 00                	push   $0x0
  pushl $216
80107385:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010738a:	e9 e9 f0 ff ff       	jmp    80106478 <alltraps>
...
8010738f:	6a 00                	push   $0x0
  pushl $217
80107391:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107396:	e9 dd f0 ff ff       	jmp    80106478 <alltraps>
...
8010739b:	6a 00                	push   $0x0
  pushl $218
8010739d:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801073a2:	e9 d1 f0 ff ff       	jmp    80106478 <alltraps>
...
801073a7:	6a 00                	push   $0x0
  pushl $219
801073a9:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801073ae:	e9 c5 f0 ff ff       	jmp    80106478 <alltraps>
...
801073b3:	6a 00                	push   $0x0
  pushl $220
801073b5:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801073ba:	e9 b9 f0 ff ff       	jmp    80106478 <alltraps>
...
801073bf:	6a 00                	push   $0x0
  pushl $221
801073c1:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801073c6:	e9 ad f0 ff ff       	jmp    80106478 <alltraps>
...
801073cb:	6a 00                	push   $0x0
  pushl $222
801073cd:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801073d2:	e9 a1 f0 ff ff       	jmp    80106478 <alltraps>
...
801073d7:	6a 00                	push   $0x0
  pushl $223
801073d9:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801073de:	e9 95 f0 ff ff       	jmp    80106478 <alltraps>
...
801073e3:	6a 00                	push   $0x0
  pushl $224
801073e5:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801073ea:	e9 89 f0 ff ff       	jmp    80106478 <alltraps>
...
801073ef:	6a 00                	push   $0x0
  pushl $225
801073f1:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801073f6:	e9 7d f0 ff ff       	jmp    80106478 <alltraps>
...
801073fb:	6a 00                	push   $0x0
  pushl $226
801073fd:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107402:	e9 71 f0 ff ff       	jmp    80106478 <alltraps>
...
80107407:	6a 00                	push   $0x0
  pushl $227
80107409:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010740e:	e9 65 f0 ff ff       	jmp    80106478 <alltraps>
...
80107413:	6a 00                	push   $0x0
  pushl $228
80107415:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010741a:	e9 59 f0 ff ff       	jmp    80106478 <alltraps>
...
8010741f:	6a 00                	push   $0x0
  pushl $229
80107421:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107426:	e9 4d f0 ff ff       	jmp    80106478 <alltraps>
...
8010742b:	6a 00                	push   $0x0
  pushl $230
8010742d:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107432:	e9 41 f0 ff ff       	jmp    80106478 <alltraps>
...
80107437:	6a 00                	push   $0x0
  pushl $231
80107439:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010743e:	e9 35 f0 ff ff       	jmp    80106478 <alltraps>
...
80107443:	6a 00                	push   $0x0
  pushl $232
80107445:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010744a:	e9 29 f0 ff ff       	jmp    80106478 <alltraps>
...
8010744f:	6a 00                	push   $0x0
  pushl $233
80107451:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107456:	e9 1d f0 ff ff       	jmp    80106478 <alltraps>
...
8010745b:	6a 00                	push   $0x0
  pushl $234
8010745d:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107462:	e9 11 f0 ff ff       	jmp    80106478 <alltraps>
...
80107467:	6a 00                	push   $0x0
  pushl $235
80107469:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
8010746e:	e9 05 f0 ff ff       	jmp    80106478 <alltraps>
...
80107473:	6a 00                	push   $0x0
  pushl $236
80107475:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010747a:	e9 f9 ef ff ff       	jmp    80106478 <alltraps>
...
8010747f:	6a 00                	push   $0x0
  pushl $237
80107481:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107486:	e9 ed ef ff ff       	jmp    80106478 <alltraps>
...
8010748b:	6a 00                	push   $0x0
  pushl $238
8010748d:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107492:	e9 e1 ef ff ff       	jmp    80106478 <alltraps>
...
80107497:	6a 00                	push   $0x0
  pushl $239
80107499:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010749e:	e9 d5 ef ff ff       	jmp    80106478 <alltraps>
...
801074a3:	6a 00                	push   $0x0
  pushl $240
801074a5:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801074aa:	e9 c9 ef ff ff       	jmp    80106478 <alltraps>
...
801074af:	6a 00                	push   $0x0
  pushl $241
801074b1:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801074b6:	e9 bd ef ff ff       	jmp    80106478 <alltraps>
...
801074bb:	6a 00                	push   $0x0
  pushl $242
801074bd:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801074c2:	e9 b1 ef ff ff       	jmp    80106478 <alltraps>
...
801074c7:	6a 00                	push   $0x0
  pushl $243
801074c9:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801074ce:	e9 a5 ef ff ff       	jmp    80106478 <alltraps>
...
801074d3:	6a 00                	push   $0x0
  pushl $244
801074d5:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801074da:	e9 99 ef ff ff       	jmp    80106478 <alltraps>
...
801074df:	6a 00                	push   $0x0
  pushl $245
801074e1:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801074e6:	e9 8d ef ff ff       	jmp    80106478 <alltraps>
...
801074eb:	6a 00                	push   $0x0
  pushl $246
801074ed:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801074f2:	e9 81 ef ff ff       	jmp    80106478 <alltraps>
...
801074f7:	6a 00                	push   $0x0
  pushl $247
801074f9:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801074fe:	e9 75 ef ff ff       	jmp    80106478 <alltraps>
...
80107503:	6a 00                	push   $0x0
  pushl $248
80107505:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010750a:	e9 69 ef ff ff       	jmp    80106478 <alltraps>
...
8010750f:	6a 00                	push   $0x0
  pushl $249
80107511:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107516:	e9 5d ef ff ff       	jmp    80106478 <alltraps>
...
8010751b:	6a 00                	push   $0x0
  pushl $250
8010751d:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107522:	e9 51 ef ff ff       	jmp    80106478 <alltraps>
...
80107527:	6a 00                	push   $0x0
  pushl $251
80107529:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010752e:	e9 45 ef ff ff       	jmp    80106478 <alltraps>
...
80107533:	6a 00                	push   $0x0
  pushl $252
80107535:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010753a:	e9 39 ef ff ff       	jmp    80106478 <alltraps>
...
8010753f:	6a 00                	push   $0x0
  pushl $253
80107541:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107546:	e9 2d ef ff ff       	jmp    80106478 <alltraps>
...
8010754b:	6a 00                	push   $0x0
  pushl $254
8010754d:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107552:	e9 21 ef ff ff       	jmp    80106478 <alltraps>
...
80107557:	6a 00                	push   $0x0
  pushl $255
80107559:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
8010755e:	e9 15 ef ff ff       	jmp    80106478 <alltraps>
...
80107566:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107569:	8b 45 0c             	mov    0xc(%ebp),%eax
8010756c:	83 e8 01             	sub    $0x1,%eax
8010756f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107573:	8b 45 08             	mov    0x8(%ebp),%eax
80107576:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010757a:	8b 45 08             	mov    0x8(%ebp),%eax
8010757d:	c1 e8 10             	shr    $0x10,%eax
80107580:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107584:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107587:	0f 01 10             	lgdtl  (%eax)
}
8010758a:	c9                   	leave  
8010758b:	c3                   	ret    
...
8010758f:	83 ec 04             	sub    $0x4,%esp
80107592:	8b 45 08             	mov    0x8(%ebp),%eax
80107595:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107599:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010759d:	0f 00 d8             	ltr    %ax
}
801075a0:	c9                   	leave  
801075a1:	c3                   	ret    
...
801075ab:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
801075af:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801075b3:	8e e8                	mov    %eax,%gs
}
801075b5:	c9                   	leave  
801075b6:	c3                   	ret    
...
801075ba:	8b 45 08             	mov    0x8(%ebp),%eax
801075bd:	0f 22 d8             	mov    %eax,%cr3
}
801075c0:	5d                   	pop    %ebp
801075c1:	c3                   	ret    
...
801075e0:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801075e3:	e8 81 b8 ff ff       	call   80102e69 <cpunum>
801075e8:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801075ee:	05 20 f9 10 80       	add    $0x8010f920,%eax
801075f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801075f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075f9:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801075ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107602:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107608:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010760b:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
8010760f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107612:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107616:	83 e2 f0             	and    $0xfffffff0,%edx
80107619:	83 ca 0a             	or     $0xa,%edx
8010761c:	88 50 7d             	mov    %dl,0x7d(%eax)
8010761f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107622:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107626:	83 ca 10             	or     $0x10,%edx
80107629:	88 50 7d             	mov    %dl,0x7d(%eax)
8010762c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010762f:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107633:	83 e2 9f             	and    $0xffffff9f,%edx
80107636:	88 50 7d             	mov    %dl,0x7d(%eax)
80107639:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010763c:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107640:	83 ca 80             	or     $0xffffff80,%edx
80107643:	88 50 7d             	mov    %dl,0x7d(%eax)
80107646:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107649:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
8010764d:	83 ca 0f             	or     $0xf,%edx
80107650:	88 50 7e             	mov    %dl,0x7e(%eax)
80107653:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107656:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
8010765a:	83 e2 ef             	and    $0xffffffef,%edx
8010765d:	88 50 7e             	mov    %dl,0x7e(%eax)
80107660:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107663:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107667:	83 e2 df             	and    $0xffffffdf,%edx
8010766a:	88 50 7e             	mov    %dl,0x7e(%eax)
8010766d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107670:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107674:	83 ca 40             	or     $0x40,%edx
80107677:	88 50 7e             	mov    %dl,0x7e(%eax)
8010767a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010767d:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107681:	83 ca 80             	or     $0xffffff80,%edx
80107684:	88 50 7e             	mov    %dl,0x7e(%eax)
80107687:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010768a:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010768e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107691:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107698:	ff ff 
8010769a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010769d:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
801076a4:	00 00 
801076a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a9:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801076b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076b3:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801076ba:	83 e2 f0             	and    $0xfffffff0,%edx
801076bd:	83 ca 02             	or     $0x2,%edx
...
8010771c:	83 e2 ef             	and    $0xffffffef,%edx
...
80107742:	83 ca 40             	or     $0x40,%edx
80107745:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010774b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010774e:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107755:	83 ca 80             	or     $0xffffff80,%edx
80107758:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
8010775e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107761:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107768:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010776b:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107772:	ff ff 
80107774:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107777:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010777e:	00 00 
80107780:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107783:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010778a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010778d:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107794:	83 e2 f0             	and    $0xfffffff0,%edx
80107797:	83 ca 0a             	or     $0xa,%edx
...
801077f6:	83 e2 ef             	and    $0xffffffef,%edx
...
8010781c:	83 ca 40             	or     $0x40,%edx
8010781f:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107825:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107828:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010782f:	83 ca 80             	or     $0xffffff80,%edx
80107832:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107838:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010783b:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107842:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107845:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
8010784c:	ff ff 
8010784e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107851:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107858:	00 00 
8010785a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010785d:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107864:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107867:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010786e:	83 e2 f0             	and    $0xfffffff0,%edx
80107871:	83 ca 02             	or     $0x2,%edx
...
801078e3:	83 e2 df             	and    $0xffffffdf,%edx
...
801078f6:	83 ca 40             	or     $0x40,%edx
801078f9:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
801078ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107902:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107909:	83 ca 80             	or     $0xffffff80,%edx
8010790c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107912:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107915:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010791c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010791f:	05 b4 00 00 00       	add    $0xb4,%eax
80107924:	89 c3                	mov    %eax,%ebx
80107926:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107929:	05 b4 00 00 00       	add    $0xb4,%eax
8010792e:	c1 e8 10             	shr    $0x10,%eax
80107931:	89 c1                	mov    %eax,%ecx
80107933:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107936:	05 b4 00 00 00       	add    $0xb4,%eax
8010793b:	c1 e8 18             	shr    $0x18,%eax
8010793e:	89 c2                	mov    %eax,%edx
80107940:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107943:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
8010794a:	00 00 
8010794c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010794f:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107956:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107959:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
8010795f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107962:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107969:	83 e1 f0             	and    $0xfffffff0,%ecx
8010796c:	83 c9 02             	or     $0x2,%ecx
8010796f:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107975:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107978:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
8010797f:	83 c9 10             	or     $0x10,%ecx
80107982:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107988:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010798b:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107992:	83 e1 9f             	and    $0xffffff9f,%ecx
80107995:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010799b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010799e:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801079a5:	83 c9 80             	or     $0xffffff80,%ecx
801079a8:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801079ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b1:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801079b8:	83 e1 f0             	and    $0xfffffff0,%ecx
801079bb:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801079c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c4:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801079cb:	83 e1 ef             	and    $0xffffffef,%ecx
801079ce:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801079d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d7:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801079de:	83 e1 df             	and    $0xffffffdf,%ecx
801079e1:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801079e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ea:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
801079f1:	83 c9 40             	or     $0x40,%ecx
801079f4:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
801079fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079fd:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107a04:	83 c9 80             	or     $0xffffff80,%ecx
80107a07:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107a0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a10:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107a16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a19:	83 c0 70             	add    $0x70,%eax
80107a1c:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107a23:	00 
80107a24:	89 04 24             	mov    %eax,(%esp)
80107a27:	e8 37 fb ff ff       	call   80107563 <lgdt>
  loadgs(SEG_KCPU << 3);
80107a2c:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107a33:	e8 6a fb ff ff       	call   801075a2 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107a38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a3b:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107a41:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107a48:	00 00 00 00 
}
80107a4c:	83 c4 24             	add    $0x24,%esp
80107a4f:	5b                   	pop    %ebx
80107a50:	5d                   	pop    %ebp
80107a51:	c3                   	ret    
...
80107a55:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107a58:	8b 45 0c             	mov    0xc(%ebp),%eax
80107a5b:	c1 e8 16             	shr    $0x16,%eax
...
80107a6a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107a6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a70:	8b 00                	mov    (%eax),%eax
80107a72:	83 e0 01             	and    $0x1,%eax
80107a75:	85 c0                	test   %eax,%eax
80107a77:	74 17                	je     80107a90 <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107a79:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a7c:	8b 00                	mov    (%eax),%eax
80107a7e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107a83:	89 04 24             	mov    %eax,(%esp)
80107a86:	e8 44 fb ff ff       	call   801075cf <p2v>
80107a8b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a8e:	eb 4b                	jmp    80107adb <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107a90:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107a94:	74 0e                	je     80107aa4 <walkpgdir+0x52>
80107a96:	e8 55 b0 ff ff       	call   80102af0 <kalloc>
80107a9b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a9e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107aa2:	75 07                	jne    80107aab <walkpgdir+0x59>
      return 0;
80107aa4:	b8 00 00 00 00       	mov    $0x0,%eax
80107aa9:	eb 47                	jmp    80107af2 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107aab:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107ab2:	00 
80107ab3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107aba:	00 
80107abb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107abe:	89 04 24             	mov    %eax,(%esp)
80107ac1:	e8 9c d5 ff ff       	call   80105062 <memset>
...
80107acc:	e8 f1 fa ff ff       	call   801075c2 <v2p>
80107ad1:	83 c8 07             	or     $0x7,%eax
80107ad4:	89 c2                	mov    %eax,%edx
80107ad6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ad9:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107adb:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ade:	c1 e8 0c             	shr    $0xc,%eax
80107ae1:	25 ff 03 00 00       	and    $0x3ff,%eax
80107ae6:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107afa:	8b 45 0c             	mov    0xc(%ebp),%eax
80107afd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b02:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107b05:	8b 55 0c             	mov    0xc(%ebp),%edx
80107b08:	8b 45 10             	mov    0x10(%ebp),%eax
80107b0b:	01 d0                	add    %edx,%eax
80107b0d:	83 e8 01             	sub    $0x1,%eax
80107b10:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107b15:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107b18:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107b1f:	00 
80107b20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b23:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b27:	8b 45 08             	mov    0x8(%ebp),%eax
80107b2a:	89 04 24             	mov    %eax,(%esp)
80107b2d:	e8 20 ff ff ff       	call   80107a52 <walkpgdir>
80107b32:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107b35:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107b39:	75 07                	jne    80107b42 <mappages+0x4e>
      return -1;
80107b3b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107b40:	eb 48                	jmp    80107b8a <mappages+0x96>
    if(*pte & PTE_P)
80107b42:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b45:	8b 00                	mov    (%eax),%eax
80107b47:	83 e0 01             	and    $0x1,%eax
80107b4a:	85 c0                	test   %eax,%eax
80107b4c:	74 0c                	je     80107b5a <mappages+0x66>
      panic("remap");
80107b4e:	c7 04 24 70 8a 10 80 	movl   $0x80108a70,(%esp)
80107b55:	e8 e0 89 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107b5a:	8b 45 18             	mov    0x18(%ebp),%eax
80107b5d:	0b 45 14             	or     0x14(%ebp),%eax
80107b60:	83 c8 01             	or     $0x1,%eax
80107b63:	89 c2                	mov    %eax,%edx
80107b65:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b68:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107b6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b6d:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107b70:	75 08                	jne    80107b7a <mappages+0x86>
      break;
80107b72:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107b78:	eb 10                	jmp    80107b8a <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107b7a:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107b81:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107b88:	eb 8e                	jmp    80107b18 <mappages+0x24>
  return 0;
}
80107b8a:	c9                   	leave  
80107b8b:	c3                   	ret    
...
80107b90:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107b93:	e8 58 af ff ff       	call   80102af0 <kalloc>
80107b98:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107b9b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107b9f:	75 0a                	jne    80107bab <setupkvm+0x1f>
    return 0;
80107ba1:	b8 00 00 00 00       	mov    $0x0,%eax
80107ba6:	e9 98 00 00 00       	jmp    80107c43 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107bab:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107bb2:	00 
80107bb3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107bba:	00 
80107bbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bbe:	89 04 24             	mov    %eax,(%esp)
80107bc1:	e8 9c d4 ff ff       	call   80105062 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107bc6:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107bcd:	e8 fd f9 ff ff       	call   801075cf <p2v>
80107bd2:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107bd7:	76 0c                	jbe    80107be5 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107bd9:	c7 04 24 76 8a 10 80 	movl   $0x80108a76,(%esp)
80107be0:	e8 55 89 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107be5:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107bec:	eb 49                	jmp    80107c37 <setupkvm+0xab>
...
80107c0d:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107c11:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107c15:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107c19:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c1d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c20:	89 04 24             	mov    %eax,(%esp)
80107c23:	e8 cc fe ff ff       	call   80107af4 <mappages>
80107c28:	85 c0                	test   %eax,%eax
80107c2a:	79 07                	jns    80107c33 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107c2c:	b8 00 00 00 00       	mov    $0x0,%eax
80107c31:	eb 10                	jmp    80107c43 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
...
80107c37:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107c3e:	72 ae                	jb     80107bee <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107c4c:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107c4f:	e8 38 ff ff ff       	call   80107b8c <setupkvm>
80107c54:	a3 f8 26 11 80       	mov    %eax,0x801126f8
  switchkvm();
...
80107c66:	a1 f8 26 11 80       	mov    0x801126f8,%eax
80107c6b:	89 04 24             	mov    %eax,(%esp)
80107c6e:	e8 4f f9 ff ff       	call   801075c2 <v2p>
80107c73:	89 04 24             	mov    %eax,(%esp)
80107c76:	e8 3c f9 ff ff       	call   801075b7 <lcr3>
}
80107c7b:	c9                   	leave  
80107c7c:	c3                   	ret    
...
80107c81:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107c84:	e8 d9 d2 ff ff       	call   80104f62 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107c89:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107c8f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c96:	83 c2 08             	add    $0x8,%edx
80107c99:	89 d3                	mov    %edx,%ebx
80107c9b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107ca2:	83 c2 08             	add    $0x8,%edx
80107ca5:	c1 ea 10             	shr    $0x10,%edx
80107ca8:	89 d1                	mov    %edx,%ecx
80107caa:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107cb1:	83 c2 08             	add    $0x8,%edx
80107cb4:	c1 ea 18             	shr    $0x18,%edx
80107cb7:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107cbe:	67 00 
80107cc0:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107cc7:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107ccd:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107cd4:	83 e1 f0             	and    $0xfffffff0,%ecx
80107cd7:	83 c9 09             	or     $0x9,%ecx
80107cda:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ce0:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ce7:	83 c9 10             	or     $0x10,%ecx
80107cea:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107cf0:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107cf7:	83 e1 9f             	and    $0xffffff9f,%ecx
80107cfa:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d00:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107d07:	83 c9 80             	or     $0xffffff80,%ecx
80107d0a:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107d10:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d17:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d1a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d20:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d27:	83 e1 ef             	and    $0xffffffef,%ecx
80107d2a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d30:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d37:	83 e1 df             	and    $0xffffffdf,%ecx
80107d3a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d40:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d47:	83 c9 40             	or     $0x40,%ecx
80107d4a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d50:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d57:	83 e1 7f             	and    $0x7f,%ecx
80107d5a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d60:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107d66:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d6c:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107d73:	83 e2 ef             	and    $0xffffffef,%edx
80107d76:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107d7c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d82:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107d88:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d8e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107d95:	8b 52 08             	mov    0x8(%edx),%edx
80107d98:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107d9e:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107da1:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107da8:	e8 df f7 ff ff       	call   8010758c <ltr>
  if(p->pgdir == 0)
80107dad:	8b 45 08             	mov    0x8(%ebp),%eax
80107db0:	8b 40 04             	mov    0x4(%eax),%eax
80107db3:	85 c0                	test   %eax,%eax
80107db5:	75 0c                	jne    80107dc3 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107db7:	c7 04 24 87 8a 10 80 	movl   $0x80108a87,(%esp)
80107dbe:	e8 77 87 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107dc3:	8b 45 08             	mov    0x8(%ebp),%eax
80107dc6:	8b 40 04             	mov    0x4(%eax),%eax
80107dc9:	89 04 24             	mov    %eax,(%esp)
80107dcc:	e8 f1 f7 ff ff       	call   801075c2 <v2p>
80107dd1:	89 04 24             	mov    %eax,(%esp)
80107dd4:	e8 de f7 ff ff       	call   801075b7 <lcr3>
  popcli();
80107dd9:	e8 c8 d1 ff ff       	call   80104fa6 <popcli>
}
80107dde:	83 c4 14             	add    $0x14,%esp
80107de1:	5b                   	pop    %ebx
80107de2:	5d                   	pop    %ebp
80107de3:	c3                   	ret    
...
80107de7:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107dea:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107df1:	76 0c                	jbe    80107dff <inituvm+0x1b>
    panic("inituvm: more than a page");
80107df3:	c7 04 24 9b 8a 10 80 	movl   $0x80108a9b,(%esp)
80107dfa:	e8 3b 87 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107dff:	e8 ec ac ff ff       	call   80102af0 <kalloc>
...
80107e1d:	e8 40 d2 ff ff       	call   80105062 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107e22:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e25:	89 04 24             	mov    %eax,(%esp)
80107e28:	e8 95 f7 ff ff       	call   801075c2 <v2p>
80107e2d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e34:	00 
80107e35:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107e39:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e40:	00 
80107e41:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e48:	00 
80107e49:	8b 45 08             	mov    0x8(%ebp),%eax
80107e4c:	89 04 24             	mov    %eax,(%esp)
80107e4f:	e8 a0 fc ff ff       	call   80107af4 <mappages>
  memmove(mem, init, sz);
80107e54:	8b 45 10             	mov    0x10(%ebp),%eax
80107e57:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107e68:	e8 c4 d2 ff ff       	call   80105131 <memmove>
}
80107e6d:	c9                   	leave  
80107e6e:	c3                   	ret    
...
80107e73:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
80107e7d:	e9 ca 00 00 00       	jmp    80107f4c <loaduvm+0xdd>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107e82:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e85:	8b 55 0c             	mov    0xc(%ebp),%edx
80107e88:	01 d0                	add    %edx,%eax
...
80107e9c:	e8 b1 fb ff ff       	call   80107a52 <walkpgdir>
80107ea1:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107ea4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ea8:	75 0c                	jne    80107eb6 <loaduvm+0x47>
      panic("loaduvm: address should exist");
80107eaa:	c7 04 24 b5 8a 10 80 	movl   $0x80108ab5,(%esp)
80107eb1:	e8 84 86 ff ff       	call   8010053a <panic>
    if (!writeFlag) {
80107eb6:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
80107eba:	75 0f                	jne    80107ecb <loaduvm+0x5c>
    	*pte = *pte & ~PTE_W;		// turn off WRITEABLE flag
80107ebc:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107ebf:	8b 00                	mov    (%eax),%eax
80107ec1:	83 e0 fd             	and    $0xfffffffd,%eax
80107ec4:	89 c2                	mov    %eax,%edx
80107ec6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107ec9:	89 10                	mov    %edx,(%eax)
    }
...
80107eda:	25 ff 0f 00 00       	and    $0xfff,%eax
80107edf:	01 d0                	add    %edx,%eax
80107ee1:	89 45 e8             	mov    %eax,-0x18(%ebp)
    // pa = PTE_ADDR(*pte); task 3
    if(sz - i < PGSIZE)
80107ee4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee7:	8b 55 18             	mov    0x18(%ebp),%edx
80107eea:	29 c2                	sub    %eax,%edx
80107eec:	89 d0                	mov    %edx,%eax
80107eee:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107ef3:	77 0f                	ja     80107f04 <loaduvm+0x95>
      n = sz - i;
80107ef5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ef8:	8b 55 18             	mov    0x18(%ebp),%edx
80107efb:	29 c2                	sub    %eax,%edx
80107efd:	89 d0                	mov    %edx,%eax
80107eff:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107f02:	eb 07                	jmp    80107f0b <loaduvm+0x9c>
    else
      n = PGSIZE;
80107f04:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107f0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f0e:	8b 55 14             	mov    0x14(%ebp),%edx
80107f11:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107f14:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f17:	89 04 24             	mov    %eax,(%esp)
80107f1a:	e8 b0 f6 ff ff       	call   801075cf <p2v>
80107f1f:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80107f34:	e8 3d 9e ff ff       	call   80101d76 <readi>
80107f39:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f3c:	74 07                	je     80107f45 <loaduvm+0xd6>
      return -1;
80107f3e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107f43:	eb 18                	jmp    80107f5d <loaduvm+0xee>
  uint i, pa, n;
  pte_t *pte;
...
80107f4f:	3b 45 18             	cmp    0x18(%ebp),%eax
80107f52:	0f 82 2a ff ff ff    	jb     80107e82 <loaduvm+0x13>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
80107f58:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107f5d:	83 c4 24             	add    $0x24,%esp
80107f60:	5b                   	pop    %ebx
80107f61:	5d                   	pop    %ebp
80107f62:	c3                   	ret    
...
80107f66:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107f6e:	79 0a                	jns    80107f7a <allocuvm+0x17>
    return 0;
80107f70:	b8 00 00 00 00       	mov    $0x0,%eax
80107f75:	e9 c1 00 00 00       	jmp    8010803b <allocuvm+0xd8>
  if(newsz < oldsz)
80107f7a:	8b 45 10             	mov    0x10(%ebp),%eax
80107f7d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f80:	73 08                	jae    80107f8a <allocuvm+0x27>
    return oldsz;
80107f82:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f85:	e9 b1 00 00 00       	jmp    8010803b <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107f8a:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f8d:	05 ff 0f 00 00       	add    $0xfff,%eax
80107f92:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f97:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107f9a:	e9 8d 00 00 00       	jmp    8010802c <allocuvm+0xc9>
    mem = kalloc();
80107f9f:	e8 4c ab ff ff       	call   80102af0 <kalloc>
80107fa4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107fa7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107fab:	75 2c                	jne    80107fd9 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107fad:	c7 04 24 d3 8a 10 80 	movl   $0x80108ad3,(%esp)
80107fb4:	e8 e7 83 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107fb9:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fbc:	89 44 24 08          	mov    %eax,0x8(%esp)
80107fc0:	8b 45 10             	mov    0x10(%ebp),%eax
80107fc3:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fc7:	8b 45 08             	mov    0x8(%ebp),%eax
80107fca:	89 04 24             	mov    %eax,(%esp)
80107fcd:	e8 6b 00 00 00       	call   8010803d <deallocuvm>
      return 0;
80107fd2:	b8 00 00 00 00       	mov    $0x0,%eax
80107fd7:	eb 62                	jmp    8010803b <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80107fd9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107fe0:	00 
80107fe1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107fe8:	00 
80107fe9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fec:	89 04 24             	mov    %eax,(%esp)
80107fef:	e8 6e d0 ff ff       	call   80105062 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107ff4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ff7:	89 04 24             	mov    %eax,(%esp)
80107ffa:	e8 c3 f5 ff ff       	call   801075c2 <v2p>
80107fff:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108002:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108009:	00 
8010800a:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010800e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108015:	00 
80108016:	89 54 24 04          	mov    %edx,0x4(%esp)
8010801a:	8b 45 08             	mov    0x8(%ebp),%eax
8010801d:	89 04 24             	mov    %eax,(%esp)
80108020:	e8 cf fa ff ff       	call   80107af4 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108032:	0f 82 67 ff ff ff    	jb     80107f9f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108040:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
8010804e:	e9 a4 00 00 00       	jmp    801080f7 <deallocuvm+0xba>
...
80108063:	e9 80 00 00 00       	jmp    801080e8 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108068:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108072:	00 
80108073:	89 44 24 04          	mov    %eax,0x4(%esp)
80108077:	8b 45 08             	mov    0x8(%ebp),%eax
8010807a:	89 04 24             	mov    %eax,(%esp)
8010807d:	e8 d0 f9 ff ff       	call   80107a52 <walkpgdir>
80108082:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108085:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108089:	75 09                	jne    80108094 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010808b:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108092:	eb 4d                	jmp    801080e1 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108094:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108097:	8b 00                	mov    (%eax),%eax
80108099:	83 e0 01             	and    $0x1,%eax
8010809c:	85 c0                	test   %eax,%eax
8010809e:	74 41                	je     801080e1 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
801080b1:	75 0c                	jne    801080bf <deallocuvm+0x82>
        panic("kfree");
801080b3:	c7 04 24 eb 8a 10 80 	movl   $0x80108aeb,(%esp)
801080ba:	e8 7b 84 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801080bf:	8b 45 ec             	mov    -0x14(%ebp),%eax
801080c2:	89 04 24             	mov    %eax,(%esp)
801080c5:	e8 05 f5 ff ff       	call   801075cf <p2v>
801080ca:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801080cd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801080d0:	89 04 24             	mov    %eax,(%esp)
801080d3:	e8 7f a9 ff ff       	call   80102a57 <kfree>
      *pte = 0;
801080d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080db:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
801080eb:	3b 45 0c             	cmp    0xc(%ebp),%eax
801080ee:	0f 82 74 ff ff ff    	jb     80108068 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
801080f4:	8b 45 10             	mov    0x10(%ebp),%eax
}
801080f7:	c9                   	leave  
801080f8:	c3                   	ret    
...
801080fc:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801080ff:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108103:	75 0c                	jne    80108111 <freevm+0x18>
    panic("freevm: no pgdir");
80108105:	c7 04 24 f1 8a 10 80 	movl   $0x80108af1,(%esp)
8010810c:	e8 29 84 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108111:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108118:	00 
80108119:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108120:	80 
80108121:	8b 45 08             	mov    0x8(%ebp),%eax
80108124:	89 04 24             	mov    %eax,(%esp)
80108127:	e8 11 ff ff ff       	call   8010803d <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010812c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108133:	eb 48                	jmp    8010817d <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
80108146:	83 e0 01             	and    $0x1,%eax
80108149:	85 c0                	test   %eax,%eax
8010814b:	74 2c                	je     80108179 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010814d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108150:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108157:	8b 45 08             	mov    0x8(%ebp),%eax
8010815a:	01 d0                	add    %edx,%eax
8010815c:	8b 00                	mov    (%eax),%eax
8010815e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108163:	89 04 24             	mov    %eax,(%esp)
80108166:	e8 64 f4 ff ff       	call   801075cf <p2v>
8010816b:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
8010816e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108171:	89 04 24             	mov    %eax,(%esp)
80108174:	e8 de a8 ff ff       	call   80102a57 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108179:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010817d:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108184:	76 af                	jbe    80108135 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010818c:	e8 c6 a8 ff ff       	call   80102a57 <kfree>
}
80108191:	c9                   	leave  
80108192:	c3                   	ret    
...
801081dc:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801081df:	e8 a8 f9 ff ff       	call   80107b8c <setupkvm>
801081e4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801081e7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081eb:	75 0a                	jne    801081f7 <copyuvm+0x1e>
    return 0;
801081ed:	b8 00 00 00 00       	mov    $0x0,%eax
801081f2:	e9 37 01 00 00       	jmp    8010832e <copyuvm+0x155>
  for(i = PGSIZE; i < sz; i += PGSIZE){
801081f7:	c7 45 f4 00 10 00 00 	movl   $0x1000,-0xc(%ebp)
801081fe:	e9 0a 01 00 00       	jmp    8010830d <copyuvm+0x134>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108203:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108206:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010820d:	00 
8010820e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108212:	8b 45 08             	mov    0x8(%ebp),%eax
80108215:	89 04 24             	mov    %eax,(%esp)
80108218:	e8 35 f8 ff ff       	call   80107a52 <walkpgdir>
8010821d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108220:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108224:	75 0c                	jne    80108232 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108226:	c7 04 24 0c 8b 10 80 	movl   $0x80108b0c,(%esp)
8010822d:	e8 08 83 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
80108232:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108235:	8b 00                	mov    (%eax),%eax
80108237:	83 e0 01             	and    $0x1,%eax
8010823a:	85 c0                	test   %eax,%eax
8010823c:	75 0c                	jne    8010824a <copyuvm+0x71>
      panic("copyuvm: page not present");
8010823e:	c7 04 24 26 8b 10 80 	movl   $0x80108b26,(%esp)
80108245:	e8 f0 82 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
80108254:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
80108257:	e8 94 a8 ff ff       	call   80102af0 <kalloc>
8010825c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010825f:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80108263:	75 05                	jne    8010826a <copyuvm+0x91>
      goto bad;
80108265:	e9 b4 00 00 00       	jmp    8010831e <copyuvm+0x145>
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010826a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010826d:	89 04 24             	mov    %eax,(%esp)
80108270:	e8 5a f3 ff ff       	call   801075cf <p2v>
80108275:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010827c:	00 
8010827d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108281:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108284:	89 04 24             	mov    %eax,(%esp)
80108287:	e8 a5 ce ff ff       	call   80105131 <memmove>
...
80108291:	83 e0 02             	and    $0x2,%eax
80108294:	85 c0                	test   %eax,%eax
80108296:	74 37                	je     801082cf <copyuvm+0xf6>
    	if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
80108298:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010829b:	89 04 24             	mov    %eax,(%esp)
8010829e:	e8 1f f3 ff ff       	call   801075c2 <v2p>
801082a3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082a6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801082ad:	00 
801082ae:	89 44 24 0c          	mov    %eax,0xc(%esp)
801082b2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082b9:	00 
801082ba:	89 54 24 04          	mov    %edx,0x4(%esp)
801082be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082c1:	89 04 24             	mov    %eax,(%esp)
801082c4:	e8 2b f8 ff ff       	call   80107af4 <mappages>
801082c9:	85 c0                	test   %eax,%eax
801082cb:	79 39                	jns    80108306 <copyuvm+0x12d>
          goto bad;
801082cd:	eb 4f                	jmp    8010831e <copyuvm+0x145>
    } else {
    	if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_U) < 0)
801082cf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801082d2:	89 04 24             	mov    %eax,(%esp)
801082d5:	e8 e8 f2 ff ff       	call   801075c2 <v2p>
801082da:	8b 55 f4             	mov    -0xc(%ebp),%edx
801082dd:	c7 44 24 10 04 00 00 	movl   $0x4,0x10(%esp)
801082e4:	00 
801082e5:	89 44 24 0c          	mov    %eax,0xc(%esp)
801082e9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801082f0:	00 
801082f1:	89 54 24 04          	mov    %edx,0x4(%esp)
801082f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082f8:	89 04 24             	mov    %eax,(%esp)
801082fb:	e8 f4 f7 ff ff       	call   80107af4 <mappages>
80108300:	85 c0                	test   %eax,%eax
80108302:	79 02                	jns    80108306 <copyuvm+0x12d>
    	          goto bad;
80108304:	eb 18                	jmp    8010831e <copyuvm+0x145>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = PGSIZE; i < sz; i += PGSIZE){
80108306:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010830d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108310:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108313:	0f 82 ea fe ff ff    	jb     80108203 <copyuvm+0x2a>
    	if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_U) < 0)
    	          goto bad;
    }
...
8010831c:	eb 10                	jmp    8010832e <copyuvm+0x155>

bad:
  freevm(d);
8010831e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108321:	89 04 24             	mov    %eax,(%esp)
80108324:	e8 d0 fd ff ff       	call   801080f9 <freevm>
  return 0;
...
80108333:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108336:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010833d:	00 
8010833e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108341:	89 44 24 04          	mov    %eax,0x4(%esp)
80108345:	8b 45 08             	mov    0x8(%ebp),%eax
80108348:	89 04 24             	mov    %eax,(%esp)
8010834b:	e8 02 f7 ff ff       	call   80107a52 <walkpgdir>
80108350:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108353:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108356:	8b 00                	mov    (%eax),%eax
80108358:	83 e0 01             	and    $0x1,%eax
8010835b:	85 c0                	test   %eax,%eax
8010835d:	75 07                	jne    80108366 <uva2ka+0x36>
    return 0;
8010835f:	b8 00 00 00 00       	mov    $0x0,%eax
80108364:	eb 25                	jmp    8010838b <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108366:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108369:	8b 00                	mov    (%eax),%eax
8010836b:	83 e0 04             	and    $0x4,%eax
8010836e:	85 c0                	test   %eax,%eax
80108370:	75 07                	jne    80108379 <uva2ka+0x49>
    return 0;
80108372:	b8 00 00 00 00       	mov    $0x0,%eax
80108377:	eb 12                	jmp    8010838b <uva2ka+0x5b>
...
80108386:	e8 44 f2 ff ff       	call   801075cf <p2v>
}
8010838b:	c9                   	leave  
8010838c:	c3                   	ret    
...
80108396:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108399:	e9 87 00 00 00       	jmp    80108425 <copyout+0x98>
...
801083b6:	e8 75 ff ff ff       	call   80108330 <uva2ka>
801083bb:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801083be:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801083c2:	75 07                	jne    801083cb <copyout+0x3e>
      return -1;
801083c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801083c9:	eb 69                	jmp    80108434 <copyout+0xa7>
    n = PGSIZE - (va - va0);
801083cb:	8b 45 0c             	mov    0xc(%ebp),%eax
801083ce:	8b 55 ec             	mov    -0x14(%ebp),%edx
801083d1:	29 c2                	sub    %eax,%edx
801083d3:	89 d0                	mov    %edx,%eax
801083d5:	05 00 10 00 00       	add    $0x1000,%eax
801083da:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801083dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083e0:	3b 45 14             	cmp    0x14(%ebp),%eax
801083e3:	76 06                	jbe    801083eb <copyout+0x5e>
      n = len;
801083e5:	8b 45 14             	mov    0x14(%ebp),%eax
801083e8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801083eb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083ee:	8b 55 0c             	mov    0xc(%ebp),%edx
801083f1:	29 c2                	sub    %eax,%edx
801083f3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801083f6:	01 c2                	add    %eax,%edx
801083f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083fb:	89 44 24 08          	mov    %eax,0x8(%esp)
801083ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108402:	89 44 24 04          	mov    %eax,0x4(%esp)
80108406:	89 14 24             	mov    %edx,(%esp)
80108409:	e8 23 cd ff ff       	call   80105131 <memmove>
    len -= n;
8010840e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108411:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108414:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108417:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
8010841a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010841d:	05 00 10 00 00       	add    $0x1000,%eax
80108422:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108425:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108429:	0f 85 6f ff ff ff    	jne    8010839e <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
