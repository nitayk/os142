...
_testTask3:     file format elf32-i386
...
void testFunction(){
   ...
   printf(1, "printFunc\n");
    1006:	c7 44 24 04 1c 18 00 	movl   $0x181c,0x4(%esp)
    100d:	00 
    100e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1015:	e8 35 04 00 00       	call   144f <printf>
}
    101a:	c9                   	leave  
    101b:	c3                   	ret    
...
int main (int argc, char** argv){
  ...
  printf(1, "writing to text section started\n");
    102a:	c7 44 24 04 28 18 00 	movl   $0x1828,0x4(%esp)
    1031:	00 
    1032:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1039:	e8 11 04 00 00       	call   144f <printf>
  *((int*)testFunction) = 15;
    103e:	b8 00 10 00 00       	mov    $0x1000,%eax
    1043:	c7 00 0f 00 00 00    	movl   $0xf,(%eax)
  printf(1, "writing to text section finished\n");
    1049:	c7 44 24 04 4c 18 00 	movl   $0x184c,0x4(%esp)
    1050:	00 
    1051:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1058:	e8 f2 03 00 00       	call   144f <printf>
  testFunction();
    105d:	e8 9e ff ff ff       	call   1000 <testFunction>
  exit();
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13e8:	0f b6 80 dc 2a 00 00 	movzbl 0x2adc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1545:	75 09                	jne    1550 <printf+0x101>
          s = "(null)";
    1547:	c7 45 f4 6e 18 00 00 	movl   $0x186e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1611:	a1 f8 2a 00 00       	mov    0x2af8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16dc:	a3 f8 2a 00 00       	mov    %eax,0x2af8
}
    16e1:	c9                   	leave  
    16e2:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1734:	a1 f8 2a 00 00       	mov    0x2af8,%eax
}
    1739:	c9                   	leave  
    173a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1750:	a1 f8 2a 00 00       	mov    0x2af8,%eax
    1755:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1758:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    175c:	75 23                	jne    1781 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    175e:	c7 45 f0 f0 2a 00 00 	movl   $0x2af0,-0x10(%ebp)
    1765:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1768:	a3 f8 2a 00 00       	mov    %eax,0x2af8
    176d:	a1 f8 2a 00 00       	mov    0x2af8,%eax
    1772:	a3 f0 2a 00 00       	mov    %eax,0x2af0
    base.s.size = 0;
    1777:	c7 05 f4 2a 00 00 00 	movl   $0x0,0x2af4
    177e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17d4:	a3 f8 2a 00 00       	mov    %eax,0x2af8
      return (void*)(p + 1);
    ...
    if(p == freep)
    17e1:	a1 f8 2a 00 00       	mov    0x2af8,%eax
