...
80100049:	e8 34 56 00 00       	call   80105682 <initlock>
...
801000bd:	e8 e1 55 00 00       	call   801056a3 <acquire>
...
80100104:	e8 fc 55 00 00       	call   80105705 <release>
        return b;
...
8010011f:	e8 05 52 00 00       	call   80105329 <sleep>
      goto loop;
...
8010017c:	e8 84 55 00 00       	call   80105705 <release>
      return b;
...
8010023c:	e8 62 54 00 00       	call   801056a3 <acquire>
...
8010029d:	e8 f5 51 00 00       	call   80105497 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 20 e6 10 80 	movl   $0x8010e620,(%esp)
801002a9:	e8 57 54 00 00       	call   80105705 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 e2 52 00 00       	call   801056a3 <acquire>
...
80100536:	e8 ca 51 00 00       	call   80105705 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100592:	e8 bd 51 00 00       	call   80105754 <getcallerpcs>
  for(i=0; i<10; i++)
...
801006dc:	e8 e4 52 00 00       	call   801059c5 <memmove>
    pos -= 80;
...
8010070b:	e8 e2 51 00 00       	call   801058f2 <memset>
  }
...
801007ed:	e8 b1 4e 00 00       	call   801056a3 <acquire>
  while((c = getc()) >= 0){
...
80100858:	e9 9e 03 00 00       	jmp    80100bfb <consoleintr+0x41b>
    case C('P'):  // Process listing.
      procdump();
8010085d:	e8 db 4c 00 00       	call   8010553d <procdump>
      break;
...
80100aa3:	e8 c8 50 00 00       	call   80105b70 <strlen>
...
80100bc4:	e8 a7 4f 00 00       	call   80105b70 <strlen>
...
80100daa:	e8 e8 46 00 00       	call   80105497 <wakeup>
    	    	consputc(c);
...
80100de2:	e8 1e 49 00 00       	call   80105705 <release>
}
80100de7:	c9                   	leave  
80100de8:	c3                   	ret    
...
80100e07:	e8 97 48 00 00       	call   801056a3 <acquire>
  while(n > 0){
...
80100e25:	e8 db 48 00 00       	call   80105705 <release>
			ilock(ip);
...
80100e4e:	e8 d6 44 00 00       	call   80105329 <sleep>
...
80100fba:	e8 46 47 00 00       	call   80105705 <release>
  ilock(ip);
...
80100ff0:	e8 ae 46 00 00       	call   801056a3 <acquire>
  for(i = 0; i < n; i++)
...
8010102a:	e8 d6 46 00 00       	call   80105705 <release>
  ilock(ip);
...
80101045:	c7 44 24 04 93 8e 10 	movl   $0x80108e93,0x4(%esp)
8010104c:	80 
8010104d:	c7 04 24 40 d0 10 80 	movl   $0x8010d040,(%esp)
80101054:	e8 29 46 00 00       	call   80105682 <initlock>
  initlock(&input.lock, "input");
80101059:	c7 44 24 04 9b 8e 10 	movl   $0x80108e9b,0x4(%esp)
80101060:	80 
80101061:	c7 04 24 60 fd 10 80 	movl   $0x8010fd60,(%esp)
80101068:	e8 15 46 00 00       	call   80105682 <initlock>
...
80101114:	e8 57 4a 00 00       	call   80105b70 <strlen>
...
801011ce:	e8 1e 74 00 00       	call   801085f1 <setupkvm>
...
80101267:	e8 57 77 00 00       	call   801089c3 <allocuvm>
...
801012a4:	e8 2b 76 00 00       	call   801088d4 <loaduvm>
...
8010130f:	e8 af 76 00 00       	call   801089c3 <allocuvm>
...
80101333:	e8 af 78 00 00       	call   80108be7 <clearpteu>
  sp = sz;
...
80101362:	e8 09 48 00 00       	call   80105b70 <strlen>
...
80101380:	e8 eb 47 00 00       	call   80105b70 <strlen>
...
801013aa:	e8 ec 79 00 00       	call   80108d9b <copyout>
...
8010144a:	e8 4c 79 00 00       	call   80108d9b <copyout>
...
801014a1:	e8 7c 46 00 00       	call   80105b22 <safestrcpy>
...
801014f3:	e8 ea 71 00 00       	call   801086e2 <switchuvm>
  freevm(oldpgdir);
801014f8:	8b 45 cc             	mov    -0x34(%ebp),%eax
801014fb:	89 04 24             	mov    %eax,(%esp)
801014fe:	e8 56 76 00 00       	call   80108b59 <freevm>
  return 0;
...
80101535:	e8 1f 76 00 00       	call   80108b59 <freevm>
  if(ip)
...
8010161a:	c7 44 24 04 a1 8e 10 	movl   $0x80108ea1,0x4(%esp)
80101621:	80 
80101622:	c7 04 24 20 fe 10 80 	movl   $0x8010fe20,(%esp)
80101629:	e8 54 40 00 00       	call   80105682 <initlock>
}
8010162e:	c9                   	leave  
8010162f:	c3                   	ret    
...
8010163d:	e8 61 40 00 00       	call   801056a3 <acquire>
...
80101666:	e8 9a 40 00 00       	call   80105705 <release>
      return f;
...
80101684:	e8 7c 40 00 00       	call   80105705 <release>
  return 0;
...
8010169d:	e8 01 40 00 00       	call   801056a3 <acquire>
  if(f->ref < 1)
...
801016aa:	7f 0c                	jg     801016b8 <filedup+0x28>
    panic("filedup");
801016ac:	c7 04 24 a8 8e 10 80 	movl   $0x80108ea8,(%esp)
...
801016ce:	e8 32 40 00 00       	call   80105705 <release>
  return f;
...
801016e5:	e8 b9 3f 00 00       	call   801056a3 <acquire>
  if(f->ref < 1)
...
801016f2:	7f 0c                	jg     80101700 <fileclose+0x28>
    panic("fileclose");
801016f4:	c7 04 24 b0 8e 10 80 	movl   $0x80108eb0,(%esp)
...
80101720:	e8 e0 3f 00 00       	call   80105705 <release>
    return;
...
8010176a:	e8 96 3f 00 00       	call   80105705 <release>
...
801018a9:	eb 0c                	jmp    801018b7 <fileread+0xba>
  ...
  panic("fileread");
801018ab:	c7 04 24 ba 8e 10 80 	movl   $0x80108eba,(%esp)
...
801019b7:	c7 04 24 c3 8e 10 80 	movl   $0x80108ec3,(%esp)
...
801019ea:	eb 0c                	jmp    801019f8 <filewrite+0x13f>
  ...
  panic("filewrite");
801019ec:	c7 04 24 d3 8e 10 80 	movl   $0x80108ed3,(%esp)
...
80101a34:	e8 8c 3f 00 00       	call   801059c5 <memmove>
  brelse(bp);
...
80101a7a:	e8 73 3e 00 00       	call   801058f2 <memset>
  log_write(bp);
...
80101bdc:	0f 82 e1 fe ff ff    	jb     80101ac3 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
80101be2:	c7 04 24 dd 8e 10 80 	movl   $0x80108edd,(%esp)
...
80101c79:	c7 04 24 f3 8e 10 80 	movl   $0x80108ef3,(%esp)
...
80101ccd:	c7 44 24 04 06 8f 10 	movl   $0x80108f06,0x4(%esp)
80101cd4:	80 
80101cd5:	c7 04 24 20 08 11 80 	movl   $0x80110820,(%esp)
80101cdc:	e8 a1 39 00 00       	call   80105682 <initlock>
}
80101ce1:	c9                   	leave  
80101ce2:	c3                   	ret    
...
80101d5e:	e8 8f 3b 00 00       	call   801058f2 <memset>
      dip->type = type;
...
80101dae:	0f 82 5a ff ff ff    	jb     80101d0e <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101db4:	c7 04 24 0d 8f 10 80 	movl   $0x80108f0d,(%esp)
...
80101e5b:	e8 65 3b 00 00       	call   801059c5 <memmove>
  log_write(bp);
...
80101e85:	e8 19 38 00 00       	call   801056a3 <acquire>
...
80101ecf:	e8 31 38 00 00       	call   80105705 <release>
      return ip;
...
80101f02:	c7 04 24 1f 8f 10 80 	movl   $0x80108f1f,(%esp)
...
80101f40:	e8 c0 37 00 00       	call   80105705 <release>
...
80101f57:	e8 47 37 00 00       	call   801056a3 <acquire>
  ip->ref++;
...
80101f72:	e8 8e 37 00 00       	call   80105705 <release>
  return ip;
...
80101f90:	7f 0c                	jg     80101f9e <ilock+0x22>
    panic("ilock");
80101f92:	c7 04 24 2f 8f 10 80 	movl   $0x80108f2f,(%esp)
80101f99:	e8 9f e5 ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101f9e:	c7 04 24 20 08 11 80 	movl   $0x80110820,(%esp)
80101fa5:	e8 f9 36 00 00       	call   801056a3 <acquire>
...
80101fba:	e8 6a 33 00 00       	call   80105329 <sleep>
...
80101fe4:	e8 1c 37 00 00       	call   80105705 <release>
...
8010208f:	e8 31 39 00 00       	call   801059c5 <memmove>
    brelse(bp);
...
801020ba:	75 0c                	jne    801020c8 <ilock+0x14c>
      panic("ilock: no type");
801020bc:	c7 04 24 35 8f 10 80 	movl   $0x80108f35,(%esp)
...
801020eb:	7f 0c                	jg     801020f9 <iunlock+0x2f>
    panic("iunlock");
801020ed:	c7 04 24 44 8f 10 80 	movl   $0x80108f44,(%esp)
801020f4:	e8 44 e4 ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801020f9:	c7 04 24 20 08 11 80 	movl   $0x80110820,(%esp)
80102100:	e8 9e 35 00 00       	call   801056a3 <acquire>
  ip->flags &= ~I_BUSY;
...
8010211c:	e8 76 33 00 00       	call   80105497 <wakeup>
  release(&icache.lock);
80102121:	c7 04 24 20 08 11 80 	movl   $0x80110820,(%esp)
80102128:	e8 d8 35 00 00       	call   80105705 <release>
}
8010212d:	c9                   	leave  
8010212e:	c3                   	ret    
...
8010213c:	e8 62 35 00 00       	call   801056a3 <acquire>
...
80102178:	74 0c                	je     80102186 <iput+0x57>
      panic("iput busy");
8010217a:	c7 04 24 4c 8f 10 80 	movl   $0x80108f4c,(%esp)
...
8010219e:	e8 62 35 00 00       	call   80105705 <release>
    itrunc(ip);
...
801021c9:	e8 d5 34 00 00       	call   801056a3 <acquire>
    ip->flags = 0;
...
801021de:	e8 b4 32 00 00       	call   80105497 <wakeup>
  }
  ip->ref--;
...
801021f9:	e8 07 35 00 00       	call   80105705 <release>
}
801021fe:	c9                   	leave  
801021ff:	c3                   	ret    
...
8010230e:	c7 04 24 56 8f 10 80 	movl   $0x80108f56,(%esp)
...
801025a6:	e8 1a 34 00 00       	call   801059c5 <memmove>
    brelse(bp);
...
8010270c:	e8 b4 32 00 00       	call   801059c5 <memmove>
    log_write(bp);
...
8010278e:	e8 d6 32 00 00       	call   80105a69 <strncmp>
}
80102793:	c9                   	leave  
80102794:	c3                   	ret    
...
801027a8:	c7 04 24 69 8f 10 80 	movl   $0x80108f69,(%esp)
...
801027e4:	74 0c                	je     801027f2 <dirlookup+0x5d>
      panic("dirlink read");
801027e6:	c7 04 24 7b 8f 10 80 	movl   $0x80108f7b,(%esp)
...
801028c8:	74 0c                	je     801028d6 <dirlink+0x79>
      panic("dirlink read");
801028ca:	c7 04 24 7b 8f 10 80 	movl   $0x80108f7b,(%esp)
...
80102910:	e8 ac 31 00 00       	call   80105ac1 <strncpy>
  de.inum = inum;
...
80102940:	74 0c                	je     8010294e <dirlink+0xf1>
    panic("dirlink");
80102942:	c7 04 24 88 8f 10 80 	movl   $0x80108f88,(%esp)
...
801029c9:	e8 f7 2f 00 00       	call   801059c5 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801029e4:	e8 dc 2f 00 00       	call   801059c5 <memmove>
    name[len] = 0;
...
80102c40:	c7 44 24 04 90 8f 10 	movl   $0x80108f90,0x4(%esp)
80102c47:	80 
80102c48:	c7 04 24 c0 d5 10 80 	movl   $0x8010d5c0,(%esp)
80102c4f:	e8 2e 2a 00 00       	call   80105682 <initlock>
  picenable(IRQ_IDE);
...
80102cea:	75 0c                	jne    80102cf8 <idestart+0x18>
    panic("idestart");
80102cec:	c7 04 24 94 8f 10 80 	movl   $0x80108f94,(%esp)
...
80102e12:	e8 8c 28 00 00       	call   801056a3 <acquire>
  if((b = idequeue) == 0){
...
80102e2c:	e8 d4 28 00 00       	call   80105705 <release>
...
80102e9f:	e8 f3 25 00 00       	call   80105497 <wakeup>
...
80102ec1:	e8 3f 28 00 00       	call   80105705 <release>
}
80102ec6:	c9                   	leave  
80102ec7:	c3                   	ret    
...
80102eda:	c7 04 24 9d 8f 10 80 	movl   $0x80108f9d,(%esp)
...
80102ef3:	c7 04 24 b1 8f 10 80 	movl   $0x80108fb1,(%esp)
...
80102f7e:	e8 a6 23 00 00       	call   80105329 <sleep>
...
80102f9a:	e8 66 27 00 00       	call   80105705 <release>
}
80102f9f:	c9                   	leave  
80102fa0:	c3                   	ret    
...
8010302a:	c7 04 24 e4 8f 10 80 	movl   $0x80108fe4,(%esp)
...
801030eb:	c7 44 24 04 16 90 10 	movl   $0x80109016,0x4(%esp)
801030f2:	80 
801030f3:	c7 04 24 00 18 11 80 	movl   $0x80111800,(%esp)
801030fa:	e8 83 25 00 00       	call   80105682 <initlock>
  kmem.use_lock = 0;
...
801031a5:	76 0c                	jbe    801031b3 <kfree+0x39>
    panic("kfree");
801031a7:	c7 04 24 1b 90 10 80 	movl   $0x8010901b,(%esp)
...
801031c9:	e8 24 27 00 00       	call   801058f2 <memset>
...
801031de:	e8 c0 24 00 00       	call   801056a3 <acquire>
  r = (struct run*)v;
...
8010320c:	e8 f4 24 00 00       	call   80105705 <release>
}
80103211:	c9                   	leave  
80103212:	c3                   	ret    
...
80103229:	e8 75 24 00 00       	call   801056a3 <acquire>
  r = kmem.freelist;
...
80103256:	e8 aa 24 00 00       	call   80105705 <release>
  return (char*)r;
...
801035d2:	c7 04 24 24 90 10 80 	movl   $0x80109024,(%esp)
...
8010372a:	c7 44 24 04 50 90 10 	movl   $0x80109050,0x4(%esp)
80103731:	80 
80103732:	c7 04 24 40 18 11 80 	movl   $0x80111840,(%esp)
80103739:	e8 44 1f 00 00       	call   80105682 <initlock>
  readsb(ROOTDEV, &sb);
...
801037ec:	e8 d4 21 00 00       	call   801059c5 <memmove>
...
8010393e:	e8 60 1d 00 00       	call   801056a3 <acquire>
  while (log.busy) {
...
80103954:	e8 d0 19 00 00       	call   80105329 <sleep>
...
80103973:	e8 8d 1d 00 00       	call   80105705 <release>
}
80103978:	c9                   	leave  
80103979:	c3                   	ret    
...
801039f4:	c7 04 24 54 90 10 80 	movl   $0x80109054,(%esp)
...
80103a09:	c7 04 24 6a 90 10 80 	movl   $0x8010906a,(%esp)
...
80103a98:	e8 28 1f 00 00       	call   801059c5 <memmove>
  bwrite(lbuf);
...
80103b38:	e8 71 4b 00 00       	call   801086ae <kvmalloc>
...
80103b4f:	e8 fd 44 00 00       	call   80108051 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103b64:	c7 04 24 81 90 10 80 	movl   $0x80109081,(%esp)
...
80103b7f:	e8 18 38 00 00       	call   8010739c <uartinit>
  pinit();         // process table
80103b84:	e8 96 0b 00 00       	call   8010471f <pinit>
  tvinit();        // trap vectors
80103b89:	e8 cd 32 00 00       	call   80106e5b <tvinit>
  binit();         // buffer cache
...
80103bab:	e8 ee 31 00 00       	call   80106d9e <timerinit>
...
80103bd6:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
80103bd9:	e8 e7 4a 00 00       	call   801086c5 <switchkvm>
  seginit();
80103bde:	e8 6e 44 00 00       	call   80108051 <seginit>
  lapicinit(cpunum());
...
80103c0b:	c7 04 24 98 90 10 80 	movl   $0x80109098,(%esp)
80103c12:	e8 8a c7 ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103c17:	e8 b3 33 00 00       	call   80106fcf <idtinit>
...
80103c69:	e8 57 1d 00 00       	call   801059c5 <memmove>
...
80103df7:	00 
80103df8:	c7 44 24 04 ac 90 10 	movl   $0x801090ac,0x4(%esp)
80103dff:	80 
80103e00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103e03:	89 04 24             	mov    %eax,(%esp)
80103e06:	e8 5e 1b 00 00       	call   80105969 <memcmp>
...
80103f38:	00 
80103f39:	c7 44 24 04 b1 90 10 	movl   $0x801090b1,0x4(%esp)
80103f40:	80 
80103f41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103f44:	89 04 24             	mov    %eax,(%esp)
80103f47:	e8 1d 1a 00 00       	call   80105969 <memcmp>
...
80104012:	8b 04 85 f4 90 10 80 	mov    -0x7fef6f0c(,%eax,4),%eax
...
8010404b:	c7 04 24 b6 90 10 80 	movl   $0x801090b6,(%esp)
...
801040de:	c7 04 24 d4 90 10 80 	movl   $0x801090d4,(%esp)
...
801043e3:	c7 44 24 04 08 91 10 	movl   $0x80109108,0x4(%esp)
801043ea:	80 
801043eb:	89 04 24             	mov    %eax,(%esp)
801043ee:	e8 8f 12 00 00       	call   80105682 <initlock>
  (*f0)->type = FD_PIPE;
...
8010449b:	e8 03 12 00 00       	call   801056a3 <acquire>
  if(writable){
...
801044be:	e8 d4 0f 00 00       	call   80105497 <wakeup>
...
801044dd:	e8 b5 0f 00 00       	call   80105497 <wakeup>
  }
...
80104502:	e8 fe 11 00 00       	call   80105705 <release>
    kfree((char*)p);
...
8010451a:	e8 e6 11 00 00       	call   80105705 <release>
}
8010451f:	c9                   	leave  
80104520:	c3                   	ret    
...
8010452e:	e8 70 11 00 00       	call   801056a3 <acquire>
  for(i = 0; i < n; i++){
...
8010455f:	e8 a1 11 00 00       	call   80105705 <release>
        return -1;
...
80104579:	e8 19 0f 00 00       	call   80105497 <wakeup>
...
80104591:	e8 93 0d 00 00       	call   80105329 <sleep>
...
801045f8:	e8 9a 0e 00 00       	call   80105497 <wakeup>
  release(&p->lock);
801045fd:	8b 45 08             	mov    0x8(%ebp),%eax
80104600:	89 04 24             	mov    %eax,(%esp)
80104603:	e8 fd 10 00 00       	call   80105705 <release>
  return n;
...
8010461e:	e8 80 10 00 00       	call   801056a3 <acquire>
...
80104638:	e8 c8 10 00 00       	call   80105705 <release>
      return -1;
...
8010465a:	e8 ca 0c 00 00       	call   80105329 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801046ea:	e8 a8 0d 00 00       	call   80105497 <wakeup>
  release(&p->lock);
801046ef:	8b 45 08             	mov    0x8(%ebp),%eax
801046f2:	89 04 24             	mov    %eax,(%esp)
801046f5:	e8 0b 10 00 00       	call   80105705 <release>
  return i;
...
8010472f:	c7 44 24 04 0d 91 10 	movl   $0x8010910d,0x4(%esp)
80104736:	80 
80104737:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
8010473e:	e8 3f 0f 00 00       	call   80105682 <initlock>
}
80104743:	c9                   	leave  
80104744:	c3                   	ret    
...
80104752:	e8 4c 0f 00 00       	call   801056a3 <acquire>
...
80104781:	e8 7f 0f 00 00       	call   80105705 <release>
  return 0;
...
80104819:	e8 e7 0e 00 00       	call   80105705 <release>
...
80104863:	ba 10 6e 10 80       	mov    $0x80106e10,%edx
...
80104893:	e8 5a 10 00 00       	call   801058f2 <memset>
  p->context->eip = (uint)forkret;
80104898:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010489b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010489e:	ba fd 52 10 80       	mov    $0x801052fd,%edx
...
801048d5:	e8 17 3d 00 00       	call   801085f1 <setupkvm>
...
801048ea:	c7 04 24 14 91 10 80 	movl   $0x80109114,(%esp)
...
80104910:	e8 34 3f 00 00       	call   80108849 <inituvm>
  p->sz = PGSIZE;
...
80104937:	e8 b6 0f 00 00       	call   801058f2 <memset>
...
801049b0:	00 
801049b1:	c7 44 24 04 2d 91 10 	movl   $0x8010912d,0x4(%esp)
801049b8:	80 
801049b9:	89 04 24             	mov    %eax,(%esp)
801049bc:	e8 61 11 00 00       	call   80105b22 <safestrcpy>
  p->cwd = namei("/");
801049c1:	c7 04 24 36 91 10 80 	movl   $0x80109136,(%esp)
...
80104a15:	e8 a9 3f 00 00       	call   801089c3 <allocuvm>
...
80104a4f:	e8 49 40 00 00       	call   80108a9d <deallocuvm>
...
80104a78:	e8 65 3c 00 00       	call   801086e2 <switchuvm>
  return 0;
...
80104abd:	e8 6b 41 00 00       	call   80108c2d <copyuvm>
...
80104bd7:	e8 46 0f 00 00       	call   80105b22 <safestrcpy>
  return pid;
...
80104bfb:	75 0c                	jne    80104c09 <exit+0x22>
    panic("init exiting");
80104bfd:	c7 04 24 38 91 10 80 	movl   $0x80109138,(%esp)
...
80104c81:	e8 1d 0a 00 00       	call   801056a3 <acquire>
...
80104ca4:	e8 37 07 00 00       	call   801053e0 <wakeup1>
...
80104ce1:	e8 fa 06 00 00       	call   801053e0 <wakeup1>
...
80104cfc:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104d03:	e8 f7 04 00 00       	call   801051ff <sched>
  panic("zombie exit");
80104d08:	c7 04 24 45 91 10 80 	movl   $0x80109145,(%esp)
...
80104d21:	e8 7d 09 00 00       	call   801056a3 <acquire>
  for(;;){
...
80104d89:	e8 cb 3d 00 00       	call   80108b59 <freevm>
        p->state = UNUSED;
...
80104dc4:	e8 3c 09 00 00       	call   80105705 <release>
        return pid;
...
80104dfd:	e8 03 09 00 00       	call   80105705 <release>
      return -1;
...
80104e1a:	e8 0a 05 00 00       	call   80105329 <sleep>
  }
...
80104e33:	e8 6b 08 00 00       	call   801056a3 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
...
80104e9f:	e8 b5 3c 00 00       	call   80108b59 <freevm>
        p->state = UNUSED;
...
80104f22:	e8 de 07 00 00       	call   80105705 <release>
        return pid;
...
80104f5b:	e8 a5 07 00 00       	call   80105705 <release>
      return -1;
...
80104f78:	e8 ac 03 00 00       	call   80105329 <sleep>
  }
...
80104fa8:	e8 91 3d 00 00       	call   80108d3e <uva2ka>
...
80104fc3:	75 0c                	jne    80104fd1 <register_handler+0x4d>
    panic("esp_offset == 0");
80104fc5:	c7 04 24 51 91 10 80 	movl   $0x80109151,(%esp)
...
80105036:	e8 68 06 00 00       	call   801056a3 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010503b:	c7 45 f4 14 1f 11 80 	movl   $0x80111f14,-0xc(%ebp)
80105042:	e9 9a 01 00 00       	jmp    801051e1 <scheduler+0x1bd>
      if(p->state != RUNNABLE)
80105047:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010504a:	8b 40 0c             	mov    0xc(%eax),%eax
8010504d:	83 f8 03             	cmp    $0x3,%eax
80105050:	0f 85 83 01 00 00    	jne    801051d9 <scheduler+0x1b5>
	}
      }
      p = winner;
      #endif // FRR or FCFS
...
80105056:	a1 14 47 11 80       	mov    0x80114714,%eax
8010505b:	89 45 f0             	mov    %eax,-0x10(%ebp)
      struct proc *winner = 0;
8010505e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
      // look for HIGH priority process
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105065:	c7 45 f4 14 1f 11 80 	movl   $0x80111f14,-0xc(%ebp)
8010506c:	eb 40                	jmp    801050ae <scheduler+0x8a>
...
80105074:	83 f8 03             	cmp    $0x3,%eax
80105077:	75 2e                	jne    801050a7 <scheduler+0x83>
80105079:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010507c:	8b 80 9c 00 00 00    	mov    0x9c(%eax),%eax
80105082:	83 f8 01             	cmp    $0x1,%eax
80105085:	75 20                	jne    801050a7 <scheduler+0x83>
80105087:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010508a:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
80105090:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80105093:	7d 12                	jge    801050a7 <scheduler+0x83>
	  minQueue = p->queuenum;
80105095:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105098:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
8010509e:	89 45 f0             	mov    %eax,-0x10(%ebp)
	  winner = p;
...
801050a4:	89 45 ec             	mov    %eax,-0x14(%ebp)
      ...
      // look for HIGH priority process
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801050a7:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
801050ae:	81 7d f4 14 47 11 80 	cmpl   $0x80114714,-0xc(%ebp)
801050b5:	72 b7                	jb     8010506e <scheduler+0x4a>
	if(p->state == RUNNABLE && p->priority == HIGH && p->queuenum < minQueue){
	  minQueue = p->queuenum;
	  winner = p;
	}
      ...
      if (!winner){
801050b7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801050bb:	75 5a                	jne    80105117 <scheduler+0xf3>
	  // look for MEDIUM priority process
	  minQueue = ptable.FRR_COUNTER; // dummy value
801050bd:	a1 14 47 11 80       	mov    0x80114714,%eax
801050c2:	89 45 f0             	mov    %eax,-0x10(%ebp)
	  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801050c5:	c7 45 f4 14 1f 11 80 	movl   $0x80111f14,-0xc(%ebp)
801050cc:	eb 40                	jmp    8010510e <scheduler+0xea>
...
801050d4:	83 f8 03             	cmp    $0x3,%eax
801050d7:	75 2e                	jne    80105107 <scheduler+0xe3>
801050d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050dc:	8b 80 9c 00 00 00    	mov    0x9c(%eax),%eax
801050e2:	83 f8 02             	cmp    $0x2,%eax
801050e5:	75 20                	jne    80105107 <scheduler+0xe3>
801050e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050ea:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
801050f0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801050f3:	7d 12                	jge    80105107 <scheduler+0xe3>
	    minQueue = p->queuenum;
801050f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050f8:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
801050fe:	89 45 f0             	mov    %eax,-0x10(%ebp)
	    winner = p;
80105101:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105104:	89 45 ec             	mov    %eax,-0x14(%ebp)
	}
      }
      if (!winner){
	  // look for MEDIUM priority process
	  minQueue = ptable.FRR_COUNTER; // dummy value
	  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105107:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
8010510e:	81 7d f4 14 47 11 80 	cmpl   $0x80114714,-0xc(%ebp)
80105115:	72 b7                	jb     801050ce <scheduler+0xaa>
	    minQueue = p->queuenum;
	    winner = p;
	  }
	}
      ...
      if (!winner){
80105117:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010511b:	75 5a                	jne    80105177 <scheduler+0x153>
	  // look for LOW priority process
	  minQueue = ptable.FRR_COUNTER; // dummy value
8010511d:	a1 14 47 11 80       	mov    0x80114714,%eax
80105122:	89 45 f0             	mov    %eax,-0x10(%ebp)
	  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105125:	c7 45 f4 14 1f 11 80 	movl   $0x80111f14,-0xc(%ebp)
8010512c:	eb 40                	jmp    8010516e <scheduler+0x14a>
	  if(p->state == RUNNABLE && p->priority == LOW && p->queuenum < minQueue){
8010512e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105131:	8b 40 0c             	mov    0xc(%eax),%eax
80105134:	83 f8 03             	cmp    $0x3,%eax
80105137:	75 2e                	jne    80105167 <scheduler+0x143>
80105139:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010513c:	8b 80 9c 00 00 00    	mov    0x9c(%eax),%eax
80105142:	83 f8 03             	cmp    $0x3,%eax
80105145:	75 20                	jne    80105167 <scheduler+0x143>
80105147:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010514a:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
80105150:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80105153:	7d 12                	jge    80105167 <scheduler+0x143>
	    minQueue = p->queuenum;
80105155:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105158:	8b 80 98 00 00 00    	mov    0x98(%eax),%eax
8010515e:	89 45 f0             	mov    %eax,-0x10(%ebp)
	    winner = p;
80105161:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105164:	89 45 ec             	mov    %eax,-0x14(%ebp)
	}
      }
      if (!winner){
	  // look for LOW priority process
	  minQueue = ptable.FRR_COUNTER; // dummy value
	  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105167:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
8010516e:	81 7d f4 14 47 11 80 	cmpl   $0x80114714,-0xc(%ebp)
80105175:	72 b7                	jb     8010512e <scheduler+0x10a>
	    minQueue = p->queuenum;
	    winner = p;
	  }
	}
      ...
      p = winner;
80105177:	8b 45 ec             	mov    -0x14(%ebp),%eax
...
80105180:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80105186:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105189:	89 04 24             	mov    %eax,(%esp)
8010518c:	e8 51 35 00 00       	call   801086e2 <switchuvm>
      p->state = RUNNING;
80105191:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105194:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      p->quanta = 1;
8010519b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010519e:	c7 80 94 00 00 00 01 	movl   $0x1,0x94(%eax)
801051a5:	00 00 00 
      swtch(&cpu->scheduler, proc->context);
801051a8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051ae:	8b 40 1c             	mov    0x1c(%eax),%eax
801051b1:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801051b8:	83 c2 04             	add    $0x4,%edx
801051bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801051bf:	89 14 24             	mov    %edx,(%esp)
801051c2:	e8 d1 09 00 00       	call   80105b98 <swtch>
      switchkvm();
801051c7:	e8 f9 34 00 00       	call   801086c5 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
801051cc:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801051d3:	00 00 00 00 
801051d7:	eb 01                	jmp    801051da <scheduler+0x1b6>
...
801051d9:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801051da:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
801051e1:	81 7d f4 14 47 11 80 	cmpl   $0x80114714,-0xc(%ebp)
801051e8:	0f 82 59 fe ff ff    	jb     80105047 <scheduler+0x23>
    ...
    release(&ptable.lock);
801051ee:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801051f5:	e8 0b 05 00 00       	call   80105705 <release>

  }
801051fa:	e9 2b fe ff ff       	jmp    8010502a <scheduler+0x6>
...
80105202:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80105205:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
8010520c:	e8 b0 05 00 00       	call   801057c1 <holding>
80105211:	85 c0                	test   %eax,%eax
80105213:	75 0c                	jne    80105221 <sched+0x22>
    panic("sched ptable.lock");
80105215:	c7 04 24 61 91 10 80 	movl   $0x80109161,(%esp)
8010521c:	e8 1c b3 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80105221:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105227:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010522d:	83 f8 01             	cmp    $0x1,%eax
80105230:	74 0c                	je     8010523e <sched+0x3f>
    panic("sched locks");
80105232:	c7 04 24 73 91 10 80 	movl   $0x80109173,(%esp)
80105239:	e8 ff b2 ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
8010523e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105244:	8b 40 0c             	mov    0xc(%eax),%eax
80105247:	83 f8 04             	cmp    $0x4,%eax
8010524a:	75 0c                	jne    80105258 <sched+0x59>
    panic("sched running");
8010524c:	c7 04 24 7f 91 10 80 	movl   $0x8010917f,(%esp)
80105253:	e8 e5 b2 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80105258:	e8 a7 f4 ff ff       	call   80104704 <readeflags>
8010525d:	25 00 02 00 00       	and    $0x200,%eax
80105262:	85 c0                	test   %eax,%eax
80105264:	74 0c                	je     80105272 <sched+0x73>
    panic("sched interruptible");
80105266:	c7 04 24 8d 91 10 80 	movl   $0x8010918d,(%esp)
...
8010527e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80105281:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105287:	8b 40 04             	mov    0x4(%eax),%eax
8010528a:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105291:	83 c2 1c             	add    $0x1c,%edx
80105294:	89 44 24 04          	mov    %eax,0x4(%esp)
80105298:	89 14 24             	mov    %edx,(%esp)
8010529b:	e8 f8 08 00 00       	call   80105b98 <swtch>
  cpu->intena = intena;
801052a0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801052a6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801052a9:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801052af:	c9                   	leave  
801052b0:	c3                   	ret    
...
801052b7:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801052be:	e8 e0 03 00 00       	call   801056a3 <acquire>
  proc->state = RUNNABLE;
801052c3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052c9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  proc->queuenum = ptable.FRR_COUNTER++;
801052d0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801052d7:	a1 14 47 11 80       	mov    0x80114714,%eax
801052dc:	89 82 98 00 00 00    	mov    %eax,0x98(%edx)
801052e2:	83 c0 01             	add    $0x1,%eax
801052e5:	a3 14 47 11 80       	mov    %eax,0x80114714
  sched();
801052ea:	e8 10 ff ff ff       	call   801051ff <sched>
  release(&ptable.lock);
801052ef:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801052f6:	e8 0a 04 00 00       	call   80105705 <release>
}
801052fb:	c9                   	leave  
801052fc:	c3                   	ret    
...
80105300:	83 ec 18             	sub    $0x18,%esp
  static int first = 1;
  // Still holding ptable.lock from scheduler.
  release(&ptable.lock);
80105303:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
8010530a:	e8 f6 03 00 00       	call   80105705 <release>

  if (first) {
8010530f:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80105314:	85 c0                	test   %eax,%eax
80105316:	74 0f                	je     80105327 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80105318:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
8010531f:	00 00 00 
    initlog();
80105322:	e8 fd e3 ff ff       	call   80103724 <initlog>
  }
...
80105337:	75 0c                	jne    80105345 <sleep+0x1c>
    panic("sleep");
80105339:	c7 04 24 a1 91 10 80 	movl   $0x801091a1,(%esp)
80105340:	e8 f8 b1 ff ff       	call   8010053d <panic>

  if(lk == 0)
80105345:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105349:	75 0c                	jne    80105357 <sleep+0x2e>
    panic("sleep without lk");
8010534b:	c7 04 24 a7 91 10 80 	movl   $0x801091a7,(%esp)
...
80105357:	81 7d 0c e0 1e 11 80 	cmpl   $0x80111ee0,0xc(%ebp)
8010535e:	74 17                	je     80105377 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80105360:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
80105367:	e8 37 03 00 00       	call   801056a3 <acquire>
    release(lk);
8010536c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010536f:	89 04 24             	mov    %eax,(%esp)
80105372:	e8 8e 03 00 00       	call   80105705 <release>
  }
...
8010537f:	74 12                	je     80105393 <sleep+0x6a>
    proc->sleeptime = ticks;
80105381:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105387:	8b 15 60 4f 11 80    	mov    0x80114f60,%edx
8010538d:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
  proc->chan = chan;
80105393:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105399:	8b 55 08             	mov    0x8(%ebp),%edx
8010539c:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
8010539f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053a5:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
801053ac:	e8 4e fe ff ff       	call   801051ff <sched>

  // Tidy up.
  proc->chan = 0;
801053b1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053b7:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
801053be:	81 7d 0c e0 1e 11 80 	cmpl   $0x80111ee0,0xc(%ebp)
801053c5:	74 17                	je     801053de <sleep+0xb5>
    release(&ptable.lock);
801053c7:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801053ce:	e8 32 03 00 00       	call   80105705 <release>
    acquire(lk);
801053d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801053d6:	89 04 24             	mov    %eax,(%esp)
801053d9:	e8 c5 02 00 00       	call   801056a3 <acquire>
  }
}
801053de:	c9                   	leave  
801053df:	c3                   	ret    
...
801053e3:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801053e6:	c7 45 fc 14 1f 11 80 	movl   $0x80111f14,-0x4(%ebp)
801053ed:	e9 96 00 00 00       	jmp    80105488 <wakeup1+0xa8>
    if(p->state == SLEEPING && p->chan == chan){
801053f2:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053f5:	8b 40 0c             	mov    0xc(%eax),%eax
801053f8:	83 f8 02             	cmp    $0x2,%eax
801053fb:	0f 85 80 00 00 00    	jne    80105481 <wakeup1+0xa1>
80105401:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105404:	8b 40 20             	mov    0x20(%eax),%eax
80105407:	3b 45 08             	cmp    0x8(%ebp),%eax
8010540a:	75 75                	jne    80105481 <wakeup1+0xa1>
      p->state = RUNNABLE;
8010540c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010540f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      if (p->priority == LOW)
80105416:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105419:	8b 80 9c 00 00 00    	mov    0x9c(%eax),%eax
8010541f:	83 f8 03             	cmp    $0x3,%eax
80105422:	75 0f                	jne    80105433 <wakeup1+0x53>
	p->priority = MEDIUM;
80105424:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105427:	c7 80 9c 00 00 00 02 	movl   $0x2,0x9c(%eax)
8010542e:	00 00 00 
80105431:	eb 0d                	jmp    80105440 <wakeup1+0x60>
      else
	p->priority = HIGH;
80105433:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105436:	c7 80 9c 00 00 00 01 	movl   $0x1,0x9c(%eax)
8010543d:	00 00 00 
      p->queuenum = ptable.FRR_COUNTER++;
80105440:	a1 14 47 11 80       	mov    0x80114714,%eax
80105445:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105448:	89 82 98 00 00 00    	mov    %eax,0x98(%edx)
8010544e:	83 c0 01             	add    $0x1,%eax
80105451:	a3 14 47 11 80       	mov    %eax,0x80114714
      int tmp = ticks;
80105456:	a1 60 4f 11 80       	mov    0x80114f60,%eax
8010545b:	89 45 f8             	mov    %eax,-0x8(%ebp)
      tmp = tmp - p->sleeptime;
8010545e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105461:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
80105467:	29 45 f8             	sub    %eax,-0x8(%ebp)
      p->iotime = p->iotime + tmp;
8010546a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010546d:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80105473:	89 c2                	mov    %eax,%edx
80105475:	03 55 f8             	add    -0x8(%ebp),%edx
80105478:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010547b:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80105481:	81 45 fc a0 00 00 00 	addl   $0xa0,-0x4(%ebp)
80105488:	81 7d fc 14 47 11 80 	cmpl   $0x80114714,-0x4(%ebp)
8010548f:	0f 82 5d ff ff ff    	jb     801053f2 <wakeup1+0x12>
      p->queuenum = ptable.FRR_COUNTER++;
      int tmp = ticks;
      tmp = tmp - p->sleeptime;
      p->iotime = p->iotime + tmp;
...
8010549a:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
8010549d:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801054a4:	e8 fa 01 00 00       	call   801056a3 <acquire>
  wakeup1(chan);
801054a9:	8b 45 08             	mov    0x8(%ebp),%eax
801054ac:	89 04 24             	mov    %eax,(%esp)
801054af:	e8 2c ff ff ff       	call   801053e0 <wakeup1>
  release(&ptable.lock);
801054b4:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801054bb:	e8 45 02 00 00       	call   80105705 <release>
}
801054c0:	c9                   	leave  
801054c1:	c3                   	ret    
...
801054c5:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801054c8:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
801054cf:	e8 cf 01 00 00       	call   801056a3 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801054d4:	c7 45 f4 14 1f 11 80 	movl   $0x80111f14,-0xc(%ebp)
801054db:	eb 44                	jmp    80105521 <kill+0x5f>
    if(p->pid == pid){
801054dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054e0:	8b 40 10             	mov    0x10(%eax),%eax
801054e3:	3b 45 08             	cmp    0x8(%ebp),%eax
801054e6:	75 32                	jne    8010551a <kill+0x58>
      p->killed = 1;
801054e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054eb:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801054f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054f5:	8b 40 0c             	mov    0xc(%eax),%eax
801054f8:	83 f8 02             	cmp    $0x2,%eax
801054fb:	75 0a                	jne    80105507 <kill+0x45>
        p->state = RUNNABLE;
801054fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105500:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80105507:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
8010550e:	e8 f2 01 00 00       	call   80105705 <release>
      return 0;
80105513:	b8 00 00 00 00       	mov    $0x0,%eax
80105518:	eb 21                	jmp    8010553b <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010551a:	81 45 f4 a0 00 00 00 	addl   $0xa0,-0xc(%ebp)
80105521:	81 7d f4 14 47 11 80 	cmpl   $0x80114714,-0xc(%ebp)
80105528:	72 b3                	jb     801054dd <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
8010552a:	c7 04 24 e0 1e 11 80 	movl   $0x80111ee0,(%esp)
80105531:	e8 cf 01 00 00       	call   80105705 <release>
  return -1;
...
80105540:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105543:	c7 45 f0 14 1f 11 80 	movl   $0x80111f14,-0x10(%ebp)
8010554a:	e9 db 00 00 00       	jmp    8010562a <procdump+0xed>
    if(p->state == UNUSED)
8010554f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105552:	8b 40 0c             	mov    0xc(%eax),%eax
80105555:	85 c0                	test   %eax,%eax
80105557:	0f 84 c5 00 00 00    	je     80105622 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010555d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105560:	8b 40 0c             	mov    0xc(%eax),%eax
80105563:	83 f8 05             	cmp    $0x5,%eax
80105566:	77 23                	ja     8010558b <procdump+0x4e>
80105568:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010556b:	8b 40 0c             	mov    0xc(%eax),%eax
8010556e:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105575:	85 c0                	test   %eax,%eax
80105577:	74 12                	je     8010558b <procdump+0x4e>
      state = states[p->state];
80105579:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010557c:	8b 40 0c             	mov    0xc(%eax),%eax
8010557f:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105586:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105589:	eb 07                	jmp    80105592 <procdump+0x55>
    else
      state = "???";
8010558b:	c7 45 ec b8 91 10 80 	movl   $0x801091b8,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80105592:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105595:	8d 50 6c             	lea    0x6c(%eax),%edx
80105598:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010559b:	8b 40 10             	mov    0x10(%eax),%eax
8010559e:	89 54 24 0c          	mov    %edx,0xc(%esp)
801055a2:	8b 55 ec             	mov    -0x14(%ebp),%edx
801055a5:	89 54 24 08          	mov    %edx,0x8(%esp)
801055a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801055ad:	c7 04 24 bc 91 10 80 	movl   $0x801091bc,(%esp)
801055b4:	e8 e8 ad ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
801055b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055bc:	8b 40 0c             	mov    0xc(%eax),%eax
801055bf:	83 f8 02             	cmp    $0x2,%eax
801055c2:	75 50                	jne    80105614 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801055c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055c7:	8b 40 1c             	mov    0x1c(%eax),%eax
801055ca:	8b 40 0c             	mov    0xc(%eax),%eax
801055cd:	83 c0 08             	add    $0x8,%eax
801055d0:	8d 55 c4             	lea    -0x3c(%ebp),%edx
801055d3:	89 54 24 04          	mov    %edx,0x4(%esp)
801055d7:	89 04 24             	mov    %eax,(%esp)
801055da:	e8 75 01 00 00       	call   80105754 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
801055df:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801055e6:	eb 1b                	jmp    80105603 <procdump+0xc6>
        cprintf(" %p", pc[i]);
801055e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055eb:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
801055ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801055f3:	c7 04 24 c5 91 10 80 	movl   $0x801091c5,(%esp)
801055fa:	e8 a2 ad ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
801055ff:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105603:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105607:	7f 0b                	jg     80105614 <procdump+0xd7>
80105609:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010560c:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105610:	85 c0                	test   %eax,%eax
80105612:	75 d4                	jne    801055e8 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80105614:	c7 04 24 c9 91 10 80 	movl   $0x801091c9,(%esp)
8010561b:	e8 81 ad ff ff       	call   801003a1 <cprintf>
80105620:	eb 01                	jmp    80105623 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80105622:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105623:	81 45 f0 a0 00 00 00 	addl   $0xa0,-0x10(%ebp)
8010562a:	81 7d f0 14 47 11 80 	cmpl   $0x80114714,-0x10(%ebp)
80105631:	0f 82 18 ff ff ff    	jb     8010554f <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80105643:	9c                   	pushf  
80105644:	5b                   	pop    %ebx
80105645:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
80105661:	83 ec 10             	sub    $0x10,%esp
  ...
  asm volatile("lock; xchgl %0, %1" :
               "+m" (*addr), "=a" (result) :
80105664:	8b 55 08             	mov    0x8(%ebp),%edx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
8010566f:	89 d8                	mov    %ebx,%eax
80105671:	f0 87 02             	lock xchg %eax,(%edx)
80105674:	89 c3                	mov    %eax,%ebx
80105676:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
8010568b:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
8010568e:	8b 45 08             	mov    0x8(%ebp),%eax
80105691:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
...
801056a9:	e8 3d 01 00 00       	call   801057eb <pushcli>
  if(holding(lk))
801056ae:	8b 45 08             	mov    0x8(%ebp),%eax
801056b1:	89 04 24             	mov    %eax,(%esp)
801056b4:	e8 08 01 00 00       	call   801057c1 <holding>
801056b9:	85 c0                	test   %eax,%eax
801056bb:	74 0c                	je     801056c9 <acquire+0x26>
    panic("acquire");
801056bd:	c7 04 24 f5 91 10 80 	movl   $0x801091f5,(%esp)
801056c4:	e8 74 ae ff ff       	call   8010053d <panic>
...
801056cd:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801056d4:	00 
801056d5:	89 04 24             	mov    %eax,(%esp)
801056d8:	e8 80 ff ff ff       	call   8010565d <xchg>
801056dd:	85 c0                	test   %eax,%eax
801056df:	75 e9                	jne    801056ca <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801056e1:	8b 45 08             	mov    0x8(%ebp),%eax
801056e4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801056eb:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
801056ee:	8b 45 08             	mov    0x8(%ebp),%eax
801056f1:	83 c0 0c             	add    $0xc,%eax
801056f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801056f8:	8d 45 08             	lea    0x8(%ebp),%eax
801056fb:	89 04 24             	mov    %eax,(%esp)
801056fe:	e8 51 00 00 00       	call   80105754 <getcallerpcs>
}
80105703:	c9                   	leave  
80105704:	c3                   	ret    
...
80105711:	e8 ab 00 00 00       	call   801057c1 <holding>
80105716:	85 c0                	test   %eax,%eax
80105718:	75 0c                	jne    80105726 <release+0x21>
    panic("release");
8010571a:	c7 04 24 fd 91 10 80 	movl   $0x801091fd,(%esp)
80105721:	e8 17 ae ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
80105726:	8b 45 08             	mov    0x8(%ebp),%eax
80105729:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105730:	8b 45 08             	mov    0x8(%ebp),%eax
80105733:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105748:	e8 10 ff ff ff       	call   8010565d <xchg>

  popcli();
8010574d:	e8 e1 00 00 00       	call   80105833 <popcli>
}
80105752:	c9                   	leave  
80105753:	c3                   	ret    

80105754 <getcallerpcs>:
...
8010575d:	83 e8 08             	sub    $0x8,%eax
80105760:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105763:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
8010576a:	eb 32                	jmp    8010579e <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
8010576c:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105770:	74 47                	je     801057b9 <getcallerpcs+0x65>
80105772:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105779:	76 3e                	jbe    801057b9 <getcallerpcs+0x65>
8010577b:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010577f:	74 38                	je     801057b9 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105781:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105784:	c1 e0 02             	shl    $0x2,%eax
80105787:	03 45 0c             	add    0xc(%ebp),%eax
8010578a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010578d:	8b 52 04             	mov    0x4(%edx),%edx
80105790:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80105792:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105795:	8b 00                	mov    (%eax),%eax
80105797:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
8010579a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010579e:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801057a2:	7e c8                	jle    8010576c <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801057a4:	eb 13                	jmp    801057b9 <getcallerpcs+0x65>
    pcs[i] = 0;
801057a6:	8b 45 f8             	mov    -0x8(%ebp),%eax
801057a9:	c1 e0 02             	shl    $0x2,%eax
801057ac:	03 45 0c             	add    0xc(%ebp),%eax
801057af:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801057b5:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801057b9:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801057bd:	7e e7                	jle    801057a6 <getcallerpcs+0x52>
    pcs[i] = 0;
}
801057bf:	c9                   	leave  
801057c0:	c3                   	ret    
...
801057cb:	74 17                	je     801057e4 <holding+0x23>
801057cd:	8b 45 08             	mov    0x8(%ebp),%eax
801057d0:	8b 50 08             	mov    0x8(%eax),%edx
801057d3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801057d9:	39 c2                	cmp    %eax,%edx
801057db:	75 07                	jne    801057e4 <holding+0x23>
801057dd:	b8 01 00 00 00       	mov    $0x1,%eax
801057e2:	eb 05                	jmp    801057e9 <holding+0x28>
...
80105836:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105839:	e8 fe fd ff ff       	call   8010563c <readeflags>
8010583e:	25 00 02 00 00       	and    $0x200,%eax
80105843:	85 c0                	test   %eax,%eax
80105845:	74 0c                	je     80105853 <popcli+0x20>
    panic("popcli - interruptible");
80105847:	c7 04 24 05 92 10 80 	movl   $0x80109205,(%esp)
8010584e:	e8 ea ac ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80105853:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105859:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010585f:	83 ea 01             	sub    $0x1,%edx
80105862:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105868:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010586e:	85 c0                	test   %eax,%eax
80105870:	79 0c                	jns    8010587e <popcli+0x4b>
    panic("popcli");
80105872:	c7 04 24 1c 92 10 80 	movl   $0x8010921c,(%esp)
80105879:	e8 bf ac ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010587e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105884:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010588a:	85 c0                	test   %eax,%eax
8010588c:	75 15                	jne    801058a3 <popcli+0x70>
8010588e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105894:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010589a:	85 c0                	test   %eax,%eax
8010589c:	74 05                	je     801058a3 <popcli+0x70>
    sti();
8010589e:	e8 b4 fd ff ff       	call   80105657 <sti>
}
801058a3:	c9                   	leave  
801058a4:	c3                   	ret    
801058a5:	00 00                	add    %al,(%eax)
	...
...
801058ad:	8b 4d 08             	mov    0x8(%ebp),%ecx
801058b0:	8b 55 10             	mov    0x10(%ebp),%edx
801058b3:	8b 45 0c             	mov    0xc(%ebp),%eax
801058b6:	89 cb                	mov    %ecx,%ebx
801058b8:	89 df                	mov    %ebx,%edi
801058ba:	89 d1                	mov    %edx,%ecx
801058bc:	fc                   	cld    
801058bd:	f3 aa                	rep stos %al,%es:(%edi)
801058bf:	89 ca                	mov    %ecx,%edx
801058c1:	89 fb                	mov    %edi,%ebx
801058c3:	89 5d 08             	mov    %ebx,0x8(%ebp)
801058c6:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
801058d0:	57                   	push   %edi
801058d1:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
801058d2:	8b 4d 08             	mov    0x8(%ebp),%ecx
801058d5:	8b 55 10             	mov    0x10(%ebp),%edx
801058d8:	8b 45 0c             	mov    0xc(%ebp),%eax
801058db:	89 cb                	mov    %ecx,%ebx
801058dd:	89 df                	mov    %ebx,%edi
801058df:	89 d1                	mov    %edx,%ecx
801058e1:	fc                   	cld    
801058e2:	f3 ab                	rep stos %eax,%es:(%edi)
801058e4:	89 ca                	mov    %ecx,%edx
801058e6:	89 fb                	mov    %edi,%ebx
801058e8:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801058fb:	83 e0 03             	and    $0x3,%eax
801058fe:	85 c0                	test   %eax,%eax
80105900:	75 49                	jne    8010594b <memset+0x59>
80105902:	8b 45 10             	mov    0x10(%ebp),%eax
80105905:	83 e0 03             	and    $0x3,%eax
80105908:	85 c0                	test   %eax,%eax
8010590a:	75 3f                	jne    8010594b <memset+0x59>
    c &= 0xFF;
8010590c:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105913:	8b 45 10             	mov    0x10(%ebp),%eax
80105916:	c1 e8 02             	shr    $0x2,%eax
80105919:	89 c2                	mov    %eax,%edx
8010591b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010591e:	89 c1                	mov    %eax,%ecx
80105920:	c1 e1 18             	shl    $0x18,%ecx
80105923:	8b 45 0c             	mov    0xc(%ebp),%eax
80105926:	c1 e0 10             	shl    $0x10,%eax
80105929:	09 c1                	or     %eax,%ecx
8010592b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010592e:	c1 e0 08             	shl    $0x8,%eax
80105931:	09 c8                	or     %ecx,%eax
80105933:	0b 45 0c             	or     0xc(%ebp),%eax
80105936:	89 54 24 08          	mov    %edx,0x8(%esp)
8010593a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010593e:	8b 45 08             	mov    0x8(%ebp),%eax
80105941:	89 04 24             	mov    %eax,(%esp)
80105944:	e8 84 ff ff ff       	call   801058cd <stosl>
80105949:	eb 19                	jmp    80105964 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010595f:	e8 44 ff ff ff       	call   801058a8 <stosb>
  return dst;
...
80105972:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
80105975:	8b 45 0c             	mov    0xc(%ebp),%eax
80105978:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010597b:	eb 32                	jmp    801059af <memcmp+0x46>
    if(*s1 != *s2)
8010597d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105980:	0f b6 10             	movzbl (%eax),%edx
80105983:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105986:	0f b6 00             	movzbl (%eax),%eax
80105989:	38 c2                	cmp    %al,%dl
8010598b:	74 1a                	je     801059a7 <memcmp+0x3e>
      return *s1 - *s2;
8010598d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105990:	0f b6 00             	movzbl (%eax),%eax
80105993:	0f b6 d0             	movzbl %al,%edx
80105996:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105999:	0f b6 00             	movzbl (%eax),%eax
8010599c:	0f b6 c0             	movzbl %al,%eax
8010599f:	89 d1                	mov    %edx,%ecx
801059a1:	29 c1                	sub    %eax,%ecx
801059a3:	89 c8                	mov    %ecx,%eax
801059a5:	eb 1c                	jmp    801059c3 <memcmp+0x5a>
    s1++, s2++;
801059a7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801059ab:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
801059b3:	0f 95 c0             	setne  %al
801059b6:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801059ba:	84 c0                	test   %al,%al
801059bc:	75 bf                	jne    8010597d <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801059ce:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
801059d1:	8b 45 08             	mov    0x8(%ebp),%eax
801059d4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801059d7:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059da:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801059dd:	73 54                	jae    80105a33 <memmove+0x6e>
801059df:	8b 45 10             	mov    0x10(%ebp),%eax
801059e2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801059e5:	01 d0                	add    %edx,%eax
801059e7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801059ea:	76 47                	jbe    80105a33 <memmove+0x6e>
    s += n;
801059ec:	8b 45 10             	mov    0x10(%ebp),%eax
801059ef:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801059f2:	8b 45 10             	mov    0x10(%ebp),%eax
801059f5:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801059f8:	eb 13                	jmp    80105a0d <memmove+0x48>
      *--d = *--s;
801059fa:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801059fe:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105a02:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a05:	0f b6 10             	movzbl (%eax),%edx
80105a08:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105a0b:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
    d += n;
    while(n-- > 0)
80105a0d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a11:	0f 95 c0             	setne  %al
80105a14:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105a18:	84 c0                	test   %al,%al
80105a1a:	75 de                	jne    801059fa <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105a1c:	eb 25                	jmp    80105a43 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105a21:	0f b6 10             	movzbl (%eax),%edx
80105a24:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105a27:	88 10                	mov    %dl,(%eax)
80105a29:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105a2d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105a31:	eb 01                	jmp    80105a34 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105a3b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105a3f:	84 c0                	test   %al,%al
80105a41:	75 db                	jne    80105a1e <memmove+0x59>
      *d++ = *s++;
...
80105a4e:	8b 45 10             	mov    0x10(%ebp),%eax
...
80105a62:	e8 5e ff ff ff       	call   801059c5 <memmove>
}
80105a67:	c9                   	leave  
80105a68:	c3                   	ret    
...
80105a6a:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105a6c:	eb 0c                	jmp    80105a7a <strncmp+0x11>
    n--, p++, q++;
80105a6e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105a72:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105a76:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
80105a7e:	74 1a                	je     80105a9a <strncmp+0x31>
80105a80:	8b 45 08             	mov    0x8(%ebp),%eax
80105a83:	0f b6 00             	movzbl (%eax),%eax
80105a86:	84 c0                	test   %al,%al
80105a88:	74 10                	je     80105a9a <strncmp+0x31>
80105a8a:	8b 45 08             	mov    0x8(%ebp),%eax
80105a8d:	0f b6 10             	movzbl (%eax),%edx
80105a90:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a93:	0f b6 00             	movzbl (%eax),%eax
80105a96:	38 c2                	cmp    %al,%dl
80105a98:	74 d4                	je     80105a6e <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80105a9a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a9e:	75 07                	jne    80105aa7 <strncmp+0x3e>
    return 0;
80105aa0:	b8 00 00 00 00       	mov    $0x0,%eax
80105aa5:	eb 18                	jmp    80105abf <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80105aa7:	8b 45 08             	mov    0x8(%ebp),%eax
80105aaa:	0f b6 00             	movzbl (%eax),%eax
80105aad:	0f b6 d0             	movzbl %al,%edx
80105ab0:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ab3:	0f b6 00             	movzbl (%eax),%eax
80105ab6:	0f b6 c0             	movzbl %al,%eax
80105ab9:	89 d1                	mov    %edx,%ecx
80105abb:	29 c1                	sub    %eax,%ecx
...
80105aca:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80105acd:	90                   	nop
80105ace:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105ad2:	0f 9f c0             	setg   %al
80105ad5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105ad9:	84 c0                	test   %al,%al
80105adb:	74 30                	je     80105b0d <strncpy+0x4c>
80105add:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ae0:	0f b6 10             	movzbl (%eax),%edx
80105ae3:	8b 45 08             	mov    0x8(%ebp),%eax
80105ae6:	88 10                	mov    %dl,(%eax)
80105ae8:	8b 45 08             	mov    0x8(%ebp),%eax
80105aeb:	0f b6 00             	movzbl (%eax),%eax
80105aee:	84 c0                	test   %al,%al
80105af0:	0f 95 c0             	setne  %al
80105af3:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105af7:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105afb:	84 c0                	test   %al,%al
80105afd:	75 cf                	jne    80105ace <strncpy+0xd>
    ;
  while(n-- > 0)
80105aff:	eb 0c                	jmp    80105b0d <strncpy+0x4c>
    *s++ = 0;
80105b01:	8b 45 08             	mov    0x8(%ebp),%eax
80105b04:	c6 00 00             	movb   $0x0,(%eax)
80105b07:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105b0b:	eb 01                	jmp    80105b0e <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
80105b0d:	90                   	nop
80105b0e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105b12:	0f 9f c0             	setg   %al
80105b15:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105b19:	84 c0                	test   %al,%al
80105b1b:	75 e4                	jne    80105b01 <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105b2b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105b2e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105b32:	7f 05                	jg     80105b39 <safestrcpy+0x17>
    return os;
80105b34:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b37:	eb 35                	jmp    80105b6e <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105b39:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105b3d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105b41:	7e 22                	jle    80105b65 <safestrcpy+0x43>
80105b43:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b46:	0f b6 10             	movzbl (%eax),%edx
80105b49:	8b 45 08             	mov    0x8(%ebp),%eax
80105b4c:	88 10                	mov    %dl,(%eax)
80105b4e:	8b 45 08             	mov    0x8(%ebp),%eax
80105b51:	0f b6 00             	movzbl (%eax),%eax
80105b54:	84 c0                	test   %al,%al
80105b56:	0f 95 c0             	setne  %al
80105b59:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105b5d:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105b61:	84 c0                	test   %al,%al
80105b63:	75 d4                	jne    80105b39 <safestrcpy+0x17>
    ;
  *s = 0;
80105b65:	8b 45 08             	mov    0x8(%ebp),%eax
80105b68:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105b73:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80105b76:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105b7d:	eb 04                	jmp    80105b83 <strlen+0x13>
80105b7f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105b83:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105b86:	03 45 08             	add    0x8(%ebp),%eax
80105b89:	0f b6 00             	movzbl (%eax),%eax
80105b8c:	84 c0                	test   %al,%al
80105b8e:	75 ef                	jne    80105b7f <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
80105b98:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105b9c:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105ba3:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105ba4:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105ba6:	89 d4                	mov    %edx,%esp
...
80105bb8:	3b 45 0c             	cmp    0xc(%ebp),%eax
80105bbb:	76 0f                	jbe    80105bcc <fetchint+0x1c>
80105bbd:	8b 45 0c             	mov    0xc(%ebp),%eax
80105bc0:	8d 50 04             	lea    0x4(%eax),%edx
80105bc3:	8b 45 08             	mov    0x8(%ebp),%eax
80105bc6:	8b 00                	mov    (%eax),%eax
80105bc8:	39 c2                	cmp    %eax,%edx
80105bca:	76 07                	jbe    80105bd3 <fetchint+0x23>
    return -1;
80105bcc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bd1:	eb 0f                	jmp    80105be2 <fetchint+0x32>
  *ip = *(int*)(addr);
80105bd3:	8b 45 0c             	mov    0xc(%ebp),%eax
80105bd6:	8b 10                	mov    (%eax),%edx
...
80105be7:	83 ec 10             	sub    $0x10,%esp
  char *s, *ep;

  if(addr >= p->sz)
80105bea:	8b 45 08             	mov    0x8(%ebp),%eax
80105bed:	8b 00                	mov    (%eax),%eax
80105bef:	3b 45 0c             	cmp    0xc(%ebp),%eax
80105bf2:	77 07                	ja     80105bfb <fetchstr+0x17>
    return -1;
80105bf4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bf9:	eb 45                	jmp    80105c40 <fetchstr+0x5c>
  *pp = (char*)addr;
80105bfb:	8b 55 0c             	mov    0xc(%ebp),%edx
80105bfe:	8b 45 10             	mov    0x10(%ebp),%eax
80105c01:	89 10                	mov    %edx,(%eax)
  ep = (char*)p->sz;
80105c03:	8b 45 08             	mov    0x8(%ebp),%eax
80105c06:	8b 00                	mov    (%eax),%eax
80105c08:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
80105c0b:	8b 45 10             	mov    0x10(%ebp),%eax
80105c0e:	8b 00                	mov    (%eax),%eax
80105c10:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105c13:	eb 1e                	jmp    80105c33 <fetchstr+0x4f>
    if(*s == 0)
80105c15:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105c18:	0f b6 00             	movzbl (%eax),%eax
80105c1b:	84 c0                	test   %al,%al
80105c1d:	75 10                	jne    80105c2f <fetchstr+0x4b>
      return s - *pp;
80105c1f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105c22:	8b 45 10             	mov    0x10(%ebp),%eax
80105c25:	8b 00                	mov    (%eax),%eax
80105c27:	89 d1                	mov    %edx,%ecx
80105c29:	29 c1                	sub    %eax,%ecx
80105c2b:	89 c8                	mov    %ecx,%eax
80105c2d:	eb 11                	jmp    80105c40 <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
80105c2f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105c33:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105c36:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105c39:	72 da                	jb     80105c15 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105c4e:	8b 40 18             	mov    0x18(%eax),%eax
80105c51:	8b 50 44             	mov    0x44(%eax),%edx
80105c54:	8b 45 08             	mov    0x8(%ebp),%eax
80105c57:	c1 e0 02             	shl    $0x2,%eax
80105c5a:	01 d0                	add    %edx,%eax
80105c5c:	8d 48 04             	lea    0x4(%eax),%ecx
80105c5f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c65:	8b 55 0c             	mov    0xc(%ebp),%edx
80105c68:	89 54 24 08          	mov    %edx,0x8(%esp)
80105c6c:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105c70:	89 04 24             	mov    %eax,(%esp)
80105c73:	e8 38 ff ff ff       	call   80105bb0 <fetchint>
}
80105c78:	c9                   	leave  
80105c79:	c3                   	ret    
...
80105d23:	83 ec 24             	sub    $0x24,%esp
  int num;
...
80105d39:	78 2e                	js     80105d69 <syscall+0x4a>
80105d3b:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105d3f:	7f 28                	jg     80105d69 <syscall+0x4a>
80105d41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d44:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105d4b:	85 c0                	test   %eax,%eax
80105d4d:	74 1a                	je     80105d69 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
80105d4f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d55:	8b 58 18             	mov    0x18(%eax),%ebx
80105d58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d5b:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105d62:	ff d0                	call   *%eax
80105d64:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105d67:	eb 73                	jmp    80105ddc <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105d69:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105d6d:	7e 30                	jle    80105d9f <syscall+0x80>
80105d6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d72:	83 f8 17             	cmp    $0x17,%eax
80105d75:	77 28                	ja     80105d9f <syscall+0x80>
80105d77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d7a:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105d81:	85 c0                	test   %eax,%eax
80105d83:	74 1a                	je     80105d9f <syscall+0x80>
    proc->tf->eax = syscalls[num]();
80105d85:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d8b:	8b 58 18             	mov    0x18(%eax),%ebx
80105d8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d91:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105d98:	ff d0                	call   *%eax
80105d9a:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105d9d:	eb 3d                	jmp    80105ddc <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105d9f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105da5:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
80105db4:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105db8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105dbc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dc0:	c7 04 24 23 92 10 80 	movl   $0x80109223,(%esp)
80105dc7:	e8 d5 a5 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105dcc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105dd2:	8b 40 18             	mov    0x18(%eax),%eax
80105dd5:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105ddc:	83 c4 24             	add    $0x24,%esp
80105ddf:	5b                   	pop    %ebx
80105de0:	5d                   	pop    %ebp
80105de1:	c3                   	ret    
	...
...
80105df7:	e8 46 fe ff ff       	call   80105c42 <argint>
80105dfc:	85 c0                	test   %eax,%eax
80105dfe:	79 07                	jns    80105e07 <argfd+0x23>
    return -1;
80105e00:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e05:	eb 50                	jmp    80105e57 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105e07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e0a:	85 c0                	test   %eax,%eax
80105e0c:	78 21                	js     80105e2f <argfd+0x4b>
80105e0e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e11:	83 f8 0f             	cmp    $0xf,%eax
80105e14:	7f 19                	jg     80105e2f <argfd+0x4b>
80105e16:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105e1c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105e1f:	83 c2 08             	add    $0x8,%edx
80105e22:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105e26:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e29:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e2d:	75 07                	jne    80105e36 <argfd+0x52>
    return -1;
80105e2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e34:	eb 21                	jmp    80105e57 <argfd+0x73>
  if(pfd)
80105e36:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105e3a:	74 08                	je     80105e44 <argfd+0x60>
    *pfd = fd;
80105e3c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105e3f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e42:	89 10                	mov    %edx,(%eax)
  if(pf)
80105e44:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105e48:	74 08                	je     80105e52 <argfd+0x6e>
    *pf = f;
80105e4a:	8b 45 10             	mov    0x10(%ebp),%eax
80105e4d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e50:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105e5c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105e5f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105e66:	eb 30                	jmp    80105e98 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105e68:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105e6e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105e71:	83 c2 08             	add    $0x8,%edx
80105e74:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105e78:	85 c0                	test   %eax,%eax
80105e7a:	75 18                	jne    80105e94 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105e7c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105e82:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105e85:	8d 4a 08             	lea    0x8(%edx),%ecx
80105e88:	8b 55 08             	mov    0x8(%ebp),%edx
80105e8b:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105e8f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105e92:	eb 0f                	jmp    80105ea3 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105e94:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105e98:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105e9c:	7e ca                	jle    80105e68 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105ea8:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
80105eab:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105eae:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eb2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105eb9:	00 
80105eba:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ec1:	e8 1e ff ff ff       	call   80105de4 <argfd>
80105ec6:	85 c0                	test   %eax,%eax
80105ec8:	79 07                	jns    80105ed1 <sys_dup+0x2c>
    return -1;
80105eca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ecf:	eb 29                	jmp    80105efa <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105ed1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed4:	89 04 24             	mov    %eax,(%esp)
80105ed7:	e8 7d ff ff ff       	call   80105e59 <fdalloc>
80105edc:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105edf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ee3:	79 07                	jns    80105eec <sys_dup+0x47>
    return -1;
80105ee5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eea:	eb 0e                	jmp    80105efa <sys_dup+0x55>
  filedup(f);
80105eec:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eef:	89 04 24             	mov    %eax,(%esp)
80105ef2:	e8 99 b7 ff ff       	call   80101690 <filedup>
  return fd;
...
80105f09:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105f10:	00 
80105f11:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f18:	e8 c7 fe ff ff       	call   80105de4 <argfd>
80105f1d:	85 c0                	test   %eax,%eax
80105f1f:	78 35                	js     80105f56 <sys_read+0x5a>
80105f21:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105f24:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f28:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105f2f:	e8 0e fd ff ff       	call   80105c42 <argint>
80105f34:	85 c0                	test   %eax,%eax
80105f36:	78 1e                	js     80105f56 <sys_read+0x5a>
...
80105f46:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f4d:	e8 28 fd ff ff       	call   80105c7a <argptr>
80105f52:	85 c0                	test   %eax,%eax
80105f54:	79 07                	jns    80105f5d <sys_read+0x61>
    return -1;
80105f56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f5b:	eb 19                	jmp    80105f76 <sys_read+0x7a>
  return fileread(f, p, n);
80105f5d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105f60:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105f63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f66:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105f6a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f6e:	89 04 24             	mov    %eax,(%esp)
80105f71:	e8 87 b8 ff ff       	call   801017fd <fileread>
}
80105f76:	c9                   	leave  
80105f77:	c3                   	ret    
...
80105f7b:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105f81:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f85:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105f8c:	00 
80105f8d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f94:	e8 4b fe ff ff       	call   80105de4 <argfd>
80105f99:	85 c0                	test   %eax,%eax
80105f9b:	78 35                	js     80105fd2 <sys_write+0x5a>
80105f9d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105fa0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fa4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105fab:	e8 92 fc ff ff       	call   80105c42 <argint>
80105fb0:	85 c0                	test   %eax,%eax
80105fb2:	78 1e                	js     80105fd2 <sys_write+0x5a>
...
80105fc2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fc9:	e8 ac fc ff ff       	call   80105c7a <argptr>
80105fce:	85 c0                	test   %eax,%eax
80105fd0:	79 07                	jns    80105fd9 <sys_write+0x61>
    return -1;
80105fd2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fd7:	eb 19                	jmp    80105ff2 <sys_write+0x7a>
  return filewrite(f, p, n);
80105fd9:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105fdc:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105fdf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105fe6:	89 54 24 04          	mov    %edx,0x4(%esp)
80105fea:	89 04 24             	mov    %eax,(%esp)
80105fed:	e8 c7 b8 ff ff       	call   801018b9 <filewrite>
}
80105ff2:	c9                   	leave  
80105ff3:	c3                   	ret    
...
80106001:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106004:	89 44 24 04          	mov    %eax,0x4(%esp)
80106008:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010600f:	e8 d0 fd ff ff       	call   80105de4 <argfd>
80106014:	85 c0                	test   %eax,%eax
80106016:	79 07                	jns    8010601f <sys_close+0x2b>
    return -1;
80106018:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010601d:	eb 24                	jmp    80106043 <sys_close+0x4f>
  proc->ofile[fd] = 0;
8010601f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106025:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106028:	83 c2 08             	add    $0x8,%edx
8010602b:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106032:	00 
  fileclose(f);
80106033:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106036:	89 04 24             	mov    %eax,(%esp)
80106039:	e8 9a b6 ff ff       	call   801016d8 <fileclose>
  return 0;
...
80106052:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106059:	00 
8010605a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106061:	e8 7e fd ff ff       	call   80105de4 <argfd>
80106066:	85 c0                	test   %eax,%eax
80106068:	78 1f                	js     80106089 <sys_fstat+0x44>
8010606a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80106071:	00 
80106072:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106075:	89 44 24 04          	mov    %eax,0x4(%esp)
80106079:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106080:	e8 f5 fb ff ff       	call   80105c7a <argptr>
80106085:	85 c0                	test   %eax,%eax
80106087:	79 07                	jns    80106090 <sys_fstat+0x4b>
    return -1;
80106089:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010608e:	eb 12                	jmp    801060a2 <sys_fstat+0x5d>
  return filestat(f, st);
80106090:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106093:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106096:	89 54 24 04          	mov    %edx,0x4(%esp)
8010609a:	89 04 24             	mov    %eax,(%esp)
8010609d:	e8 0c b7 ff ff       	call   801017ae <filestat>
}
801060a2:	c9                   	leave  
801060a3:	c3                   	ret    
...
801060aa:	8d 45 d8             	lea    -0x28(%ebp),%eax
801060ad:	89 44 24 04          	mov    %eax,0x4(%esp)
801060b1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060b8:	e8 1f fc ff ff       	call   80105cdc <argstr>
801060bd:	85 c0                	test   %eax,%eax
801060bf:	78 17                	js     801060d8 <sys_link+0x34>
801060c1:	8d 45 dc             	lea    -0x24(%ebp),%eax
801060c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801060c8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060cf:	e8 08 fc ff ff       	call   80105cdc <argstr>
801060d4:	85 c0                	test   %eax,%eax
801060d6:	79 0a                	jns    801060e2 <sys_link+0x3e>
    return -1;
801060d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060dd:	e9 3c 01 00 00       	jmp    8010621e <sys_link+0x17a>
  if((ip = namei(old)) == 0)
801060e2:	8b 45 d8             	mov    -0x28(%ebp),%eax
801060e5:	89 04 24             	mov    %eax,(%esp)
801060e8:	e8 31 ca ff ff       	call   80102b1e <namei>
801060ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060f0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060f4:	75 0a                	jne    80106100 <sys_link+0x5c>
    return -1;
801060f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060fb:	e9 1e 01 00 00       	jmp    8010621e <sys_link+0x17a>

  begin_trans();
80106100:	e8 2c d8 ff ff       	call   80103931 <begin_trans>

  ilock(ip);
80106105:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106108:	89 04 24             	mov    %eax,(%esp)
8010610b:	e8 6c be ff ff       	call   80101f7c <ilock>
  if(ip->type == T_DIR){
80106110:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106113:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106117:	66 83 f8 01          	cmp    $0x1,%ax
8010611b:	75 1a                	jne    80106137 <sys_link+0x93>
    iunlockput(ip);
8010611d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106120:	89 04 24             	mov    %eax,(%esp)
80106123:	e8 d8 c0 ff ff       	call   80102200 <iunlockput>
    commit_trans();
80106128:	e8 4d d8 ff ff       	call   8010397a <commit_trans>
    return -1;
8010612d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106132:	e9 e7 00 00 00       	jmp    8010621e <sys_link+0x17a>
  }

  ip->nlink++;
80106137:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010613a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010613e:	8d 50 01             	lea    0x1(%eax),%edx
80106141:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106144:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106148:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010614b:	89 04 24             	mov    %eax,(%esp)
8010614e:	e8 6d bc ff ff       	call   80101dc0 <iupdate>
  iunlock(ip);
80106153:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106156:	89 04 24             	mov    %eax,(%esp)
80106159:	e8 6c bf ff ff       	call   801020ca <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010615e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106161:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80106164:	89 54 24 04          	mov    %edx,0x4(%esp)
80106168:	89 04 24             	mov    %eax,(%esp)
8010616b:	e8 d0 c9 ff ff       	call   80102b40 <nameiparent>
80106170:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106173:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106177:	74 68                	je     801061e1 <sys_link+0x13d>
    goto bad;
  ilock(dp);
80106179:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010617c:	89 04 24             	mov    %eax,(%esp)
8010617f:	e8 f8 bd ff ff       	call   80101f7c <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80106184:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106187:	8b 10                	mov    (%eax),%edx
80106189:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010618c:	8b 00                	mov    (%eax),%eax
8010618e:	39 c2                	cmp    %eax,%edx
80106190:	75 20                	jne    801061b2 <sys_link+0x10e>
80106192:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106195:	8b 40 04             	mov    0x4(%eax),%eax
80106198:	89 44 24 08          	mov    %eax,0x8(%esp)
8010619c:	8d 45 e2             	lea    -0x1e(%ebp),%eax
8010619f:	89 44 24 04          	mov    %eax,0x4(%esp)
801061a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061a6:	89 04 24             	mov    %eax,(%esp)
801061a9:	e8 af c6 ff ff       	call   8010285d <dirlink>
801061ae:	85 c0                	test   %eax,%eax
801061b0:	79 0d                	jns    801061bf <sys_link+0x11b>
    iunlockput(dp);
801061b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061b5:	89 04 24             	mov    %eax,(%esp)
801061b8:	e8 43 c0 ff ff       	call   80102200 <iunlockput>
    goto bad;
801061bd:	eb 23                	jmp    801061e2 <sys_link+0x13e>
  }
  iunlockput(dp);
801061bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061c2:	89 04 24             	mov    %eax,(%esp)
801061c5:	e8 36 c0 ff ff       	call   80102200 <iunlockput>
  iput(ip);
801061ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061cd:	89 04 24             	mov    %eax,(%esp)
801061d0:	e8 5a bf ff ff       	call   8010212f <iput>

  commit_trans();
801061d5:	e8 a0 d7 ff ff       	call   8010397a <commit_trans>

  return 0;
801061da:	b8 00 00 00 00       	mov    $0x0,%eax
801061df:	eb 3d                	jmp    8010621e <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
801061e8:	e8 8f bd ff ff       	call   80101f7c <ilock>
  ip->nlink--;
801061ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061f0:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801061f4:	8d 50 ff             	lea    -0x1(%eax),%edx
801061f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061fa:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801061fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106201:	89 04 24             	mov    %eax,(%esp)
80106204:	e8 b7 bb ff ff       	call   80101dc0 <iupdate>
  iunlockput(ip);
80106209:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010620c:	89 04 24             	mov    %eax,(%esp)
8010620f:	e8 ec bf ff ff       	call   80102200 <iunlockput>
  commit_trans();
80106214:	e8 61 d7 ff ff       	call   8010397a <commit_trans>
  return -1;
...
80106223:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80106226:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
8010622d:	eb 4b                	jmp    8010627a <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010622f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106232:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106239:	00 
8010623a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010623e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106241:	89 44 24 04          	mov    %eax,0x4(%esp)
80106245:	8b 45 08             	mov    0x8(%ebp),%eax
80106248:	89 04 24             	mov    %eax,(%esp)
8010624b:	e8 22 c2 ff ff       	call   80102472 <readi>
80106250:	83 f8 10             	cmp    $0x10,%eax
80106253:	74 0c                	je     80106261 <isdirempty+0x41>
      panic("isdirempty: readi");
80106255:	c7 04 24 3f 92 10 80 	movl   $0x8010923f,(%esp)
8010625c:	e8 dc a2 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80106261:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80106265:	66 85 c0             	test   %ax,%ax
80106268:	74 07                	je     80106271 <isdirempty+0x51>
      return 0;
8010626a:	b8 00 00 00 00       	mov    $0x0,%eax
8010626f:	eb 1b                	jmp    8010628c <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80106274:	83 c0 10             	add    $0x10,%eax
80106277:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010627a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010627d:	8b 45 08             	mov    0x8(%ebp),%eax
80106280:	8b 40 18             	mov    0x18(%eax),%eax
80106283:	39 c2                	cmp    %eax,%edx
80106285:	72 a8                	jb     8010622f <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80106291:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80106294:	8d 45 cc             	lea    -0x34(%ebp),%eax
80106297:	89 44 24 04          	mov    %eax,0x4(%esp)
8010629b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062a2:	e8 35 fa ff ff       	call   80105cdc <argstr>
801062a7:	85 c0                	test   %eax,%eax
801062a9:	79 0a                	jns    801062b5 <sys_unlink+0x27>
    return -1;
801062ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062b0:	e9 aa 01 00 00       	jmp    8010645f <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
801062b5:	8b 45 cc             	mov    -0x34(%ebp),%eax
801062b8:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801062bb:	89 54 24 04          	mov    %edx,0x4(%esp)
801062bf:	89 04 24             	mov    %eax,(%esp)
801062c2:	e8 79 c8 ff ff       	call   80102b40 <nameiparent>
801062c7:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062ca:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062ce:	75 0a                	jne    801062da <sys_unlink+0x4c>
    return -1;
801062d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062d5:	e9 85 01 00 00       	jmp    8010645f <sys_unlink+0x1d1>

  begin_trans();
801062da:	e8 52 d6 ff ff       	call   80103931 <begin_trans>

  ilock(dp);
801062df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062e2:	89 04 24             	mov    %eax,(%esp)
801062e5:	e8 92 bc ff ff       	call   80101f7c <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801062ea:	c7 44 24 04 51 92 10 	movl   $0x80109251,0x4(%esp)
801062f1:	80 
801062f2:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801062f5:	89 04 24             	mov    %eax,(%esp)
801062f8:	e8 76 c4 ff ff       	call   80102773 <namecmp>
801062fd:	85 c0                	test   %eax,%eax
801062ff:	0f 84 45 01 00 00    	je     8010644a <sys_unlink+0x1bc>
80106305:	c7 44 24 04 53 92 10 	movl   $0x80109253,0x4(%esp)
8010630c:	80 
8010630d:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106310:	89 04 24             	mov    %eax,(%esp)
80106313:	e8 5b c4 ff ff       	call   80102773 <namecmp>
80106318:	85 c0                	test   %eax,%eax
8010631a:	0f 84 2a 01 00 00    	je     8010644a <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106320:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106323:	89 44 24 08          	mov    %eax,0x8(%esp)
80106327:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010632a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010632e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106331:	89 04 24             	mov    %eax,(%esp)
80106334:	e8 5c c4 ff ff       	call   80102795 <dirlookup>
80106339:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010633c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106340:	0f 84 03 01 00 00    	je     80106449 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80106346:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106349:	89 04 24             	mov    %eax,(%esp)
8010634c:	e8 2b bc ff ff       	call   80101f7c <ilock>

  if(ip->nlink < 1)
80106351:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106354:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106358:	66 85 c0             	test   %ax,%ax
8010635b:	7f 0c                	jg     80106369 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
8010635d:	c7 04 24 56 92 10 80 	movl   $0x80109256,(%esp)
80106364:	e8 d4 a1 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106369:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010636c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106370:	66 83 f8 01          	cmp    $0x1,%ax
80106374:	75 1f                	jne    80106395 <sys_unlink+0x107>
80106376:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106379:	89 04 24             	mov    %eax,(%esp)
8010637c:	e8 9f fe ff ff       	call   80106220 <isdirempty>
80106381:	85 c0                	test   %eax,%eax
80106383:	75 10                	jne    80106395 <sys_unlink+0x107>
    iunlockput(ip);
80106385:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106388:	89 04 24             	mov    %eax,(%esp)
8010638b:	e8 70 be ff ff       	call   80102200 <iunlockput>
    goto bad;
80106390:	e9 b5 00 00 00       	jmp    8010644a <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80106395:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010639c:	00 
8010639d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801063a4:	00 
801063a5:	8d 45 e0             	lea    -0x20(%ebp),%eax
801063a8:	89 04 24             	mov    %eax,(%esp)
801063ab:	e8 42 f5 ff ff       	call   801058f2 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801063b0:	8b 45 c8             	mov    -0x38(%ebp),%eax
801063b3:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801063ba:	00 
801063bb:	89 44 24 08          	mov    %eax,0x8(%esp)
801063bf:	8d 45 e0             	lea    -0x20(%ebp),%eax
801063c2:	89 44 24 04          	mov    %eax,0x4(%esp)
801063c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063c9:	89 04 24             	mov    %eax,(%esp)
801063cc:	e8 0c c2 ff ff       	call   801025dd <writei>
801063d1:	83 f8 10             	cmp    $0x10,%eax
801063d4:	74 0c                	je     801063e2 <sys_unlink+0x154>
    panic("unlink: writei");
801063d6:	c7 04 24 68 92 10 80 	movl   $0x80109268,(%esp)
801063dd:	e8 5b a1 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
801063e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063e5:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801063e9:	66 83 f8 01          	cmp    $0x1,%ax
801063ed:	75 1c                	jne    8010640b <sys_unlink+0x17d>
    dp->nlink--;
801063ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063f2:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801063f6:	8d 50 ff             	lea    -0x1(%eax),%edx
801063f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063fc:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106400:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106403:	89 04 24             	mov    %eax,(%esp)
80106406:	e8 b5 b9 ff ff       	call   80101dc0 <iupdate>
  }
  iunlockput(dp);
8010640b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010640e:	89 04 24             	mov    %eax,(%esp)
80106411:	e8 ea bd ff ff       	call   80102200 <iunlockput>

  ip->nlink--;
80106416:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106419:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010641d:	8d 50 ff             	lea    -0x1(%eax),%edx
80106420:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106423:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106427:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010642a:	89 04 24             	mov    %eax,(%esp)
8010642d:	e8 8e b9 ff ff       	call   80101dc0 <iupdate>
  iunlockput(ip);
80106432:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106435:	89 04 24             	mov    %eax,(%esp)
80106438:	e8 c3 bd ff ff       	call   80102200 <iunlockput>

  commit_trans();
8010643d:	e8 38 d5 ff ff       	call   8010397a <commit_trans>

  return 0;
80106442:	b8 00 00 00 00       	mov    $0x0,%eax
80106447:	eb 16                	jmp    8010645f <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106450:	e8 ab bd ff ff       	call   80102200 <iunlockput>
  commit_trans();
80106455:	e8 20 d5 ff ff       	call   8010397a <commit_trans>
  return -1;
...
80106464:	83 ec 48             	sub    $0x48,%esp
80106467:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010646a:	8b 55 10             	mov    0x10(%ebp),%edx
8010646d:	8b 45 14             	mov    0x14(%ebp),%eax
80106470:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106474:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106478:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010647c:	8d 45 de             	lea    -0x22(%ebp),%eax
8010647f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106483:	8b 45 08             	mov    0x8(%ebp),%eax
80106486:	89 04 24             	mov    %eax,(%esp)
80106489:	e8 b2 c6 ff ff       	call   80102b40 <nameiparent>
8010648e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106491:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106495:	75 0a                	jne    801064a1 <create+0x40>
    return 0;
80106497:	b8 00 00 00 00       	mov    $0x0,%eax
8010649c:	e9 7e 01 00 00       	jmp    8010661f <create+0x1be>
  ilock(dp);
801064a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064a4:	89 04 24             	mov    %eax,(%esp)
801064a7:	e8 d0 ba ff ff       	call   80101f7c <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801064ac:	8d 45 ec             	lea    -0x14(%ebp),%eax
801064af:	89 44 24 08          	mov    %eax,0x8(%esp)
801064b3:	8d 45 de             	lea    -0x22(%ebp),%eax
801064b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801064ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064bd:	89 04 24             	mov    %eax,(%esp)
801064c0:	e8 d0 c2 ff ff       	call   80102795 <dirlookup>
801064c5:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064c8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064cc:	74 47                	je     80106515 <create+0xb4>
    iunlockput(dp);
801064ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d1:	89 04 24             	mov    %eax,(%esp)
801064d4:	e8 27 bd ff ff       	call   80102200 <iunlockput>
    ilock(ip);
801064d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064dc:	89 04 24             	mov    %eax,(%esp)
801064df:	e8 98 ba ff ff       	call   80101f7c <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801064e4:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801064e9:	75 15                	jne    80106500 <create+0x9f>
801064eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ee:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801064f2:	66 83 f8 02          	cmp    $0x2,%ax
801064f6:	75 08                	jne    80106500 <create+0x9f>
      return ip;
801064f8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064fb:	e9 1f 01 00 00       	jmp    8010661f <create+0x1be>
    iunlockput(ip);
80106500:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106503:	89 04 24             	mov    %eax,(%esp)
80106506:	e8 f5 bc ff ff       	call   80102200 <iunlockput>
    return 0;
8010650b:	b8 00 00 00 00       	mov    $0x0,%eax
80106510:	e9 0a 01 00 00       	jmp    8010661f <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106515:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106519:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651c:	8b 00                	mov    (%eax),%eax
8010651e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106522:	89 04 24             	mov    %eax,(%esp)
80106525:	e8 b9 b7 ff ff       	call   80101ce3 <ialloc>
8010652a:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010652d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106531:	75 0c                	jne    8010653f <create+0xde>
    panic("create: ialloc");
80106533:	c7 04 24 77 92 10 80 	movl   $0x80109277,(%esp)
8010653a:	e8 fe 9f ff ff       	call   8010053d <panic>

  ilock(ip);
8010653f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106542:	89 04 24             	mov    %eax,(%esp)
80106545:	e8 32 ba ff ff       	call   80101f7c <ilock>
  ip->major = major;
8010654a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010654d:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106551:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106555:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106558:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
8010655c:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106560:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106563:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106569:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010656c:	89 04 24             	mov    %eax,(%esp)
8010656f:	e8 4c b8 ff ff       	call   80101dc0 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106574:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106579:	75 6a                	jne    801065e5 <create+0x184>
    dp->nlink++;  // for ".."
8010657b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106582:	8d 50 01             	lea    0x1(%eax),%edx
80106585:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106588:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
8010658c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010658f:	89 04 24             	mov    %eax,(%esp)
80106592:	e8 29 b8 ff ff       	call   80101dc0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106597:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010659a:	8b 40 04             	mov    0x4(%eax),%eax
8010659d:	89 44 24 08          	mov    %eax,0x8(%esp)
801065a1:	c7 44 24 04 51 92 10 	movl   $0x80109251,0x4(%esp)
801065a8:	80 
801065a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065ac:	89 04 24             	mov    %eax,(%esp)
801065af:	e8 a9 c2 ff ff       	call   8010285d <dirlink>
801065b4:	85 c0                	test   %eax,%eax
801065b6:	78 21                	js     801065d9 <create+0x178>
801065b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065bb:	8b 40 04             	mov    0x4(%eax),%eax
801065be:	89 44 24 08          	mov    %eax,0x8(%esp)
801065c2:	c7 44 24 04 53 92 10 	movl   $0x80109253,0x4(%esp)
801065c9:	80 
801065ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065cd:	89 04 24             	mov    %eax,(%esp)
801065d0:	e8 88 c2 ff ff       	call   8010285d <dirlink>
801065d5:	85 c0                	test   %eax,%eax
801065d7:	79 0c                	jns    801065e5 <create+0x184>
      panic("create dots");
801065d9:	c7 04 24 86 92 10 80 	movl   $0x80109286,(%esp)
801065e0:	e8 58 9f ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801065e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065e8:	8b 40 04             	mov    0x4(%eax),%eax
801065eb:	89 44 24 08          	mov    %eax,0x8(%esp)
801065ef:	8d 45 de             	lea    -0x22(%ebp),%eax
801065f2:	89 44 24 04          	mov    %eax,0x4(%esp)
801065f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065f9:	89 04 24             	mov    %eax,(%esp)
801065fc:	e8 5c c2 ff ff       	call   8010285d <dirlink>
80106601:	85 c0                	test   %eax,%eax
80106603:	79 0c                	jns    80106611 <create+0x1b0>
    panic("create: dirlink");
80106605:	c7 04 24 92 92 10 80 	movl   $0x80109292,(%esp)
8010660c:	e8 2c 9f ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106611:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106614:	89 04 24             	mov    %eax,(%esp)
80106617:	e8 e4 bb ff ff       	call   80102200 <iunlockput>
...
80106635:	e8 a2 f6 ff ff       	call   80105cdc <argstr>
8010663a:	85 c0                	test   %eax,%eax
8010663c:	78 17                	js     80106655 <sys_open+0x34>
8010663e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106641:	89 44 24 04          	mov    %eax,0x4(%esp)
80106645:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010664c:	e8 f1 f5 ff ff       	call   80105c42 <argint>
80106651:	85 c0                	test   %eax,%eax
80106653:	79 0a                	jns    8010665f <sys_open+0x3e>
    return -1;
80106655:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010665a:	e9 46 01 00 00       	jmp    801067a5 <sys_open+0x184>
  if(omode & O_CREATE){
8010665f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106662:	25 00 02 00 00       	and    $0x200,%eax
80106667:	85 c0                	test   %eax,%eax
80106669:	74 40                	je     801066ab <sys_open+0x8a>
    begin_trans();
8010666b:	e8 c1 d2 ff ff       	call   80103931 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106670:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106673:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010667a:	00 
8010667b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106682:	00 
80106683:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010668a:	00 
8010668b:	89 04 24             	mov    %eax,(%esp)
8010668e:	e8 ce fd ff ff       	call   80106461 <create>
80106693:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80106696:	e8 df d2 ff ff       	call   8010397a <commit_trans>
    if(ip == 0)
8010669b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010669f:	75 5c                	jne    801066fd <sys_open+0xdc>
      return -1;
801066a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066a6:	e9 fa 00 00 00       	jmp    801067a5 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
801066ab:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066ae:	89 04 24             	mov    %eax,(%esp)
801066b1:	e8 68 c4 ff ff       	call   80102b1e <namei>
801066b6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066b9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066bd:	75 0a                	jne    801066c9 <sys_open+0xa8>
      return -1;
801066bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066c4:	e9 dc 00 00 00       	jmp    801067a5 <sys_open+0x184>
    ilock(ip);
801066c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066cc:	89 04 24             	mov    %eax,(%esp)
801066cf:	e8 a8 b8 ff ff       	call   80101f7c <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801066d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801066db:	66 83 f8 01          	cmp    $0x1,%ax
801066df:	75 1c                	jne    801066fd <sys_open+0xdc>
801066e1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066e4:	85 c0                	test   %eax,%eax
801066e6:	74 15                	je     801066fd <sys_open+0xdc>
      iunlockput(ip);
801066e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066eb:	89 04 24             	mov    %eax,(%esp)
801066ee:	e8 0d bb ff ff       	call   80102200 <iunlockput>
      return -1;
801066f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066f8:	e9 a8 00 00 00       	jmp    801067a5 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
801066fd:	e8 2e af ff ff       	call   80101630 <filealloc>
80106702:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106705:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106709:	74 14                	je     8010671f <sys_open+0xfe>
8010670b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010670e:	89 04 24             	mov    %eax,(%esp)
80106711:	e8 43 f7 ff ff       	call   80105e59 <fdalloc>
80106716:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106719:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010671d:	79 23                	jns    80106742 <sys_open+0x121>
    if(f)
8010671f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106723:	74 0b                	je     80106730 <sys_open+0x10f>
      fileclose(f);
80106725:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106728:	89 04 24             	mov    %eax,(%esp)
8010672b:	e8 a8 af ff ff       	call   801016d8 <fileclose>
    iunlockput(ip);
80106730:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106733:	89 04 24             	mov    %eax,(%esp)
80106736:	e8 c5 ba ff ff       	call   80102200 <iunlockput>
    return -1;
8010673b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106740:	eb 63                	jmp    801067a5 <sys_open+0x184>
  }
  iunlock(ip);
80106742:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106745:	89 04 24             	mov    %eax,(%esp)
80106748:	e8 7d b9 ff ff       	call   801020ca <iunlock>

  f->type = FD_INODE;
8010674d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106750:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106756:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106759:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010675c:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010675f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106762:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106769:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010676c:	83 e0 01             	and    $0x1,%eax
8010676f:	85 c0                	test   %eax,%eax
80106771:	0f 94 c2             	sete   %dl
80106774:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106777:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010677a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010677d:	83 e0 01             	and    $0x1,%eax
80106780:	84 c0                	test   %al,%al
80106782:	75 0a                	jne    8010678e <sys_open+0x16d>
80106784:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106787:	83 e0 02             	and    $0x2,%eax
8010678a:	85 c0                	test   %eax,%eax
8010678c:	74 07                	je     80106795 <sys_open+0x174>
8010678e:	b8 01 00 00 00       	mov    $0x1,%eax
80106793:	eb 05                	jmp    8010679a <sys_open+0x179>
80106795:	b8 00 00 00 00       	mov    $0x0,%eax
8010679a:	89 c2                	mov    %eax,%edx
8010679c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010679f:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801067aa:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
801067ad:	e8 7f d1 ff ff       	call   80103931 <begin_trans>
...
801067c0:	e8 17 f5 ff ff       	call   80105cdc <argstr>
801067c5:	85 c0                	test   %eax,%eax
801067c7:	78 2c                	js     801067f5 <sys_mkdir+0x4e>
801067c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801067cc:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801067d3:	00 
801067d4:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801067db:	00 
801067dc:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801067e3:	00 
801067e4:	89 04 24             	mov    %eax,(%esp)
801067e7:	e8 75 fc ff ff       	call   80106461 <create>
801067ec:	89 45 f4             	mov    %eax,-0xc(%ebp)
801067ef:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801067f3:	75 0c                	jne    80106801 <sys_mkdir+0x5a>
    commit_trans();
801067f5:	e8 80 d1 ff ff       	call   8010397a <commit_trans>
    return -1;
801067fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067ff:	eb 15                	jmp    80106816 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106801:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106804:	89 04 24             	mov    %eax,(%esp)
80106807:	e8 f4 b9 ff ff       	call   80102200 <iunlockput>
  commit_trans();
8010680c:	e8 69 d1 ff ff       	call   8010397a <commit_trans>
  return 0;
...
8010681b:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
8010681e:	e8 0e d1 ff ff       	call   80103931 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80106823:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106826:	89 44 24 04          	mov    %eax,0x4(%esp)
8010682a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106831:	e8 a6 f4 ff ff       	call   80105cdc <argstr>
80106836:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106839:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010683d:	78 5e                	js     8010689d <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010683f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106842:	89 44 24 04          	mov    %eax,0x4(%esp)
80106846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010684d:	e8 f0 f3 ff ff       	call   80105c42 <argint>
  char *path;
  int len;
  int major, minor;
...
80106854:	78 47                	js     8010689d <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106856:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106859:	89 44 24 04          	mov    %eax,0x4(%esp)
8010685d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106864:	e8 d9 f3 ff ff       	call   80105c42 <argint>
  int len;
  int major, minor;
...
8010686b:	78 30                	js     8010689d <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
8010686d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106870:	0f bf c8             	movswl %ax,%ecx
80106873:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106876:	0f bf d0             	movswl %ax,%edx
80106879:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010687c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106880:	89 54 24 08          	mov    %edx,0x8(%esp)
80106884:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010688b:	00 
8010688c:	89 04 24             	mov    %eax,(%esp)
8010688f:	e8 cd fb ff ff       	call   80106461 <create>
80106894:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106897:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010689b:	75 0c                	jne    801068a9 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
8010689d:	e8 d8 d0 ff ff       	call   8010397a <commit_trans>
    return -1;
801068a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068a7:	eb 15                	jmp    801068be <sys_mknod+0xa6>
  }
  iunlockput(ip);
801068a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068ac:	89 04 24             	mov    %eax,(%esp)
801068af:	e8 4c b9 ff ff       	call   80102200 <iunlockput>
  commit_trans();
801068b4:	e8 c1 d0 ff ff       	call   8010397a <commit_trans>
  return 0;
...
801068cd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068d4:	e8 03 f4 ff ff       	call   80105cdc <argstr>
801068d9:	85 c0                	test   %eax,%eax
801068db:	78 14                	js     801068f1 <sys_chdir+0x31>
801068dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068e0:	89 04 24             	mov    %eax,(%esp)
801068e3:	e8 36 c2 ff ff       	call   80102b1e <namei>
801068e8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801068eb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801068ef:	75 07                	jne    801068f8 <sys_chdir+0x38>
    return -1;
801068f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068f6:	eb 57                	jmp    8010694f <sys_chdir+0x8f>
  ilock(ip);
801068f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068fb:	89 04 24             	mov    %eax,(%esp)
801068fe:	e8 79 b6 ff ff       	call   80101f7c <ilock>
  if(ip->type != T_DIR){
80106903:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106906:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010690a:	66 83 f8 01          	cmp    $0x1,%ax
8010690e:	74 12                	je     80106922 <sys_chdir+0x62>
    iunlockput(ip);
80106910:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106913:	89 04 24             	mov    %eax,(%esp)
80106916:	e8 e5 b8 ff ff       	call   80102200 <iunlockput>
    return -1;
8010691b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106920:	eb 2d                	jmp    8010694f <sys_chdir+0x8f>
  }
  iunlock(ip);
80106922:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106925:	89 04 24             	mov    %eax,(%esp)
80106928:	e8 9d b7 ff ff       	call   801020ca <iunlock>
  iput(proc->cwd);
8010692d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106933:	8b 40 68             	mov    0x68(%eax),%eax
80106936:	89 04 24             	mov    %eax,(%esp)
80106939:	e8 f1 b7 ff ff       	call   8010212f <iput>
  proc->cwd = ip;
8010693e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106944:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106947:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
8010694a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010694f:	c9                   	leave  
80106950:	c3                   	ret    
...
80106954:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
8010695d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106961:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106968:	e8 6f f3 ff ff       	call   80105cdc <argstr>
8010696d:	85 c0                	test   %eax,%eax
8010696f:	78 1a                	js     8010698b <sys_exec+0x3a>
80106971:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106977:	89 44 24 04          	mov    %eax,0x4(%esp)
8010697b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106982:	e8 bb f2 ff ff       	call   80105c42 <argint>
80106987:	85 c0                	test   %eax,%eax
80106989:	79 0a                	jns    80106995 <sys_exec+0x44>
    return -1;
8010698b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106990:	e9 e2 00 00 00       	jmp    80106a77 <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
80106995:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010699c:	00 
8010699d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069a4:	00 
801069a5:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801069ab:	89 04 24             	mov    %eax,(%esp)
801069ae:	e8 3f ef ff ff       	call   801058f2 <memset>
  for(i=0;; i++){
801069b3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801069ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069bd:	83 f8 1f             	cmp    $0x1f,%eax
801069c0:	76 0a                	jbe    801069cc <sys_exec+0x7b>
      return -1;
801069c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069c7:	e9 ab 00 00 00       	jmp    80106a77 <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
801069cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069cf:	c1 e0 02             	shl    $0x2,%eax
801069d2:	89 c2                	mov    %eax,%edx
801069d4:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801069da:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
801069dd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069e3:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
801069e9:	89 54 24 08          	mov    %edx,0x8(%esp)
801069ed:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801069f1:	89 04 24             	mov    %eax,(%esp)
801069f4:	e8 b7 f1 ff ff       	call   80105bb0 <fetchint>
801069f9:	85 c0                	test   %eax,%eax
801069fb:	79 07                	jns    80106a04 <sys_exec+0xb3>
      return -1;
801069fd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a02:	eb 73                	jmp    80106a77 <sys_exec+0x126>
    if(uarg == 0){
80106a04:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106a0a:	85 c0                	test   %eax,%eax
80106a0c:	75 26                	jne    80106a34 <sys_exec+0xe3>
      argv[i] = 0;
80106a0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a11:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106a18:	00 00 00 00 
      break;
80106a1c:	90                   	nop
    }
...
80106a20:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106a26:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a2a:	89 04 24             	mov    %eax,(%esp)
80106a2d:	e8 7e a6 ff ff       	call   801010b0 <exec>
80106a32:	eb 43                	jmp    80106a77 <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106a37:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106a3e:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106a44:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
80106a47:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80106a4d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a53:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a57:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a5b:	89 04 24             	mov    %eax,(%esp)
80106a5e:	e8 81 f1 ff ff       	call   80105be4 <fetchstr>
80106a63:	85 c0                	test   %eax,%eax
80106a65:	79 07                	jns    80106a6e <sys_exec+0x11d>
      return -1;
80106a67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a6c:	eb 09                	jmp    80106a77 <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106a6e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
80106a72:	e9 43 ff ff ff       	jmp    801069ba <sys_exec+0x69>
  return exec(path, argv);
}
80106a77:	c9                   	leave  
80106a78:	c3                   	ret    
...
80106a7c:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106a7f:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106a86:	00 
80106a87:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a8a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a8e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a95:	e8 e0 f1 ff ff       	call   80105c7a <argptr>
80106a9a:	85 c0                	test   %eax,%eax
80106a9c:	79 0a                	jns    80106aa8 <sys_pipe+0x2f>
    return -1;
80106a9e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106aa3:	e9 9b 00 00 00       	jmp    80106b43 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106aa8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106aab:	89 44 24 04          	mov    %eax,0x4(%esp)
80106aaf:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106ab2:	89 04 24             	mov    %eax,(%esp)
80106ab5:	e8 92 d8 ff ff       	call   8010434c <pipealloc>
80106aba:	85 c0                	test   %eax,%eax
80106abc:	79 07                	jns    80106ac5 <sys_pipe+0x4c>
    return -1;
80106abe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ac3:	eb 7e                	jmp    80106b43 <sys_pipe+0xca>
  fd0 = -1;
80106ac5:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106acc:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106acf:	89 04 24             	mov    %eax,(%esp)
80106ad2:	e8 82 f3 ff ff       	call   80105e59 <fdalloc>
80106ad7:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106ada:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106ade:	78 14                	js     80106af4 <sys_pipe+0x7b>
80106ae0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ae3:	89 04 24             	mov    %eax,(%esp)
80106ae6:	e8 6e f3 ff ff       	call   80105e59 <fdalloc>
80106aeb:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106aee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106af2:	79 37                	jns    80106b2b <sys_pipe+0xb2>
    if(fd0 >= 0)
80106af4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106af8:	78 14                	js     80106b0e <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106afa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106b00:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106b03:	83 c2 08             	add    $0x8,%edx
80106b06:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106b0d:	00 
    fileclose(rf);
80106b0e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106b11:	89 04 24             	mov    %eax,(%esp)
80106b14:	e8 bf ab ff ff       	call   801016d8 <fileclose>
    fileclose(wf);
80106b19:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b1c:	89 04 24             	mov    %eax,(%esp)
80106b1f:	e8 b4 ab ff ff       	call   801016d8 <fileclose>
    return -1;
80106b24:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b29:	eb 18                	jmp    80106b43 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106b2b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b2e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106b31:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106b33:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106b36:	8d 50 04             	lea    0x4(%eax),%edx
80106b39:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b3c:	89 02                	mov    %eax,(%edx)
  return 0;
80106b3e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106b43:	c9                   	leave  
80106b44:	c3                   	ret    
80106b45:	00 00                	add    %al,(%eax)
	...
...
80106b4b:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106b4e:	e8 31 df ff ff       	call   80104a84 <fork>
}
80106b53:	c9                   	leave  
80106b54:	c3                   	ret    
...
80106b58:	83 ec 08             	sub    $0x8,%esp
  exit();
80106b5b:	e8 87 e0 ff ff       	call   80104be7 <exit>
...
80106b6a:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106b6d:	e8 a2 e1 ff ff       	call   80104d14 <wait>
}
80106b72:	c9                   	leave  
80106b73:	c3                   	ret    
...
80106b7a:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b81:	00 
80106b82:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b85:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b89:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b90:	e8 e5 f0 ff ff       	call   80105c7a <argptr>
80106b95:	85 c0                	test   %eax,%eax
80106b97:	79 07                	jns    80106ba0 <sys_wait2+0x2c>
80106b99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b9e:	eb 65                	jmp    80106c05 <sys_wait2+0x91>
...
80106baf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106bb6:	e8 bf f0 ff ff       	call   80105c7a <argptr>
80106bbb:	85 c0                	test   %eax,%eax
80106bbd:	79 07                	jns    80106bc6 <sys_wait2+0x52>
80106bbf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bc4:	eb 3f                	jmp    80106c05 <sys_wait2+0x91>
  if (argptr(2, (void*)&iotime, sizeof(iotime)) <0) return -1;
80106bc6:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106bcd:	00 
80106bce:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106bd1:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bd5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106bdc:	e8 99 f0 ff ff       	call   80105c7a <argptr>
80106be1:	85 c0                	test   %eax,%eax
80106be3:	79 07                	jns    80106bec <sys_wait2+0x78>
80106be5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bea:	eb 19                	jmp    80106c05 <sys_wait2+0x91>
  return wait2(wtime, rtime, iotime);
80106bec:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106bef:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106bf2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bf5:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106bf9:	89 54 24 04          	mov    %edx,0x4(%esp)
80106bfd:	89 04 24             	mov    %eax,(%esp)
80106c00:	e8 21 e2 ff ff       	call   80104e26 <wait2>
}
80106c05:	c9                   	leave  
80106c06:	c3                   	ret    
...
80106c1b:	e8 22 f0 ff ff       	call   80105c42 <argint>
80106c20:	85 c0                	test   %eax,%eax
80106c22:	79 07                	jns    80106c2b <sys_kill+0x24>
    return -1;
80106c24:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c29:	eb 0b                	jmp    80106c36 <sys_kill+0x2f>
  return kill(pid);
80106c2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c2e:	89 04 24             	mov    %eax,(%esp)
80106c31:	e8 8c e8 ff ff       	call   801054c2 <kill>
}
80106c36:	c9                   	leave  
80106c37:	c3                   	ret    
...
80106c41:	8b 40 10             	mov    0x10(%eax),%eax
}
80106c44:	5d                   	pop    %ebp
80106c45:	c3                   	ret    
...
80106c49:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80106c4c:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106c4f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c53:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c5a:	e8 e3 ef ff ff       	call   80105c42 <argint>
80106c5f:	85 c0                	test   %eax,%eax
80106c61:	79 07                	jns    80106c6a <sys_sbrk+0x24>
    return -1;
80106c63:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c68:	eb 24                	jmp    80106c8e <sys_sbrk+0x48>
  addr = proc->sz;
80106c6a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
80106c7b:	e8 5f dd ff ff       	call   801049df <growproc>
80106c80:	85 c0                	test   %eax,%eax
80106c82:	79 07                	jns    80106c8b <sys_sbrk+0x45>
    return -1;
80106c84:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c89:	eb 03                	jmp    80106c8e <sys_sbrk+0x48>
  return addr;
...
80106c93:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106c96:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106c99:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c9d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ca4:	e8 99 ef ff ff       	call   80105c42 <argint>
80106ca9:	85 c0                	test   %eax,%eax
80106cab:	79 07                	jns    80106cb4 <sys_sleep+0x24>
    return -1;
80106cad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cb2:	eb 6c                	jmp    80106d20 <sys_sleep+0x90>
  acquire(&tickslock);
80106cb4:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80106cbb:	e8 e3 e9 ff ff       	call   801056a3 <acquire>
  ticks0 = ticks;
80106cc0:	a1 60 4f 11 80       	mov    0x80114f60,%eax
80106cc5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106cc8:	eb 34                	jmp    80106cfe <sys_sleep+0x6e>
    if(proc->killed){
80106cca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cd0:	8b 40 24             	mov    0x24(%eax),%eax
80106cd3:	85 c0                	test   %eax,%eax
80106cd5:	74 13                	je     80106cea <sys_sleep+0x5a>
      release(&tickslock);
80106cd7:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80106cde:	e8 22 ea ff ff       	call   80105705 <release>
      return -1;
80106ce3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ce8:	eb 36                	jmp    80106d20 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106cea:	c7 44 24 04 20 47 11 	movl   $0x80114720,0x4(%esp)
80106cf1:	80 
80106cf2:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80106cf9:	e8 2b e6 ff ff       	call   80105329 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106cfe:	a1 60 4f 11 80       	mov    0x80114f60,%eax
80106d03:	89 c2                	mov    %eax,%edx
80106d05:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106d08:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d0b:	39 c2                	cmp    %eax,%edx
80106d0d:	72 bb                	jb     80106cca <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106d0f:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80106d16:	e8 ea e9 ff ff       	call   80105705 <release>
  return 0;
...
80106d25:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106d28:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80106d2f:	e8 6f e9 ff ff       	call   801056a3 <acquire>
  xticks = ticks;
80106d34:	a1 60 4f 11 80       	mov    0x80114f60,%eax
80106d39:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106d3c:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80106d43:	e8 bd e9 ff ff       	call   80105705 <release>
  return xticks;
...
80106d50:	83 ec 28             	sub    $0x28,%esp
          char *path;
          if(argstr(0, &path) < 0)
80106d53:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d56:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d5a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d61:	e8 76 ef ff ff       	call   80105cdc <argstr>
80106d66:	85 c0                	test   %eax,%eax
80106d68:	79 07                	jns    80106d71 <sys_add_path+0x24>
            return -1;
80106d6a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d6f:	eb 0b                	jmp    80106d7c <sys_add_path+0x2f>
          return add_path(path);
80106d71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d74:	89 04 24             	mov    %eax,(%esp)
80106d77:	e8 0a a8 ff ff       	call   80101586 <add_path>
...
80106d86:	8b 55 08             	mov    0x8(%ebp),%edx
80106d89:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d8c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106d90:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106d93:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106d97:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106d9b:	ee                   	out    %al,(%dx)
}
80106d9c:	c9                   	leave  
80106d9d:	c3                   	ret    
...
80106da1:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106da4:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106dab:	00 
80106dac:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106db3:	e8 c8 ff ff ff       	call   80106d80 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106db8:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106dbf:	00 
80106dc0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106dc7:	e8 b4 ff ff ff       	call   80106d80 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106dcc:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106dd3:	00 
80106dd4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106ddb:	e8 a0 ff ff ff       	call   80106d80 <outb>
  picenable(IRQ_TIMER);
80106de0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106de7:	e8 e9 d3 ff ff       	call   801041d5 <picenable>
}
80106dec:	c9                   	leave  
80106ded:	c3                   	ret    
	...
...
80106e07:	54                   	push   %esp
  call trap
80106e08:	e8 de 01 00 00       	call   80106feb <trap>
  addl $4, %esp
...
80106e4c:	0f 20 d3             	mov    %cr2,%ebx
80106e4f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106e52:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106e5e:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106e61:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106e68:	e9 c3 00 00 00       	jmp    80106f30 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106e6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e70:	8b 04 85 a0 c0 10 80 	mov    -0x7fef3f60(,%eax,4),%eax
80106e77:	89 c2                	mov    %eax,%edx
80106e79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e7c:	66 89 14 c5 60 47 11 	mov    %dx,-0x7feeb8a0(,%eax,8)
80106e83:	80 
80106e84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e87:	66 c7 04 c5 62 47 11 	movw   $0x8,-0x7feeb89e(,%eax,8)
80106e8e:	80 08 00 
80106e91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e94:	0f b6 14 c5 64 47 11 	movzbl -0x7feeb89c(,%eax,8),%edx
80106e9b:	80 
80106e9c:	83 e2 e0             	and    $0xffffffe0,%edx
80106e9f:	88 14 c5 64 47 11 80 	mov    %dl,-0x7feeb89c(,%eax,8)
80106ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ea9:	0f b6 14 c5 64 47 11 	movzbl -0x7feeb89c(,%eax,8),%edx
80106eb0:	80 
80106eb1:	83 e2 1f             	and    $0x1f,%edx
80106eb4:	88 14 c5 64 47 11 80 	mov    %dl,-0x7feeb89c(,%eax,8)
80106ebb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ebe:	0f b6 14 c5 65 47 11 	movzbl -0x7feeb89b(,%eax,8),%edx
80106ec5:	80 
80106ec6:	83 e2 f0             	and    $0xfffffff0,%edx
80106ec9:	83 ca 0e             	or     $0xe,%edx
80106ecc:	88 14 c5 65 47 11 80 	mov    %dl,-0x7feeb89b(,%eax,8)
80106ed3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ed6:	0f b6 14 c5 65 47 11 	movzbl -0x7feeb89b(,%eax,8),%edx
80106edd:	80 
80106ede:	83 e2 ef             	and    $0xffffffef,%edx
80106ee1:	88 14 c5 65 47 11 80 	mov    %dl,-0x7feeb89b(,%eax,8)
80106ee8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106eeb:	0f b6 14 c5 65 47 11 	movzbl -0x7feeb89b(,%eax,8),%edx
80106ef2:	80 
80106ef3:	83 e2 9f             	and    $0xffffff9f,%edx
80106ef6:	88 14 c5 65 47 11 80 	mov    %dl,-0x7feeb89b(,%eax,8)
80106efd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f00:	0f b6 14 c5 65 47 11 	movzbl -0x7feeb89b(,%eax,8),%edx
80106f07:	80 
80106f08:	83 ca 80             	or     $0xffffff80,%edx
80106f0b:	88 14 c5 65 47 11 80 	mov    %dl,-0x7feeb89b(,%eax,8)
80106f12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f15:	8b 04 85 a0 c0 10 80 	mov    -0x7fef3f60(,%eax,4),%eax
80106f1c:	c1 e8 10             	shr    $0x10,%eax
80106f1f:	89 c2                	mov    %eax,%edx
80106f21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f24:	66 89 14 c5 66 47 11 	mov    %dx,-0x7feeb89a(,%eax,8)
80106f2b:	80 
void
tvinit(void)
{
...
80106f30:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106f37:	0f 8e 30 ff ff ff    	jle    80106e6d <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f3d:	a1 a0 c1 10 80       	mov    0x8010c1a0,%eax
80106f42:	66 a3 60 49 11 80    	mov    %ax,0x80114960
80106f48:	66 c7 05 62 49 11 80 	movw   $0x8,0x80114962
80106f4f:	08 00 
80106f51:	0f b6 05 64 49 11 80 	movzbl 0x80114964,%eax
80106f58:	83 e0 e0             	and    $0xffffffe0,%eax
80106f5b:	a2 64 49 11 80       	mov    %al,0x80114964
80106f60:	0f b6 05 64 49 11 80 	movzbl 0x80114964,%eax
80106f67:	83 e0 1f             	and    $0x1f,%eax
80106f6a:	a2 64 49 11 80       	mov    %al,0x80114964
80106f6f:	0f b6 05 65 49 11 80 	movzbl 0x80114965,%eax
80106f76:	83 c8 0f             	or     $0xf,%eax
80106f79:	a2 65 49 11 80       	mov    %al,0x80114965
80106f7e:	0f b6 05 65 49 11 80 	movzbl 0x80114965,%eax
80106f85:	83 e0 ef             	and    $0xffffffef,%eax
80106f88:	a2 65 49 11 80       	mov    %al,0x80114965
80106f8d:	0f b6 05 65 49 11 80 	movzbl 0x80114965,%eax
80106f94:	83 c8 60             	or     $0x60,%eax
80106f97:	a2 65 49 11 80       	mov    %al,0x80114965
80106f9c:	0f b6 05 65 49 11 80 	movzbl 0x80114965,%eax
80106fa3:	83 c8 80             	or     $0xffffff80,%eax
80106fa6:	a2 65 49 11 80       	mov    %al,0x80114965
80106fab:	a1 a0 c1 10 80       	mov    0x8010c1a0,%eax
80106fb0:	c1 e8 10             	shr    $0x10,%eax
80106fb3:	66 a3 66 49 11 80    	mov    %ax,0x80114966
  
  initlock(&tickslock, "time");
80106fb9:	c7 44 24 04 a4 92 10 	movl   $0x801092a4,0x4(%esp)
80106fc0:	80 
80106fc1:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80106fc8:	e8 b5 e6 ff ff       	call   80105682 <initlock>
}
80106fcd:	c9                   	leave  
80106fce:	c3                   	ret    
...
80106fd2:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106fd5:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106fdc:	00 
80106fdd:	c7 04 24 60 47 11 80 	movl   $0x80114760,(%esp)
80106fe4:	e8 33 fe ff ff       	call   80106e1c <lidt>
}
80106fe9:	c9                   	leave  
80106fea:	c3                   	ret    
...
{
80106feb:	55                   	push   %ebp
80106fec:	89 e5                	mov    %esp,%ebp
80106fee:	57                   	push   %edi
80106fef:	56                   	push   %esi
80106ff0:	53                   	push   %ebx
80106ff1:	83 ec 4c             	sub    $0x4c,%esp
  if(tf->trapno == T_SYSCALL){
80106ff4:	8b 45 08             	mov    0x8(%ebp),%eax
80106ff7:	8b 40 30             	mov    0x30(%eax),%eax
80106ffa:	83 f8 40             	cmp    $0x40,%eax
80106ffd:	75 3e                	jne    8010703d <trap+0x52>
    if(proc->killed)
80106fff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107005:	8b 40 24             	mov    0x24(%eax),%eax
80107008:	85 c0                	test   %eax,%eax
8010700a:	74 05                	je     80107011 <trap+0x26>
      exit();
8010700c:	e8 d6 db ff ff       	call   80104be7 <exit>
    proc->tf = tf;
80107011:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107017:	8b 55 08             	mov    0x8(%ebp),%edx
8010701a:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010701d:	e8 fd ec ff ff       	call   80105d1f <syscall>
    if(proc->killed)
80107022:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107028:	8b 40 24             	mov    0x24(%eax),%eax
8010702b:	85 c0                	test   %eax,%eax
8010702d:	0f 84 15 03 00 00    	je     80107348 <trap+0x35d>
      exit();
80107033:	e8 af db ff ff       	call   80104be7 <exit>
    return;
80107038:	e9 0b 03 00 00       	jmp    80107348 <trap+0x35d>
  }

  switch(tf->trapno){
8010703d:	8b 45 08             	mov    0x8(%ebp),%eax
80107040:	8b 40 30             	mov    0x30(%eax),%eax
80107043:	83 e8 20             	sub    $0x20,%eax
80107046:	83 f8 1f             	cmp    $0x1f,%eax
80107049:	0f 87 10 01 00 00    	ja     8010715f <trap+0x174>
8010704f:	8b 04 85 4c 93 10 80 	mov    -0x7fef6cb4(,%eax,4),%eax
80107056:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107058:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010705e:	0f b6 00             	movzbl (%eax),%eax
80107061:	84 c0                	test   %al,%al
80107063:	0f 85 81 00 00 00    	jne    801070ea <trap+0xff>
      acquire(&tickslock);
80107069:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
80107070:	e8 2e e6 ff ff       	call   801056a3 <acquire>
      ticks++;
80107075:	a1 60 4f 11 80       	mov    0x80114f60,%eax
8010707a:	83 c0 01             	add    $0x1,%eax
8010707d:	a3 60 4f 11 80       	mov    %eax,0x80114f60
      if (proc && proc->state == RUNNING){
80107082:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107088:	85 c0                	test   %eax,%eax
8010708a:	74 46                	je     801070d2 <trap+0xe7>
8010708c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107092:	8b 40 0c             	mov    0xc(%eax),%eax
80107095:	83 f8 04             	cmp    $0x4,%eax
80107098:	75 38                	jne    801070d2 <trap+0xe7>
	proc->rtime = proc->rtime + 1;
8010709a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070a0:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801070a7:	8b 92 8c 00 00 00    	mov    0x8c(%edx),%edx
801070ad:	83 c2 01             	add    $0x1,%edx
801070b0:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
	proc->quanta = proc->quanta + 1;
801070b6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801070bc:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801070c3:	8b 92 94 00 00 00    	mov    0x94(%edx),%edx
801070c9:	83 c2 01             	add    $0x1,%edx
801070cc:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
      }
      wakeup(&ticks);
801070d2:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801070d9:	e8 b9 e3 ff ff       	call   80105497 <wakeup>
      release(&tickslock);
801070de:	c7 04 24 20 47 11 80 	movl   $0x80114720,(%esp)
801070e5:	e8 1b e6 ff ff       	call   80105705 <release>
    }
    lapiceoi();
801070ea:	e8 0e c5 ff ff       	call   801035fd <lapiceoi>
    break;
801070ef:	e9 41 01 00 00       	jmp    80107235 <trap+0x24a>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801070f4:	e8 0c bd ff ff       	call   80102e05 <ideintr>
    lapiceoi();
801070f9:	e8 ff c4 ff ff       	call   801035fd <lapiceoi>
    break;
801070fe:	e9 32 01 00 00       	jmp    80107235 <trap+0x24a>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80107103:	e8 d3 c2 ff ff       	call   801033db <kbdintr>
    lapiceoi();
80107108:	e8 f0 c4 ff ff       	call   801035fd <lapiceoi>
    break;
8010710d:	e9 23 01 00 00       	jmp    80107235 <trap+0x24a>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80107112:	e8 39 04 00 00       	call   80107550 <uartintr>
    lapiceoi();
80107117:	e8 e1 c4 ff ff       	call   801035fd <lapiceoi>
    break;
8010711c:	e9 14 01 00 00       	jmp    80107235 <trap+0x24a>
  case T_IRQ0 + 7:
...
80107149:	c7 04 24 ac 92 10 80 	movl   $0x801092ac,(%esp)
80107150:	e8 4c 92 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80107155:	e8 a3 c4 ff ff       	call   801035fd <lapiceoi>
    break;
8010715a:	e9 d6 00 00 00       	jmp    80107235 <trap+0x24a>
...
80107167:	74 11                	je     8010717a <trap+0x18f>
...
80107178:	75 46                	jne    801071c0 <trap+0x1d5>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010717a:	e8 c6 fc ff ff       	call   80106e45 <rcr2>
...
801071a8:	c7 04 24 d0 92 10 80 	movl   $0x801092d0,(%esp)
801071af:	e8 ed 91 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801071b4:	c7 04 24 02 93 10 80 	movl   $0x80109302,(%esp)
801071bb:	e8 7d 93 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071c0:	e8 80 fc ff ff       	call   80106e45 <rcr2>
...
801071ee:	89 45 d4             	mov    %eax,-0x2c(%ebp)
...
8010720e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80107211:	89 54 24 08          	mov    %edx,0x8(%esp)
80107215:	89 44 24 04          	mov    %eax,0x4(%esp)
80107219:	c7 04 24 08 93 10 80 	movl   $0x80109308,(%esp)
...
80107232:	eb 01                	jmp    80107235 <trap+0x24a>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
8010725c:	75 05                	jne    80107263 <trap+0x278>
    exit();
8010725e:	e8 84 d9 ff ff       	call   80104be7 <exit>
...
8010726b:	0f 84 a7 00 00 00    	je     80107318 <trap+0x32d>
80107271:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107277:	8b 40 0c             	mov    0xc(%eax),%eax
8010727a:	83 f8 04             	cmp    $0x4,%eax
8010727d:	0f 85 95 00 00 00    	jne    80107318 <trap+0x32d>
80107283:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107289:	8b 88 94 00 00 00    	mov    0x94(%eax),%ecx
8010728f:	ba 67 66 66 66       	mov    $0x66666667,%edx
80107294:	89 c8                	mov    %ecx,%eax
80107296:	f7 ea                	imul   %edx
80107298:	d1 fa                	sar    %edx
8010729a:	89 c8                	mov    %ecx,%eax
8010729c:	c1 f8 1f             	sar    $0x1f,%eax
8010729f:	29 c2                	sub    %eax,%edx
801072a1:	89 d0                	mov    %edx,%eax
801072a3:	c1 e0 02             	shl    $0x2,%eax
801072a6:	01 d0                	add    %edx,%eax
801072a8:	89 ca                	mov    %ecx,%edx
801072aa:	29 c2                	sub    %eax,%edx
801072ac:	85 d2                	test   %edx,%edx
801072ae:	75 68                	jne    80107318 <trap+0x32d>
801072b0:	8b 45 08             	mov    0x8(%ebp),%eax
801072b3:	8b 40 30             	mov    0x30(%eax),%eax
801072b6:	83 f8 20             	cmp    $0x20,%eax
801072b9:	75 5d                	jne    80107318 <trap+0x32d>
    int check = 1;
801072bb:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
    #ifdef _3Q
    if (proc->priority == LOW)
801072c2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801072c8:	8b 80 9c 00 00 00    	mov    0x9c(%eax),%eax
801072ce:	83 f8 03             	cmp    $0x3,%eax
801072d1:	75 07                	jne    801072da <trap+0x2ef>
      check = 0;
801072d3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    #endif
    if (check){
801072da:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801072de:	74 38                	je     80107318 <trap+0x32d>
      if (proc->priority == HIGH)
801072e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801072e6:	8b 80 9c 00 00 00    	mov    0x9c(%eax),%eax
801072ec:	83 f8 01             	cmp    $0x1,%eax
801072ef:	75 12                	jne    80107303 <trap+0x318>
	proc->priority = MEDIUM;
801072f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801072f7:	c7 80 9c 00 00 00 02 	movl   $0x2,0x9c(%eax)
801072fe:	00 00 00 
80107301:	eb 10                	jmp    80107313 <trap+0x328>
      else
	proc->priority = LOW;
80107303:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107309:	c7 80 9c 00 00 00 03 	movl   $0x3,0x9c(%eax)
80107310:	00 00 00 
      yield();
80107313:	e8 99 df ff ff       	call   801052b1 <yield>
    }
  }
  #endif
...
8010733f:	75 08                	jne    80107349 <trap+0x35e>
    exit();
80107341:	e8 a1 d8 ff ff       	call   80104be7 <exit>
80107346:	eb 01                	jmp    80107349 <trap+0x35e>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80107349:	83 c4 4c             	add    $0x4c,%esp
8010734c:	5b                   	pop    %ebx
8010734d:	5e                   	pop    %esi
8010734e:	5f                   	pop    %edi
8010734f:	5d                   	pop    %ebp
...
8010743c:	74 6c                	je     801074aa <uartinit+0x10e>
    return;
  uart = 1;
8010743e:	c7 05 0c d6 10 80 01 	movl   $0x1,0x8010d60c
80107445:	00 00 00 
...
80107467:	e8 69 cd ff ff       	call   801041d5 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010746c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107473:	00 
80107474:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010747b:	e8 0a bc ff ff       	call   8010308a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107480:	c7 45 f4 cc 93 10 80 	movl   $0x801093cc,-0xc(%ebp)
...
801074b0:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801074b3:	a1 0c d6 10 80       	mov    0x8010d60c,%eax
...
801074cc:	e8 51 c1 ff ff       	call   80103622 <microdelay>
{
  int i;
...
8010750f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107512:	a1 0c d6 10 80       	mov    0x8010d60c,%eax
...
8010755d:	e8 7e 92 ff ff       	call   801007e0 <consoleintr>
}
80107562:	c9                   	leave  
80107563:	c3                   	ret    
...
80107566:	6a 00                	push   $0x0
  jmp alltraps
80107568:	e9 83 f8 ff ff       	jmp    80106df0 <alltraps>
...
80107581:	6a 03                	push   $0x3
  jmp alltraps
80107583:	e9 68 f8 ff ff       	jmp    80106df0 <alltraps>
...
8010758a:	6a 04                	push   $0x4
  jmp alltraps
8010758c:	e9 5f f8 ff ff       	jmp    80106df0 <alltraps>
...
80107593:	6a 05                	push   $0x5
  jmp alltraps
80107595:	e9 56 f8 ff ff       	jmp    80106df0 <alltraps>
...
8010759c:	6a 06                	push   $0x6
  jmp alltraps
8010759e:	e9 4d f8 ff ff       	jmp    80106df0 <alltraps>
...
801075a5:	6a 07                	push   $0x7
  jmp alltraps
801075a7:	e9 44 f8 ff ff       	jmp    80106df0 <alltraps>
...
801075ac:	6a 08                	push   $0x8
  jmp alltraps
801075ae:	e9 3d f8 ff ff       	jmp    80106df0 <alltraps>
...
801075b5:	6a 09                	push   $0x9
  jmp alltraps
801075b7:	e9 34 f8 ff ff       	jmp    80106df0 <alltraps>
...
801075bc:	6a 0a                	push   $0xa
  jmp alltraps
801075be:	e9 2d f8 ff ff       	jmp    80106df0 <alltraps>
...
801075c3:	6a 0b                	push   $0xb
  jmp alltraps
801075c5:	e9 26 f8 ff ff       	jmp    80106df0 <alltraps>
...
801075ca:	6a 0c                	push   $0xc
  jmp alltraps
801075cc:	e9 1f f8 ff ff       	jmp    80106df0 <alltraps>
...
801075d1:	6a 0d                	push   $0xd
  jmp alltraps
801075d3:	e9 18 f8 ff ff       	jmp    80106df0 <alltraps>
...
801075f1:	6a 11                	push   $0x11
  jmp alltraps
801075f3:	e9 f8 f7 ff ff       	jmp    80106df0 <alltraps>
...
801075fa:	6a 12                	push   $0x12
  jmp alltraps
801075fc:	e9 ef f7 ff ff       	jmp    80106df0 <alltraps>
...
80107603:	6a 13                	push   $0x13
  jmp alltraps
80107605:	e9 e6 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010760c:	6a 14                	push   $0x14
  jmp alltraps
8010760e:	e9 dd f7 ff ff       	jmp    80106df0 <alltraps>
...
80107615:	6a 15                	push   $0x15
  jmp alltraps
80107617:	e9 d4 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010761e:	6a 16                	push   $0x16
  jmp alltraps
80107620:	e9 cb f7 ff ff       	jmp    80106df0 <alltraps>
...
80107627:	6a 17                	push   $0x17
  jmp alltraps
80107629:	e9 c2 f7 ff ff       	jmp    80106df0 <alltraps>
...
80107630:	6a 18                	push   $0x18
  jmp alltraps
80107632:	e9 b9 f7 ff ff       	jmp    80106df0 <alltraps>
...
80107639:	6a 19                	push   $0x19
  jmp alltraps
8010763b:	e9 b0 f7 ff ff       	jmp    80106df0 <alltraps>
...
80107642:	6a 1a                	push   $0x1a
  jmp alltraps
80107644:	e9 a7 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010764b:	6a 1b                	push   $0x1b
  jmp alltraps
8010764d:	e9 9e f7 ff ff       	jmp    80106df0 <alltraps>
...
80107654:	6a 1c                	push   $0x1c
  jmp alltraps
80107656:	e9 95 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010765d:	6a 1d                	push   $0x1d
  jmp alltraps
8010765f:	e9 8c f7 ff ff       	jmp    80106df0 <alltraps>
...
80107666:	6a 1e                	push   $0x1e
  jmp alltraps
80107668:	e9 83 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010766f:	6a 1f                	push   $0x1f
  jmp alltraps
80107671:	e9 7a f7 ff ff       	jmp    80106df0 <alltraps>
...
80107678:	6a 20                	push   $0x20
  jmp alltraps
8010767a:	e9 71 f7 ff ff       	jmp    80106df0 <alltraps>
...
80107681:	6a 21                	push   $0x21
  jmp alltraps
80107683:	e9 68 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010768a:	6a 22                	push   $0x22
  jmp alltraps
8010768c:	e9 5f f7 ff ff       	jmp    80106df0 <alltraps>
...
80107693:	6a 23                	push   $0x23
  jmp alltraps
80107695:	e9 56 f7 ff ff       	jmp    80106df0 <alltraps>
...
8010769c:	6a 24                	push   $0x24
  jmp alltraps
8010769e:	e9 4d f7 ff ff       	jmp    80106df0 <alltraps>
...
801076a5:	6a 25                	push   $0x25
  jmp alltraps
801076a7:	e9 44 f7 ff ff       	jmp    80106df0 <alltraps>
...
801076ae:	6a 26                	push   $0x26
  jmp alltraps
801076b0:	e9 3b f7 ff ff       	jmp    80106df0 <alltraps>
...
801076b7:	6a 27                	push   $0x27
  jmp alltraps
801076b9:	e9 32 f7 ff ff       	jmp    80106df0 <alltraps>
...
801076c0:	6a 28                	push   $0x28
  jmp alltraps
801076c2:	e9 29 f7 ff ff       	jmp    80106df0 <alltraps>
...
801076c9:	6a 29                	push   $0x29
  jmp alltraps
801076cb:	e9 20 f7 ff ff       	jmp    80106df0 <alltraps>
...
801076d2:	6a 2a                	push   $0x2a
  jmp alltraps
801076d4:	e9 17 f7 ff ff       	jmp    80106df0 <alltraps>
...
801076db:	6a 2b                	push   $0x2b
  jmp alltraps
801076dd:	e9 0e f7 ff ff       	jmp    80106df0 <alltraps>
...
801076e4:	6a 2c                	push   $0x2c
  jmp alltraps
801076e6:	e9 05 f7 ff ff       	jmp    80106df0 <alltraps>
...
801076ed:	6a 2d                	push   $0x2d
  jmp alltraps
801076ef:	e9 fc f6 ff ff       	jmp    80106df0 <alltraps>
...
801076f6:	6a 2e                	push   $0x2e
  jmp alltraps
801076f8:	e9 f3 f6 ff ff       	jmp    80106df0 <alltraps>
...
801076ff:	6a 2f                	push   $0x2f
  jmp alltraps
80107701:	e9 ea f6 ff ff       	jmp    80106df0 <alltraps>
...
80107708:	6a 30                	push   $0x30
  jmp alltraps
8010770a:	e9 e1 f6 ff ff       	jmp    80106df0 <alltraps>
...
80107711:	6a 31                	push   $0x31
  jmp alltraps
80107713:	e9 d8 f6 ff ff       	jmp    80106df0 <alltraps>
...
8010771a:	6a 32                	push   $0x32
  jmp alltraps
8010771c:	e9 cf f6 ff ff       	jmp    80106df0 <alltraps>
...
80107723:	6a 33                	push   $0x33
  jmp alltraps
80107725:	e9 c6 f6 ff ff       	jmp    80106df0 <alltraps>
...
8010772c:	6a 34                	push   $0x34
  jmp alltraps
8010772e:	e9 bd f6 ff ff       	jmp    80106df0 <alltraps>
...
80107735:	6a 35                	push   $0x35
  jmp alltraps
80107737:	e9 b4 f6 ff ff       	jmp    80106df0 <alltraps>
...
8010773e:	6a 36                	push   $0x36
  jmp alltraps
80107740:	e9 ab f6 ff ff       	jmp    80106df0 <alltraps>
...
80107747:	6a 37                	push   $0x37
  jmp alltraps
80107749:	e9 a2 f6 ff ff       	jmp    80106df0 <alltraps>
...
80107750:	6a 38                	push   $0x38
  jmp alltraps
80107752:	e9 99 f6 ff ff       	jmp    80106df0 <alltraps>
...
80107759:	6a 39                	push   $0x39
  jmp alltraps
8010775b:	e9 90 f6 ff ff       	jmp    80106df0 <alltraps>
...
80107762:	6a 3a                	push   $0x3a
  jmp alltraps
80107764:	e9 87 f6 ff ff       	jmp    80106df0 <alltraps>
...
8010776b:	6a 3b                	push   $0x3b
  jmp alltraps
8010776d:	e9 7e f6 ff ff       	jmp    80106df0 <alltraps>
...
80107774:	6a 3c                	push   $0x3c
  jmp alltraps
80107776:	e9 75 f6 ff ff       	jmp    80106df0 <alltraps>
...
8010777d:	6a 3d                	push   $0x3d
  jmp alltraps
8010777f:	e9 6c f6 ff ff       	jmp    80106df0 <alltraps>
...
80107786:	6a 3e                	push   $0x3e
  jmp alltraps
80107788:	e9 63 f6 ff ff       	jmp    80106df0 <alltraps>
...
8010778f:	6a 3f                	push   $0x3f
  jmp alltraps
80107791:	e9 5a f6 ff ff       	jmp    80106df0 <alltraps>
...
80107798:	6a 40                	push   $0x40
  jmp alltraps
8010779a:	e9 51 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077a1:	6a 41                	push   $0x41
  jmp alltraps
801077a3:	e9 48 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077aa:	6a 42                	push   $0x42
  jmp alltraps
801077ac:	e9 3f f6 ff ff       	jmp    80106df0 <alltraps>
...
801077b3:	6a 43                	push   $0x43
  jmp alltraps
801077b5:	e9 36 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077bc:	6a 44                	push   $0x44
  jmp alltraps
801077be:	e9 2d f6 ff ff       	jmp    80106df0 <alltraps>
...
801077c5:	6a 45                	push   $0x45
  jmp alltraps
801077c7:	e9 24 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077ce:	6a 46                	push   $0x46
  jmp alltraps
801077d0:	e9 1b f6 ff ff       	jmp    80106df0 <alltraps>
...
801077d7:	6a 47                	push   $0x47
  jmp alltraps
801077d9:	e9 12 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077e0:	6a 48                	push   $0x48
  jmp alltraps
801077e2:	e9 09 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077e9:	6a 49                	push   $0x49
  jmp alltraps
801077eb:	e9 00 f6 ff ff       	jmp    80106df0 <alltraps>
...
801077f2:	6a 4a                	push   $0x4a
  jmp alltraps
801077f4:	e9 f7 f5 ff ff       	jmp    80106df0 <alltraps>
...
801077fb:	6a 4b                	push   $0x4b
  jmp alltraps
801077fd:	e9 ee f5 ff ff       	jmp    80106df0 <alltraps>
...
80107804:	6a 4c                	push   $0x4c
  jmp alltraps
80107806:	e9 e5 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010780d:	6a 4d                	push   $0x4d
  jmp alltraps
8010780f:	e9 dc f5 ff ff       	jmp    80106df0 <alltraps>
...
80107816:	6a 4e                	push   $0x4e
  jmp alltraps
80107818:	e9 d3 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010781f:	6a 4f                	push   $0x4f
  jmp alltraps
80107821:	e9 ca f5 ff ff       	jmp    80106df0 <alltraps>
...
80107828:	6a 50                	push   $0x50
  jmp alltraps
8010782a:	e9 c1 f5 ff ff       	jmp    80106df0 <alltraps>
...
80107831:	6a 51                	push   $0x51
  jmp alltraps
80107833:	e9 b8 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010783a:	6a 52                	push   $0x52
  jmp alltraps
8010783c:	e9 af f5 ff ff       	jmp    80106df0 <alltraps>
...
80107843:	6a 53                	push   $0x53
  jmp alltraps
80107845:	e9 a6 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010784c:	6a 54                	push   $0x54
  jmp alltraps
8010784e:	e9 9d f5 ff ff       	jmp    80106df0 <alltraps>
...
80107855:	6a 55                	push   $0x55
  jmp alltraps
80107857:	e9 94 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010785e:	6a 56                	push   $0x56
  jmp alltraps
80107860:	e9 8b f5 ff ff       	jmp    80106df0 <alltraps>
...
80107867:	6a 57                	push   $0x57
  jmp alltraps
80107869:	e9 82 f5 ff ff       	jmp    80106df0 <alltraps>
...
80107870:	6a 58                	push   $0x58
  jmp alltraps
80107872:	e9 79 f5 ff ff       	jmp    80106df0 <alltraps>
...
80107879:	6a 59                	push   $0x59
  jmp alltraps
8010787b:	e9 70 f5 ff ff       	jmp    80106df0 <alltraps>
...
80107882:	6a 5a                	push   $0x5a
  jmp alltraps
80107884:	e9 67 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010788b:	6a 5b                	push   $0x5b
  jmp alltraps
8010788d:	e9 5e f5 ff ff       	jmp    80106df0 <alltraps>
...
80107894:	6a 5c                	push   $0x5c
  jmp alltraps
80107896:	e9 55 f5 ff ff       	jmp    80106df0 <alltraps>
...
8010789d:	6a 5d                	push   $0x5d
  jmp alltraps
8010789f:	e9 4c f5 ff ff       	jmp    80106df0 <alltraps>
...
801078a6:	6a 5e                	push   $0x5e
  jmp alltraps
801078a8:	e9 43 f5 ff ff       	jmp    80106df0 <alltraps>
...
801078af:	6a 5f                	push   $0x5f
  jmp alltraps
801078b1:	e9 3a f5 ff ff       	jmp    80106df0 <alltraps>
...
801078b8:	6a 60                	push   $0x60
  jmp alltraps
801078ba:	e9 31 f5 ff ff       	jmp    80106df0 <alltraps>
...
801078c1:	6a 61                	push   $0x61
  jmp alltraps
801078c3:	e9 28 f5 ff ff       	jmp    80106df0 <alltraps>
...
801078ca:	6a 62                	push   $0x62
  jmp alltraps
801078cc:	e9 1f f5 ff ff       	jmp    80106df0 <alltraps>
...
801078d3:	6a 63                	push   $0x63
  jmp alltraps
801078d5:	e9 16 f5 ff ff       	jmp    80106df0 <alltraps>
...
801078dc:	6a 64                	push   $0x64
  jmp alltraps
801078de:	e9 0d f5 ff ff       	jmp    80106df0 <alltraps>
...
801078e5:	6a 65                	push   $0x65
  jmp alltraps
801078e7:	e9 04 f5 ff ff       	jmp    80106df0 <alltraps>
...
801078ee:	6a 66                	push   $0x66
  jmp alltraps
801078f0:	e9 fb f4 ff ff       	jmp    80106df0 <alltraps>
...
801078f7:	6a 67                	push   $0x67
  jmp alltraps
801078f9:	e9 f2 f4 ff ff       	jmp    80106df0 <alltraps>
...
80107900:	6a 68                	push   $0x68
  jmp alltraps
80107902:	e9 e9 f4 ff ff       	jmp    80106df0 <alltraps>
...
80107909:	6a 69                	push   $0x69
  jmp alltraps
8010790b:	e9 e0 f4 ff ff       	jmp    80106df0 <alltraps>
...
80107912:	6a 6a                	push   $0x6a
  jmp alltraps
80107914:	e9 d7 f4 ff ff       	jmp    80106df0 <alltraps>
...
8010791b:	6a 6b                	push   $0x6b
  jmp alltraps
8010791d:	e9 ce f4 ff ff       	jmp    80106df0 <alltraps>
...
80107924:	6a 6c                	push   $0x6c
  jmp alltraps
80107926:	e9 c5 f4 ff ff       	jmp    80106df0 <alltraps>
...
8010792d:	6a 6d                	push   $0x6d
  jmp alltraps
8010792f:	e9 bc f4 ff ff       	jmp    80106df0 <alltraps>
...
80107936:	6a 6e                	push   $0x6e
  jmp alltraps
80107938:	e9 b3 f4 ff ff       	jmp    80106df0 <alltraps>
...
8010793f:	6a 6f                	push   $0x6f
  jmp alltraps
80107941:	e9 aa f4 ff ff       	jmp    80106df0 <alltraps>
...
80107948:	6a 70                	push   $0x70
  jmp alltraps
8010794a:	e9 a1 f4 ff ff       	jmp    80106df0 <alltraps>
...
80107951:	6a 71                	push   $0x71
  jmp alltraps
80107953:	e9 98 f4 ff ff       	jmp    80106df0 <alltraps>
...
8010795a:	6a 72                	push   $0x72
  jmp alltraps
8010795c:	e9 8f f4 ff ff       	jmp    80106df0 <alltraps>
...
80107963:	6a 73                	push   $0x73
  jmp alltraps
80107965:	e9 86 f4 ff ff       	jmp    80106df0 <alltraps>
...
8010796c:	6a 74                	push   $0x74
  jmp alltraps
8010796e:	e9 7d f4 ff ff       	jmp    80106df0 <alltraps>
...
80107975:	6a 75                	push   $0x75
  jmp alltraps
80107977:	e9 74 f4 ff ff       	jmp    80106df0 <alltraps>
...
8010797e:	6a 76                	push   $0x76
  jmp alltraps
80107980:	e9 6b f4 ff ff       	jmp    80106df0 <alltraps>
...
80107987:	6a 77                	push   $0x77
  jmp alltraps
80107989:	e9 62 f4 ff ff       	jmp    80106df0 <alltraps>
...
80107990:	6a 78                	push   $0x78
  jmp alltraps
80107992:	e9 59 f4 ff ff       	jmp    80106df0 <alltraps>
...
80107999:	6a 79                	push   $0x79
  jmp alltraps
8010799b:	e9 50 f4 ff ff       	jmp    80106df0 <alltraps>
...
801079a2:	6a 7a                	push   $0x7a
  jmp alltraps
801079a4:	e9 47 f4 ff ff       	jmp    80106df0 <alltraps>
...
801079ab:	6a 7b                	push   $0x7b
  jmp alltraps
801079ad:	e9 3e f4 ff ff       	jmp    80106df0 <alltraps>
...
801079b4:	6a 7c                	push   $0x7c
  jmp alltraps
801079b6:	e9 35 f4 ff ff       	jmp    80106df0 <alltraps>
...
801079bd:	6a 7d                	push   $0x7d
  jmp alltraps
801079bf:	e9 2c f4 ff ff       	jmp    80106df0 <alltraps>
...
801079c6:	6a 7e                	push   $0x7e
  jmp alltraps
801079c8:	e9 23 f4 ff ff       	jmp    80106df0 <alltraps>
...
801079cf:	6a 7f                	push   $0x7f
  jmp alltraps
801079d1:	e9 1a f4 ff ff       	jmp    80106df0 <alltraps>
...
801079d8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801079dd:	e9 0e f4 ff ff       	jmp    80106df0 <alltraps>
...
801079e4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801079e9:	e9 02 f4 ff ff       	jmp    80106df0 <alltraps>
...
801079f0:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801079f5:	e9 f6 f3 ff ff       	jmp    80106df0 <alltraps>
...
801079fc:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107a01:	e9 ea f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a08:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107a0d:	e9 de f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a14:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107a19:	e9 d2 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a20:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107a25:	e9 c6 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a2c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107a31:	e9 ba f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a38:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107a3d:	e9 ae f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a44:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107a49:	e9 a2 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a50:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107a55:	e9 96 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a5c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107a61:	e9 8a f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a68:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107a6d:	e9 7e f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a74:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107a79:	e9 72 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a80:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107a85:	e9 66 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a8c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107a91:	e9 5a f3 ff ff       	jmp    80106df0 <alltraps>
...
80107a98:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107a9d:	e9 4e f3 ff ff       	jmp    80106df0 <alltraps>
...
80107aa4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107aa9:	e9 42 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107ab0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107ab5:	e9 36 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107abc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107ac1:	e9 2a f3 ff ff       	jmp    80106df0 <alltraps>
...
80107ac8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107acd:	e9 1e f3 ff ff       	jmp    80106df0 <alltraps>
...
80107ad4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107ad9:	e9 12 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107ae0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107ae5:	e9 06 f3 ff ff       	jmp    80106df0 <alltraps>
...
80107aec:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107af1:	e9 fa f2 ff ff       	jmp    80106df0 <alltraps>
...
80107af8:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107afd:	e9 ee f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b04:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107b09:	e9 e2 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b10:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107b15:	e9 d6 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b1c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107b21:	e9 ca f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b28:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107b2d:	e9 be f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b34:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107b39:	e9 b2 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b40:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107b45:	e9 a6 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b4c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107b51:	e9 9a f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b58:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107b5d:	e9 8e f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b64:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107b69:	e9 82 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b70:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107b75:	e9 76 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b7c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107b81:	e9 6a f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b88:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107b8d:	e9 5e f2 ff ff       	jmp    80106df0 <alltraps>
...
80107b94:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107b99:	e9 52 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107ba0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107ba5:	e9 46 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107bac:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107bb1:	e9 3a f2 ff ff       	jmp    80106df0 <alltraps>
...
80107bb8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107bbd:	e9 2e f2 ff ff       	jmp    80106df0 <alltraps>
...
80107bc4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107bc9:	e9 22 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107bd0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107bd5:	e9 16 f2 ff ff       	jmp    80106df0 <alltraps>
...
80107bdc:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107be1:	e9 0a f2 ff ff       	jmp    80106df0 <alltraps>
...
80107be8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107bed:	e9 fe f1 ff ff       	jmp    80106df0 <alltraps>
...
80107bf4:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107bf9:	e9 f2 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c00:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107c05:	e9 e6 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c0c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107c11:	e9 da f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c18:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107c1d:	e9 ce f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c24:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107c29:	e9 c2 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c30:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107c35:	e9 b6 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c3c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107c41:	e9 aa f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c48:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107c4d:	e9 9e f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c54:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107c59:	e9 92 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c60:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107c65:	e9 86 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c6c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107c71:	e9 7a f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c78:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107c7d:	e9 6e f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c84:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107c89:	e9 62 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c90:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107c95:	e9 56 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107c9c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107ca1:	e9 4a f1 ff ff       	jmp    80106df0 <alltraps>
...
80107ca8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107cad:	e9 3e f1 ff ff       	jmp    80106df0 <alltraps>
...
80107cb4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107cb9:	e9 32 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107cc0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107cc5:	e9 26 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107ccc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107cd1:	e9 1a f1 ff ff       	jmp    80106df0 <alltraps>
...
80107cd8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107cdd:	e9 0e f1 ff ff       	jmp    80106df0 <alltraps>
...
80107ce4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107ce9:	e9 02 f1 ff ff       	jmp    80106df0 <alltraps>
...
80107cf0:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107cf5:	e9 f6 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107cfc:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107d01:	e9 ea f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d08:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107d0d:	e9 de f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d14:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107d19:	e9 d2 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d20:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107d25:	e9 c6 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d2c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107d31:	e9 ba f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d38:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107d3d:	e9 ae f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d44:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107d49:	e9 a2 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d50:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107d55:	e9 96 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d5c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107d61:	e9 8a f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d68:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107d6d:	e9 7e f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d74:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107d79:	e9 72 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d80:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107d85:	e9 66 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d8c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107d91:	e9 5a f0 ff ff       	jmp    80106df0 <alltraps>
...
80107d98:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107d9d:	e9 4e f0 ff ff       	jmp    80106df0 <alltraps>
...
80107da4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107da9:	e9 42 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107db0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107db5:	e9 36 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107dbc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107dc1:	e9 2a f0 ff ff       	jmp    80106df0 <alltraps>
...
80107dc8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107dcd:	e9 1e f0 ff ff       	jmp    80106df0 <alltraps>
...
80107dd4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107dd9:	e9 12 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107de0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107de5:	e9 06 f0 ff ff       	jmp    80106df0 <alltraps>
...
80107dec:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107df1:	e9 fa ef ff ff       	jmp    80106df0 <alltraps>
...
80107df8:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107dfd:	e9 ee ef ff ff       	jmp    80106df0 <alltraps>
...
80107e04:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107e09:	e9 e2 ef ff ff       	jmp    80106df0 <alltraps>
...
80107e10:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107e15:	e9 d6 ef ff ff       	jmp    80106df0 <alltraps>
...
80107e1c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107e21:	e9 ca ef ff ff       	jmp    80106df0 <alltraps>
...
80107e28:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107e2d:	e9 be ef ff ff       	jmp    80106df0 <alltraps>
...
80107e34:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107e39:	e9 b2 ef ff ff       	jmp    80106df0 <alltraps>
...
80107e40:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107e45:	e9 a6 ef ff ff       	jmp    80106df0 <alltraps>
...
80107e4c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107e51:	e9 9a ef ff ff       	jmp    80106df0 <alltraps>
...
80107e58:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107e5d:	e9 8e ef ff ff       	jmp    80106df0 <alltraps>
...
80107e64:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107e69:	e9 82 ef ff ff       	jmp    80106df0 <alltraps>
...
80107e70:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107e75:	e9 76 ef ff ff       	jmp    80106df0 <alltraps>
...
80107e7c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107e81:	e9 6a ef ff ff       	jmp    80106df0 <alltraps>
...
80107e88:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107e8d:	e9 5e ef ff ff       	jmp    80106df0 <alltraps>
...
80107e94:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107e99:	e9 52 ef ff ff       	jmp    80106df0 <alltraps>
...
80107ea0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107ea5:	e9 46 ef ff ff       	jmp    80106df0 <alltraps>
...
80107eac:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107eb1:	e9 3a ef ff ff       	jmp    80106df0 <alltraps>
...
80107eb8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107ebd:	e9 2e ef ff ff       	jmp    80106df0 <alltraps>
...
80107ec4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107ec9:	e9 22 ef ff ff       	jmp    80106df0 <alltraps>
...
80107ed0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107ed5:	e9 16 ef ff ff       	jmp    80106df0 <alltraps>
...
80107edc:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107ee1:	e9 0a ef ff ff       	jmp    80106df0 <alltraps>
...
80107ee8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107eed:	e9 fe ee ff ff       	jmp    80106df0 <alltraps>
...
80107ef4:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107ef9:	e9 f2 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f00:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107f05:	e9 e6 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f0c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107f11:	e9 da ee ff ff       	jmp    80106df0 <alltraps>
...
80107f18:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107f1d:	e9 ce ee ff ff       	jmp    80106df0 <alltraps>
...
80107f24:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107f29:	e9 c2 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f30:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107f35:	e9 b6 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f3c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107f41:	e9 aa ee ff ff       	jmp    80106df0 <alltraps>
...
80107f48:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107f4d:	e9 9e ee ff ff       	jmp    80106df0 <alltraps>
...
80107f54:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107f59:	e9 92 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f60:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107f65:	e9 86 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f6c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107f71:	e9 7a ee ff ff       	jmp    80106df0 <alltraps>
...
80107f78:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107f7d:	e9 6e ee ff ff       	jmp    80106df0 <alltraps>
...
80107f84:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107f89:	e9 62 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f90:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107f95:	e9 56 ee ff ff       	jmp    80106df0 <alltraps>
...
80107f9c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107fa1:	e9 4a ee ff ff       	jmp    80106df0 <alltraps>
...
80107fa8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107fad:	e9 3e ee ff ff       	jmp    80106df0 <alltraps>
...
80107fb4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107fb9:	e9 32 ee ff ff       	jmp    80106df0 <alltraps>
...
80107fc0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107fc5:	e9 26 ee ff ff       	jmp    80106df0 <alltraps>
...
80107fcc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107fd1:	e9 1a ee ff ff       	jmp    80106df0 <alltraps>
	...
...
80108055:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80108058:	e8 44 b5 ff ff       	call   801035a1 <cpunum>
8010805d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80108063:	05 e0 18 11 80       	add    $0x801118e0,%eax
...
80108505:	e8 09 ad ff ff       	call   80103213 <kalloc>
...
80108530:	e8 bd d3 ff ff       	call   801058f2 <memset>
...
801085b3:	74 0c                	je     801085c1 <mappages+0x64>
      panic("remap");
801085b5:	c7 04 24 d4 93 10 80 	movl   $0x801093d4,(%esp)
...
801085f8:	e8 16 ac ff ff       	call   80103213 <kalloc>
...
80108626:	e8 c7 d2 ff ff       	call   801058f2 <memset>
...
8010863e:	c7 04 24 da 93 10 80 	movl   $0x801093da,(%esp)
80108645:	e8 f3 7e ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010864a:	c7 45 f4 a0 c4 10 80 	movl   $0x8010c4a0,-0xc(%ebp)
...
8010869c:	81 7d f4 e0 c4 10 80 	cmpl   $0x8010c4e0,-0xc(%ebp)
...
801086b9:	a3 b8 4f 11 80       	mov    %eax,0x80114fb8
  switchkvm();
...
801086cb:	a1 b8 4f 11 80       	mov    0x80114fb8,%eax
...
801086e6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801086e9:	e8 fd d0 ff ff       	call   801057eb <pushcli>
...
8010881c:	c7 04 24 eb 93 10 80 	movl   $0x801093eb,(%esp)
...
80108839:	e8 ee f7 ff ff       	call   8010802c <lcr3>
  popcli();
8010883e:	e8 f0 cf ff ff       	call   80105833 <popcli>
}
...
80108858:	c7 04 24 ff 93 10 80 	movl   $0x801093ff,(%esp)
8010885f:	e8 d9 7c ff ff       	call   8010053d <panic>
  mem = kalloc();
80108864:	e8 aa a9 ff ff       	call   80103213 <kalloc>
...
80108882:	e8 6b d0 ff ff       	call   801058f2 <memset>
...
801088cd:	e8 f3 d0 ff ff       	call   801059c5 <memmove>
}
801088d2:	c9                   	leave  
801088d3:	c3                   	ret    
...
801088e7:	c7 04 24 1c 94 10 80 	movl   $0x8010941c,(%esp)
...
80108927:	c7 04 24 3f 94 10 80 	movl   $0x8010943f,(%esp)
...
80108994:	e8 d9 9a ff ff       	call   80102472 <readi>
...
80108a4f:	e8 9e ce ff ff       	call   801058f2 <memset>
...
80108b11:	75 0c                	jne    80108b1f <deallocuvm+0x82>
        panic("kfree");
80108b13:	c7 04 24 75 94 10 80 	movl   $0x80109475,(%esp)
...
80108b33:	e8 42 a6 ff ff       	call   8010317a <kfree>
      *pte = 0;
...
80108b65:	c7 04 24 7b 94 10 80 	movl   $0x8010947b,(%esp)
...
80108bc8:	e8 ad a5 ff ff       	call   8010317a <kfree>
  uint i;
...
80108be0:	e8 95 a5 ff ff       	call   8010317a <kfree>
}
80108be5:	c9                   	leave  
80108be6:	c3                   	ret    
...
80108c0e:	75 0c                	jne    80108c1c <clearpteu+0x35>
    panic("clearpteu");
80108c10:	c7 04 24 8c 94 10 80 	movl   $0x8010948c,(%esp)
...
80108c7a:	c7 04 24 96 94 10 80 	movl   $0x80109496,(%esp)
...
80108c92:	c7 04 24 b0 94 10 80 	movl   $0x801094b0,(%esp)
...
80108ca8:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
80108cab:	e8 63 a5 ff ff       	call   80103213 <kalloc>
...
80108cd6:	e8 ea cc ff ff       	call   801059c5 <memmove>
...
80108e1b:	e8 a5 cb ff ff       	call   801059c5 <memmove>
    len -= n;
